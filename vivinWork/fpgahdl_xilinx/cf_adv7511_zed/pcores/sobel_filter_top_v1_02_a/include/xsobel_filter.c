...
void XSobel_filter_InterruptClear(XSobel_filter *InstancePtr, u32 Mask) {
    ...
    Register =  XSobel_filter_ReadReg(InstancePtr->Control_bus_BaseAddress, XSOBEL_FILTER_CONTROL_BUS_ADDR_ISR);
    XSobel_filter_WriteReg(InstancePtr->Control_bus_BaseAddress, XSOBEL_FILTER_CONTROL_BUS_ADDR_ISR, Register & Mask);
}
