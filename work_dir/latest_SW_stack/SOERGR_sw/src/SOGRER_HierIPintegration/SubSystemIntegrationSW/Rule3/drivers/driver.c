...
void Subsystem_R3_intrInitialize(Subsystem_R3_DriverInstance *InstancePtr, IntCntrl_t *InterruptController){
	...
	// Interrupt initializing the GrayscaleIP
    GrayscaleIP_Driver_intrInitialize(&InstancePtr->_GrayscaleIP_DriverInstance, InterruptController);
...
void Subsystem_R3_initialize(Subsystem_R3_DriverInstance *InstancePtr, Subsystem_R3_RegMap Subsystem_InitMode){
	...
	Subsystem_InitMode._GrayscaleIP_RegMap.ROWS_DATA.mask = 0xffffffff;
	Subsystem_InitMode._GrayscaleIP_RegMap.ROWS_DATA.value = 480;
	Subsystem_InitMode._GrayscaleIP_RegMap.COLS_DATA.mask = 0xffffffff;
	Subsystem_InitMode._GrayscaleIP_RegMap.COLS_DATA.value = 640;
    GrayscaleIP_RegWrite(InstancePtr->_GrayscaleIP_DriverInstance.baseaddr + 0x0, 0x00000081, 0x81);


    // initializing the GrayscaleIP
    GrayscaleIP_Driver_initialize(&InstancePtr->_GrayscaleIP_DriverInstance, Subsystem_InitMode._GrayscaleIP_RegMap);
...
void Subsystem_R3_start(Subsystem_R3_DriverInstance *InstancePtr, Subsystem_R3_RegMap Subsystem_R3_StartMode,
	...
	GrayscaleIP_Driver_start(&InstancePtr->_GrayscaleIP_DriverInstance, Subsystem_R3_StartMode._GrayscaleIP_RegMap);
	// starting the VDMAIP
	VDMAIP_Driver_start(&InstancePtr->_VDMAIP_DriverInstance, Subsystem_R3_StartMode._VDMAIP_RegMap);
...
void Subsystem_R3_stop(Subsystem_R3_DriverInstance *InstancePtr, Subsystem_R3_RegMap Subsystem_R3_StopMode) {
	...
	GrayscaleIP_Driver_stop(&InstancePtr->_GrayscaleIP_DriverInstance, Subsystem_R3_StopMode._GrayscaleIP_RegMap);
	// stopping VDMAIP
	VDMAIP_Driver_stop(&InstancePtr->_VDMAIP_DriverInstance, Subsystem_R3_StopMode._VDMAIP_RegMap);
}
