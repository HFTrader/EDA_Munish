...
#ifndef _AXIvideo2Mat_64_1080_1920_16_s_HH_
#define _AXIvideo2Mat_64_1080_1920_16_s_HH_
...
struct AXIvideo2Mat_64_1080_1920_16_s : public sc_module {
    ...
    // Module declarations
    AXIvideo2Mat_64_1080_1920_16_s(sc_module_name name);
    SC_HAS_PROCESS(AXIvideo2Mat_64_1080_1920_16_s);

    ~AXIvideo2Mat_64_1080_1920_16_s();
    ...
    sc_signal< sc_lv<12> > t_V_1_reg_231;
    sc_signal< sc_lv<64> > axi_data_V_2_reg_242;
    sc_signal< sc_lv<1> > eol_6_reg_253;
    sc_signal< sc_lv<1> > eol_reg_264;
    ...
    sc_signal< sc_lv<12> > i_V_reg_469;
    sc_signal< sc_lv<1> > exitcond3_fu_393_p2;
    sc_signal< sc_lv<1> > exitcond3_reg_474;
    sc_signal< sc_logic > ap_reg_ppiten_pp1_it0;
    sc_signal< sc_lv<1> > sof_load_reg_483;
    sc_signal< bool > ap_sig_bdd_144;
    sc_signal< sc_logic > ap_reg_ppiten_pp1_it1;
    sc_signal< sc_lv<12> > j_V_fu_398_p2;
    sc_signal< sc_lv<1> > sof_load_load_fu_404_p1;
    sc_signal< sc_lv<1> > exitcond_fu_382_p2;
    sc_signal< sc_lv<64> > axi_data_V_reg_163;
    sc_signal< sc_lv<1> > axi_last_V_reg_175;
    sc_signal< sc_lv<1> > axi_user_V_reg_187;
    sc_signal< sc_lv<64> > axi_data_V_4_reg_321;
    sc_signal< sc_lv<64> > axi_data_V_1_reg_198;
    sc_signal< sc_lv<1> > axi_last_V_4_reg_333;
    sc_signal< sc_lv<1> > axi_last_V_1_reg_209;
    sc_signal< sc_lv<12> > t_V_reg_220;
    sc_signal< sc_lv<64> > axi_data_V_8_phi_fu_280_p6;
    sc_signal< sc_lv<1> > axi_last_V_7_phi_fu_295_p6;
    sc_signal< sc_lv<1> > eol_5_phi_fu_310_p6;
    sc_signal< sc_lv<1> > eol_1_reg_345;
    sc_signal< sc_logic > AXI_video_strm_V_0_update;
    sc_signal< sc_lv<1> > sof_fu_108;
    ...
    void thread_axi_data_V_8_phi_fu_280_p6();
    void thread_axi_last_V_7_phi_fu_295_p6();
    void thread_eol_5_phi_fu_310_p6();
    ...
    void thread_j_V_fu_398_p2();
    void thread_sof_load_load_fu_404_p1();
