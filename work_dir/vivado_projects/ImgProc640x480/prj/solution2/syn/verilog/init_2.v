...
always @ (ap_CS_fsm or ap_sig_bdd_29 or tmp_112_fu_33_p1 or ap_return_0_preg)
begin
    if (((ap_ST_st1_fsm_0 == ap_CS_fsm) & ~ap_sig_bdd_29)) begin
...
always @ (ap_CS_fsm or ap_sig_bdd_29 or tmp_fu_29_p1 or ap_return_1_preg)
begin
    if (((ap_ST_st1_fsm_0 == ap_CS_fsm) & ~ap_sig_bdd_29)) begin
...
assign tmp_112_fu_33_p1 = p_rows[11:0];
