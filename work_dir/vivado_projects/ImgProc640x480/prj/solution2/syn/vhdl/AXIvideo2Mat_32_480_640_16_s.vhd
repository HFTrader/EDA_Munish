...
entity AXIvideo2Mat_32_480_640_16_s is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of AXIvideo2Mat_32_480_640_16_s is 
    ...
    signal t_V_3_reg_229 : STD_LOGIC_VECTOR (11 downto 0);
    signal axi_data_V_2_reg_240 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal axi_data_V_1_reg_196 : STD_LOGIC_VECTOR (31 downto 0);
    signal axi_last_V_4_reg_331 : STD_LOGIC_VECTOR (0 downto 0);
    signal axi_last_V_1_reg_207 : STD_LOGIC_VECTOR (0 downto 0);
...
begin
    ...
    axi_data_V_8_phi_fu_278_p6_assign_proc : process(AXI_video_strm_V_data_V_dout, axi_data_V_2_reg_240, sof_load_reg_481, ap_sig_bdd_322, ap_sig_bdd_324, ap_sig_bdd_274)
    begin
    ...
    exitcond3_fu_391_p2 <= "1" when (t_V_3_reg_229 = img_cols_V_read) else "0";
    ...
    j_V_fu_396_p2 <= std_logic_vector(unsigned(t_V_3_reg_229) + unsigned(ap_const_lv12_1));
