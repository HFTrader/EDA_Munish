...
architecture behav of init is 
    ...
    signal tmp_110_fu_33_p1 : STD_LOGIC_VECTOR (11 downto 0);
...
begin
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if (((ap_ST_st1_fsm_0 = ap_CS_fsm) and not(ap_sig_bdd_31))) then 
                    ap_return_0_preg <= tmp_110_fu_33_p1;
                end if; 
            end if;
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if (((ap_ST_st1_fsm_0 = ap_CS_fsm) and not(ap_sig_bdd_31))) then 
                    ap_return_1_preg <= tmp_110_fu_33_p1;
                end if; 
            end if;
        end if;
    end process;
    ...
    ap_return_0_assign_proc : process(ap_CS_fsm, ap_sig_bdd_31, tmp_110_fu_33_p1, ap_return_0_preg)
    begin
        if (((ap_ST_st1_fsm_0 = ap_CS_fsm) and not(ap_sig_bdd_31))) then 
            ap_return_0 <= tmp_110_fu_33_p1;
        else 
    ...
    ap_return_1_assign_proc : process(ap_CS_fsm, ap_sig_bdd_31, tmp_110_fu_33_p1, ap_return_1_preg)
    begin
        if (((ap_ST_st1_fsm_0 = ap_CS_fsm) and not(ap_sig_bdd_31))) then 
            ap_return_1 <= tmp_110_fu_33_p1;
        else 
    ...
    ap_return_2_assign_proc : process(ap_CS_fsm, ap_sig_bdd_31, tmp_fu_29_p1, ap_return_2_preg)
    begin
        if (((ap_ST_st1_fsm_0 = ap_CS_fsm) and not(ap_sig_bdd_31))) then 
            ap_return_2 <= tmp_fu_29_p1;
        else 
    ...
    ap_return_3_assign_proc : process(ap_CS_fsm, ap_sig_bdd_31, tmp_fu_29_p1, ap_return_3_preg)
    begin
        if (((ap_ST_st1_fsm_0 = ap_CS_fsm) and not(ap_sig_bdd_31))) then 
            ap_return_3 <= tmp_fu_29_p1;
        else 
    ...
    tmp_110_fu_33_p1 <= p_rows(12 - 1 downto 0);
    tmp_fu_29_p1 <= p_cols(12 - 1 downto 0);
end behav;
