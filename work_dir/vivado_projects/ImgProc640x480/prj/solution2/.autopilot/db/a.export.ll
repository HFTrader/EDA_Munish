; ModuleID = '/ise_local2/umair_temp/vivado_projects/ImgProc640x480/prj/solution2/.autopilot/db/a.o.2.bc'
target datalayout = "e-p:64:64:64-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:64:64-f32:32:32-f64:64:64-v64:64:64-v128:128:128-a0:0:64-s0:64:64-f80:128:128-n8:16:32:64"
target triple = "x86_64-unknown-linux-gnu"

%0 = type { i32, i4, i4, i1, i1, i1, i1 }
%"hls::GetMaxDepth_ret" = type { double, double }
%"hls::Mat<480, 640, 16>::init.1_ret" = type { i12, i12 }
%"hls::Mat<480, 640, 16>::init.2_ret" = type { i12, i12 }
%"hls::Mat<480, 640, 16>::init.3_ret" = type { i12, i12 }
%"hls::Mat<480, 640, 16>::init_ret" = type { i12, i12, i12, i12 }
...
%"struct.hls::Mat<480,640,16>" = type { %"struct.ap_fixed<12,12,SC_RND,SC_WRAP,0>", %"struct.ap_fixed<12,12,SC_RND,SC_WRAP,0>", [3 x %"struct.hls::stream<unsigned char>"] }
...
@llvm_global_ctors_1 = appending global [1 x void ()*] [void ()* @_GLOBAL__I__Z5SobelRN3hls3MatILi480ELi640ELi16EEES2_ii] ; <[1 x void ()*]*> [#uses=0]
@llvm_global_dtors_0 = appending global [1 x i32] [i32 65535] ; <[1 x i32]*> [#uses=0]
@llvm_global_dtors_1 = appending global [1 x void ()*] [void ()* @_GLOBAL__D__Z5SobelRN3hls3MatILi480ELi640ELi16EEES2_ii] ; <[1 x void ()*]*> [#uses=0]
@p_str47 = internal constant [58 x i8] c"hls::LineBuffer<3, 640, unsigned char>::LineBuffer.region\00" ; <[58 x i8]*> [#uses=2]
@p_str48 = internal constant [58 x i8] c"hls::LineBuffer<3, 640, unsigned char>::LineBuffer.region\00" ; <[58 x i8]*> [#uses=2]
...
entry:
  ...
  %call_ret = call fastcc %"hls::Mat<480, 640, 16>::init_ret" @init(i32 %rows_read, i32 %cols_read) ; <%"hls::Mat<480, 640, 16>::init_ret"> [#uses=4]
  %img_0_rows_V = extractvalue %"hls::Mat<480, 640, 16>::init_ret" %call_ret, 0 ; <i12> [#uses=1]
  %img_0_rows_V_channel = extractvalue %"hls::Mat<480, 640, 16>::init_ret" %call_ret, 1 ; <i12> [#uses=1]
  %img_0_cols_V = extractvalue %"hls::Mat<480, 640, 16>::init_ret" %call_ret, 2 ; <i12> [#uses=1]
  %img_0_cols_V_channel = extractvalue %"hls::Mat<480, 640, 16>::init_ret" %call_ret, 3 ; <i12> [#uses=1]
  %call_ret1 = call fastcc %"hls::Mat<480, 640, 16>::init.1_ret" @init.1(i32 %rows_read, i32 %cols_read) ; <%"hls::Mat<480, 640, 16>::init.1_ret"> [#uses=2]
  %img_1_rows_V = extractvalue %"hls::Mat<480, 640, 16>::init.1_ret" %call_ret1, 0 ; <i12> [#uses=1]
  %img_1_cols_V = extractvalue %"hls::Mat<480, 640, 16>::init.1_ret" %call_ret1, 1 ; <i12> [#uses=1]
  %call_ret2 = call fastcc %"hls::Mat<480, 640, 16>::init.1_ret" @init.2(i32 %rows_read, i32 %cols_read) ; <%"hls::Mat<480, 640, 16>::init.1_ret"> [#uses=2]
  %img_2_rows_V = extractvalue %"hls::Mat<480, 640, 16>::init.1_ret" %call_ret2, 0 ; <i12> [#uses=1]
  %img_2_cols_V = extractvalue %"hls::Mat<480, 640, 16>::init.1_ret" %call_ret2, 1 ; <i12> [#uses=1]
  %call_ret3 = call fastcc %"hls::Mat<480, 640, 16>::init.1_ret" @init.3(i32 %rows_read, i32 %cols_read) ; <%"hls::Mat<480, 640, 16>::init.1_ret"> [#uses=2]
  %img_3_rows_V = extractvalue %"hls::Mat<480, 640, 16>::init.1_ret" %call_ret3, 0 ; <i12> [#uses=1]
  %img_3_cols_V = extractvalue %"hls::Mat<480, 640, 16>::init.1_ret" %call_ret3, 1 ; <i12> [#uses=1]
  call fastcc void @"AXIvideo2Mat<32,480,640,16>"(i32* %input_V_data_V, i4* %input_V_keep_V, i4* %input_V_strb_V, i1* %input_V_user_V, i1* %input_V_last_V, i1* %input_V_id_V, i1* %input_V_dest_V, i12 %img_0_rows_V, i12 %img_0_cols_V, i8* %img_0_data_stream_0_V, i8* %img_0_data_stream_1_V, i8* %img_0_data_stream_2_V)
  call fastcc void @"CvtColor<0,16,16,480,640>"(i12 %img_0_rows_V_channel, i12 %img_0_cols_V_channel, i8* %img_0_data_stream_0_V, i8* %img_0_data_stream_1_V, i8* %img_0_data_stream_2_V, i8* %img_1_data_stream_0_V, i8* %img_1_data_stream_1_V, i8* %img_1_data_stream_2_V)
  ...
  call fastcc void @"Erode<16,16,480,640>"(i12 %img_2_rows_V, i12 %img_2_cols_V, i8* %img_2_data_stream_0_V, i8* %img_2_data_stream_1_V, i8* %img_2_data_stream_2_V, i8* %img_3_data_stream_0_V, i8* %img_3_data_stream_1_V, i8* %img_3_data_stream_2_V)
  call fastcc void @"Mat2AXIvideo<32,480,640,16>"(i12 %img_3_rows_V, i12 %img_3_cols_V, i8* %img_3_data_stream_0_V, i8* %img_3_data_stream_1_V, i8* %img_3_data_stream_2_V, i32* %output_V_data_V, i4* %output_V_keep_V, i4* %output_V_strb_V, i1* %output_V_user_V, i1* %output_V_last_V, i1* %output_V_id_V, i1* %output_V_dest_V)
  ret void
}
...
declare void @_GLOBAL__I__Z5SobelRN3hls3MatILi480ELi640ELi16EEES2_ii() nounwind

declare void @_GLOBAL__D__Z5SobelRN3hls3MatILi480ELi640ELi16EEES2_ii() nounwind
...
define internal fastcc void @"filter_opr<filter2d_kernel,16,16,int,int,480,640,3,3>"(i8* %p_src_data_stream_0_V, i8* %p_src_data_stream_1_V, i8* %p_src_data_stream_2_V, i8* %p_dst_data_stream_0_V, i8* %p_dst_data_stream_1_V, i8* %p_dst_data_stream_2_V, i12 %rows, i12 %cols) {
entry_ifconv:
  ...
  %k_buf_0_val_0 = alloca [640 x i8], align 1     ; <[640 x i8]*> [#uses=3]
  %k_buf_0_val_1 = alloca [640 x i8], align 1     ; <[640 x i8]*> [#uses=4]
  %k_buf_0_val_2 = alloca [640 x i8], align 1     ; <[640 x i8]*> [#uses=4]
  %k_buf_1_val_0 = alloca [640 x i8], align 1     ; <[640 x i8]*> [#uses=3]
  %k_buf_1_val_1 = alloca [640 x i8], align 1     ; <[640 x i8]*> [#uses=4]
  %k_buf_1_val_2 = alloca [640 x i8], align 1     ; <[640 x i8]*> [#uses=4]
  %k_buf_2_val_0 = alloca [640 x i8], align 1     ; <[640 x i8]*> [#uses=3]
  %k_buf_2_val_1 = alloca [640 x i8], align 1     ; <[640 x i8]*> [#uses=4]
  %k_buf_2_val_2 = alloca [640 x i8], align 1     ; <[640 x i8]*> [#uses=4]
...
bb3:                                              ; preds = %bb4
  %rbegin2 = call i32 (...)* @_ssdm_op_SpecRegionBegin([58 x i8]* @p_str47) nounwind ; <i32> [#uses=1]
...
bb3304305:                                        ; preds = %branch5, %branch4, %branch3
  %rend484 = call i32 (...)* @_ssdm_op_SpecRegionEnd([58 x i8]* @p_str47, i32 %rbegin2) nounwind ; <i32> [#uses=0]
  br label %bb4
...
bb12:                                             ; preds = %bb106
  ...
  call void (...)* @_ssdm_op_SpecLoopTripCount(i64 5, i64 480, i64 0)
...
bb13_ifconv:                                      ; preds = %bb103
  ...
  call void (...)* @_ssdm_op_SpecLoopTripCount(i64 2, i64 640, i64 0)
...
bb52.preheader.0:                                 ; preds = %branch53, %branch52, %branch51, %bb38.0
  %k_buf_0_val_1_addr_2 = getelementptr [640 x i8]* %k_buf_0_val_1, i64 0, i64 %tmp_30 ; <i8*> [#uses=2]
  %temp_10 = load i8* %k_buf_0_val_1_addr_2, align 1 ; <i8> [#uses=3]
  store i8 %temp_10, i8* %k_buf_0_val_2_addr_1, align 1
  %k_buf_0_val_0_addr_2 = getelementptr [640 x i8]* %k_buf_0_val_0, i64 0, i64 %tmp_30 ; <i8*> [#uses=2]
...
bb38.0:                                           ; preds = %bb37.0
  ...
  %k_buf_0_val_2_addr_1 = getelementptr [640 x i8]* %k_buf_0_val_2, i64 0, i64 %tmp_30 ; <i8*> [#uses=2]
...
bb81.preheader.0:                                 ; preds = %bb74.0
  ...
  %k_buf_0_val_1_addr_3 = getelementptr [640 x i8]* %k_buf_0_val_1, i64 0, i64 %tmp_37 ; <i8*> [#uses=1]
  %src_kernel_win_0_val_0_0_9 = load i8* %k_buf_0_val_1_addr_3, align 1 ; <i8> [#uses=3]
  %k_buf_0_val_2_addr_3 = getelementptr [640 x i8]* %k_buf_0_val_2, i64 0, i64 %tmp_37 ; <i8*> [#uses=1]
...
bb61.preheader.0:                                 ; preds = %bb55.0, %bb36.0
  ...
  %k_buf_0_val_0_addr_1 = getelementptr [640 x i8]* %k_buf_0_val_0, i64 0, i64 %tmp_33 ; <i8*> [#uses=1]
  %src_kernel_win_0_val_0_0_5 = load i8* %k_buf_0_val_0_addr_1, align 1 ; <i8> [#uses=1]
  %k_buf_0_val_1_addr_1 = getelementptr [640 x i8]* %k_buf_0_val_1, i64 0, i64 %tmp_33 ; <i8*> [#uses=1]
  %src_kernel_win_0_val_1_0_4 = load i8* %k_buf_0_val_1_addr_1, align 1 ; <i8> [#uses=1]
  %k_buf_0_val_2_addr_2 = getelementptr [640 x i8]* %k_buf_0_val_2, i64 0, i64 %tmp_33 ; <i8*> [#uses=1]
...
bb29.preheader.0_ifconv:                          ; preds = %bb13_ifconv
  ...
  %k_buf_0_val_0_addr = getelementptr [640 x i8]* %k_buf_0_val_0, i64 0, i64 %tmp_28 ; <i8*> [#uses=1]
  %k_buf_0_val_0_load = load i8* %k_buf_0_val_0_addr, align 1 ; <i8> [#uses=4]
  store i8 %k_buf_0_val_0_load, i8* %col_buf_val_0_0_0, align 1
  %k_buf_0_val_1_addr = getelementptr [640 x i8]* %k_buf_0_val_1, i64 0, i64 %tmp_28 ; <i8*> [#uses=1]
  %k_buf_0_val_1_load = load i8* %k_buf_0_val_1_addr, align 1 ; <i8> [#uses=6]
  %k_buf_0_val_2_addr = getelementptr [640 x i8]* %k_buf_0_val_2, i64 0, i64 %tmp_28 ; <i8*> [#uses=1]
...
bb52.preheader.1:                                 ; preds = %branch62, %branch61, %branch60, %bb38.1
  %k_buf_1_val_1_addr_2 = getelementptr [640 x i8]* %k_buf_1_val_1, i64 0, i64 %tmp_184_1 ; <i8*> [#uses=2]
  %temp = load i8* %k_buf_1_val_1_addr_2, align 1 ; <i8> [#uses=3]
  store i8 %temp, i8* %k_buf_1_val_2_addr_1, align 1
  %k_buf_1_val_0_addr_2 = getelementptr [640 x i8]* %k_buf_1_val_0, i64 0, i64 %tmp_184_1 ; <i8*> [#uses=2]
...
bb38.1:                                           ; preds = %bb37.1
  ...
  %k_buf_1_val_2_addr_1 = getelementptr [640 x i8]* %k_buf_1_val_2, i64 0, i64 %tmp_184_1 ; <i8*> [#uses=2]
...
bb81.preheader.1:                                 ; preds = %bb74.1
  ...
  %k_buf_1_val_1_addr_3 = getelementptr [640 x i8]* %k_buf_1_val_1, i64 0, i64 %tmp_197_1 ; <i8*> [#uses=1]
  %src_kernel_win_1_val_0_0_9 = load i8* %k_buf_1_val_1_addr_3, align 1 ; <i8> [#uses=3]
  %k_buf_1_val_2_addr_3 = getelementptr [640 x i8]* %k_buf_1_val_2, i64 0, i64 %tmp_197_1 ; <i8*> [#uses=1]
...
bb61.preheader.1:                                 ; preds = %bb55.1, %bb36.1
  ...
  %k_buf_1_val_0_addr_1 = getelementptr [640 x i8]* %k_buf_1_val_0, i64 0, i64 %tmp_189_1 ; <i8*> [#uses=1]
  %src_kernel_win_1_val_0_0_5 = load i8* %k_buf_1_val_0_addr_1, align 1 ; <i8> [#uses=1]
  %k_buf_1_val_1_addr_1 = getelementptr [640 x i8]* %k_buf_1_val_1, i64 0, i64 %tmp_189_1 ; <i8*> [#uses=1]
  %src_kernel_win_1_val_1_0_4 = load i8* %k_buf_1_val_1_addr_1, align 1 ; <i8> [#uses=1]
  %k_buf_1_val_2_addr_2 = getelementptr [640 x i8]* %k_buf_1_val_2, i64 0, i64 %tmp_189_1 ; <i8*> [#uses=1]
...
bb29.preheader.1_ifconv:                          ; preds = %bb99.0_ifconv
  ...
  %k_buf_1_val_0_addr = getelementptr [640 x i8]* %k_buf_1_val_0, i64 0, i64 %tmp_177_1 ; <i8*> [#uses=1]
  %k_buf_1_val_0_load = load i8* %k_buf_1_val_0_addr, align 1 ; <i8> [#uses=4]
  store i8 %k_buf_1_val_0_load, i8* %col_buf_val_1_0_0, align 1
  %k_buf_1_val_1_addr = getelementptr [640 x i8]* %k_buf_1_val_1, i64 0, i64 %tmp_177_1 ; <i8*> [#uses=1]
  %k_buf_1_val_1_load = load i8* %k_buf_1_val_1_addr, align 1 ; <i8> [#uses=6]
  %k_buf_1_val_2_addr = getelementptr [640 x i8]* %k_buf_1_val_2, i64 0, i64 %tmp_177_1 ; <i8*> [#uses=1]
...
bb52.preheader.2:                                 ; preds = %branch71, %branch70, %branch69, %bb38.2
  %k_buf_2_val_1_addr_2 = getelementptr [640 x i8]* %k_buf_2_val_1, i64 0, i64 %tmp_184_2 ; <i8*> [#uses=2]
  %temp_13 = load i8* %k_buf_2_val_1_addr_2, align 1 ; <i8> [#uses=3]
  store i8 %temp_13, i8* %k_buf_2_val_2_addr_1, align 1
  %k_buf_2_val_0_addr_2 = getelementptr [640 x i8]* %k_buf_2_val_0, i64 0, i64 %tmp_184_2 ; <i8*> [#uses=2]
...
bb38.2:                                           ; preds = %bb37.2
  ...
  %k_buf_2_val_2_addr_1 = getelementptr [640 x i8]* %k_buf_2_val_2, i64 0, i64 %tmp_184_2 ; <i8*> [#uses=2]
...
bb81.preheader.2:                                 ; preds = %bb74.2
  ...
  %k_buf_2_val_1_addr_3 = getelementptr [640 x i8]* %k_buf_2_val_1, i64 0, i64 %tmp_197_2 ; <i8*> [#uses=1]
  %src_kernel_win_2_val_0_0_8 = load i8* %k_buf_2_val_1_addr_3, align 1 ; <i8> [#uses=3]
  %k_buf_2_val_2_addr_3 = getelementptr [640 x i8]* %k_buf_2_val_2, i64 0, i64 %tmp_197_2 ; <i8*> [#uses=1]
...
bb61.preheader.2:                                 ; preds = %bb55.2, %bb36.2
  ...
  %k_buf_2_val_0_addr_1 = getelementptr [640 x i8]* %k_buf_2_val_0, i64 0, i64 %tmp_189_2 ; <i8*> [#uses=1]
  %src_kernel_win_2_val_0_0_5 = load i8* %k_buf_2_val_0_addr_1, align 1 ; <i8> [#uses=1]
  %k_buf_2_val_1_addr_1 = getelementptr [640 x i8]* %k_buf_2_val_1, i64 0, i64 %tmp_189_2 ; <i8*> [#uses=1]
  %src_kernel_win_2_val_1_0_4 = load i8* %k_buf_2_val_1_addr_1, align 1 ; <i8> [#uses=1]
  %k_buf_2_val_2_addr_2 = getelementptr [640 x i8]* %k_buf_2_val_2, i64 0, i64 %tmp_189_2 ; <i8*> [#uses=1]
...
bb29.preheader.2_ifconv:                          ; preds = %bb99.1_ifconv
  ...
  %k_buf_2_val_0_addr = getelementptr [640 x i8]* %k_buf_2_val_0, i64 0, i64 %tmp_177_2 ; <i8*> [#uses=1]
  %k_buf_2_val_0_load = load i8* %k_buf_2_val_0_addr, align 1 ; <i8> [#uses=4]
  store i8 %k_buf_2_val_0_load, i8* %col_buf_val_2_0_0, align 1
  %k_buf_2_val_1_addr = getelementptr [640 x i8]* %k_buf_2_val_1, i64 0, i64 %tmp_177_2 ; <i8*> [#uses=1]
  %k_buf_2_val_1_load = load i8* %k_buf_2_val_1_addr, align 1 ; <i8> [#uses=6]
  %k_buf_2_val_2_addr = getelementptr [640 x i8]* %k_buf_2_val_2, i64 0, i64 %tmp_177_2 ; <i8*> [#uses=1]
...
define internal fastcc void @"filter_opr<erode_kernel,16,16,unsigned char,int,480,640,3,3>"(i8* %p_src_data_stream_0_V, i8* %p_src_data_stream_1_V, i8* %p_src_data_stream_2_V, i8* %p_dst_data_stream_0_V, i8* %p_dst_data_stream_1_V, i8* %p_dst_data_stream_2_V, i8 %kernel_val_0_0_read, i8 %kernel_val_0_1_read, i8 %kernel_val_0_2_read, i8 %kernel_val_1_0_read, i8 %kernel_val_1_1_read, i8 %kernel_val_1_2_read, i8 %kernel_val_2_0_read, i8 %kernel_val_2_1_read, i8 %kernel_val_2_2_read, i12 %rows, i12 %cols) {
entry_ifconv:
...
bb3:                                              ; preds = %bb4
  %rbegin6 = call i32 (...)* @_ssdm_op_SpecRegionBegin([58 x i8]* @p_str48) nounwind ; <i32> [#uses=1]
  switch i2 %p_0202_rec, label %branch2 [
    i2 0, label %branch0
    i2 1, label %branch1
  ]
...
bb3315316:                                        ; preds = %branch5, %branch4, %branch3
  %rend484 = call i32 (...)* @_ssdm_op_SpecRegionEnd([58 x i8]* @p_str48, i32 %rbegin6) nounwind ; <i32> [#uses=0]
  br label %bb4
...
bb52.preheader.0:                                 ; preds = %branch53, %branch52, %branch51, %bb38.0
  %k_buf_0_val_1_addr_5 = getelementptr [640 x i8]* %k_buf_0_val_1, i64 0, i64 %tmp_62 ; <i8*> [#uses=2]
  %temp_57 = load i8* %k_buf_0_val_1_addr_5, align 1 ; <i8> [#uses=3]
  store i8 %temp_57, i8* %k_buf_0_val_2_addr_4, align 1
  %k_buf_0_val_0_addr_4 = getelementptr [640 x i8]* %k_buf_0_val_0, i64 0, i64 %tmp_62 ; <i8*> [#uses=2]
...
bb38.0:                                           ; preds = %bb37.0
  ...
  %k_buf_0_val_2_addr_4 = getelementptr [640 x i8]* %k_buf_0_val_2, i64 0, i64 %tmp_62 ; <i8*> [#uses=2]
...
bb81.preheader.0:                                 ; preds = %bb74.0
  ...
  %k_buf_0_val_1_addr_6 = getelementptr [640 x i8]* %k_buf_0_val_1, i64 0, i64 %tmp_69 ; <i8*> [#uses=1]
  %src_kernel_win_0_val_0_0_18 = load i8* %k_buf_0_val_1_addr_6, align 1 ; <i8> [#uses=3]
  %k_buf_0_val_2_addr_6 = getelementptr [640 x i8]* %k_buf_0_val_2, i64 0, i64 %tmp_69 ; <i8*> [#uses=1]
...
bb61.preheader.0:                                 ; preds = %bb55.0, %bb36.0
  ...
  %k_buf_0_val_0_addr_3 = getelementptr [640 x i8]* %k_buf_0_val_0, i64 0, i64 %tmp_65 ; <i8*> [#uses=1]
  %src_kernel_win_0_val_0_0_14 = load i8* %k_buf_0_val_0_addr_3, align 1 ; <i8> [#uses=1]
  %k_buf_0_val_1_addr_4 = getelementptr [640 x i8]* %k_buf_0_val_1, i64 0, i64 %tmp_65 ; <i8*> [#uses=1]
  %src_kernel_win_0_val_1_0_13 = load i8* %k_buf_0_val_1_addr_4, align 1 ; <i8> [#uses=1]
  %k_buf_0_val_2_addr_5 = getelementptr [640 x i8]* %k_buf_0_val_2, i64 0, i64 %tmp_65 ; <i8*> [#uses=1]
...
bb29.preheader.0_ifconv:                          ; preds = %bb13_ifconv
  ...
  %k_buf_0_val_0_addr = getelementptr [640 x i8]* %k_buf_0_val_0, i64 0, i64 %tmp_58 ; <i8*> [#uses=1]
  %k_buf_0_val_0_load = load i8* %k_buf_0_val_0_addr, align 1 ; <i8> [#uses=4]
  store i8 %k_buf_0_val_0_load, i8* %col_buf_val_0_0_0, align 1
  %k_buf_0_val_1_addr = getelementptr [640 x i8]* %k_buf_0_val_1, i64 0, i64 %tmp_58 ; <i8*> [#uses=1]
  %k_buf_0_val_1_load = load i8* %k_buf_0_val_1_addr, align 1 ; <i8> [#uses=6]
  %k_buf_0_val_2_addr = getelementptr [640 x i8]* %k_buf_0_val_2, i64 0, i64 %tmp_58 ; <i8*> [#uses=1]
  %k_buf_0_val_2_load = load i8* %k_buf_0_val_2_addr, align 1 ; <i8> [#uses=6]
...
bb52.preheader.1:                                 ; preds = %branch62, %branch61, %branch60, %bb38.1
  %k_buf_1_val_1_addr_5 = getelementptr [640 x i8]* %k_buf_1_val_1, i64 0, i64 %tmp_101_1 ; <i8*> [#uses=2]
  %temp = load i8* %k_buf_1_val_1_addr_5, align 1 ; <i8> [#uses=3]
  store i8 %temp, i8* %k_buf_1_val_2_addr_4, align 1
  %k_buf_1_val_0_addr_4 = getelementptr [640 x i8]* %k_buf_1_val_0, i64 0, i64 %tmp_101_1 ; <i8*> [#uses=2]
...
bb38.1:                                           ; preds = %bb37.1
  ...
  %k_buf_1_val_2_addr_4 = getelementptr [640 x i8]* %k_buf_1_val_2, i64 0, i64 %tmp_101_1 ; <i8*> [#uses=2]
...
bb81.preheader.1:                                 ; preds = %bb74.1
  ...
  %k_buf_1_val_1_addr_6 = getelementptr [640 x i8]* %k_buf_1_val_1, i64 0, i64 %tmp_114_1 ; <i8*> [#uses=1]
  %src_kernel_win_1_val_0_0_18 = load i8* %k_buf_1_val_1_addr_6, align 1 ; <i8> [#uses=3]
  %k_buf_1_val_2_addr_6 = getelementptr [640 x i8]* %k_buf_1_val_2, i64 0, i64 %tmp_114_1 ; <i8*> [#uses=1]
...
bb61.preheader.1:                                 ; preds = %bb55.1, %bb36.1
  ...
  %k_buf_1_val_0_addr_3 = getelementptr [640 x i8]* %k_buf_1_val_0, i64 0, i64 %tmp_106_1 ; <i8*> [#uses=1]
  %src_kernel_win_1_val_0_0_14 = load i8* %k_buf_1_val_0_addr_3, align 1 ; <i8> [#uses=1]
  %k_buf_1_val_1_addr_4 = getelementptr [640 x i8]* %k_buf_1_val_1, i64 0, i64 %tmp_106_1 ; <i8*> [#uses=1]
  %src_kernel_win_1_val_1_0_9 = load i8* %k_buf_1_val_1_addr_4, align 1 ; <i8> [#uses=1]
  %k_buf_1_val_2_addr_5 = getelementptr [640 x i8]* %k_buf_1_val_2, i64 0, i64 %tmp_106_1 ; <i8*> [#uses=1]
...
bb29.preheader.1_ifconv:                          ; preds = %bb99.0_ifconv
  ...
  %k_buf_1_val_0_addr = getelementptr [640 x i8]* %k_buf_1_val_0, i64 0, i64 %tmp_94_1 ; <i8*> [#uses=1]
  %k_buf_1_val_0_load = load i8* %k_buf_1_val_0_addr, align 1 ; <i8> [#uses=4]
  store i8 %k_buf_1_val_0_load, i8* %col_buf_val_1_0_0, align 1
  %k_buf_1_val_1_addr = getelementptr [640 x i8]* %k_buf_1_val_1, i64 0, i64 %tmp_94_1 ; <i8*> [#uses=1]
  %k_buf_1_val_1_load = load i8* %k_buf_1_val_1_addr, align 1 ; <i8> [#uses=6]
  %k_buf_1_val_2_addr = getelementptr [640 x i8]* %k_buf_1_val_2, i64 0, i64 %tmp_94_1 ; <i8*> [#uses=1]
  %k_buf_1_val_2_load = load i8* %k_buf_1_val_2_addr, align 1 ; <i8> [#uses=6]
...
bb52.preheader.2:                                 ; preds = %branch71, %branch70, %branch69, %bb38.2
  %k_buf_2_val_1_addr_5 = getelementptr [640 x i8]* %k_buf_2_val_1, i64 0, i64 %tmp_101_2 ; <i8*> [#uses=2]
  %temp_60 = load i8* %k_buf_2_val_1_addr_5, align 1 ; <i8> [#uses=3]
  store i8 %temp_60, i8* %k_buf_2_val_2_addr_4, align 1
  %k_buf_2_val_0_addr_4 = getelementptr [640 x i8]* %k_buf_2_val_0, i64 0, i64 %tmp_101_2 ; <i8*> [#uses=2]
...
bb38.2:                                           ; preds = %bb37.2
  ...
  %k_buf_2_val_2_addr_4 = getelementptr [640 x i8]* %k_buf_2_val_2, i64 0, i64 %tmp_101_2 ; <i8*> [#uses=2]
...
bb81.preheader.2:                                 ; preds = %bb74.2
  ...
  %k_buf_2_val_1_addr_6 = getelementptr [640 x i8]* %k_buf_2_val_1, i64 0, i64 %tmp_114_2 ; <i8*> [#uses=1]
  %src_kernel_win_2_val_0_0_16 = load i8* %k_buf_2_val_1_addr_6, align 1 ; <i8> [#uses=3]
  %k_buf_2_val_2_addr_6 = getelementptr [640 x i8]* %k_buf_2_val_2, i64 0, i64 %tmp_114_2 ; <i8*> [#uses=1]
...
bb61.preheader.2:                                 ; preds = %bb55.2, %bb36.2
  ...
  %k_buf_2_val_0_addr_3 = getelementptr [640 x i8]* %k_buf_2_val_0, i64 0, i64 %tmp_106_2 ; <i8*> [#uses=1]
  %src_kernel_win_2_val_0_0_14 = load i8* %k_buf_2_val_0_addr_3, align 1 ; <i8> [#uses=1]
  %k_buf_2_val_1_addr_4 = getelementptr [640 x i8]* %k_buf_2_val_1, i64 0, i64 %tmp_106_2 ; <i8*> [#uses=1]
  %src_kernel_win_2_val_1_0_9 = load i8* %k_buf_2_val_1_addr_4, align 1 ; <i8> [#uses=1]
  %k_buf_2_val_2_addr_5 = getelementptr [640 x i8]* %k_buf_2_val_2, i64 0, i64 %tmp_106_2 ; <i8*> [#uses=1]
...
bb29.preheader.2_ifconv:                          ; preds = %bb99.1_ifconv
  ...
  %k_buf_2_val_0_addr = getelementptr [640 x i8]* %k_buf_2_val_0, i64 0, i64 %tmp_94_2 ; <i8*> [#uses=1]
  %k_buf_2_val_0_load = load i8* %k_buf_2_val_0_addr, align 1 ; <i8> [#uses=4]
  store i8 %k_buf_2_val_0_load, i8* %col_buf_val_2_0_0, align 1
  %k_buf_2_val_1_addr = getelementptr [640 x i8]* %k_buf_2_val_1, i64 0, i64 %tmp_94_2 ; <i8*> [#uses=1]
  %k_buf_2_val_1_load = load i8* %k_buf_2_val_1_addr, align 1 ; <i8> [#uses=6]
  %k_buf_2_val_2_addr = getelementptr [640 x i8]* %k_buf_2_val_2, i64 0, i64 %tmp_94_2 ; <i8*> [#uses=1]
  %k_buf_2_val_2_load = load i8* %k_buf_2_val_2_addr, align 1 ; <i8> [#uses=6]
...
define internal fastcc void @"AXIvideo2Mat<32,480,640,16>"(i32* %AXI_video_strm_V_data_V, i4* %AXI_video_strm_V_keep_V, i4* %AXI_video_strm_V_strb_V, i1* %AXI_video_strm_V_user_V, i1* %AXI_video_strm_V_last_V, i1* %AXI_video_strm_V_id_V, i1* %AXI_video_strm_V_dest_V, i12 %img_rows_V_read, i12 %img_cols_V_read, i8* %img_data_stream_0_V, i8* %img_data_stream_1_V, i8* %img_data_stream_2_V) {
entry:
...
bb6:                                              ; preds = %bb37
  ...
  call void (...)* @_ssdm_op_SpecLoopTripCount(i32 0, i32 480, i32 0, [1 x i8]* @p_str20) nounwind
  br label %bb29

bb7:                                              ; preds = %bb29
  %sof_load = load i1* %sof                       ; <i1> [#uses=1]
  %tmp_71 = call i32 (...)* @_ssdm_op_SpecRegionBegin([13 x i8]* @p_str27) ; <i32> [#uses=1]
  call void (...)* @_ssdm_op_SpecLoopTripCount(i32 0, i32 640, i32 0, [1 x i8]* @p_str20) nounwind
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, [1 x i8]* @p_str20) nounwind
...
define internal fastcc void @"CvtColor<0,16,16,480,640>"(i12 %p_src_rows_V_read, i12 %p_src_cols_V_read, i8* %p_src_data_stream_0_V, i8* %p_src_data_stream_1_V, i8* %p_src_data_stream_2_V, i8* %p_dst_data_stream_0_V, i8* %p_dst_data_stream_1_V, i8* %p_dst_data_stream_2_V) {
entry:
...
bb4.i:                                            ; preds = %bb3.i, %entry
  ...
  br i1 %exitcond4, label %"CvtColor_opr<kernel_RGB2GRAY,16,16,480,640>.exit", label %bb.i

"CvtColor_opr<kernel_RGB2GRAY,16,16,480,640>.exit": ; preds = %bb4.i
  ret void
}
...
entry:
  ...
  call fastcc void @"filter_opr<filter2d_kernel,16,16,int,int,480,640,3,3>"(i8* %src_data_stream_0_V, i8* %src_data_stream_1_V, i8* %src_data_stream_2_V, i8* %dst_data_stream_0_V, i8* %dst_data_stream_1_V, i8* %dst_data_stream_2_V, i12 %src_rows_V_read_1, i12 %src_cols_V_read_1)
  ret void
}

define internal fastcc void @"Erode<16,16,480,640>"(i12 %p_src_rows_V_read, i12 %p_src_cols_V_read, i8* %p_src_data_stream_0_V, i8* %p_src_data_stream_1_V, i8* %p_src_data_stream_2_V, i8* %p_dst_data_stream_0_V, i8* %p_dst_data_stream_1_V, i8* %p_dst_data_stream_2_V) {
entry:
  %empty = call i32 (...)* @_ssdm_op_SpecFifo(i8* %p_dst_data_stream_2_V, [8 x i8]* @str170, i32 0, i32 0, [8 x i8]* @str170) ; <i32> [#uses=0]
...
"getStructuringElement<unsigned char,int,int,3,3>.exit": ; preds = %bb32.i
  call fastcc void @"filter_opr<erode_kernel,16,16,unsigned char,int,480,640,3,3>"(i8* %p_src_data_stream_0_V, i8* %p_src_data_stream_1_V, i8* %p_src_data_stream_2_V, i8* %p_dst_data_stream_0_V, i8* %p_dst_data_stream_1_V, i8* %p_dst_data_stream_2_V, i8 %temp_kernel_val_0_0, i8 %temp_kernel_val_0_1, i8 %temp_kernel_val_0_2, i8 %temp_kernel_val_1_0, i8 %temp_kernel_val_1_1, i8 %temp_kernel_val_1_2, i8 %temp_kernel_val_2_0, i8 %temp_kernel_val_2_1, i8 %temp_kernel_val_2_2, i12 %p_src_rows_V_read_2, i12 %p_src_cols_V_read_2)
  ret void
}

define internal fastcc void @"Mat2AXIvideo<32,480,640,16>"(i12 %img_rows_V_read, i12 %img_cols_V_read, i8* %img_data_stream_0_V, i8* %img_data_stream_1_V, i8* %img_data_stream_2_V, i32* %AXI_video_strm_V_data_V, i4* %AXI_video_strm_V_keep_V, i4* %AXI_video_strm_V_strb_V, i1* %AXI_video_strm_V_user_V, i1* %AXI_video_strm_V_last_V, i1* %AXI_video_strm_V_id_V, i1* %AXI_video_strm_V_dest_V) {
entry:
...
define internal fastcc %"hls::Mat<480, 640, 16>::init_ret" @init(i32 %p_rows, i32 %p_cols) {
entry:
  ...
  %tmp = trunc i32 %p_cols_read to i12            ; <i12> [#uses=2]
  %tmp_110 = trunc i32 %p_rows_read to i12        ; <i12> [#uses=2]
  %mrv = insertvalue %"hls::Mat<480, 640, 16>::init_ret" undef, i12 %tmp_110, 0 ; <%"hls::Mat<480, 640, 16>::init_ret"> [#uses=1]
  %mrv_1 = insertvalue %"hls::Mat<480, 640, 16>::init_ret" %mrv, i12 %tmp_110, 1 ; <%"hls::Mat<480, 640, 16>::init_ret"> [#uses=1]
  %mrv_2 = insertvalue %"hls::Mat<480, 640, 16>::init_ret" %mrv_1, i12 %tmp, 2 ; <%"hls::Mat<480, 640, 16>::init_ret"> [#uses=1]
  %mrv_3 = insertvalue %"hls::Mat<480, 640, 16>::init_ret" %mrv_2, i12 %tmp, 3 ; <%"hls::Mat<480, 640, 16>::init_ret"> [#uses=1]
  ret %"hls::Mat<480, 640, 16>::init_ret" %mrv_3
}

define internal fastcc %"hls::Mat<480, 640, 16>::init.1_ret" @init.1(i32 %p_rows, i32 %p_cols) {
entry:
  call void (...)* @_ssdm_op_SpecIFCore(i32 %p_cols, [1 x i8]* @p_str20, [10 x i8]* @p_str44, [1 x i8]* @p_str20, [1 x i8]* @p_str20, [1 x i8]* @p_str20, [24 x i8]* @p_str45)
  call void (...)* @_ssdm_op_SpecIFCore(i32 %p_rows, [1 x i8]* @p_str20, [10 x i8]* @p_str44, [1 x i8]* @p_str20, [1 x i8]* @p_str20, [1 x i8]* @p_str20, [24 x i8]* @p_str45)
  %p_cols_read = call i32 @_ssdm_op_WireRead.i32(i32 %p_cols) ; <i32> [#uses=1]
  %p_rows_read = call i32 @_ssdm_op_WireRead.i32(i32 %p_rows) ; <i32> [#uses=1]
  %tmp = trunc i32 %p_cols_read to i12            ; <i12> [#uses=1]
  %tmp_111 = trunc i32 %p_rows_read to i12        ; <i12> [#uses=1]
  %mrv = insertvalue %"hls::Mat<480, 640, 16>::init.1_ret" undef, i12 %tmp_111, 0 ; <%"hls::Mat<480, 640, 16>::init.1_ret"> [#uses=1]
  %mrv_1 = insertvalue %"hls::Mat<480, 640, 16>::init.1_ret" %mrv, i12 %tmp, 1 ; <%"hls::Mat<480, 640, 16>::init.1_ret"> [#uses=1]
  ret %"hls::Mat<480, 640, 16>::init.1_ret" %mrv_1
}

define internal fastcc %"hls::Mat<480, 640, 16>::init.1_ret" @init.2(i32 %p_rows, i32 %p_cols) {
entry:
  call void (...)* @_ssdm_op_SpecIFCore(i32 %p_cols, [1 x i8]* @p_str20, [10 x i8]* @p_str44, [1 x i8]* @p_str20, [1 x i8]* @p_str20, [1 x i8]* @p_str20, [24 x i8]* @p_str45)
  call void (...)* @_ssdm_op_SpecIFCore(i32 %p_rows, [1 x i8]* @p_str20, [10 x i8]* @p_str44, [1 x i8]* @p_str20, [1 x i8]* @p_str20, [1 x i8]* @p_str20, [24 x i8]* @p_str45)
  %p_cols_read = call i32 @_ssdm_op_WireRead.i32(i32 %p_cols) ; <i32> [#uses=1]
  %p_rows_read = call i32 @_ssdm_op_WireRead.i32(i32 %p_rows) ; <i32> [#uses=1]
  %tmp = trunc i32 %p_cols_read to i12            ; <i12> [#uses=1]
  %tmp_112 = trunc i32 %p_rows_read to i12        ; <i12> [#uses=1]
  %mrv = insertvalue %"hls::Mat<480, 640, 16>::init.1_ret" undef, i12 %tmp_112, 0 ; <%"hls::Mat<480, 640, 16>::init.1_ret"> [#uses=1]
  %mrv_1 = insertvalue %"hls::Mat<480, 640, 16>::init.1_ret" %mrv, i12 %tmp, 1 ; <%"hls::Mat<480, 640, 16>::init.1_ret"> [#uses=1]
  ret %"hls::Mat<480, 640, 16>::init.1_ret" %mrv_1
}

define internal fastcc %"hls::Mat<480, 640, 16>::init.1_ret" @init.3(i32 %p_rows, i32 %p_cols) {
entry:
  call void (...)* @_ssdm_op_SpecIFCore(i32 %p_cols, [1 x i8]* @p_str20, [10 x i8]* @p_str44, [1 x i8]* @p_str20, [1 x i8]* @p_str20, [1 x i8]* @p_str20, [24 x i8]* @p_str45)
  call void (...)* @_ssdm_op_SpecIFCore(i32 %p_rows, [1 x i8]* @p_str20, [10 x i8]* @p_str44, [1 x i8]* @p_str20, [1 x i8]* @p_str20, [1 x i8]* @p_str20, [24 x i8]* @p_str45)
  %p_cols_read = call i32 @_ssdm_op_WireRead.i32(i32 %p_cols) ; <i32> [#uses=1]
  %p_rows_read = call i32 @_ssdm_op_WireRead.i32(i32 %p_rows) ; <i32> [#uses=1]
  %tmp = trunc i32 %p_cols_read to i12            ; <i12> [#uses=1]
  %tmp_113 = trunc i32 %p_rows_read to i12        ; <i12> [#uses=1]
  %mrv = insertvalue %"hls::Mat<480, 640, 16>::init.1_ret" undef, i12 %tmp_113, 0 ; <%"hls::Mat<480, 640, 16>::init.1_ret"> [#uses=1]
  %mrv_1 = insertvalue %"hls::Mat<480, 640, 16>::init.1_ret" %mrv, i12 %tmp, 1 ; <%"hls::Mat<480, 640, 16>::init.1_ret"> [#uses=1]
  ret %"hls::Mat<480, 640, 16>::init.1_ret" %mrv_1
}
...
!1 = metadata !{i32 458798, i32 0, metadata !2, metadata !"Sobel", metadata !"Sobel", metadata !"_Z5SobelRN3hls3MatILi480ELi640ELi16EEES2_ii", metadata !3, i32 44, metadata !4, i1 false, i1 true, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
!2 = metadata !{i32 458769, i32 0, i32 4, metadata !"top.pragma.2.cpp", metadata !"/ise_local2/umair_temp/vivado_projects/ImgProc640x480/prj/solution2/.autopilot/db", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.7)", i1 true, i1 false, metadata !"", i32 0} ; [ DW_TAG_compile_unit ]
!3 = metadata !{i32 458769, i32 0, i32 4, metadata !"top.cpp", metadata !"/ise_local2/umair_temp/vivado_projects/ImgProc640x480/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.7)", i1 false, i1 false, metadata !"", i32 0} ; [ DW_TAG_compile_unit ]
...
!8 = metadata !{i32 458769, i32 0, i32 4, metadata !"top.h", metadata !"/ise_local2/umair_temp/vivado_projects/ImgProc640x480/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.7)", i1 false, i1 false, metadata !"", i32 0} ; [ DW_TAG_compile_unit ]
!9 = metadata !{i32 458771, metadata !10, metadata !"Mat<480,640,16>", metadata !12, i32 445, i64 64, i64 16, i64 0, i32 0, null, metadata !13, i32 0, null} ; [ DW_TAG_structure_type ]
...
!416 = metadata !{i32 458798, i32 0, metadata !9, metadata !"init", metadata !"init", metadata !"_ZN3hls3MatILi480ELi640ELi16EE4initEii", metadata !12, i32 487, metadata !367, i1 false, i1 true, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
!417 = metadata !{i32 458798, i32 0, metadata !9, metadata !"assignto", metadata !"assignto", metadata !"_ZN3hls3MatILi480ELi640ELi16EE8assigntoERS1_", metadata !12, i32 494, metadata !418, i1 false, i1 false, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
...
!420 = metadata !{i32 458768, metadata !2, metadata !"hlsMat<480,640,16>", metadata !2, i32 0, i64 64, i64 64, i64 0, i32 0, metadata !9} ; [ DW_TAG_reference_type ]
!421 = metadata !{i32 458798, i32 0, metadata !9, metadata !"read", metadata !"read", metadata !"_ZN3hls3MatILi480ELi640ELi16EE4readEv", metadata !12, i32 501, metadata !422, i1 false, i1 true, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
...
!444 = metadata !{i32 458798, i32 0, metadata !9, metadata !"read", metadata !"read", metadata !"_ZN3hls3MatILi480ELi640ELi16EE4readERNS_6ScalarILi3EhEE", metadata !12, i32 513, metadata !445, i1 false, i1 false, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
...
!448 = metadata !{i32 458798, i32 0, metadata !9, metadata !"write", metadata !"write", metadata !"_ZN3hls3MatILi480ELi640ELi16EE5writeENS_6ScalarILi3EhEE", metadata !12, i32 519, metadata !449, i1 false, i1 true, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
...
!451 = metadata !{i32 458798, i32 0, metadata !9, metadata !"operator>>", metadata !"operator>>", metadata !"_ZN3hls3MatILi480ELi640ELi16EErsERNS_6ScalarILi3EhEE", metadata !12, i32 529, metadata !445, i1 false, i1 true, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
!452 = metadata !{i32 458798, i32 0, metadata !9, metadata !"operator<<", metadata !"operator<<", metadata !"_ZN3hls3MatILi480ELi640ELi16EElsENS_6ScalarILi3EhEE", metadata !12, i32 535, metadata !449, i1 false, i1 true, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
!453 = metadata !{i32 458798, i32 0, metadata !9, metadata !"empty", metadata !"empty", metadata !"_ZN3hls3MatILi480ELi640ELi16EE5emptyEv", metadata !12, i32 541, metadata !454, i1 false, i1 false, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
...
!456 = metadata !{i32 458798, i32 0, metadata !9, metadata !"type", metadata !"type", metadata !"_ZNK3hls3MatILi480ELi640ELi16EE4typeEv", metadata !12, i32 553, metadata !457, i1 false, i1 false, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
...
!462 = metadata !{i32 458798, i32 0, metadata !9, metadata !"depth", metadata !"depth", metadata !"_ZNK3hls3MatILi480ELi640ELi16EE5depthEv", metadata !12, i32 559, metadata !457, i1 false, i1 true, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
!463 = metadata !{i32 458798, i32 0, metadata !9, metadata !"channels", metadata !"channels", metadata !"_ZNK3hls3MatILi480ELi640ELi16EE8channelsEv", metadata !12, i32 564, metadata !457, i1 false, i1 false, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
