...
architecture behav of AXIvideo2Mat_32_1080_1920_16_s is 
    ...
    signal t_V_2_reg_229 : STD_LOGIC_VECTOR (11 downto 0);
...
begin
    ...
    exitcond3_fu_391_p2 <= "1" when (t_V_2_reg_229 = img_cols_V_read) else "0";
    ...
    j_V_fu_396_p2 <= std_logic_vector(unsigned(t_V_2_reg_229) + unsigned(ap_const_lv12_1));
