...
void Erode_32_32_1080_1920_s_k_buf_0_val_0::proc_mem_q()
{
...
void Erode_32_32_1080_1920_s_k_buf_0_val_0::proc_mem_ra()
{
...
void Erode_32_32_1080_1920_s_k_buf_0_val_0::proc_mem_ce()
{
    sc_lv<1> tmp;
    tmp[0] = ce0.read();
    mem_ce.write(tmp);
...
void Erode_32_32_1080_1920_s_k_buf_0_val_0::proc_mem_wa()
{
    sc_lv<1 * AddressWidth> tmp;
    tmp = (address1.read());
    mem_wa.write(tmp);
...
void Erode_32_32_1080_1920_s_k_buf_0_val_0::proc_mem_we()
{
    sc_lv<1> tmp;
    tmp[0] = we1.read();
    mem_we.write(tmp);
...
void Erode_32_32_1080_1920_s_k_buf_0_val_0::proc_mem_d()
{
...
void Erode_32_32_1080_1920_s_k_buf_0_val_0::proc_op()
{
...
void Erode_32_32_1080_1920_s_k_buf_0_val_0::proc_addr()
{
...
// check collision
void Erode_32_32_1080_1920_s_k_buf_0_val_0::proc_check()
{
    int f = 0;
    for (int i = 0; i < 1; i++) {
        for (int j = i + 1; j < 2; j++) {
