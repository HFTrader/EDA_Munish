...
entry:
  ...
  call void (...)* @_ssdm_op_SpecIFCore(i64* %input_V_data_V, i8* %input_V_keep_V, i8* %input_V_strb_V, i1* %input_V_user_V, i1* %input_V_last_V, i1* %input_V_id_V, i1* %input_V_dest_V, [1 x i8]* @p_str20, [5 x i8]* @p_str32, [1 x i8]* @p_str20, [1 x i8]* @p_str20, [1 x i8]* @p_str20, [25 x i8]* @p_str33)
  call void (...)* @_ssdm_op_SpecIFCore(i64* %output_V_data_V, i8* %output_V_keep_V, i8* %output_V_strb_V, i1* %output_V_user_V, i1* %output_V_last_V, i1* %output_V_id_V, i1* %output_V_dest_V, [1 x i8]* @p_str20, [5 x i8]* @p_str32, [1 x i8]* @p_str20, [1 x i8]* @p_str20, [1 x i8]* @p_str20, [26 x i8]* @p_str34)
  call void (...)* @_ssdm_op_SpecIFCore(i32 %rows, [1 x i8]* @p_str20, [10 x i8]* @p_str35, [1 x i8]* @p_str20, [1 x i8]* @p_str20, [1 x i8]* @p_str20, [24 x i8]* @p_str36)
  call void (...)* @_ssdm_op_SpecIFCore(i32 %cols, [1 x i8]* @p_str20, [10 x i8]* @p_str35, [1 x i8]* @p_str20, [1 x i8]* @p_str20, [1 x i8]* @p_str20, [24 x i8]* @p_str36)
  call void (...)* @_ssdm_op_SpecIFCore(i32 0, [1 x i8]* @p_str20, [10 x i8]* @p_str35, [1 x i8]* @p_str20, [1 x i8]* @p_str20, [1 x i8]* @p_str20, [24 x i8]* @p_str36)
  call void (...)* @_ssdm_op_SpecWire(i32 %rows, [10 x i8]* @p_str37, i32 0, i32 0, [1 x i8]* @p_str20) nounwind
  call void (...)* @_ssdm_op_SpecWire(i32 %cols, [10 x i8]* @p_str37, i32 0, i32 0, [1 x i8]* @p_str20) nounwind
  ...
  %img_0_rows_V = extractvalue %"hls::Mat<1080, 1920, 16>::init_ret" %call_ret1, 0 ; <i12> [#uses=1]
  %img_0_rows_V_channel = extractvalue %"hls::Mat<1080, 1920, 16>::init_ret" %call_ret1, 1 ; <i12> [#uses=1]
  %img_0_cols_V = extractvalue %"hls::Mat<1080, 1920, 16>::init_ret" %call_ret1, 2 ; <i12> [#uses=1]
  %img_0_cols_V_channel = extractvalue %"hls::Mat<1080, 1920, 16>::init_ret" %call_ret1, 3 ; <i12> [#uses=1]
  call fastcc void @init.1(i32 %rows_read, i32 %cols_read)
  call fastcc void @"AXIvideo2Mat<64,1080,1920,16>"(i64* %input_V_data_V, i8* %input_V_keep_V, i8* %input_V_strb_V, i1* %input_V_user_V, i1* %input_V_last_V, i1* %input_V_id_V, i1* %input_V_dest_V, i12 %img_0_rows_V, i12 %img_0_cols_V, i8* %img_0_data_stream_0_V, i8* %img_0_data_stream_1_V, i8* %img_0_data_stream_2_V)
...
bb2:                                              ; preds = %bb3
  ...
  %empty_67 = call %0 @_ssdm_op_FifoRead.volatile.i64P.i8P.i8P.i1P.i1P.i1P.i1P(i64* %AXI_video_strm_V_data_V, i8* %AXI_video_strm_V_keep_V, i8* %AXI_video_strm_V_strb_V, i1* %AXI_video_strm_V_user_V, i1* %AXI_video_strm_V_last_V, i1* %AXI_video_strm_V_id_V, i1* %AXI_video_strm_V_dest_V) ; <%0> [#uses=3]
  %tmp_data_V = extractvalue %0 %empty_67, 0      ; <i64> [#uses=1]
  %tmp_user_V = extractvalue %0 %empty_67, 3      ; <i1> [#uses=1]
  %tmp_last_V = extractvalue %0 %empty_67, 4      ; <i1> [#uses=1]
  %empty_68 = call i32 (...)* @_ssdm_op_SpecRegionEnd([13 x i8]* @p_str25, i32 %tmp) ; <i32> [#uses=0]
  br label %bb3
...
bb12:                                             ; preds = %bb9
  %empty_69 = call %0 @_ssdm_op_FifoRead.volatile.i64P.i8P.i8P.i1P.i1P.i1P.i1P(i64* %AXI_video_strm_V_data_V, i8* %AXI_video_strm_V_keep_V, i8* %AXI_video_strm_V_strb_V, i1* %AXI_video_strm_V_user_V, i1* %AXI_video_strm_V_last_V, i1* %AXI_video_strm_V_id_V, i1* %AXI_video_strm_V_dest_V) ; <%0> [#uses=2]
  %tmp_data_V_1 = extractvalue %0 %empty_69, 0    ; <i64> [#uses=1]
  %tmp_last_V_1 = extractvalue %0 %empty_69, 4    ; <i1> [#uses=2]
  br label %bb14
...
bb14:                                             ; preds = %bb14.pre, %bb12, %bb9
  ...
  %pix_val_0 = trunc i64 %axi_data_V_8 to i8      ; <i8> [#uses=1]
  %pix_val_1 = call i8 @_ssdm_op_PartSelect.i8.i64.i32.i32(i64 %axi_data_V_8, i32 8, i32 15) ; <i8> [#uses=1]
  %pix_val_2 = call i8 @_ssdm_op_PartSelect.i8.i64.i32.i32(i64 %axi_data_V_8, i32 16, i32 23) ; <i8> [#uses=1]
  ...
  %empty_70 = call i32 (...)* @_ssdm_op_SpecRegionEnd([13 x i8]* @p_str27, i32 %tmp_2) ; <i32> [#uses=0]
  br label %bb29
...
bb31:                                             ; preds = %bb32
  ...
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, [1 x i8]* @p_str20) nounwind
  %empty_71 = call %0 @_ssdm_op_FifoRead.volatile.i64P.i8P.i8P.i1P.i1P.i1P.i1P(i64* %AXI_video_strm_V_data_V, i8* %AXI_video_strm_V_keep_V, i8* %AXI_video_strm_V_strb_V, i1* %AXI_video_strm_V_user_V, i1* %AXI_video_strm_V_last_V, i1* %AXI_video_strm_V_id_V, i1* %AXI_video_strm_V_dest_V) ; <%0> [#uses=2]
  %tmp_data_V_2 = extractvalue %0 %empty_71, 0    ; <i64> [#uses=1]
  %tmp_last_V_2 = extractvalue %0 %empty_71, 4    ; <i1> [#uses=2]
  %empty_72 = call i32 (...)* @_ssdm_op_SpecRegionEnd([13 x i8]* @p_str28, i32 %tmp_3) ; <i32> [#uses=0]
  br label %bb32
...
bb35:                                             ; preds = %bb32
  %empty_73 = call i32 (...)* @_ssdm_op_SpecRegionEnd([13 x i8]* @p_str26, i32 %tmp_1) ; <i32> [#uses=0]
  br label %bb37
...
bb3:                                              ; preds = %bb14
  ...
  %tmp_9 = call i8 @_ssdm_op_FifoRead.volatile.i8P(i8* %img_data_stream_0_V) ; <i8> [#uses=1]
  %tmp_10 = call i8 @_ssdm_op_FifoRead.volatile.i8P(i8* %img_data_stream_1_V) ; <i8> [#uses=1]
  %tmp_11 = call i8 @_ssdm_op_FifoRead.volatile.i8P(i8* %img_data_stream_2_V) ; <i8> [#uses=1]
  %axi_data_V = call i64 @_ssdm_op_BitConcatenate.i64.i40.i8.i8.i8(i40 -1, i8 %tmp_11, i8 %tmp_10, i8 %tmp_9) ; <i64> [#uses=1]
  ...
  %empty_83 = call i32 (...)* @_ssdm_op_SpecRegionEnd([13 x i8]* @p_str31, i32 %tmp_8) ; <i32> [#uses=0]
...
bb15:                                             ; preds = %bb14
  %empty_84 = call i32 (...)* @_ssdm_op_SpecRegionEnd([13 x i8]* @p_str30, i32 %tmp) ; <i32> [#uses=0]
  br label %bb17
...
entry:
  ...
  %tmp_12 = trunc i32 %p_cols_read to i12         ; <i12> [#uses=2]
  ...
  %mrv_2 = insertvalue %"hls::Mat<1080, 1920, 16>::init_ret" %mrv_1, i12 %tmp_12, 2 ; <%"hls::Mat<1080, 1920, 16>::init_ret"> [#uses=1]
  %mrv_3 = insertvalue %"hls::Mat<1080, 1920, 16>::init_ret" %mrv_2, i12 %tmp_12, 3 ; <%"hls::Mat<1080, 1920, 16>::init_ret"> [#uses=1]
