; ModuleID = '/nfs/TUEIEDAprojects/SystemDesign/work/zynq/umair-razzaq/xapp1167/sw/erode/prj/solution1/.autopilot/db/a.o.3.bc'
target datalayout = "e-p:64:64:64-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:64:64-f32:32:32-f64:64:64-v64:64:64-v128:128:128-a0:0:64-s0:64:64-f80:128:128-n8:16:32:64"
target triple = "x86_64-unknown-linux-gnu"

%0 = type { i64, i8, i8, i1, i1, i1, i1 }
...
@p_str20 = private constant [1 x i8] zeroinitializer, align 1 ; <[1 x i8]*> [#uses=55]
...
@p_str32 = private constant [5 x i8] c"AXIS\00", align 1 ; <[5 x i8]*> [#uses=4]
@p_str33 = private constant [25 x i8] c"-bus_bundle INPUT_STREAM\00", align 1 ; <[25 x i8]*> [#uses=2]
@p_str34 = private constant [26 x i8] c"-bus_bundle OUTPUT_STREAM\00", align 1 ; <[26 x i8]*> [#uses=2]
@p_str35 = private constant [10 x i8] c"AXI_SLAVE\00", align 1 ; <[10 x i8]*> [#uses=7]
@p_str36 = private constant [24 x i8] c"-bus_bundle CONTROL_BUS\00", align 1 ; <[24 x i8]*> [#uses=7]
@p_str37 = private constant [10 x i8] c"ap_stable\00", align 1 ; <[10 x i8]*> [#uses=2]
...
define void @image_filter(i64* %input_V_data_V, i8* %input_V_keep_V, i8* %input_V_strb_V, i1* %input_V_user_V, i1* %input_V_last_V, i1* %input_V_id_V, i1* %input_V_dest_V, i64* %output_V_data_V, i8* %output_V_keep_V, i8* %output_V_strb_V, i1* %output_V_user_V, i1* %output_V_last_V, i1* %output_V_id_V, i1* %output_V_dest_V, i32 %rows, i32 %cols) {
entry:
  call void (...)* @_ssdm_op_SpecDataflowPipeline(i32 -1, [1 x i8]* @p_str20) nounwind, !dbg !466
  %empty = call i32 (...)* @_ssdm_op_SpecFifo(i1* %output_V_dest_V, [8 x i8]* @str42, i32 0, i32 0, [8 x i8]* @str42) ; <i32> [#uses=0]
  %empty_21 = call i32 (...)* @_ssdm_op_SpecFifo(i1* %output_V_id_V, [8 x i8]* @str41, i32 0, i32 0, [8 x i8]* @str41) ; <i32> [#uses=0]
  %empty_22 = call i32 (...)* @_ssdm_op_SpecFifo(i1* %output_V_last_V, [8 x i8]* @str40, i32 0, i32 0, [8 x i8]* @str40) ; <i32> [#uses=0]
  %empty_23 = call i32 (...)* @_ssdm_op_SpecFifo(i1* %output_V_user_V, [8 x i8]* @str39, i32 0, i32 0, [8 x i8]* @str39) ; <i32> [#uses=0]
  %empty_24 = call i32 (...)* @_ssdm_op_SpecFifo(i8* %output_V_strb_V, [8 x i8]* @str38, i32 0, i32 0, [8 x i8]* @str38) ; <i32> [#uses=0]
  %empty_25 = call i32 (...)* @_ssdm_op_SpecFifo(i8* %output_V_keep_V, [8 x i8]* @str37, i32 0, i32 0, [8 x i8]* @str37) ; <i32> [#uses=0]
  %empty_26 = call i32 (...)* @_ssdm_op_SpecFifo(i64* %output_V_data_V, [8 x i8]* @str36, i32 0, i32 0, [8 x i8]* @str36) ; <i32> [#uses=0]
  %empty_27 = call i32 (...)* @_ssdm_op_SpecFifo(i1* %input_V_dest_V, [8 x i8]* @str35, i32 0, i32 0, [8 x i8]* @str35) ; <i32> [#uses=0]
  %empty_28 = call i32 (...)* @_ssdm_op_SpecFifo(i1* %input_V_id_V, [8 x i8]* @str34, i32 0, i32 0, [8 x i8]* @str34) ; <i32> [#uses=0]
  %empty_29 = call i32 (...)* @_ssdm_op_SpecFifo(i1* %input_V_last_V, [8 x i8]* @str33, i32 0, i32 0, [8 x i8]* @str33) ; <i32> [#uses=0]
  %empty_30 = call i32 (...)* @_ssdm_op_SpecFifo(i1* %input_V_user_V, [8 x i8]* @str32, i32 0, i32 0, [8 x i8]* @str32) ; <i32> [#uses=0]
  %empty_31 = call i32 (...)* @_ssdm_op_SpecFifo(i8* %input_V_strb_V, [8 x i8]* @str31, i32 0, i32 0, [8 x i8]* @str31) ; <i32> [#uses=0]
  %empty_32 = call i32 (...)* @_ssdm_op_SpecFifo(i8* %input_V_keep_V, [8 x i8]* @str30, i32 0, i32 0, [8 x i8]* @str30) ; <i32> [#uses=0]
  %empty_33 = call i32 (...)* @_ssdm_op_SpecFifo(i64* %input_V_data_V, [8 x i8]* @str, i32 0, i32 0, [8 x i8]* @str) ; <i32> [#uses=0]
  %cols_read = call i32 @_ssdm_op_WireRead.i32(i32 %cols) ; <i32> [#uses=2]
  call void @llvm.dbg.value(metadata !{i32 %cols_read}, i64 0, metadata !1519)
  call void @llvm.dbg.value(metadata !{i32 %cols_read}, i64 0, metadata !1520) nounwind
  call void @llvm.dbg.value(metadata !{i32 %cols_read}, i64 0, metadata !1520) nounwind
  %rows_read = call i32 @_ssdm_op_WireRead.i32(i32 %rows) ; <i32> [#uses=2]
  call void @llvm.dbg.value(metadata !{i32 %rows_read}, i64 0, metadata !1522)
  call void @llvm.dbg.value(metadata !{i32 %rows_read}, i64 0, metadata !1523) nounwind
  call void @llvm.dbg.value(metadata !{i32 %rows_read}, i64 0, metadata !1523) nounwind
  %img_0_data_stream_0_V = alloca i8, align 1     ; <i8*> [#uses=5]
  %empty_34 = call i32 (...)* @_ssdm_op_SpecChannel([22 x i8]* @str49, i32 1, [1 x i8]* @str50, [1 x i8]* @str50, i32 1, i32 1, i8* %img_0_data_stream_0_V, i8* %img_0_data_stream_0_V) ; <i32> [#uses=0]
  %empty_35 = call i32 (...)* @_ssdm_op_SpecFifo(i8* %img_0_data_stream_0_V, [8 x i8]* @str51, i32 0, i32 0, [8 x i8]* @str51) ; <i32> [#uses=0]
  %img_0_data_stream_1_V = alloca i8, align 1     ; <i8*> [#uses=5]
  %empty_36 = call i32 (...)* @_ssdm_op_SpecChannel([22 x i8]* @str52, i32 1, [1 x i8]* @str53, [1 x i8]* @str53, i32 1, i32 1, i8* %img_0_data_stream_1_V, i8* %img_0_data_stream_1_V) ; <i32> [#uses=0]
  %empty_37 = call i32 (...)* @_ssdm_op_SpecFifo(i8* %img_0_data_stream_1_V, [8 x i8]* @str54, i32 0, i32 0, [8 x i8]* @str54) ; <i32> [#uses=0]
  %img_0_data_stream_2_V = alloca i8, align 1     ; <i8*> [#uses=5]
  %empty_38 = call i32 (...)* @_ssdm_op_SpecChannel([22 x i8]* @str55, i32 1, [1 x i8]* @str56, [1 x i8]* @str56, i32 1, i32 1, i8* %img_0_data_stream_2_V, i8* %img_0_data_stream_2_V) ; <i32> [#uses=0]
  %empty_39 = call i32 (...)* @_ssdm_op_SpecFifo(i8* %img_0_data_stream_2_V, [8 x i8]* @str57, i32 0, i32 0, [8 x i8]* @str57) ; <i32> [#uses=0]
  call void @llvm.dbg.value(metadata !{i64* %input_V_data_V}, i64 0, metadata !1524)
  call void @llvm.dbg.value(metadata !{i8* %input_V_keep_V}, i64 0, metadata !1537)
  call void @llvm.dbg.value(metadata !{i8* %input_V_strb_V}, i64 0, metadata !1549)
  call void @llvm.dbg.value(metadata !{i1* %input_V_user_V}, i64 0, metadata !1550)
  call void @llvm.dbg.value(metadata !{i1* %input_V_last_V}, i64 0, metadata !1562)
  call void @llvm.dbg.value(metadata !{i1* %input_V_id_V}, i64 0, metadata !1563)
  call void @llvm.dbg.value(metadata !{i1* %input_V_dest_V}, i64 0, metadata !1564)
  call void @llvm.dbg.value(metadata !{i64* %output_V_data_V}, i64 0, metadata !1565)
  call void @llvm.dbg.value(metadata !{i8* %output_V_keep_V}, i64 0, metadata !1567)
  call void @llvm.dbg.value(metadata !{i8* %output_V_strb_V}, i64 0, metadata !1568)
  call void @llvm.dbg.value(metadata !{i1* %output_V_user_V}, i64 0, metadata !1569)
  call void @llvm.dbg.value(metadata !{i1* %output_V_last_V}, i64 0, metadata !1570)
  call void @llvm.dbg.value(metadata !{i1* %output_V_id_V}, i64 0, metadata !1571)
  call void @llvm.dbg.value(metadata !{i1* %output_V_dest_V}, i64 0, metadata !1572)
  call void @llvm.dbg.value(metadata !{i32 %rows}, i64 0, metadata !1522)
  call void @llvm.dbg.value(metadata !{i32 %cols}, i64 0, metadata !1519)
  call void @llvm.dbg.declare(metadata !{i8* %img_0_data_stream_0_V}, metadata !1573), !dbg !1579
  call void @llvm.dbg.declare(metadata !{i8* %img_0_data_stream_1_V}, metadata !1580), !dbg !1579
  call void @llvm.dbg.declare(metadata !{i8* %img_0_data_stream_2_V}, metadata !1581), !dbg !1579
  call void (...)* @_ssdm_op_SpecIFCore(i64* %input_V_data_V, i8* %input_V_keep_V, i8* %input_V_strb_V, i1* %input_V_user_V, i1* %input_V_last_V, i1* %input_V_id_V, i1* %input_V_dest_V, [1 x i8]* @p_str20, [5 x i8]* @p_str32, [1 x i8]* @p_str20, [1 x i8]* @p_str20, [1 x i8]* @p_str20, [25 x i8]* @p_str33), !dbg !1582
  call void (...)* @_ssdm_op_SpecIFCore(i64* %output_V_data_V, i8* %output_V_keep_V, i8* %output_V_strb_V, i1* %output_V_user_V, i1* %output_V_last_V, i1* %output_V_id_V, i1* %output_V_dest_V, [1 x i8]* @p_str20, [5 x i8]* @p_str32, [1 x i8]* @p_str20, [1 x i8]* @p_str20, [1 x i8]* @p_str20, [26 x i8]* @p_str34), !dbg !1583
  call void (...)* @_ssdm_op_SpecIFCore(i32 %rows, [1 x i8]* @p_str20, [10 x i8]* @p_str35, [1 x i8]* @p_str20, [1 x i8]* @p_str20, [1 x i8]* @p_str20, [24 x i8]* @p_str36), !dbg !1584
  call void (...)* @_ssdm_op_SpecIFCore(i32 %cols, [1 x i8]* @p_str20, [10 x i8]* @p_str35, [1 x i8]* @p_str20, [1 x i8]* @p_str20, [1 x i8]* @p_str20, [24 x i8]* @p_str36), !dbg !1585
  call void (...)* @_ssdm_op_SpecIFCore(i32 0, [1 x i8]* @p_str20, [10 x i8]* @p_str35, [1 x i8]* @p_str20, [1 x i8]* @p_str20, [1 x i8]* @p_str20, [24 x i8]* @p_str36), !dbg !1586
  call void (...)* @_ssdm_op_SpecWire(i32 %rows, [10 x i8]* @p_str37, i32 0, i32 0, [1 x i8]* @p_str20) nounwind, !dbg !1587
  call void (...)* @_ssdm_op_SpecWire(i32 %cols, [10 x i8]* @p_str37, i32 0, i32 0, [1 x i8]* @p_str20) nounwind, !dbg !1588
  call void @llvm.dbg.value(metadata !{i32 %rows}, i64 0, metadata !1523) nounwind
  call void @llvm.dbg.value(metadata !{i32 %cols}, i64 0, metadata !1520) nounwind
  call void @llvm.dbg.value(metadata !{i32 %rows}, i64 0, metadata !1523) nounwind
  call void @llvm.dbg.value(metadata !{i32 %cols}, i64 0, metadata !1520) nounwind
  %call_ret1 = call fastcc %"hls::Mat<1080, 1920, 16>::init_ret" @init(i32 %rows_read, i32 %cols_read), !dbg !1589 ; <%"hls::Mat<1080, 1920, 16>::init_ret"> [#uses=4]
  %img_0_rows_V = extractvalue %"hls::Mat<1080, 1920, 16>::init_ret" %call_ret1, 0, !dbg !1589 ; <i12> [#uses=1]
  call void @llvm.dbg.value(metadata !{i12 %img_0_rows_V}, i64 0, metadata !1593), !dbg !1589
  %img_0_rows_V_channel = extractvalue %"hls::Mat<1080, 1920, 16>::init_ret" %call_ret1, 1, !dbg !1589 ; <i12> [#uses=1]
  %img_0_cols_V = extractvalue %"hls::Mat<1080, 1920, 16>::init_ret" %call_ret1, 2, !dbg !1589 ; <i12> [#uses=1]
  call void @llvm.dbg.value(metadata !{i12 %img_0_cols_V}, i64 0, metadata !1602), !dbg !1589
  %img_0_cols_V_channel = extractvalue %"hls::Mat<1080, 1920, 16>::init_ret" %call_ret1, 3, !dbg !1589 ; <i12> [#uses=1]
  call fastcc void @init.1(i32 %rows_read, i32 %cols_read), !dbg !1603
  call fastcc void @"AXIvideo2Mat<64,1080,1920,16>"(i64* %input_V_data_V, i8* %input_V_keep_V, i8* %input_V_strb_V, i1* %input_V_user_V, i1* %input_V_last_V, i1* %input_V_id_V, i1* %input_V_dest_V, i12 %img_0_rows_V, i12 %img_0_cols_V, i8* %img_0_data_stream_0_V, i8* %img_0_data_stream_1_V, i8* %img_0_data_stream_2_V), !dbg !1605
  call fastcc void @"Mat2AXIvideo<64,1080,1920,16>"(i12 %img_0_rows_V_channel, i12 %img_0_cols_V_channel, i8* %img_0_data_stream_0_V, i8* %img_0_data_stream_1_V, i8* %img_0_data_stream_2_V, i64* %output_V_data_V, i8* %output_V_keep_V, i8* %output_V_strb_V, i1* %output_V_user_V, i1* %output_V_last_V, i1* %output_V_id_V, i1* %output_V_dest_V), !dbg !1606
  ret void, !dbg !1607
}
...
entry:
  %empty = call i64 @llvm.part.select.i64(i64 %0, i32 %1, i32 %2) ; <i64> [#uses=1]
  %empty_40 = trunc i64 %empty to i8              ; <i8> [#uses=1]
  ret i8 %empty_40
}

define weak i64 @_ssdm_op_BitConcatenate.i64.i40.i8.i8.i8(i40, i8, i8, i8) nounwind readnone {
entry:
  %empty = zext i8 %2 to i16                      ; <i16> [#uses=1]
  %empty_41 = zext i8 %3 to i16                   ; <i16> [#uses=2]
  %empty_42 = trunc i16 %empty to i8              ; <i8> [#uses=1]
  %empty_43 = call i8 @_ssdm_op_PartSelect.i8.i16.i32.i32(i16 %empty_41, i32 8, i32 15) ; <i8> [#uses=1]
  %empty_44 = or i8 %empty_42, %empty_43          ; <i8> [#uses=1]
  %empty_45 = call i16 @_ssdm_op_PartSet.i16.i16.i8.i32.i32(i16 %empty_41, i8 %empty_44, i32 8, i32 15) ; <i16> [#uses=1]
  %empty_46 = zext i8 %1 to i24                   ; <i24> [#uses=1]
  %empty_47 = zext i16 %empty_45 to i24           ; <i24> [#uses=2]
  %empty_48 = trunc i24 %empty_46 to i8           ; <i8> [#uses=1]
  %empty_49 = call i8 @_ssdm_op_PartSelect.i8.i24.i32.i32(i24 %empty_47, i32 16, i32 23) ; <i8> [#uses=1]
  %empty_50 = or i8 %empty_48, %empty_49          ; <i8> [#uses=1]
  %empty_51 = call i24 @_ssdm_op_PartSet.i24.i24.i8.i32.i32(i24 %empty_47, i8 %empty_50, i32 16, i32 23) ; <i24> [#uses=1]
  %empty_52 = zext i40 %0 to i64                  ; <i64> [#uses=1]
  %empty_53 = zext i24 %empty_51 to i64           ; <i64> [#uses=2]
  %empty_54 = trunc i64 %empty_52 to i40          ; <i40> [#uses=1]
  %empty_55 = call i40 @_ssdm_op_PartSelect.i40.i64.i32.i32(i64 %empty_53, i32 24, i32 63) ; <i40> [#uses=1]
  %empty_56 = or i40 %empty_54, %empty_55         ; <i40> [#uses=1]
  %empty_57 = call i64 @_ssdm_op_PartSet.i64.i64.i40.i32.i32(i64 %empty_53, i40 %empty_56, i32 24, i32 63) ; <i64> [#uses=1]
  ret i64 %empty_57
}
...
define internal fastcc void @"AXIvideo2Mat<64,1080,1920,16>"(i64* %AXI_video_strm_V_data_V, i8* %AXI_video_strm_V_keep_V, i8* %AXI_video_strm_V_strb_V, i1* %AXI_video_strm_V_user_V, i1* %AXI_video_strm_V_last_V, i1* %AXI_video_strm_V_id_V, i1* %AXI_video_strm_V_dest_V, i12 %img_rows_V_read, i12 %img_cols_V_read, i8* %img_data_stream_0_V, i8* %img_data_stream_1_V, i8* %img_data_stream_2_V) {
entry:
  %empty = call i32 (...)* @_ssdm_op_SpecFifo(i8* %img_data_stream_2_V, [8 x i8]* @str57, i32 0, i32 0, [8 x i8]* @str57) ; <i32> [#uses=0]
  %empty_58 = call i32 (...)* @_ssdm_op_SpecFifo(i8* %img_data_stream_1_V, [8 x i8]* @str54, i32 0, i32 0, [8 x i8]* @str54) ; <i32> [#uses=0]
  %empty_59 = call i32 (...)* @_ssdm_op_SpecFifo(i8* %img_data_stream_0_V, [8 x i8]* @str51, i32 0, i32 0, [8 x i8]* @str51) ; <i32> [#uses=0]
  %empty_60 = call i32 (...)* @_ssdm_op_SpecFifo(i1* %AXI_video_strm_V_dest_V, [8 x i8]* @str35, i32 0, i32 0, [8 x i8]* @str35) ; <i32> [#uses=0]
  %empty_61 = call i32 (...)* @_ssdm_op_SpecFifo(i1* %AXI_video_strm_V_id_V, [8 x i8]* @str34, i32 0, i32 0, [8 x i8]* @str34) ; <i32> [#uses=0]
  %empty_62 = call i32 (...)* @_ssdm_op_SpecFifo(i1* %AXI_video_strm_V_last_V, [8 x i8]* @str33, i32 0, i32 0, [8 x i8]* @str33) ; <i32> [#uses=0]
  %empty_63 = call i32 (...)* @_ssdm_op_SpecFifo(i1* %AXI_video_strm_V_user_V, [8 x i8]* @str32, i32 0, i32 0, [8 x i8]* @str32) ; <i32> [#uses=0]
  %empty_64 = call i32 (...)* @_ssdm_op_SpecFifo(i8* %AXI_video_strm_V_strb_V, [8 x i8]* @str31, i32 0, i32 0, [8 x i8]* @str31) ; <i32> [#uses=0]
  %empty_65 = call i32 (...)* @_ssdm_op_SpecFifo(i8* %AXI_video_strm_V_keep_V, [8 x i8]* @str30, i32 0, i32 0, [8 x i8]* @str30) ; <i32> [#uses=0]
  %empty_66 = call i32 (...)* @_ssdm_op_SpecFifo(i64* %AXI_video_strm_V_data_V, [8 x i8]* @str, i32 0, i32 0, [8 x i8]* @str) ; <i32> [#uses=0]
  call void (...)* @_ssdm_op_SpecIFCore(i64* %AXI_video_strm_V_data_V, i8* %AXI_video_strm_V_keep_V, i8* %AXI_video_strm_V_strb_V, i1* %AXI_video_strm_V_user_V, i1* %AXI_video_strm_V_last_V, i1* %AXI_video_strm_V_id_V, i1* %AXI_video_strm_V_dest_V, [1 x i8]* @p_str20, [5 x i8]* @p_str32, [1 x i8]* @p_str20, [1 x i8]* @p_str20, [1 x i8]* @p_str20, [25 x i8]* @p_str33)
  %img_cols_V_read_1 = call i12 @_ssdm_op_WireRead.i12(i12 %img_cols_V_read) ; <i12> [#uses=1]
  call void @llvm.dbg.value(metadata !{i12 %img_cols_V_read_1}, i64 0, metadata !1608)
  call void @llvm.dbg.value(metadata !{i12 %img_cols_V_read_1}, i64 0, metadata !1616)
  call void @llvm.dbg.value(metadata !{i12 %img_cols_V_read_1}, i64 0, metadata !1620)
  %img_rows_V_read_1 = call i12 @_ssdm_op_WireRead.i12(i12 %img_rows_V_read) ; <i12> [#uses=1]
  call void @llvm.dbg.value(metadata !{i12 %img_rows_V_read_1}, i64 0, metadata !1622)
  call void @llvm.dbg.value(metadata !{i12 %img_rows_V_read_1}, i64 0, metadata !1623)
  call void @llvm.dbg.value(metadata !{i12 %img_rows_V_read_1}, i64 0, metadata !1624)
  call void @llvm.dbg.value(metadata !{i64* %AXI_video_strm_V_data_V}, i64 0, metadata !1625)
  call void @llvm.dbg.value(metadata !{i8* %AXI_video_strm_V_keep_V}, i64 0, metadata !1627)
  call void @llvm.dbg.value(metadata !{i8* %AXI_video_strm_V_strb_V}, i64 0, metadata !1628)
  call void @llvm.dbg.value(metadata !{i1* %AXI_video_strm_V_user_V}, i64 0, metadata !1629)
  call void @llvm.dbg.value(metadata !{i1* %AXI_video_strm_V_last_V}, i64 0, metadata !1630)
  call void @llvm.dbg.value(metadata !{i1* %AXI_video_strm_V_id_V}, i64 0, metadata !1631)
  call void @llvm.dbg.value(metadata !{i1* %AXI_video_strm_V_dest_V}, i64 0, metadata !1632)
  call void @llvm.dbg.value(metadata !{i12 %img_rows_V_read}, i64 0, metadata !1622)
  call void @llvm.dbg.value(metadata !{i12 %img_cols_V_read}, i64 0, metadata !1608)
  call void @llvm.dbg.value(metadata !{i8* %img_data_stream_0_V}, i64 0, metadata !1633)
  call void @llvm.dbg.value(metadata !{i8* %img_data_stream_1_V}, i64 0, metadata !1635)
  call void @llvm.dbg.value(metadata !{i8* %img_data_stream_2_V}, i64 0, metadata !1636)
  call void @llvm.dbg.value(metadata !{i12 %img_rows_V_read}, i64 0, metadata !1637), !dbg !1641
  call void @llvm.dbg.value(metadata !{i12 %img_cols_V_read}, i64 0, metadata !1642), !dbg !1644
  br label %bb3, !dbg !1645

bb2:                                              ; preds = %bb3
  call void @llvm.dbg.value(metadata !{i64 %axi_data_V}, i64 0, metadata !1646)
  call void @llvm.dbg.value(metadata !{i1 %axi_user_V}, i64 0, metadata !1648)
  call void @llvm.dbg.value(metadata !{i1 %axi_last_V}, i64 0, metadata !1649)
  call void @llvm.dbg.value(metadata !{i1 %axi_user_V}, i64 0, metadata !1650)
  %tmp = call i32 (...)* @_ssdm_op_SpecRegionBegin([13 x i8]* @p_str25), !dbg !1651 ; <i32> [#uses=1]
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, [1 x i8]* @p_str20) nounwind, !dbg !1652
  call void @llvm.dbg.value(metadata !{i64* %AXI_video_strm_V_data_V}, i64 0, metadata !1653)
  call void @llvm.dbg.value(metadata !{i8* %AXI_video_strm_V_keep_V}, i64 0, metadata !1657)
  call void @llvm.dbg.value(metadata !{i8* %AXI_video_strm_V_strb_V}, i64 0, metadata !1658)
  call void @llvm.dbg.value(metadata !{i1* %AXI_video_strm_V_user_V}, i64 0, metadata !1659)
  call void @llvm.dbg.value(metadata !{i1* %AXI_video_strm_V_last_V}, i64 0, metadata !1660)
  call void @llvm.dbg.value(metadata !{i1* %AXI_video_strm_V_id_V}, i64 0, metadata !1661)
  call void @llvm.dbg.value(metadata !{i1* %AXI_video_strm_V_dest_V}, i64 0, metadata !1662)
  call void @llvm.dbg.value(metadata !{i64* %AXI_video_strm_V_data_V}, i64 0, metadata !1663)
  call void @llvm.dbg.value(metadata !{i8* %AXI_video_strm_V_keep_V}, i64 0, metadata !1665)
  call void @llvm.dbg.value(metadata !{i8* %AXI_video_strm_V_strb_V}, i64 0, metadata !1666)
  call void @llvm.dbg.value(metadata !{i1* %AXI_video_strm_V_user_V}, i64 0, metadata !1667)
  call void @llvm.dbg.value(metadata !{i1* %AXI_video_strm_V_last_V}, i64 0, metadata !1668)
  call void @llvm.dbg.value(metadata !{i1* %AXI_video_strm_V_id_V}, i64 0, metadata !1669)
  call void @llvm.dbg.value(metadata !{i1* %AXI_video_strm_V_dest_V}, i64 0, metadata !1670)
  %empty_67 = call %0 @_ssdm_op_FifoRead.volatile.i64P.i8P.i8P.i1P.i1P.i1P.i1P(i64* %AXI_video_strm_V_data_V, i8* %AXI_video_strm_V_keep_V, i8* %AXI_video_strm_V_strb_V, i1* %AXI_video_strm_V_user_V, i1* %AXI_video_strm_V_last_V, i1* %AXI_video_strm_V_id_V, i1* %AXI_video_strm_V_dest_V), !dbg !1671 ; <%0> [#uses=3]
  %tmp_data_V = extractvalue %0 %empty_67, 0, !dbg !1671 ; <i64> [#uses=1]
  %tmp_user_V = extractvalue %0 %empty_67, 3, !dbg !1671 ; <i1> [#uses=1]
  %tmp_last_V = extractvalue %0 %empty_67, 4, !dbg !1671 ; <i1> [#uses=1]
  call void @llvm.dbg.value(metadata !{i64 %tmp_data_V}, i64 0, metadata !1677), !dbg !1671
  call void @llvm.dbg.value(metadata !{i1 %tmp_user_V}, i64 0, metadata !1679), !dbg !1671
  call void @llvm.dbg.value(metadata !{i1 %tmp_last_V}, i64 0, metadata !1680), !dbg !1671
  call void @llvm.dbg.value(metadata !{i64 %tmp_data_V}, i64 0, metadata !1646), !dbg !1681
  call void @llvm.dbg.value(metadata !{i1 %tmp_user_V}, i64 0, metadata !1648), !dbg !1685
  call void @llvm.dbg.value(metadata !{i1 %tmp_last_V}, i64 0, metadata !1649), !dbg !1685
  call void @llvm.dbg.value(metadata !{i1 %tmp_user_V}, i64 0, metadata !1650), !dbg !1687
  %empty_68 = call i32 (...)* @_ssdm_op_SpecRegionEnd([13 x i8]* @p_str25, i32 %tmp), !dbg !1688 ; <i32> [#uses=0]
  br label %bb3, !dbg !1688

bb3:                                              ; preds = %bb2, %entry
  %axi_data_V = phi i64 [ undef, %entry ], [ %tmp_data_V, %bb2 ] ; <i64> [#uses=1]
  %axi_last_V = phi i1 [ undef, %entry ], [ %tmp_last_V, %bb2 ] ; <i1> [#uses=1]
  %axi_user_V = phi i1 [ false, %entry ], [ %tmp_user_V, %bb2 ] ; <i1> [#uses=1]
  br i1 %axi_user_V, label %bb37.preheader, label %bb2, !dbg !1651

bb37.preheader:                                   ; preds = %bb3
  %sof = alloca i1                                ; <i1*> [#uses=3]
  call void @llvm.dbg.declare(metadata !{i1* %sof}, metadata !1650)
  store i1 true, i1* %sof
  br label %bb37

bb6:                                              ; preds = %bb37
  %tmp_1 = call i32 (...)* @_ssdm_op_SpecRegionBegin([13 x i8]* @p_str26), !dbg !1689 ; <i32> [#uses=1]
  call void (...)* @_ssdm_op_SpecLoopTripCount(i32 0, i32 1080, i32 0, [1 x i8]* @p_str20) nounwind, !dbg !1692
  br label %bb29, !dbg !1693

bb7:                                              ; preds = %bb29
  %sof_load = load i1* %sof, !dbg !1695           ; <i1> [#uses=1]
  %tmp_2 = call i32 (...)* @_ssdm_op_SpecRegionBegin([13 x i8]* @p_str27), !dbg !1693 ; <i32> [#uses=1]
  call void (...)* @_ssdm_op_SpecLoopTripCount(i32 0, i32 1920, i32 0, [1 x i8]* @p_str20) nounwind, !dbg !1696
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, [1 x i8]* @p_str20) nounwind, !dbg !1697
  br i1 %sof_load, label %bb14.pre, label %bb9, !dbg !1695

bb9:                                              ; preds = %bb7
  br i1 %eol, label %bb14, label %bb12, !dbg !1698
...
bb12:                                             ; preds = %bb9
  ...
  call void @llvm.dbg.value(metadata !{i1* %AXI_video_strm_V_id_V}, i64 0, metadata !1661)
  call void @llvm.dbg.value(metadata !{i1* %AXI_video_strm_V_dest_V}, i64 0, metadata !1662)
  %empty_69 = call %0 @_ssdm_op_FifoRead.volatile.i64P.i8P.i8P.i1P.i1P.i1P.i1P(i64* %AXI_video_strm_V_data_V, i8* %AXI_video_strm_V_keep_V, i8* %AXI_video_strm_V_strb_V, i1* %AXI_video_strm_V_user_V, i1* %AXI_video_strm_V_last_V, i1* %AXI_video_strm_V_id_V, i1* %AXI_video_strm_V_dest_V), !dbg !1699 ; <%0> [#uses=2]
  %tmp_data_V_1 = extractvalue %0 %empty_69, 0, !dbg !1699 ; <i64> [#uses=1]
  %tmp_last_V_1 = extractvalue %0 %empty_69, 4, !dbg !1699 ; <i1> [#uses=2]
  call void @llvm.dbg.value(metadata !{i64 %tmp_data_V_1}, i64 0, metadata !1677), !dbg !1699
  call void @llvm.dbg.value(metadata !{i1 %tmp_last_V_1}, i64 0, metadata !1680), !dbg !1699
  call void @llvm.dbg.value(metadata !{i64 %tmp_data_V_1}, i64 0, metadata !1646), !dbg !1702
  call void @llvm.dbg.value(metadata !{i1 %tmp_last_V_1}, i64 0, metadata !1649), !dbg !1705
  call void @llvm.dbg.value(metadata !{i1 %tmp_last_V_1}, i64 0, metadata !1706), !dbg !1707
  br label %bb14, !dbg !1707
...
bb14:                                             ; preds = %bb14.pre, %bb12, %bb9
  %axi_data_V_8 = phi i64 [ %tmp_data_V_1, %bb12 ], [ %axi_data_V_2, %bb14.pre ], [ 0, %bb9 ] ; <i64> [#uses=4]
  ...
  call void @llvm.dbg.value(metadata !{i64 %axi_data_V_8}, i64 0, metadata !1646)
  call void @llvm.dbg.value(metadata !{i1 %axi_last_V_7}, i64 0, metadata !1649)
  call void @llvm.dbg.value(metadata !{i1 %eol_5}, i64 0, metadata !1706)
  call void @llvm.dbg.value(metadata !{i64 %axi_data_V_8}, i64 0, metadata !1708)
  call void @llvm.dbg.value(metadata !{i1 %axi_last_V_7}, i64 0, metadata !1713)
  call void @llvm.dbg.value(metadata !{i64 %axi_data_V_8}, i64 0, metadata !1714) nounwind, !dbg !1718
  %pix_val_0 = trunc i64 %axi_data_V_8 to i8, !dbg !1718 ; <i8> [#uses=1]
  call void @llvm.dbg.value(metadata !{i8 %pix_val_0}, i64 0, metadata !1726), !dbg !1721
  call void @llvm.dbg.value(metadata !{i64 %axi_data_V_8}, i64 0, metadata !1708)
  call void @llvm.dbg.value(metadata !{i1 %axi_last_V_7}, i64 0, metadata !1713)
  call void @llvm.dbg.value(metadata !{i64 %axi_data_V_8}, i64 0, metadata !1714) nounwind, !dbg !1718
  %pix_val_1 = call i8 @_ssdm_op_PartSelect.i8.i64.i32.i32(i64 %axi_data_V_8, i32 8, i32 15), !dbg !1718 ; <i8> [#uses=1]
  call void @llvm.dbg.value(metadata !{i8 %pix_val_1}, i64 0, metadata !1728), !dbg !1721
  call void @llvm.dbg.value(metadata !{i64 %axi_data_V_8}, i64 0, metadata !1708)
  call void @llvm.dbg.value(metadata !{i1 %axi_last_V_7}, i64 0, metadata !1713)
  call void @llvm.dbg.value(metadata !{i64 %axi_data_V_8}, i64 0, metadata !1714) nounwind, !dbg !1718
  %pix_val_2 = call i8 @_ssdm_op_PartSelect.i8.i64.i32.i32(i64 %axi_data_V_8, i32 16, i32 23), !dbg !1718 ; <i8> [#uses=1]
  call void @llvm.dbg.value(metadata !{i8 %pix_val_2}, i64 0, metadata !1729), !dbg !1721
  call void @llvm.dbg.value(metadata !{i8 %pix_val_0}, i64 0, metadata !1730)
  call void @llvm.dbg.value(metadata !{i8 %pix_val_1}, i64 0, metadata !1732)
  call void @llvm.dbg.value(metadata !{i8 %pix_val_2}, i64 0, metadata !1733)
  call void @llvm.dbg.value(metadata !{i12 %img_rows_V_read}, i64 0, metadata !1623)
  call void @llvm.dbg.value(metadata !{i12 %img_cols_V_read}, i64 0, metadata !1616)
  call void @llvm.dbg.value(metadata !{i8* %img_data_stream_0_V}, i64 0, metadata !1734)
  call void @llvm.dbg.value(metadata !{i8* %img_data_stream_1_V}, i64 0, metadata !1735)
  call void @llvm.dbg.value(metadata !{i8* %img_data_stream_2_V}, i64 0, metadata !1736)
  call void @llvm.dbg.value(metadata !{i8 %pix_val_0}, i64 0, metadata !1737)
  call void @llvm.dbg.value(metadata !{i8 %pix_val_1}, i64 0, metadata !1739)
  call void @llvm.dbg.value(metadata !{i8 %pix_val_2}, i64 0, metadata !1740)
  call void @llvm.dbg.value(metadata !{i12 %img_rows_V_read}, i64 0, metadata !1624)
  call void @llvm.dbg.value(metadata !{i12 %img_cols_V_read}, i64 0, metadata !1620)
  call void @llvm.dbg.value(metadata !{i8* %img_data_stream_0_V}, i64 0, metadata !1741)
  call void @llvm.dbg.value(metadata !{i8* %img_data_stream_1_V}, i64 0, metadata !1742)
  call void @llvm.dbg.value(metadata !{i8* %img_data_stream_2_V}, i64 0, metadata !1743)
  call void @_ssdm_op_FifoWrite.volatile.i8P(i8* %img_data_stream_0_V, i8 %pix_val_0), !dbg !1744
  call void @_ssdm_op_FifoWrite.volatile.i8P(i8* %img_data_stream_1_V, i8 %pix_val_1), !dbg !1744
  call void @_ssdm_op_FifoWrite.volatile.i8P(i8* %img_data_stream_2_V, i8 %pix_val_2), !dbg !1744
  %empty_70 = call i32 (...)* @_ssdm_op_SpecRegionEnd([13 x i8]* @p_str27, i32 %tmp_2), !dbg !1755 ; <i32> [#uses=0]
  call void @llvm.dbg.value(metadata !{i12 %t_V_1}, i64 0, metadata !1756), !dbg !1760
  call void @llvm.dbg.value(metadata !{i12 %j_V}, i64 0, metadata !1761), !dbg !1763
  br label %bb29, !dbg !1693

bb29:                                             ; preds = %bb14, %bb6
  %axi_data_V_2 = phi i64 [ %axi_data_V_1, %bb6 ], [ %axi_data_V_8, %bb14 ] ; <i64> [#uses=2]
  ...
  call void @llvm.dbg.value(metadata !{i1 %eol_6}, i64 0, metadata !1706), !dbg !1768
  call void @llvm.dbg.value(metadata !{i64 %axi_data_V_2}, i64 0, metadata !1646)
  call void @llvm.dbg.value(metadata !{i1 %eol_6}, i64 0, metadata !1649)
  call void @llvm.dbg.value(metadata !{i12 %t_V_1}, i64 0, metadata !1761)
  call void @llvm.dbg.value(metadata !{i1 %eol}, i64 0, metadata !1706)
  %exitcond3 = icmp eq i12 %t_V_1, %img_cols_V_read_1, !dbg !1769 ; <i1> [#uses=1]
  %j_V = add i12 %t_V_1, 1, !dbg !1763            ; <i12> [#uses=1]
  br i1 %exitcond3, label %bb32, label %bb7, !dbg !1693

bb31:                                             ; preds = %bb32
  call void @llvm.dbg.value(metadata !{i64 %axi_data_V_4}, i64 0, metadata !1646)
  call void @llvm.dbg.value(metadata !{i1 %axi_last_V_4}, i64 0, metadata !1649)
  call void @llvm.dbg.value(metadata !{i1 %eol_1}, i64 0, metadata !1706)
  %tmp_3 = call i32 (...)* @_ssdm_op_SpecRegionBegin([13 x i8]* @p_str28), !dbg !1774 ; <i32> [#uses=1]
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, [1 x i8]* @p_str20) nounwind, !dbg !1775
  call void @llvm.dbg.value(metadata !{i64* %AXI_video_strm_V_data_V}, i64 0, metadata !1653)
  call void @llvm.dbg.value(metadata !{i8* %AXI_video_strm_V_keep_V}, i64 0, metadata !1657)
  call void @llvm.dbg.value(metadata !{i8* %AXI_video_strm_V_strb_V}, i64 0, metadata !1658)
  call void @llvm.dbg.value(metadata !{i1* %AXI_video_strm_V_user_V}, i64 0, metadata !1659)
  ...
  call void @llvm.dbg.value(metadata !{i1* %AXI_video_strm_V_id_V}, i64 0, metadata !1669)
  call void @llvm.dbg.value(metadata !{i1* %AXI_video_strm_V_dest_V}, i64 0, metadata !1670)
  %empty_71 = call %0 @_ssdm_op_FifoRead.volatile.i64P.i8P.i8P.i1P.i1P.i1P.i1P(i64* %AXI_video_strm_V_data_V, i8* %AXI_video_strm_V_keep_V, i8* %AXI_video_strm_V_strb_V, i1* %AXI_video_strm_V_user_V, i1* %AXI_video_strm_V_last_V, i1* %AXI_video_strm_V_id_V, i1* %AXI_video_strm_V_dest_V), !dbg !1776 ; <%0> [#uses=2]
  %tmp_data_V_2 = extractvalue %0 %empty_71, 0, !dbg !1776 ; <i64> [#uses=1]
  %tmp_last_V_2 = extractvalue %0 %empty_71, 4, !dbg !1776 ; <i1> [#uses=2]
  call void @llvm.dbg.value(metadata !{i64 %tmp_data_V_2}, i64 0, metadata !1677), !dbg !1776
  call void @llvm.dbg.value(metadata !{i1 %tmp_last_V_2}, i64 0, metadata !1680), !dbg !1776
  call void @llvm.dbg.value(metadata !{i64 %tmp_data_V_2}, i64 0, metadata !1646), !dbg !1779
  call void @llvm.dbg.value(metadata !{i1 %tmp_last_V_2}, i64 0, metadata !1649), !dbg !1782
  call void @llvm.dbg.value(metadata !{i1 %tmp_last_V_2}, i64 0, metadata !1706), !dbg !1783
  %empty_72 = call i32 (...)* @_ssdm_op_SpecRegionEnd([13 x i8]* @p_str28, i32 %tmp_3), !dbg !1784 ; <i32> [#uses=0]
  br label %bb32, !dbg !1784

bb32:                                             ; preds = %bb31, %bb29
  %axi_data_V_4 = phi i64 [ %tmp_data_V_2, %bb31 ], [ %axi_data_V_2, %bb29 ] ; <i64> [#uses=1]
  %axi_last_V_4 = phi i1 [ %tmp_last_V_2, %bb31 ], [ %eol_6, %bb29 ] ; <i1> [#uses=1]
  %eol_1 = phi i1 [ %tmp_last_V_2, %bb31 ], [ %eol, %bb29 ] ; <i1> [#uses=1]
  br i1 %eol_1, label %bb35, label %bb31, !dbg !1774

bb35:                                             ; preds = %bb32
  %empty_73 = call i32 (...)* @_ssdm_op_SpecRegionEnd([13 x i8]* @p_str26, i32 %tmp_1), !dbg !1785 ; <i32> [#uses=0]
  call void @llvm.dbg.value(metadata !{i12 %t_V}, i64 0, metadata !1756), !dbg !1786
  call void @llvm.dbg.value(metadata !{i12 %i_V}, i64 0, metadata !1788), !dbg !1790
  br label %bb37, !dbg !1787

bb37:                                             ; preds = %bb35, %bb37.preheader
  %axi_data_V_1 = phi i64 [ %axi_data_V_4, %bb35 ], [ %axi_data_V, %bb37.preheader ] ; <i64> [#uses=1]
  ...
  call void @llvm.dbg.value(metadata !{i64 %axi_data_V_1}, i64 0, metadata !1646)
  call void @llvm.dbg.value(metadata !{i1 %axi_last_V_1}, i64 0, metadata !1649)
  call void @llvm.dbg.value(metadata !{i12 %t_V}, i64 0, metadata !1788)
  %exitcond = icmp eq i12 %t_V, %img_rows_V_read_1, !dbg !1792 ; <i1> [#uses=1]
  %i_V = add i12 %t_V, 1, !dbg !1790              ; <i12> [#uses=1]
  br i1 %exitcond, label %return, label %bb6, !dbg !1787

return:                                           ; preds = %bb37
  ret void
}

define internal fastcc void @"Mat2AXIvideo<64,1080,1920,16>"(i12 %img_rows_V_read, i12 %img_cols_V_read, i8* %img_data_stream_0_V, i8* %img_data_stream_1_V, i8* %img_data_stream_2_V, i64* %AXI_video_strm_V_data_V, i8* %AXI_video_strm_V_keep_V, i8* %AXI_video_strm_V_strb_V, i1* %AXI_video_strm_V_user_V, i1* %AXI_video_strm_V_last_V, i1* %AXI_video_strm_V_id_V, i1* %AXI_video_strm_V_dest_V) {
entry:
  %sof_2 = alloca i1                              ; <i1*> [#uses=3]
  call void @llvm.dbg.declare(metadata !{i1* %sof_2}, metadata !1793)
  %empty = call i32 (...)* @_ssdm_op_SpecFifo(i8* %img_data_stream_2_V, [8 x i8]* @str57, i32 0, i32 0, [8 x i8]* @str57) ; <i32> [#uses=0]
  %empty_74 = call i32 (...)* @_ssdm_op_SpecFifo(i8* %img_data_stream_1_V, [8 x i8]* @str54, i32 0, i32 0, [8 x i8]* @str54) ; <i32> [#uses=0]
  %empty_75 = call i32 (...)* @_ssdm_op_SpecFifo(i8* %img_data_stream_0_V, [8 x i8]* @str51, i32 0, i32 0, [8 x i8]* @str51) ; <i32> [#uses=0]
  %empty_76 = call i32 (...)* @_ssdm_op_SpecFifo(i1* %AXI_video_strm_V_dest_V, [8 x i8]* @str42, i32 0, i32 0, [8 x i8]* @str42) ; <i32> [#uses=0]
  %empty_77 = call i32 (...)* @_ssdm_op_SpecFifo(i1* %AXI_video_strm_V_id_V, [8 x i8]* @str41, i32 0, i32 0, [8 x i8]* @str41) ; <i32> [#uses=0]
  %empty_78 = call i32 (...)* @_ssdm_op_SpecFifo(i1* %AXI_video_strm_V_last_V, [8 x i8]* @str40, i32 0, i32 0, [8 x i8]* @str40) ; <i32> [#uses=0]
  %empty_79 = call i32 (...)* @_ssdm_op_SpecFifo(i1* %AXI_video_strm_V_user_V, [8 x i8]* @str39, i32 0, i32 0, [8 x i8]* @str39) ; <i32> [#uses=0]
  %empty_80 = call i32 (...)* @_ssdm_op_SpecFifo(i8* %AXI_video_strm_V_strb_V, [8 x i8]* @str38, i32 0, i32 0, [8 x i8]* @str38) ; <i32> [#uses=0]
  %empty_81 = call i32 (...)* @_ssdm_op_SpecFifo(i8* %AXI_video_strm_V_keep_V, [8 x i8]* @str37, i32 0, i32 0, [8 x i8]* @str37) ; <i32> [#uses=0]
  %empty_82 = call i32 (...)* @_ssdm_op_SpecFifo(i64* %AXI_video_strm_V_data_V, [8 x i8]* @str36, i32 0, i32 0, [8 x i8]* @str36) ; <i32> [#uses=0]
  call void (...)* @_ssdm_op_SpecIFCore(i64* %AXI_video_strm_V_data_V, i8* %AXI_video_strm_V_keep_V, i8* %AXI_video_strm_V_strb_V, i1* %AXI_video_strm_V_user_V, i1* %AXI_video_strm_V_last_V, i1* %AXI_video_strm_V_id_V, i1* %AXI_video_strm_V_dest_V, [1 x i8]* @p_str20, [5 x i8]* @p_str32, [1 x i8]* @p_str20, [1 x i8]* @p_str20, [1 x i8]* @p_str20, [26 x i8]* @p_str34)
  %img_cols_V_read_2 = call i12 @_ssdm_op_WireRead.i12(i12 %img_cols_V_read) ; <i12> [#uses=2]
  call void @llvm.dbg.value(metadata !{i12 %img_cols_V_read_2}, i64 0, metadata !1799)
  call void @llvm.dbg.value(metadata !{i12 %img_cols_V_read_2}, i64 0, metadata !1801)
  call void @llvm.dbg.value(metadata !{i12 %img_cols_V_read_2}, i64 0, metadata !1803)
  %img_rows_V_read_2 = call i12 @_ssdm_op_WireRead.i12(i12 %img_rows_V_read) ; <i12> [#uses=1]
  call void @llvm.dbg.value(metadata !{i12 %img_rows_V_read_2}, i64 0, metadata !1805)
  call void @llvm.dbg.value(metadata !{i12 %img_rows_V_read_2}, i64 0, metadata !1806)
  call void @llvm.dbg.value(metadata !{i12 %img_rows_V_read_2}, i64 0, metadata !1807)
  call void @llvm.dbg.value(metadata !{i12 %img_rows_V_read}, i64 0, metadata !1805)
  call void @llvm.dbg.value(metadata !{i12 %img_cols_V_read}, i64 0, metadata !1799)
  call void @llvm.dbg.value(metadata !{i8* %img_data_stream_0_V}, i64 0, metadata !1808)
  call void @llvm.dbg.value(metadata !{i8* %img_data_stream_1_V}, i64 0, metadata !1809)
  call void @llvm.dbg.value(metadata !{i8* %img_data_stream_2_V}, i64 0, metadata !1810)
  call void @llvm.dbg.value(metadata !{i64* %AXI_video_strm_V_data_V}, i64 0, metadata !1811)
  call void @llvm.dbg.value(metadata !{i8* %AXI_video_strm_V_keep_V}, i64 0, metadata !1813)
  call void @llvm.dbg.value(metadata !{i8* %AXI_video_strm_V_strb_V}, i64 0, metadata !1814)
  call void @llvm.dbg.value(metadata !{i1* %AXI_video_strm_V_user_V}, i64 0, metadata !1815)
  call void @llvm.dbg.value(metadata !{i1* %AXI_video_strm_V_last_V}, i64 0, metadata !1816)
  call void @llvm.dbg.value(metadata !{i1* %AXI_video_strm_V_id_V}, i64 0, metadata !1817)
  call void @llvm.dbg.value(metadata !{i1* %AXI_video_strm_V_dest_V}, i64 0, metadata !1818)
  call void @llvm.dbg.value(metadata !{i12 %img_rows_V_read}, i64 0, metadata !1819), !dbg !1821
  call void @llvm.dbg.value(metadata !{i12 %img_cols_V_read}, i64 0, metadata !1822), !dbg !1824
  %retval_i_cast = zext i12 %img_cols_V_read_2 to i13, !dbg !1825 ; <i13> [#uses=1]
  %op2_assign = add i13 %retval_i_cast, -1, !dbg !1825 ; <i13> [#uses=1]
  store i1 true, i1* %sof_2
  br label %bb17, !dbg !1828

bb2:                                              ; preds = %bb17
  %tmp = call i32 (...)* @_ssdm_op_SpecRegionBegin([13 x i8]* @p_str30), !dbg !1828 ; <i32> [#uses=1]
  call void (...)* @_ssdm_op_SpecLoopTripCount(i32 0, i32 1080, i32 0, [1 x i8]* @p_str20) nounwind, !dbg !1829
  br label %bb14, !dbg !1830

bb3:                                              ; preds = %bb14
  %sof_2_load = load i1* %sof_2, !dbg !1831       ; <i1> [#uses=1]
  %tmp_8 = call i32 (...)* @_ssdm_op_SpecRegionBegin([13 x i8]* @p_str31), !dbg !1830 ; <i32> [#uses=1]
  call void (...)* @_ssdm_op_SpecLoopTripCount(i32 0, i32 1920, i32 0, [1 x i8]* @p_str20) nounwind, !dbg !1837
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, [1 x i8]* @p_str20) nounwind, !dbg !1838
  call void @llvm.dbg.value(metadata !{i13 %op2_assign}, i64 0, metadata !1839)
  call void @llvm.dbg.value(metadata !{i13 %op2_assign}, i64 0, metadata !1843)
  %tmp_cast = zext i12 %t_V_2 to i13, !dbg !1845  ; <i13> [#uses=1]
  %axi_last_V = icmp eq i13 %tmp_cast, %op2_assign, !dbg !1845 ; <i1> [#uses=1]
  call void @llvm.dbg.value(metadata !{i1 %axi_last_V}, i64 0, metadata !1851), !dbg !1853
  call void @llvm.dbg.value(metadata !{i12 %img_rows_V_read}, i64 0, metadata !1806)
  call void @llvm.dbg.value(metadata !{i12 %img_cols_V_read}, i64 0, metadata !1801)
  call void @llvm.dbg.value(metadata !{i8* %img_data_stream_0_V}, i64 0, metadata !1855)
  call void @llvm.dbg.value(metadata !{i8* %img_data_stream_1_V}, i64 0, metadata !1856)
  call void @llvm.dbg.value(metadata !{i8* %img_data_stream_2_V}, i64 0, metadata !1857)
  call void @llvm.dbg.value(metadata !{i12 %img_rows_V_read}, i64 0, metadata !1807)
  call void @llvm.dbg.value(metadata !{i12 %img_cols_V_read}, i64 0, metadata !1803)
  call void @llvm.dbg.value(metadata !{i8* %img_data_stream_0_V}, i64 0, metadata !1858)
  call void @llvm.dbg.value(metadata !{i8* %img_data_stream_1_V}, i64 0, metadata !1859)
  call void @llvm.dbg.value(metadata !{i8* %img_data_stream_2_V}, i64 0, metadata !1860)
  %tmp_9 = call i8 @_ssdm_op_FifoRead.volatile.i8P(i8* %img_data_stream_0_V), !dbg !1861 ; <i8> [#uses=1]
  call void @llvm.dbg.value(metadata !{i8 %tmp_9}, i64 0, metadata !1872), !dbg !1861
  call void @llvm.dbg.value(metadata !{i8 %tmp_9}, i64 0, metadata !1873), !dbg !1877
  %tmp_10 = call i8 @_ssdm_op_FifoRead.volatile.i8P(i8* %img_data_stream_1_V), !dbg !1861 ; <i8> [#uses=1]
  call void @llvm.dbg.value(metadata !{i8 %tmp_10}, i64 0, metadata !1872), !dbg !1861
  call void @llvm.dbg.value(metadata !{i8 %tmp_10}, i64 0, metadata !1878), !dbg !1877
  %tmp_11 = call i8 @_ssdm_op_FifoRead.volatile.i8P(i8* %img_data_stream_2_V), !dbg !1861 ; <i8> [#uses=1]
  call void @llvm.dbg.value(metadata !{i8 %tmp_11}, i64 0, metadata !1872), !dbg !1861
  call void @llvm.dbg.value(metadata !{i8 %tmp_11}, i64 0, metadata !1879), !dbg !1877
  call void @llvm.dbg.value(metadata !{i8 %tmp_9}, i64 0, metadata !1880), !dbg !1869
  call void @llvm.dbg.value(metadata !{i8 %tmp_10}, i64 0, metadata !1882), !dbg !1869
  call void @llvm.dbg.value(metadata !{i8 %tmp_11}, i64 0, metadata !1883), !dbg !1869
  call void @llvm.dbg.value(metadata !{i8 %tmp_9}, i64 0, metadata !1884) nounwind
  call void @llvm.dbg.value(metadata !{i8 %tmp_10}, i64 0, metadata !1884) nounwind
  call void @llvm.dbg.value(metadata !{i8 %tmp_11}, i64 0, metadata !1884) nounwind
  %axi_data_V = call i64 @_ssdm_op_BitConcatenate.i64.i40.i8.i8.i8(i40 -1, i8 %tmp_11, i8 %tmp_10, i8 %tmp_9), !dbg !1888 ; <i64> [#uses=1]
  call void @llvm.dbg.value(metadata !{i64 %axi_data_V}, i64 0, metadata !1896)
  call void @llvm.dbg.value(metadata !{i64 %axi_data_V}, i64 0, metadata !1897) nounwind, !dbg !1888
  call void @llvm.dbg.value(metadata !{i64 %axi_data_V}, i64 0, metadata !1896), !dbg !1888
  call void @llvm.dbg.value(metadata !{i64* %AXI_video_strm_V_data_V}, i64 0, metadata !1899)
  call void @llvm.dbg.value(metadata !{i8* %AXI_video_strm_V_keep_V}, i64 0, metadata !1901)
  call void @llvm.dbg.value(metadata !{i8* %AXI_video_strm_V_strb_V}, i64 0, metadata !1902)
  call void @llvm.dbg.value(metadata !{i1* %AXI_video_strm_V_user_V}, i64 0, metadata !1903)
  call void @llvm.dbg.value(metadata !{i1* %AXI_video_strm_V_last_V}, i64 0, metadata !1904)
  call void @llvm.dbg.value(metadata !{i1* %AXI_video_strm_V_id_V}, i64 0, metadata !1905)
  call void @llvm.dbg.value(metadata !{i1* %AXI_video_strm_V_dest_V}, i64 0, metadata !1906)
  call void @llvm.dbg.value(metadata !{i64* %AXI_video_strm_V_data_V}, i64 0, metadata !1907)
  call void @llvm.dbg.value(metadata !{i8* %AXI_video_strm_V_keep_V}, i64 0, metadata !1909)
  call void @llvm.dbg.value(metadata !{i8* %AXI_video_strm_V_strb_V}, i64 0, metadata !1910)
  call void @llvm.dbg.value(metadata !{i1* %AXI_video_strm_V_user_V}, i64 0, metadata !1911)
  call void @llvm.dbg.value(metadata !{i1* %AXI_video_strm_V_last_V}, i64 0, metadata !1912)
  call void @llvm.dbg.value(metadata !{i1* %AXI_video_strm_V_id_V}, i64 0, metadata !1913)
  call void @llvm.dbg.value(metadata !{i1* %AXI_video_strm_V_dest_V}, i64 0, metadata !1914)
  call void @_ssdm_op_FifoWrite.volatile.i64P.i8P.i8P.i1P.i1P.i1P.i1P(i64* %AXI_video_strm_V_data_V, i8* %AXI_video_strm_V_keep_V, i8* %AXI_video_strm_V_strb_V, i1* %AXI_video_strm_V_user_V, i1* %AXI_video_strm_V_last_V, i1* %AXI_video_strm_V_id_V, i1* %AXI_video_strm_V_dest_V, i64 %axi_data_V, i8 -1, i8 undef, i1 %sof_2_load, i1 %axi_last_V, i1 undef, i1 undef), !dbg !1831
  %empty_83 = call i32 (...)* @_ssdm_op_SpecRegionEnd([13 x i8]* @p_str31, i32 %tmp_8), !dbg !1915 ; <i32> [#uses=0]
  call void @llvm.dbg.value(metadata !{i12 %t_V_2}, i64 0, metadata !1756), !dbg !1916
  call void @llvm.dbg.value(metadata !{i12 %j_V}, i64 0, metadata !1917), !dbg !1919
  store i1 false, i1* %sof_2
  br label %bb14, !dbg !1830

bb14:                                             ; preds = %bb3, %bb2
  %t_V_2 = phi i12 [ 0, %bb2 ], [ %j_V, %bb3 ]    ; <i12> [#uses=3]
  call void @llvm.dbg.value(metadata !{i12 %t_V_2}, i64 0, metadata !1917)
  %exitcond2 = icmp eq i12 %t_V_2, %img_cols_V_read_2, !dbg !1921 ; <i1> [#uses=1]
  %j_V = add i12 %t_V_2, 1, !dbg !1919            ; <i12> [#uses=1]
  br i1 %exitcond2, label %bb15, label %bb3, !dbg !1830

bb15:                                             ; preds = %bb14
  %empty_84 = call i32 (...)* @_ssdm_op_SpecRegionEnd([13 x i8]* @p_str30, i32 %tmp), !dbg !1922 ; <i32> [#uses=0]
  call void @llvm.dbg.value(metadata !{i12 %t_V}, i64 0, metadata !1756), !dbg !1923
  call void @llvm.dbg.value(metadata !{i12 %i_V}, i64 0, metadata !1924), !dbg !1926
  br label %bb17, !dbg !1828

bb17:                                             ; preds = %bb15, %entry
  %t_V = phi i12 [ 0, %entry ], [ %i_V, %bb15 ]   ; <i12> [#uses=2]
  call void @llvm.dbg.value(metadata !{i12 %t_V}, i64 0, metadata !1924)
  %exitcond = icmp eq i12 %t_V, %img_rows_V_read_2, !dbg !1928 ; <i1> [#uses=1]
  %i_V = add i12 %t_V, 1, !dbg !1926              ; <i12> [#uses=1]
  br i1 %exitcond, label %return, label %bb2, !dbg !1828

return:                                           ; preds = %bb17
  ret void
}

define internal fastcc void @init.1(i32 %p_rows, i32 %p_cols) {
entry:
  call void (...)* @_ssdm_op_SpecIFCore(i32 %p_cols, [1 x i8]* @p_str20, [10 x i8]* @p_str35, [1 x i8]* @p_str20, [1 x i8]* @p_str20, [1 x i8]* @p_str20, [24 x i8]* @p_str36)
  call void (...)* @_ssdm_op_SpecIFCore(i32 %p_rows, [1 x i8]* @p_str20, [10 x i8]* @p_str35, [1 x i8]* @p_str20, [1 x i8]* @p_str20, [1 x i8]* @p_str20, [24 x i8]* @p_str36)
  call void @llvm.dbg.value(metadata !{i32 %p_rows}, i64 0, metadata !1929)
  call void @llvm.dbg.value(metadata !{i32 %p_cols}, i64 0, metadata !1930)
  ret void
}
...
entry:
  ...
  call void @llvm.dbg.value(metadata !{i32 %p_cols_read}, i64 0, metadata !1930)
  call void @llvm.dbg.value(metadata !{i32 %p_cols_read}, i64 0, metadata !1931)
  %p_rows_read = call i32 @_ssdm_op_WireRead.i32(i32 %p_rows) ; <i32> [#uses=1]
  call void @llvm.dbg.value(metadata !{i32 %p_rows_read}, i64 0, metadata !1929)
  call void @llvm.dbg.value(metadata !{i32 %p_rows_read}, i64 0, metadata !1931)
  call void @llvm.dbg.value(metadata !{i32 %p_rows}, i64 0, metadata !1929)
  call void @llvm.dbg.value(metadata !{i32 %p_cols}, i64 0, metadata !1930)
  call void @llvm.dbg.value(metadata !{i32 %p_rows}, i64 0, metadata !1931)
  %tmp = trunc i32 %p_rows_read to i12, !dbg !1933 ; <i12> [#uses=2]
  call void @llvm.dbg.value(metadata !{i32 %p_cols}, i64 0, metadata !1931)
  %tmp_12 = trunc i32 %p_cols_read to i12, !dbg !1937 ; <i12> [#uses=2]
  call void @llvm.dbg.value(metadata !{i12 %tmp}, i64 0, metadata !1939)
  call void @llvm.dbg.value(metadata !{i12 %tmp_12}, i64 0, metadata !1941)
  %mrv = insertvalue %"hls::Mat<1080, 1920, 16>::init_ret" undef, i12 %tmp, 0, !dbg !1938 ; <%"hls::Mat<1080, 1920, 16>::init_ret"> [#uses=1]
  %mrv_1 = insertvalue %"hls::Mat<1080, 1920, 16>::init_ret" %mrv, i12 %tmp, 1, !dbg !1938 ; <%"hls::Mat<1080, 1920, 16>::init_ret"> [#uses=1]
  %mrv_2 = insertvalue %"hls::Mat<1080, 1920, 16>::init_ret" %mrv_1, i12 %tmp_12, 2, !dbg !1938 ; <%"hls::Mat<1080, 1920, 16>::init_ret"> [#uses=1]
  %mrv_3 = insertvalue %"hls::Mat<1080, 1920, 16>::init_ret" %mrv_2, i12 %tmp_12, 3, !dbg !1938 ; <%"hls::Mat<1080, 1920, 16>::init_ret"> [#uses=1]
  ret %"hls::Mat<1080, 1920, 16>::init_ret" %mrv_3, !dbg !1938
}
...
define weak void @_ssdm_op_FifoWrite.volatile.i64P.i8P.i8P.i1P.i1P.i1P.i1P(i64*, i8*, i8*, i1*, i1*, i1*, i1*, i64, i8, i8, i1, i1, i1, i1) {
entry:
  %empty = call i64 @_autotb_FifoWrite_i64(i64* %0, i64 %7) ; <i64> [#uses=0]
  %empty_85 = call i8 @_autotb_FifoWrite_i8(i8* %1, i8 %8) ; <i8> [#uses=0]
  %empty_86 = call i8 @_autotb_FifoWrite_i8(i8* %2, i8 %9) ; <i8> [#uses=0]
  %empty_87 = call i1 @_autotb_FifoWrite_i1(i1* %3, i1 %10) ; <i1> [#uses=0]
  %empty_88 = call i1 @_autotb_FifoWrite_i1(i1* %4, i1 %11) ; <i1> [#uses=0]
  %empty_89 = call i1 @_autotb_FifoWrite_i1(i1* %5, i1 %12) ; <i1> [#uses=0]
  %empty_90 = call i1 @_autotb_FifoWrite_i1(i1* %6, i1 %13) ; <i1> [#uses=0]
  ret void
}

define weak %0 @_ssdm_op_FifoRead.volatile.i64P.i8P.i8P.i1P.i1P.i1P.i1P(i64*, i8*, i8*, i1*, i1*, i1*, i1*) {
entry:
  %empty = call i64 @_autotb_FifoRead_i64(i64* %0) ; <i64> [#uses=1]
  %empty_91 = call i8 @_autotb_FifoRead_i8(i8* %1) ; <i8> [#uses=1]
  %empty_92 = call i8 @_autotb_FifoRead_i8(i8* %2) ; <i8> [#uses=1]
  %empty_93 = call i1 @_autotb_FifoRead_i1(i1* %3) ; <i1> [#uses=1]
  %empty_94 = call i1 @_autotb_FifoRead_i1(i1* %4) ; <i1> [#uses=1]
  %empty_95 = call i1 @_autotb_FifoRead_i1(i1* %5) ; <i1> [#uses=1]
  %empty_96 = call i1 @_autotb_FifoRead_i1(i1* %6) ; <i1> [#uses=1]
  %mrv_0 = insertvalue %0 undef, i64 %empty, 0    ; <%0> [#uses=1]
  %mrv1 = insertvalue %0 %mrv_0, i8 %empty_91, 1  ; <%0> [#uses=1]
  %mrv2 = insertvalue %0 %mrv1, i8 %empty_92, 2   ; <%0> [#uses=1]
  %mrv3 = insertvalue %0 %mrv2, i1 %empty_93, 3   ; <%0> [#uses=1]
  %mrv4 = insertvalue %0 %mrv3, i1 %empty_94, 4   ; <%0> [#uses=1]
  %mrv5 = insertvalue %0 %mrv4, i1 %empty_95, 5   ; <%0> [#uses=1]
  %mrv6 = insertvalue %0 %mrv5, i1 %empty_96, 6   ; <%0> [#uses=1]
  ret %0 %mrv6
}
...
entry:
  ...
  %empty_97 = trunc i16 %empty to i8              ; <i8> [#uses=1]
  ret i8 %empty_97
}
...
entry:
  ...
  %empty_98 = trunc i24 %empty to i8              ; <i8> [#uses=1]
  ret i8 %empty_98
}
...
define weak i40 @_ssdm_op_PartSelect.i40.i64.i32.i32(i64, i32, i32) nounwind readnone {
entry:
  %empty = call i64 @llvm.part.select.i64(i64 %0, i32 %1, i32 %2) ; <i64> [#uses=1]
  %empty_99 = trunc i64 %empty to i40             ; <i40> [#uses=1]
  ret i40 %empty_99
}

define weak i64 @_ssdm_op_PartSet.i64.i64.i40.i32.i32(i64, i40, i32, i32) nounwind readnone {
entry:
  %empty = call i64 @llvm.part.set.i64.i40(i64 %0, i40 %1, i32 %2, i32 %3) ; <i64> [#uses=1]
  ret i64 %empty
}
...
declare i64 @llvm.part.set.i64.i40(i64, i40, i32, i32) nounwind readnone
...
!1519 = metadata !{i32 459009, metadata !469, metadata !"cols", metadata !3, i32 65, metadata !59} ; [ DW_TAG_arg_variable ]
!1520 = metadata !{i32 459009, metadata !1521, metadata !"_cols", metadata !12, i32 477, metadata !59} ; [ DW_TAG_arg_variable ]
!1521 = metadata !{i32 458798, i32 0, metadata !9, metadata !"Mat", metadata !"Mat", metadata !"_ZN3hls3MatILi1080ELi1920ELi16EEC1Eii", metadata !12, i32 477, metadata !367, i1 false, i1 true, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
!1522 = metadata !{i32 459009, metadata !469, metadata !"rows", metadata !3, i32 65, metadata !59} ; [ DW_TAG_arg_variable ]
!1523 = metadata !{i32 459009, metadata !1521, metadata !"_rows", metadata !12, i32 477, metadata !59} ; [ DW_TAG_arg_variable ]
!1524 = metadata !{i32 462851, metadata !1525, metadata !"input.V.data.V", metadata !3, i32 65, metadata !1526} ; [ DW_TAG_arg_variable_field ]
!1525 = metadata !{i32 459009, metadata !469, metadata !"input", metadata !3, i32 65, metadata !472} ; [ DW_TAG_arg_variable ]
!1526 = metadata !{i32 458767, metadata !2, metadata !"", metadata !2, i32 0, i64 64, i64 64, i64 0, i32 0, metadata !1527} ; [ DW_TAG_pointer_type ]
!1527 = metadata !{i32 458772, metadata !10, metadata !"stream<ap_axiu<64, 1, 1, 1> >", metadata !11, i32 34, i64 64, i64 64, i64 0, i32 0, null, metadata !1528, i32 0, null} ; [ DW_TAG_structure_field_type ]
!1528 = metadata !{metadata !1529}
!1529 = metadata !{i32 458772, metadata !2, metadata !"ap_axiu<64,1,1,1>", metadata !479, i32 55, i64 64, i64 64, i64 0, i32 0, null, metadata !1530, i32 0, null} ; [ DW_TAG_structure_field_type ]
!1530 = metadata !{metadata !1531}
!1531 = metadata !{i32 458772, metadata !2, metadata !"ap_uint<64>", metadata !16, i32 134, i64 64, i64 64, i64 0, i32 0, null, metadata !1532, i32 0, null} ; [ DW_TAG_structure_field_type ]
!1532 = metadata !{metadata !1533}
!1533 = metadata !{i32 458772, metadata !2, metadata !"ap_int_base<64,false,true>", metadata !20, i32 599, i64 64, i64 64, i64 0, i32 0, null, metadata !1534, i32 0, null} ; [ DW_TAG_structure_field_type ]
!1534 = metadata !{metadata !1535}
!1535 = metadata !{i32 458772, metadata !2, metadata !"ssdm_int<64,false>", metadata !24, i32 68, i64 64, i64 64, i64 0, i32 0, null, metadata !1536, i32 0, null} ; [ DW_TAG_structure_field_type ]
!1536 = metadata !{metadata !490}
!1537 = metadata !{i32 462851, metadata !1525, metadata !"input.V.keep.V", metadata !3, i32 65, metadata !1538} ; [ DW_TAG_arg_variable_field ]
!1538 = metadata !{i32 458767, metadata !2, metadata !"", metadata !2, i32 0, i64 64, i64 64, i64 0, i32 0, metadata !1539} ; [ DW_TAG_pointer_type ]
!1539 = metadata !{i32 458772, metadata !10, metadata !"stream<ap_axiu<64, 1, 1, 1> >", metadata !11, i32 34, i64 8, i64 64, i64 0, i32 0, null, metadata !1540, i32 0, null} ; [ DW_TAG_structure_field_type ]
!1540 = metadata !{metadata !1541}
!1541 = metadata !{i32 458772, metadata !2, metadata !"ap_axiu<64,1,1,1>", metadata !479, i32 55, i64 8, i64 64, i64 0, i32 0, null, metadata !1542, i32 0, null} ; [ DW_TAG_structure_field_type ]
!1542 = metadata !{metadata !1543}
!1543 = metadata !{i32 458772, metadata !2, metadata !"ap_uint<8>", metadata !16, i32 134, i64 8, i64 8, i64 0, i32 0, null, metadata !1544, i32 0, null} ; [ DW_TAG_structure_field_type ]
!1544 = metadata !{metadata !1545}
!1545 = metadata !{i32 458772, metadata !2, metadata !"ap_int_base<8,false,true>", metadata !20, i32 599, i64 8, i64 8, i64 0, i32 0, null, metadata !1546, i32 0, null} ; [ DW_TAG_structure_field_type ]
!1546 = metadata !{metadata !1547}
!1547 = metadata !{i32 458772, metadata !2, metadata !"ssdm_int<8,false>", metadata !24, i32 10, i64 8, i64 8, i64 0, i32 0, null, metadata !1548, i32 0, null} ; [ DW_TAG_structure_field_type ]
!1548 = metadata !{metadata !848}
!1549 = metadata !{i32 462851, metadata !1525, metadata !"input.V.strb.V", metadata !3, i32 65, metadata !1538} ; [ DW_TAG_arg_variable_field ]
!1550 = metadata !{i32 462851, metadata !1525, metadata !"input.V.user.V", metadata !3, i32 65, metadata !1551} ; [ DW_TAG_arg_variable_field ]
!1551 = metadata !{i32 458767, metadata !2, metadata !"", metadata !2, i32 0, i64 64, i64 64, i64 0, i32 0, metadata !1552} ; [ DW_TAG_pointer_type ]
!1552 = metadata !{i32 458772, metadata !10, metadata !"stream<ap_axiu<64, 1, 1, 1> >", metadata !11, i32 34, i64 8, i64 64, i64 0, i32 0, null, metadata !1553, i32 0, null} ; [ DW_TAG_structure_field_type ]
!1553 = metadata !{metadata !1554}
!1554 = metadata !{i32 458772, metadata !2, metadata !"ap_axiu<64,1,1,1>", metadata !479, i32 55, i64 8, i64 64, i64 0, i32 0, null, metadata !1555, i32 0, null} ; [ DW_TAG_structure_field_type ]
!1555 = metadata !{metadata !1556}
!1556 = metadata !{i32 458772, metadata !2, metadata !"ap_uint<1>", metadata !16, i32 134, i64 8, i64 8, i64 0, i32 0, null, metadata !1557, i32 0, null} ; [ DW_TAG_structure_field_type ]
!1557 = metadata !{metadata !1558}
!1558 = metadata !{i32 458772, metadata !2, metadata !"ap_int_base<1,false,true>", metadata !20, i32 599, i64 8, i64 8, i64 0, i32 0, null, metadata !1559, i32 0, null} ; [ DW_TAG_structure_field_type ]
!1559 = metadata !{metadata !1560}
!1560 = metadata !{i32 458772, metadata !2, metadata !"ssdm_int<1,false>", metadata !24, i32 3, i64 8, i64 8, i64 0, i32 0, null, metadata !1561, i32 0, null} ; [ DW_TAG_structure_field_type ]
!1561 = metadata !{metadata !1175}
!1562 = metadata !{i32 462851, metadata !1525, metadata !"input.V.last.V", metadata !3, i32 65, metadata !1551} ; [ DW_TAG_arg_variable_field ]
!1563 = metadata !{i32 462851, metadata !1525, metadata !"input.V.id.V", metadata !3, i32 65, metadata !1551} ; [ DW_TAG_arg_variable_field ]
!1564 = metadata !{i32 462851, metadata !1525, metadata !"input.V.dest.V", metadata !3, i32 65, metadata !1551} ; [ DW_TAG_arg_variable_field ]
!1565 = metadata !{i32 462851, metadata !1566, metadata !"output.V.data.V", metadata !3, i32 65, metadata !1526} ; [ DW_TAG_arg_variable_field ]
!1566 = metadata !{i32 459009, metadata !469, metadata !"output", metadata !3, i32 65, metadata !472} ; [ DW_TAG_arg_variable ]
!1567 = metadata !{i32 462851, metadata !1566, metadata !"output.V.keep.V", metadata !3, i32 65, metadata !1538} ; [ DW_TAG_arg_variable_field ]
!1568 = metadata !{i32 462851, metadata !1566, metadata !"output.V.strb.V", metadata !3, i32 65, metadata !1538} ; [ DW_TAG_arg_variable_field ]
!1569 = metadata !{i32 462851, metadata !1566, metadata !"output.V.user.V", metadata !3, i32 65, metadata !1551} ; [ DW_TAG_arg_variable_field ]
!1570 = metadata !{i32 462851, metadata !1566, metadata !"output.V.last.V", metadata !3, i32 65, metadata !1551} ; [ DW_TAG_arg_variable_field ]
!1571 = metadata !{i32 462851, metadata !1566, metadata !"output.V.id.V", metadata !3, i32 65, metadata !1551} ; [ DW_TAG_arg_variable_field ]
!1572 = metadata !{i32 462851, metadata !1566, metadata !"output.V.dest.V", metadata !3, i32 65, metadata !1551} ; [ DW_TAG_arg_variable_field ]
!1573 = metadata !{i32 462849, metadata !1574, metadata !"img_0.data_stream[0].V", metadata !3, i32 77, metadata !1575} ; [ DW_TAG_auto_variable_field ]
!1574 = metadata !{i32 459008, metadata !467, metadata !"img_0", metadata !3, i32 77, metadata !7} ; [ DW_TAG_auto_variable ]
!1575 = metadata !{i32 458772, metadata !10, metadata !"Mat<1080,1920,16>", metadata !12, i32 445, i64 8, i64 16, i64 0, i32 0, null, metadata !1576, i32 0, null} ; [ DW_TAG_structure_field_type ]
!1576 = metadata !{metadata !1577}
!1577 = metadata !{i32 458772, metadata !10, metadata !"stream<unsigned char>", metadata !11, i32 34, i64 8, i64 8, i64 0, i32 0, null, metadata !1578, i32 0, null} ; [ DW_TAG_structure_field_type ]
!1578 = metadata !{metadata !318}
!1579 = metadata !{i32 65, i32 0, metadata !467, null}
!1580 = metadata !{i32 462849, metadata !1574, metadata !"img_0.data_stream[1].V", metadata !3, i32 77, metadata !1575} ; [ DW_TAG_auto_variable_field ]
!1581 = metadata !{i32 462849, metadata !1574, metadata !"img_0.data_stream[2].V", metadata !3, i32 77, metadata !1575} ; [ DW_TAG_auto_variable_field ]
!1582 = metadata !{i32 67, i32 0, metadata !467, null}
!1583 = metadata !{i32 68, i32 0, metadata !467, null}
!1584 = metadata !{i32 70, i32 0, metadata !467, null}
!1585 = metadata !{i32 71, i32 0, metadata !467, null}
!1586 = metadata !{i32 72, i32 0, metadata !467, null}
!1587 = metadata !{i32 74, i32 0, metadata !467, null}
!1588 = metadata !{i32 75, i32 0, metadata !467, null}
...
!1591 = metadata !{i32 458763, metadata !1521, i32 477, i32 0} ; [ DW_TAG_lexical_block ]
!1592 = metadata !{i32 77, i32 0, metadata !467, null}
!1593 = metadata !{i32 462849, metadata !1574, metadata !"img_0.rows.V", metadata !3, i32 77, metadata !1594} ; [ DW_TAG_auto_variable_field ]
...
!1602 = metadata !{i32 462849, metadata !1574, metadata !"img_0.cols.V", metadata !3, i32 77, metadata !1594} ; [ DW_TAG_auto_variable_field ]
...
!1608 = metadata !{i32 462853, metadata !1609, metadata !"img.cols.V", metadata !1611, i32 98, metadata !1594} ; [ DW_TAG_arg_variable_field_ro ]
!1609 = metadata !{i32 459009, metadata !1610, metadata !"img", metadata !1611, i32 98, metadata !1615} ; [ DW_TAG_arg_variable ]
...
!1616 = metadata !{i32 462853, metadata !1617, metadata !"Mat<1080,1920,16>.cols.V", metadata !12, i32 535, metadata !1594} ; [ DW_TAG_arg_variable_field_ro ]
!1617 = metadata !{i32 459009, metadata !452, metadata !"this", metadata !12, i32 535, metadata !1618} ; [ DW_TAG_arg_variable ]
!1618 = metadata !{i32 458790, metadata !2, metadata !"", metadata !2, i32 0, i64 64, i64 64, i64 0, i32 64, metadata !1619} ; [ DW_TAG_const_type ]
!1619 = metadata !{i32 458767, metadata !2, metadata !"", metadata !2, i32 0, i64 64, i64 64, i64 0, i32 0, metadata !9} ; [ DW_TAG_pointer_type ]
!1620 = metadata !{i32 462853, metadata !1621, metadata !"Mat<1080,1920,16>.cols.V", metadata !12, i32 519, metadata !1594} ; [ DW_TAG_arg_variable_field_ro ]
!1621 = metadata !{i32 459009, metadata !448, metadata !"this", metadata !12, i32 519, metadata !1618} ; [ DW_TAG_arg_variable ]
!1622 = metadata !{i32 462853, metadata !1609, metadata !"img.rows.V", metadata !1611, i32 98, metadata !1594} ; [ DW_TAG_arg_variable_field_ro ]
!1623 = metadata !{i32 462853, metadata !1617, metadata !"Mat<1080,1920,16>.rows.V", metadata !12, i32 535, metadata !1594} ; [ DW_TAG_arg_variable_field_ro ]
!1624 = metadata !{i32 462853, metadata !1621, metadata !"Mat<1080,1920,16>.rows.V", metadata !12, i32 519, metadata !1594} ; [ DW_TAG_arg_variable_field_ro ]
!1625 = metadata !{i32 462851, metadata !1626, metadata !"AXI_video_strm.V.data.V", metadata !1611, i32 98, metadata !1526} ; [ DW_TAG_arg_variable_field ]
!1626 = metadata !{i32 459009, metadata !1610, metadata !"AXI_video_strm", metadata !1611, i32 98, metadata !1614} ; [ DW_TAG_arg_variable ]
!1627 = metadata !{i32 462851, metadata !1626, metadata !"AXI_video_strm.V.keep.V", metadata !1611, i32 98, metadata !1538} ; [ DW_TAG_arg_variable_field ]
!1628 = metadata !{i32 462851, metadata !1626, metadata !"AXI_video_strm.V.strb.V", metadata !1611, i32 98, metadata !1538} ; [ DW_TAG_arg_variable_field ]
!1629 = metadata !{i32 462851, metadata !1626, metadata !"AXI_video_strm.V.user.V", metadata !1611, i32 98, metadata !1551} ; [ DW_TAG_arg_variable_field ]
!1630 = metadata !{i32 462851, metadata !1626, metadata !"AXI_video_strm.V.last.V", metadata !1611, i32 98, metadata !1551} ; [ DW_TAG_arg_variable_field ]
!1631 = metadata !{i32 462851, metadata !1626, metadata !"AXI_video_strm.V.id.V", metadata !1611, i32 98, metadata !1551} ; [ DW_TAG_arg_variable_field ]
!1632 = metadata !{i32 462851, metadata !1626, metadata !"AXI_video_strm.V.dest.V", metadata !1611, i32 98, metadata !1551} ; [ DW_TAG_arg_variable_field ]
!1633 = metadata !{i32 462851, metadata !1609, metadata !"img.data_stream[0].V", metadata !1611, i32 98, metadata !1634} ; [ DW_TAG_arg_variable_field ]
!1634 = metadata !{i32 458767, metadata !10, metadata !"", metadata !12, i32 445, i64 64, i64 64, i64 0, i32 0, metadata !1575} ; [ DW_TAG_pointer_type ]
!1635 = metadata !{i32 462851, metadata !1609, metadata !"img.data_stream[1].V", metadata !1611, i32 98, metadata !1634} ; [ DW_TAG_arg_variable_field ]
!1636 = metadata !{i32 462851, metadata !1609, metadata !"img.data_stream[2].V", metadata !1611, i32 98, metadata !1634} ; [ DW_TAG_arg_variable_field ]
!1637 = metadata !{i32 462849, metadata !1638, metadata !"rows.V", metadata !1611, i32 105, metadata !1596} ; [ DW_TAG_auto_variable_field ]
!1638 = metadata !{i32 459008, metadata !1639, metadata !"rows", metadata !1611, i32 105, metadata !15} ; [ DW_TAG_auto_variable ]
!1639 = metadata !{i32 458763, metadata !1640, i32 98, i32 0} ; [ DW_TAG_lexical_block ]
!1640 = metadata !{i32 458763, metadata !1610, i32 98, i32 0} ; [ DW_TAG_lexical_block ]
!1641 = metadata !{i32 105, i32 0, metadata !1639, null}
!1642 = metadata !{i32 462849, metadata !1643, metadata !"cols.V", metadata !1611, i32 106, metadata !1596} ; [ DW_TAG_auto_variable_field ]
!1643 = metadata !{i32 459008, metadata !1639, metadata !"cols", metadata !1611, i32 106, metadata !15} ; [ DW_TAG_auto_variable ]
!1644 = metadata !{i32 106, i32 0, metadata !1639, null}
!1645 = metadata !{i32 107, i32 0, metadata !1639, null}
!1646 = metadata !{i32 462849, metadata !1647, metadata !"axi.data.V", metadata !1611, i32 101, metadata !1529} ; [ DW_TAG_auto_variable_field ]
!1647 = metadata !{i32 459008, metadata !1639, metadata !"axi", metadata !1611, i32 101, metadata !478} ; [ DW_TAG_auto_variable ]
!1648 = metadata !{i32 462849, metadata !1647, metadata !"axi.user.V", metadata !1611, i32 101, metadata !1554} ; [ DW_TAG_auto_variable_field ]
!1649 = metadata !{i32 462849, metadata !1647, metadata !"axi.last.V", metadata !1611, i32 101, metadata !1554} ; [ DW_TAG_auto_variable_field ]
!1650 = metadata !{i32 459008, metadata !1639, metadata !"sof", metadata !1611, i32 107, metadata !39} ; [ DW_TAG_auto_variable ]
!1651 = metadata !{i32 108, i32 0, metadata !1639, null}
!1652 = metadata !{i32 109, i32 0, metadata !1639, null}
!1653 = metadata !{i32 462851, metadata !1654, metadata !"stream<ap_axiu<64, 1, 1, 1> >.V.data.V", metadata !11, i32 55, metadata !1526} ; [ DW_TAG_arg_variable_field ]
!1654 = metadata !{i32 459009, metadata !1497, metadata !"this", metadata !11, i32 55, metadata !1655} ; [ DW_TAG_arg_variable ]
!1655 = metadata !{i32 458790, metadata !2, metadata !"", metadata !2, i32 0, i64 64, i64 64, i64 0, i32 64, metadata !1656} ; [ DW_TAG_const_type ]
!1656 = metadata !{i32 458767, metadata !2, metadata !"", metadata !2, i32 0, i64 64, i64 64, i64 0, i32 0, metadata !475} ; [ DW_TAG_pointer_type ]
!1657 = metadata !{i32 462851, metadata !1654, metadata !"stream<ap_axiu<64, 1, 1, 1> >.V.keep.V", metadata !11, i32 55, metadata !1538} ; [ DW_TAG_arg_variable_field ]
!1658 = metadata !{i32 462851, metadata !1654, metadata !"stream<ap_axiu<64, 1, 1, 1> >.V.strb.V", metadata !11, i32 55, metadata !1538} ; [ DW_TAG_arg_variable_field ]
!1659 = metadata !{i32 462851, metadata !1654, metadata !"stream<ap_axiu<64, 1, 1, 1> >.V.user.V", metadata !11, i32 55, metadata !1551} ; [ DW_TAG_arg_variable_field ]
!1660 = metadata !{i32 462851, metadata !1654, metadata !"stream<ap_axiu<64, 1, 1, 1> >.V.last.V", metadata !11, i32 55, metadata !1551} ; [ DW_TAG_arg_variable_field ]
!1661 = metadata !{i32 462851, metadata !1654, metadata !"stream<ap_axiu<64, 1, 1, 1> >.V.id.V", metadata !11, i32 55, metadata !1551} ; [ DW_TAG_arg_variable_field ]
!1662 = metadata !{i32 462851, metadata !1654, metadata !"stream<ap_axiu<64, 1, 1, 1> >.V.dest.V", metadata !11, i32 55, metadata !1551} ; [ DW_TAG_arg_variable_field ]
!1663 = metadata !{i32 462851, metadata !1664, metadata !"stream<ap_axiu<64, 1, 1, 1> >.V.data.V", metadata !11, i32 77, metadata !1526} ; [ DW_TAG_arg_variable_field ]
!1664 = metadata !{i32 459009, metadata !1508, metadata !"this", metadata !11, i32 77, metadata !1655} ; [ DW_TAG_arg_variable ]
!1665 = metadata !{i32 462851, metadata !1664, metadata !"stream<ap_axiu<64, 1, 1, 1> >.V.keep.V", metadata !11, i32 77, metadata !1538} ; [ DW_TAG_arg_variable_field ]
!1666 = metadata !{i32 462851, metadata !1664, metadata !"stream<ap_axiu<64, 1, 1, 1> >.V.strb.V", metadata !11, i32 77, metadata !1538} ; [ DW_TAG_arg_variable_field ]
!1667 = metadata !{i32 462851, metadata !1664, metadata !"stream<ap_axiu<64, 1, 1, 1> >.V.user.V", metadata !11, i32 77, metadata !1551} ; [ DW_TAG_arg_variable_field ]
!1668 = metadata !{i32 462851, metadata !1664, metadata !"stream<ap_axiu<64, 1, 1, 1> >.V.last.V", metadata !11, i32 77, metadata !1551} ; [ DW_TAG_arg_variable_field ]
!1669 = metadata !{i32 462851, metadata !1664, metadata !"stream<ap_axiu<64, 1, 1, 1> >.V.id.V", metadata !11, i32 77, metadata !1551} ; [ DW_TAG_arg_variable_field ]
!1670 = metadata !{i32 462851, metadata !1664, metadata !"stream<ap_axiu<64, 1, 1, 1> >.V.dest.V", metadata !11, i32 77, metadata !1551} ; [ DW_TAG_arg_variable_field ]
!1671 = metadata !{i32 79, i32 0, metadata !1672, metadata !1674}
!1672 = metadata !{i32 458763, metadata !1673, i32 77, i32 0} ; [ DW_TAG_lexical_block ]
!1673 = metadata !{i32 458763, metadata !1508, i32 77, i32 0} ; [ DW_TAG_lexical_block ]
!1674 = metadata !{i32 56, i32 0, metadata !1675, metadata !1676}
!1675 = metadata !{i32 458763, metadata !1497, i32 55, i32 0} ; [ DW_TAG_lexical_block ]
!1676 = metadata !{i32 110, i32 0, metadata !1639, null}
!1677 = metadata !{i32 462849, metadata !1678, metadata !"tmp.data.V", metadata !11, i32 78, metadata !1529} ; [ DW_TAG_auto_variable_field ]
!1678 = metadata !{i32 459008, metadata !1672, metadata !"tmp", metadata !11, i32 78, metadata !478} ; [ DW_TAG_auto_variable ]
!1679 = metadata !{i32 462849, metadata !1678, metadata !"tmp.user.V", metadata !11, i32 78, metadata !1554} ; [ DW_TAG_auto_variable_field ]
!1680 = metadata !{i32 462849, metadata !1678, metadata !"tmp.last.V", metadata !11, i32 78, metadata !1554} ; [ DW_TAG_auto_variable_field ]
!1681 = metadata !{i32 231, i32 0, metadata !1682, metadata !1683}
!1682 = metadata !{i32 458763, metadata !836, i32 230, i32 0} ; [ DW_TAG_lexical_block ]
!1683 = metadata !{i32 55, i32 0, metadata !1471, metadata !1684}
!1684 = metadata !{i32 80, i32 0, metadata !1672, metadata !1674}
!1685 = metadata !{i32 231, i32 0, metadata !1686, metadata !1683}
!1686 = metadata !{i32 458763, metadata !1465, i32 230, i32 0} ; [ DW_TAG_lexical_block ]
!1687 = metadata !{i32 111, i32 0, metadata !1639, null}
!1688 = metadata !{i32 112, i32 0, metadata !1639, null}
!1689 = metadata !{i32 113, i32 0, metadata !1690, null}
!1690 = metadata !{i32 458763, metadata !1691, i32 113, i32 0} ; [ DW_TAG_lexical_block ]
!1691 = metadata !{i32 458763, metadata !1639, i32 108, i32 0} ; [ DW_TAG_lexical_block ]
!1692 = metadata !{i32 114, i32 0, metadata !1690, null}
!1693 = metadata !{i32 116, i32 0, metadata !1694, null}
!1694 = metadata !{i32 458763, metadata !1690, i32 115, i32 0} ; [ DW_TAG_lexical_block ]
!1695 = metadata !{i32 120, i32 0, metadata !1694, null}
!1696 = metadata !{i32 117, i32 0, metadata !1694, null}
!1697 = metadata !{i32 119, i32 0, metadata !1694, null}
!1698 = metadata !{i32 124, i32 0, metadata !1694, null}
!1699 = metadata !{i32 79, i32 0, metadata !1672, metadata !1700}
!1700 = metadata !{i32 56, i32 0, metadata !1675, metadata !1701}
!1701 = metadata !{i32 126, i32 0, metadata !1694, null}
!1702 = metadata !{i32 231, i32 0, metadata !1682, metadata !1703}
!1703 = metadata !{i32 55, i32 0, metadata !1471, metadata !1704}
!1704 = metadata !{i32 80, i32 0, metadata !1672, metadata !1700}
!1705 = metadata !{i32 231, i32 0, metadata !1686, metadata !1703}
!1706 = metadata !{i32 459008, metadata !1690, metadata !"eol", metadata !1611, i32 115, metadata !39} ; [ DW_TAG_auto_variable ]
!1707 = metadata !{i32 127, i32 0, metadata !1694, null}
!1708 = metadata !{i32 462851, metadata !1709, metadata !"axi.data.V", metadata !1611, i32 49, metadata !1529} ; [ DW_TAG_arg_variable_field ]
!1709 = metadata !{i32 459009, metadata !1710, metadata !"axi", metadata !1611, i32 49, metadata !478} ; [ DW_TAG_arg_variable ]
!1710 = metadata !{i32 458798, i32 0, metadata !10, metadata !"AXIGetBitFields<64, unsigned char>", metadata !"AXIGetBitFields<64, unsigned char>", metadata !"_ZN3hls15AXIGetBitFieldsILi64EhEEv7ap_axiuIXT_ELi1ELi1ELi1EEiiRT0_", metadata !1611, i32 49, metadata !1711, i1 false, i1 true, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
...
!1712 = metadata !{null, metadata !478, metadata !59, metadata !59, metadata !338}
!1713 = metadata !{i32 462851, metadata !1709, metadata !"axi.last.V", metadata !1611, i32 49, metadata !1554} ; [ DW_TAG_arg_variable_field ]
!1714 = metadata !{i32 459008, metadata !1715, metadata !"__Val2__", metadata !20, i32 1098, metadata !491} ; [ DW_TAG_auto_variable ]
!1715 = metadata !{i32 458763, metadata !1716, i32 1097, i32 0} ; [ DW_TAG_lexical_block ]
!1716 = metadata !{i32 458763, metadata !1717, i32 1097, i32 0} ; [ DW_TAG_lexical_block ]
!1717 = metadata !{i32 458763, metadata !696, i32 1097, i32 0} ; [ DW_TAG_lexical_block ]
!1718 = metadata !{i32 1098, i32 0, metadata !1715, metadata !1719}
!1719 = metadata !{i32 893, i32 0, metadata !1720, metadata !1721}
!1720 = metadata !{i32 458763, metadata !666, i32 892, i32 0} ; [ DW_TAG_lexical_block ]
!1721 = metadata !{i32 52, i32 0, metadata !1722, metadata !1724}
!1722 = metadata !{i32 458763, metadata !1723, i32 49, i32 0} ; [ DW_TAG_lexical_block ]
!1723 = metadata !{i32 458763, metadata !1710, i32 49, i32 0} ; [ DW_TAG_lexical_block ]
!1724 = metadata !{i32 138, i32 0, metadata !1725, null}
!1725 = metadata !{i32 458763, metadata !1694, i32 135, i32 0} ; [ DW_TAG_lexical_block ]
!1726 = metadata !{i32 462849, metadata !1727, metadata !"pix.val[0]", metadata !1611, i32 102, metadata !47} ; [ DW_TAG_auto_variable_field ]
!1727 = metadata !{i32 459008, metadata !1639, metadata !"pix", metadata !1611, i32 102, metadata !424} ; [ DW_TAG_auto_variable ]
!1728 = metadata !{i32 462849, metadata !1727, metadata !"pix.val[1]", metadata !1611, i32 102, metadata !47} ; [ DW_TAG_auto_variable_field ]
!1729 = metadata !{i32 462849, metadata !1727, metadata !"pix.val[2]", metadata !1611, i32 102, metadata !47} ; [ DW_TAG_auto_variable_field ]
!1730 = metadata !{i32 462851, metadata !1731, metadata !"s.val[0]", metadata !12, i32 535, metadata !47} ; [ DW_TAG_arg_variable_field ]
!1731 = metadata !{i32 459009, metadata !452, metadata !"s", metadata !12, i32 535, metadata !424} ; [ DW_TAG_arg_variable ]
!1732 = metadata !{i32 462851, metadata !1731, metadata !"s.val[1]", metadata !12, i32 535, metadata !47} ; [ DW_TAG_arg_variable_field ]
!1733 = metadata !{i32 462851, metadata !1731, metadata !"s.val[2]", metadata !12, i32 535, metadata !47} ; [ DW_TAG_arg_variable_field ]
!1734 = metadata !{i32 462851, metadata !1617, metadata !"Mat<1080,1920,16>.data_stream[0].V", metadata !12, i32 535, metadata !1634} ; [ DW_TAG_arg_variable_field ]
!1735 = metadata !{i32 462851, metadata !1617, metadata !"Mat<1080,1920,16>.data_stream[1].V", metadata !12, i32 535, metadata !1634} ; [ DW_TAG_arg_variable_field ]
!1736 = metadata !{i32 462851, metadata !1617, metadata !"Mat<1080,1920,16>.data_stream[2].V", metadata !12, i32 535, metadata !1634} ; [ DW_TAG_arg_variable_field ]
!1737 = metadata !{i32 462851, metadata !1738, metadata !"s.val[0]", metadata !12, i32 519, metadata !47} ; [ DW_TAG_arg_variable_field ]
!1738 = metadata !{i32 459009, metadata !448, metadata !"s", metadata !12, i32 519, metadata !424} ; [ DW_TAG_arg_variable ]
!1739 = metadata !{i32 462851, metadata !1738, metadata !"s.val[1]", metadata !12, i32 519, metadata !47} ; [ DW_TAG_arg_variable_field ]
!1740 = metadata !{i32 462851, metadata !1738, metadata !"s.val[2]", metadata !12, i32 519, metadata !47} ; [ DW_TAG_arg_variable_field ]
!1741 = metadata !{i32 462851, metadata !1621, metadata !"Mat<1080,1920,16>.data_stream[0].V", metadata !12, i32 519, metadata !1634} ; [ DW_TAG_arg_variable_field ]
!1742 = metadata !{i32 462851, metadata !1621, metadata !"Mat<1080,1920,16>.data_stream[1].V", metadata !12, i32 519, metadata !1634} ; [ DW_TAG_arg_variable_field ]
!1743 = metadata !{i32 462851, metadata !1621, metadata !"Mat<1080,1920,16>.data_stream[2].V", metadata !12, i32 519, metadata !1634} ; [ DW_TAG_arg_variable_field ]
!1744 = metadata !{i32 100, i32 0, metadata !1745, metadata !1747}
!1745 = metadata !{i32 458763, metadata !1746, i32 98, i32 0} ; [ DW_TAG_lexical_block ]
!1746 = metadata !{i32 458763, metadata !356, i32 98, i32 0} ; [ DW_TAG_lexical_block ]
!1747 = metadata !{i32 60, i32 0, metadata !1748, metadata !1749}
!1748 = metadata !{i32 458763, metadata !339, i32 59, i32 0} ; [ DW_TAG_lexical_block ]
!1749 = metadata !{i32 524, i32 0, metadata !1750, metadata !1752}
!1750 = metadata !{i32 458763, metadata !1751, i32 519, i32 0} ; [ DW_TAG_lexical_block ]
!1751 = metadata !{i32 458763, metadata !448, i32 519, i32 0} ; [ DW_TAG_lexical_block ]
!1752 = metadata !{i32 537, i32 0, metadata !1753, metadata !1754}
!1753 = metadata !{i32 458763, metadata !452, i32 535, i32 0} ; [ DW_TAG_lexical_block ]
!1754 = metadata !{i32 140, i32 0, metadata !1694, null}
!1755 = metadata !{i32 141, i32 0, metadata !1694, null}
!1756 = metadata !{i32 462849, metadata !1757, metadata !"t.V", metadata !20, i32 1731, metadata !1598} ; [ DW_TAG_auto_variable_field ]
!1757 = metadata !{i32 459008, metadata !1758, metadata !"t", metadata !20, i32 1731, metadata !19} ; [ DW_TAG_auto_variable ]
!1758 = metadata !{i32 458763, metadata !1759, i32 1730, i32 0} ; [ DW_TAG_lexical_block ]
!1759 = metadata !{i32 458763, metadata !191, i32 1730, i32 0} ; [ DW_TAG_lexical_block ]
!1760 = metadata !{i32 1731, i32 0, metadata !1758, metadata !1693}
!1761 = metadata !{i32 462849, metadata !1762, metadata !"j.V", metadata !1611, i32 116, metadata !1596} ; [ DW_TAG_auto_variable_field ]
!1762 = metadata !{i32 459008, metadata !1694, metadata !"j", metadata !1611, i32 116, metadata !15} ; [ DW_TAG_auto_variable ]
!1763 = metadata !{i32 1702, i32 0, metadata !1764, metadata !1767}
!1764 = metadata !{i32 458798, i32 0, metadata !19, metadata !"operator+=<1, false>", metadata !"operator+=<1, false>", metadata !"_ZN11ap_int_baseILi12ELb0ELb1EEpLILi1ELb0EEERS0_RKS_IXT_EXT0_EXleT_Li64EEE", metadata !20, i32 1702, metadata !1765, i1 false, i1 true, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
...
!1766 = metadata !{metadata !116, metadata !35, metadata !1237}
!1767 = metadata !{i32 1732, i32 0, metadata !1758, metadata !1693}
!1768 = metadata !{i32 122, i32 0, metadata !1694, null}
!1769 = metadata !{i32 1857, i32 0, metadata !1770, metadata !1693}
!1770 = metadata !{i32 458763, metadata !1771, i32 1856, i32 0} ; [ DW_TAG_lexical_block ]
!1771 = metadata !{i32 458798, i32 0, metadata !19, metadata !"operator< <12, false>", metadata !"operator< <12, false>", metadata !"_ZNK11ap_int_baseILi12ELb0ELb1EEltILi12ELb0EEEbRKS_IXT_EXT0_EXleT_Li64EEE", metadata !20, i32 1856, metadata !1772, i1 false, i1 true, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
...
!1773 = metadata !{metadata !39, metadata !137, metadata !105}
!1774 = metadata !{i32 142, i32 0, metadata !1690, null}
!1775 = metadata !{i32 143, i32 0, metadata !1690, null}
!1776 = metadata !{i32 79, i32 0, metadata !1672, metadata !1777}
!1777 = metadata !{i32 56, i32 0, metadata !1675, metadata !1778}
!1778 = metadata !{i32 145, i32 0, metadata !1690, null}
!1779 = metadata !{i32 231, i32 0, metadata !1682, metadata !1780}
!1780 = metadata !{i32 55, i32 0, metadata !1471, metadata !1781}
!1781 = metadata !{i32 80, i32 0, metadata !1672, metadata !1777}
!1782 = metadata !{i32 231, i32 0, metadata !1686, metadata !1780}
!1783 = metadata !{i32 146, i32 0, metadata !1690, null}
!1784 = metadata !{i32 148, i32 0, metadata !1690, null}
!1785 = metadata !{i32 149, i32 0, metadata !1690, null}
!1786 = metadata !{i32 1731, i32 0, metadata !1758, metadata !1787}
!1787 = metadata !{i32 113, i32 0, metadata !1691, null}
!1788 = metadata !{i32 462849, metadata !1789, metadata !"i.V", metadata !1611, i32 113, metadata !1596} ; [ DW_TAG_auto_variable_field ]
!1789 = metadata !{i32 459008, metadata !1691, metadata !"i", metadata !1611, i32 113, metadata !15} ; [ DW_TAG_auto_variable ]
!1790 = metadata !{i32 1702, i32 0, metadata !1764, metadata !1791}
!1791 = metadata !{i32 1732, i32 0, metadata !1758, metadata !1787}
!1792 = metadata !{i32 1857, i32 0, metadata !1770, metadata !1787}
!1793 = metadata !{i32 459008, metadata !1794, metadata !"sof", metadata !1611, i32 166, metadata !39} ; [ DW_TAG_auto_variable ]
!1794 = metadata !{i32 458763, metadata !1795, i32 157, i32 0} ; [ DW_TAG_lexical_block ]
!1795 = metadata !{i32 458763, metadata !1796, i32 157, i32 0} ; [ DW_TAG_lexical_block ]
!1796 = metadata !{i32 458798, i32 0, metadata !10, metadata !"Mat2AXIvideo<64, 1080, 1920, 16>", metadata !"Mat2AXIvideo<64, 1080, 1920, 16>", metadata !"_ZN3hls12Mat2AXIvideoILi64ELi1080ELi1920ELi16EEEiRNS_3MatIXT0_EXT1_EXT2_EEERNS_6streamI7ap_axiuIXT_ELi1ELi1ELi1EEEE", metadata !1611, i32 157, metadata !1797, i1 false, i1 true, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
...
!1798 = metadata !{metadata !59, metadata !1615, metadata !1614}
!1799 = metadata !{i32 462853, metadata !1800, metadata !"img.cols.V", metadata !1611, i32 157, metadata !1594} ; [ DW_TAG_arg_variable_field_ro ]
!1800 = metadata !{i32 459009, metadata !1796, metadata !"img", metadata !1611, i32 157, metadata !1615} ; [ DW_TAG_arg_variable ]
!1801 = metadata !{i32 462853, metadata !1802, metadata !"Mat<1080,1920,16>.cols.V", metadata !12, i32 529, metadata !1594} ; [ DW_TAG_arg_variable_field_ro ]
!1802 = metadata !{i32 459009, metadata !451, metadata !"this", metadata !12, i32 529, metadata !1618} ; [ DW_TAG_arg_variable ]
!1803 = metadata !{i32 462853, metadata !1804, metadata !"Mat<1080,1920,16>.cols.V", metadata !12, i32 501, metadata !1594} ; [ DW_TAG_arg_variable_field_ro ]
!1804 = metadata !{i32 459009, metadata !421, metadata !"this", metadata !12, i32 501, metadata !1618} ; [ DW_TAG_arg_variable ]
!1805 = metadata !{i32 462853, metadata !1800, metadata !"img.rows.V", metadata !1611, i32 157, metadata !1594} ; [ DW_TAG_arg_variable_field_ro ]
!1806 = metadata !{i32 462853, metadata !1802, metadata !"Mat<1080,1920,16>.rows.V", metadata !12, i32 529, metadata !1594} ; [ DW_TAG_arg_variable_field_ro ]
!1807 = metadata !{i32 462853, metadata !1804, metadata !"Mat<1080,1920,16>.rows.V", metadata !12, i32 501, metadata !1594} ; [ DW_TAG_arg_variable_field_ro ]
!1808 = metadata !{i32 462851, metadata !1800, metadata !"img.data_stream[0].V", metadata !1611, i32 157, metadata !1634} ; [ DW_TAG_arg_variable_field ]
!1809 = metadata !{i32 462851, metadata !1800, metadata !"img.data_stream[1].V", metadata !1611, i32 157, metadata !1634} ; [ DW_TAG_arg_variable_field ]
!1810 = metadata !{i32 462851, metadata !1800, metadata !"img.data_stream[2].V", metadata !1611, i32 157, metadata !1634} ; [ DW_TAG_arg_variable_field ]
!1811 = metadata !{i32 462851, metadata !1812, metadata !"AXI_video_strm.V.data.V", metadata !1611, i32 157, metadata !1526} ; [ DW_TAG_arg_variable_field ]
!1812 = metadata !{i32 459009, metadata !1796, metadata !"AXI_video_strm", metadata !1611, i32 157, metadata !1614} ; [ DW_TAG_arg_variable ]
!1813 = metadata !{i32 462851, metadata !1812, metadata !"AXI_video_strm.V.keep.V", metadata !1611, i32 157, metadata !1538} ; [ DW_TAG_arg_variable_field ]
!1814 = metadata !{i32 462851, metadata !1812, metadata !"AXI_video_strm.V.strb.V", metadata !1611, i32 157, metadata !1538} ; [ DW_TAG_arg_variable_field ]
!1815 = metadata !{i32 462851, metadata !1812, metadata !"AXI_video_strm.V.user.V", metadata !1611, i32 157, metadata !1551} ; [ DW_TAG_arg_variable_field ]
!1816 = metadata !{i32 462851, metadata !1812, metadata !"AXI_video_strm.V.last.V", metadata !1611, i32 157, metadata !1551} ; [ DW_TAG_arg_variable_field ]
!1817 = metadata !{i32 462851, metadata !1812, metadata !"AXI_video_strm.V.id.V", metadata !1611, i32 157, metadata !1551} ; [ DW_TAG_arg_variable_field ]
!1818 = metadata !{i32 462851, metadata !1812, metadata !"AXI_video_strm.V.dest.V", metadata !1611, i32 157, metadata !1551} ; [ DW_TAG_arg_variable_field ]
!1819 = metadata !{i32 462849, metadata !1820, metadata !"rows.V", metadata !1611, i32 164, metadata !1596} ; [ DW_TAG_auto_variable_field ]
!1820 = metadata !{i32 459008, metadata !1794, metadata !"rows", metadata !1611, i32 164, metadata !15} ; [ DW_TAG_auto_variable ]
!1821 = metadata !{i32 164, i32 0, metadata !1794, null}
!1822 = metadata !{i32 462849, metadata !1823, metadata !"cols.V", metadata !1611, i32 165, metadata !1596} ; [ DW_TAG_auto_variable_field ]
!1823 = metadata !{i32 459008, metadata !1794, metadata !"cols", metadata !1611, i32 165, metadata !15} ; [ DW_TAG_auto_variable ]
!1824 = metadata !{i32 165, i32 0, metadata !1794, null}
!1825 = metadata !{i32 179, i32 0, metadata !1826, null}
!1826 = metadata !{i32 458763, metadata !1827, i32 168, i32 0} ; [ DW_TAG_lexical_block ]
!1827 = metadata !{i32 458763, metadata !1794, i32 166, i32 0} ; [ DW_TAG_lexical_block ]
!1828 = metadata !{i32 167, i32 0, metadata !1827, null}
!1829 = metadata !{i32 168, i32 0, metadata !1827, null}
!1830 = metadata !{i32 169, i32 0, metadata !1826, null}
!1831 = metadata !{i32 100, i32 0, metadata !1832, metadata !1834}
!1832 = metadata !{i32 458763, metadata !1833, i32 98, i32 0} ; [ DW_TAG_lexical_block ]
!1833 = metadata !{i32 458763, metadata !1515, i32 98, i32 0} ; [ DW_TAG_lexical_block ]
!1834 = metadata !{i32 60, i32 0, metadata !1835, metadata !1836}
!1835 = metadata !{i32 458763, metadata !1500, i32 59, i32 0} ; [ DW_TAG_lexical_block ]
!1836 = metadata !{i32 190, i32 0, metadata !1826, null}
!1837 = metadata !{i32 170, i32 0, metadata !1826, null}
!1838 = metadata !{i32 172, i32 0, metadata !1826, null}
!1839 = metadata !{i32 459009, metadata !1840, metadata !"op2", metadata !20, i32 3338, metadata !135} ; [ DW_TAG_arg_variable ]
!1840 = metadata !{i32 458798, i32 0, metadata !2, metadata !"operator==<12, false>", metadata !"operator==<12, false>", metadata !"_ZeqILi12ELb0EEbRK11ap_int_baseIXT_EXT0_EXleT_Li64EEEy", metadata !20, i32 3338, metadata !1841, i1 false, i1 true, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
...
!1842 = metadata !{metadata !39, metadata !105, metadata !79}
!1843 = metadata !{i32 459009, metadata !1844, metadata !"op", metadata !20, i32 1363, metadata !135} ; [ DW_TAG_arg_variable ]
!1844 = metadata !{i32 458798, i32 0, metadata !485, metadata !"ap_int_base", metadata !"ap_int_base", metadata !"_ZN11ap_int_baseILi64ELb0ELb1EEC1Ey", metadata !20, i32 1363, metadata !531, i1 false, i1 true, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
!1845 = metadata !{i32 1849, i32 0, metadata !1846, metadata !1850}
!1846 = metadata !{i32 458763, metadata !1847, i32 1848, i32 0} ; [ DW_TAG_lexical_block ]
!1847 = metadata !{i32 458798, i32 0, metadata !19, metadata !"operator==<64, false>", metadata !"operator==<64, false>", metadata !"_ZNK11ap_int_baseILi12ELb0ELb1EEeqILi64ELb0EEEbRKS_IXT_EXT0_EXleT_Li64EEE", metadata !20, i32 1848, metadata !1848, i1 false, i1 true, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
...
!1849 = metadata !{metadata !39, metadata !137, metadata !553}
!1850 = metadata !{i32 3338, i32 0, metadata !1840, metadata !1825}
!1851 = metadata !{i32 462849, metadata !1852, metadata !"axi.last.V", metadata !1611, i32 161, metadata !1554} ; [ DW_TAG_auto_variable_field ]
!1852 = metadata !{i32 459008, metadata !1794, metadata !"axi", metadata !1611, i32 161, metadata !478} ; [ DW_TAG_auto_variable ]
!1853 = metadata !{i32 231, i32 0, metadata !1686, metadata !1854}
!1854 = metadata !{i32 182, i32 0, metadata !1826, null}
!1855 = metadata !{i32 462851, metadata !1802, metadata !"Mat<1080,1920,16>.data_stream[0].V", metadata !12, i32 529, metadata !1634} ; [ DW_TAG_arg_variable_field ]
!1856 = metadata !{i32 462851, metadata !1802, metadata !"Mat<1080,1920,16>.data_stream[1].V", metadata !12, i32 529, metadata !1634} ; [ DW_TAG_arg_variable_field ]
!1857 = metadata !{i32 462851, metadata !1802, metadata !"Mat<1080,1920,16>.data_stream[2].V", metadata !12, i32 529, metadata !1634} ; [ DW_TAG_arg_variable_field ]
!1858 = metadata !{i32 462851, metadata !1804, metadata !"Mat<1080,1920,16>.data_stream[0].V", metadata !12, i32 501, metadata !1634} ; [ DW_TAG_arg_variable_field ]
!1859 = metadata !{i32 462851, metadata !1804, metadata !"Mat<1080,1920,16>.data_stream[1].V", metadata !12, i32 501, metadata !1634} ; [ DW_TAG_arg_variable_field ]
!1860 = metadata !{i32 462851, metadata !1804, metadata !"Mat<1080,1920,16>.data_stream[2].V", metadata !12, i32 501, metadata !1634} ; [ DW_TAG_arg_variable_field ]
!1861 = metadata !{i32 79, i32 0, metadata !1862, metadata !1864}
!1862 = metadata !{i32 458763, metadata !1863, i32 77, i32 0} ; [ DW_TAG_lexical_block ]
!1863 = metadata !{i32 458763, metadata !349, i32 77, i32 0} ; [ DW_TAG_lexical_block ]
!1864 = metadata !{i32 56, i32 0, metadata !1865, metadata !1866}
!1865 = metadata !{i32 458763, metadata !335, i32 55, i32 0} ; [ DW_TAG_lexical_block ]
!1866 = metadata !{i32 507, i32 0, metadata !1867, metadata !1869}
!1867 = metadata !{i32 458763, metadata !1868, i32 501, i32 0} ; [ DW_TAG_lexical_block ]
!1868 = metadata !{i32 458763, metadata !421, i32 501, i32 0} ; [ DW_TAG_lexical_block ]
!1869 = metadata !{i32 531, i32 0, metadata !1870, metadata !1871}
!1870 = metadata !{i32 458763, metadata !451, i32 529, i32 0} ; [ DW_TAG_lexical_block ]
!1871 = metadata !{i32 184, i32 0, metadata !1826, null}
!1872 = metadata !{i32 459008, metadata !1862, metadata !"tmp", metadata !11, i32 78, metadata !47} ; [ DW_TAG_auto_variable ]
!1873 = metadata !{i32 462849, metadata !1874, metadata !"scl.val[0]", metadata !12, i32 503, metadata !1875} ; [ DW_TAG_auto_variable_field ]
!1874 = metadata !{i32 459008, metadata !1867, metadata !"scl", metadata !12, i32 503, metadata !424} ; [ DW_TAG_auto_variable ]
!1875 = metadata !{i32 458772, metadata !10, metadata !"Scalar<3,unsigned char>", metadata !12, i32 175, i64 8, i64 8, i64 0, i32 0, null, metadata !1876, i32 0, null} ; [ DW_TAG_structure_field_type ]
!1876 = metadata !{metadata !47}
!1877 = metadata !{i32 80, i32 0, metadata !1862, metadata !1864}
!1878 = metadata !{i32 462849, metadata !1874, metadata !"scl.val[1]", metadata !12, i32 503, metadata !1875} ; [ DW_TAG_auto_variable_field ]
!1879 = metadata !{i32 462849, metadata !1874, metadata !"scl.val[2]", metadata !12, i32 503, metadata !47} ; [ DW_TAG_auto_variable_field ]
!1880 = metadata !{i32 462849, metadata !1881, metadata !"pix.val[0]", metadata !1611, i32 160, metadata !47} ; [ DW_TAG_auto_variable_field ]
!1881 = metadata !{i32 459008, metadata !1794, metadata !"pix", metadata !1611, i32 160, metadata !424} ; [ DW_TAG_auto_variable ]
!1882 = metadata !{i32 462849, metadata !1881, metadata !"pix.val[1]", metadata !1611, i32 160, metadata !47} ; [ DW_TAG_auto_variable_field ]
!1883 = metadata !{i32 462849, metadata !1881, metadata !"pix.val[2]", metadata !1611, i32 160, metadata !47} ; [ DW_TAG_auto_variable_field ]
!1884 = metadata !{i32 459009, metadata !1885, metadata !"val", metadata !1611, i32 72, metadata !47} ; [ DW_TAG_arg_variable ]
!1885 = metadata !{i32 458798, i32 0, metadata !10, metadata !"AXISetBitFields<64, unsigned char>", metadata !"AXISetBitFields<64, unsigned char>", metadata !"_ZN3hls15AXISetBitFieldsILi64EhEEvR7ap_axiuIXT_ELi1ELi1ELi1EEiiT0_", metadata !1611, i32 72, metadata !1886, i1 false, i1 true, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
...
!1887 = metadata !{null, metadata !1474, metadata !59, metadata !59, metadata !47}
!1888 = metadata !{i32 898, i32 0, metadata !1889, metadata !1891}
!1889 = metadata !{i32 458763, metadata !1890, i32 896, i32 0} ; [ DW_TAG_lexical_block ]
!1890 = metadata !{i32 458763, metadata !669, i32 896, i32 0} ; [ DW_TAG_lexical_block ]
!1891 = metadata !{i32 75, i32 0, metadata !1892, metadata !1894}
!1892 = metadata !{i32 458763, metadata !1893, i32 72, i32 0} ; [ DW_TAG_lexical_block ]
!1893 = metadata !{i32 458763, metadata !1885, i32 72, i32 0} ; [ DW_TAG_lexical_block ]
!1894 = metadata !{i32 187, i32 0, metadata !1895, null}
!1895 = metadata !{i32 458763, metadata !1826, i32 185, i32 0} ; [ DW_TAG_lexical_block ]
!1896 = metadata !{i32 462849, metadata !1852, metadata !"axi.data.V", metadata !1611, i32 161, metadata !1529} ; [ DW_TAG_auto_variable_field ]
!1897 = metadata !{i32 459008, metadata !1898, metadata !"__Result__", metadata !20, i32 898, metadata !491} ; [ DW_TAG_auto_variable ]
!1898 = metadata !{i32 458763, metadata !1889, i32 898, i32 0} ; [ DW_TAG_lexical_block ]
!1899 = metadata !{i32 462851, metadata !1900, metadata !"stream<ap_axiu<64, 1, 1, 1> >.V.data.V", metadata !11, i32 59, metadata !1526} ; [ DW_TAG_arg_variable_field ]
!1900 = metadata !{i32 459009, metadata !1500, metadata !"this", metadata !11, i32 59, metadata !1655} ; [ DW_TAG_arg_variable ]
!1901 = metadata !{i32 462851, metadata !1900, metadata !"stream<ap_axiu<64, 1, 1, 1> >.V.keep.V", metadata !11, i32 59, metadata !1538} ; [ DW_TAG_arg_variable_field ]
!1902 = metadata !{i32 462851, metadata !1900, metadata !"stream<ap_axiu<64, 1, 1, 1> >.V.strb.V", metadata !11, i32 59, metadata !1538} ; [ DW_TAG_arg_variable_field ]
!1903 = metadata !{i32 462851, metadata !1900, metadata !"stream<ap_axiu<64, 1, 1, 1> >.V.user.V", metadata !11, i32 59, metadata !1551} ; [ DW_TAG_arg_variable_field ]
!1904 = metadata !{i32 462851, metadata !1900, metadata !"stream<ap_axiu<64, 1, 1, 1> >.V.last.V", metadata !11, i32 59, metadata !1551} ; [ DW_TAG_arg_variable_field ]
!1905 = metadata !{i32 462851, metadata !1900, metadata !"stream<ap_axiu<64, 1, 1, 1> >.V.id.V", metadata !11, i32 59, metadata !1551} ; [ DW_TAG_arg_variable_field ]
!1906 = metadata !{i32 462851, metadata !1900, metadata !"stream<ap_axiu<64, 1, 1, 1> >.V.dest.V", metadata !11, i32 59, metadata !1551} ; [ DW_TAG_arg_variable_field ]
!1907 = metadata !{i32 462851, metadata !1908, metadata !"stream<ap_axiu<64, 1, 1, 1> >.V.data.V", metadata !11, i32 98, metadata !1526} ; [ DW_TAG_arg_variable_field ]
!1908 = metadata !{i32 459009, metadata !1515, metadata !"this", metadata !11, i32 98, metadata !1655} ; [ DW_TAG_arg_variable ]
!1909 = metadata !{i32 462851, metadata !1908, metadata !"stream<ap_axiu<64, 1, 1, 1> >.V.keep.V", metadata !11, i32 98, metadata !1538} ; [ DW_TAG_arg_variable_field ]
!1910 = metadata !{i32 462851, metadata !1908, metadata !"stream<ap_axiu<64, 1, 1, 1> >.V.strb.V", metadata !11, i32 98, metadata !1538} ; [ DW_TAG_arg_variable_field ]
!1911 = metadata !{i32 462851, metadata !1908, metadata !"stream<ap_axiu<64, 1, 1, 1> >.V.user.V", metadata !11, i32 98, metadata !1551} ; [ DW_TAG_arg_variable_field ]
!1912 = metadata !{i32 462851, metadata !1908, metadata !"stream<ap_axiu<64, 1, 1, 1> >.V.last.V", metadata !11, i32 98, metadata !1551} ; [ DW_TAG_arg_variable_field ]
!1913 = metadata !{i32 462851, metadata !1908, metadata !"stream<ap_axiu<64, 1, 1, 1> >.V.id.V", metadata !11, i32 98, metadata !1551} ; [ DW_TAG_arg_variable_field ]
!1914 = metadata !{i32 462851, metadata !1908, metadata !"stream<ap_axiu<64, 1, 1, 1> >.V.dest.V", metadata !11, i32 98, metadata !1551} ; [ DW_TAG_arg_variable_field ]
!1915 = metadata !{i32 191, i32 0, metadata !1826, null}
!1916 = metadata !{i32 1731, i32 0, metadata !1758, metadata !1830}
!1917 = metadata !{i32 462849, metadata !1918, metadata !"j.V", metadata !1611, i32 169, metadata !1596} ; [ DW_TAG_auto_variable_field ]
!1918 = metadata !{i32 459008, metadata !1826, metadata !"j", metadata !1611, i32 169, metadata !15} ; [ DW_TAG_auto_variable ]
!1919 = metadata !{i32 1702, i32 0, metadata !1764, metadata !1920}
!1920 = metadata !{i32 1732, i32 0, metadata !1758, metadata !1830}
!1921 = metadata !{i32 1857, i32 0, metadata !1770, metadata !1830}
!1922 = metadata !{i32 192, i32 0, metadata !1827, null}
!1923 = metadata !{i32 1731, i32 0, metadata !1758, metadata !1828}
!1924 = metadata !{i32 462849, metadata !1925, metadata !"i.V", metadata !1611, i32 167, metadata !1596} ; [ DW_TAG_auto_variable_field ]
!1925 = metadata !{i32 459008, metadata !1827, metadata !"i", metadata !1611, i32 167, metadata !15} ; [ DW_TAG_auto_variable ]
!1926 = metadata !{i32 1702, i32 0, metadata !1764, metadata !1927}
!1927 = metadata !{i32 1732, i32 0, metadata !1758, metadata !1828}
!1928 = metadata !{i32 1857, i32 0, metadata !1770, metadata !1828}
!1929 = metadata !{i32 459009, metadata !416, metadata !"_rows", metadata !12, i32 487, metadata !59} ; [ DW_TAG_arg_variable ]
!1930 = metadata !{i32 459009, metadata !416, metadata !"_cols", metadata !12, i32 487, metadata !59} ; [ DW_TAG_arg_variable ]
!1931 = metadata !{i32 459009, metadata !1932, metadata !"val", metadata !16, i32 204, metadata !59} ; [ DW_TAG_arg_variable ]
!1932 = metadata !{i32 458798, i32 0, metadata !15, metadata !"ap_uint", metadata !"ap_uint", metadata !"_ZN7ap_uintILi12EEC1Ei", metadata !16, i32 204, metadata !265, i1 false, i1 true, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
!1933 = metadata !{i32 204, i32 0, metadata !1932, metadata !1934}
!1934 = metadata !{i32 489, i32 0, metadata !1935, null}
!1935 = metadata !{i32 458763, metadata !1936, i32 487, i32 0} ; [ DW_TAG_lexical_block ]
!1936 = metadata !{i32 458763, metadata !416, i32 487, i32 0} ; [ DW_TAG_lexical_block ]
!1937 = metadata !{i32 204, i32 0, metadata !1932, metadata !1938}
!1938 = metadata !{i32 490, i32 0, metadata !1935, null}
!1939 = metadata !{i32 462855, metadata !1940, metadata !"Mat<1080,1920,16>.rows.V", metadata !12, i32 487, metadata !1594} ; [ DW_TAG_arg_variable_field_wo ]
!1940 = metadata !{i32 459009, metadata !416, metadata !"this", metadata !12, i32 487, metadata !1618} ; [ DW_TAG_arg_variable ]
!1941 = metadata !{i32 462855, metadata !1940, metadata !"Mat<1080,1920,16>.cols.V", metadata !12, i32 487, metadata !1594} ; [ DW_TAG_arg_variable_field_wo ]
