...
module convert_to_gray_OUTPUT_STREAM_if (
    // AXI4-Stream singals
    input  wire        ACLK,
    input  wire        ARESETN,
    output wire        TVALID,
...
//------------------------Instantiation------------------
// rs
convert_to_gray_OUTPUT_STREAM_reg_slice #(
    .N       ( 44 )
) rs (
    .clk     ( ACLK ),
    .reset   ( ARESETN ),
...
convert_to_gray_OUTPUT_STREAM_fifo #(
    .DATA_BITS  ( 32 ),
    .DEPTH_BITS ( 4 )
) output_V_data_V_fifo (
    .clk        ( ACLK ),
...
module convert_to_gray_OUTPUT_STREAM_fifo
#(parameter
    DATA_BITS  = 8,
    DEPTH_BITS = 4
)(
...
module convert_to_gray_OUTPUT_STREAM_reg_slice
#(parameter
    N = 8   // data width
) (
    // system signals
