; ModuleID = '/nfs/TUEIEDAprojects/SystemDesign/work/zynq/mamatha/uzair_sharif/EDA_Munish/work_dir/vivado_projects/cvtColor/cvt_prj/solution3/.autopilot/db/a.o.2.bc'
...
@str = internal constant [16 x i8] c"convert_to_gray\00"
@str109 = internal constant [8 x i8] c"ap_fifo\00"
@str110 = internal constant [8 x i8] c"ap_fifo\00"
@str111 = internal constant [8 x i8] c"ap_fifo\00"
@str112 = internal constant [8 x i8] c"ap_fifo\00"
@str113 = internal constant [8 x i8] c"ap_fifo\00"
...
define void @convert_to_gray(i32* %input_V_data_V, i4* %input_V_keep_V, i4* %input_V_strb_V, i1* %input_V_user_V, i1* %input_V_last_V, i1* %input_V_id_V, i1* %input_V_dest_V, i32* %output_V_data_V, i4* %output_V_keep_V, i4* %output_V_strb_V, i1* %output_V_user_V, i1* %output_V_last_V, i1* %output_V_id_V, i1* %output_V_dest_V, i32 %rows, i32 %cols) {
  ...
  %empty = call i32 (...)* @_ssdm_op_SpecFifo(i1* %output_V_dest_V, [8 x i8]* @str122, i32 0, i32 0, i32 0, [8 x i8]* @str122)
  %empty_24 = call i32 (...)* @_ssdm_op_SpecFifo(i1* %output_V_id_V, [8 x i8]* @str121, i32 0, i32 0, i32 0, [8 x i8]* @str121)
  %empty_25 = call i32 (...)* @_ssdm_op_SpecFifo(i1* %output_V_last_V, [8 x i8]* @str120, i32 0, i32 0, i32 0, [8 x i8]* @str120)
  %empty_26 = call i32 (...)* @_ssdm_op_SpecFifo(i1* %output_V_user_V, [8 x i8]* @str119, i32 0, i32 0, i32 0, [8 x i8]* @str119)
  %empty_27 = call i32 (...)* @_ssdm_op_SpecFifo(i4* %output_V_strb_V, [8 x i8]* @str118, i32 0, i32 0, i32 0, [8 x i8]* @str118)
  %empty_28 = call i32 (...)* @_ssdm_op_SpecFifo(i4* %output_V_keep_V, [8 x i8]* @str117, i32 0, i32 0, i32 0, [8 x i8]* @str117)
  %empty_29 = call i32 (...)* @_ssdm_op_SpecFifo(i32* %output_V_data_V, [8 x i8]* @str116, i32 0, i32 0, i32 0, [8 x i8]* @str116)
  %empty_30 = call i32 (...)* @_ssdm_op_SpecFifo(i1* %input_V_dest_V, [8 x i8]* @str115, i32 0, i32 0, i32 0, [8 x i8]* @str115)
  %empty_31 = call i32 (...)* @_ssdm_op_SpecFifo(i1* %input_V_id_V, [8 x i8]* @str114, i32 0, i32 0, i32 0, [8 x i8]* @str114)
  %empty_32 = call i32 (...)* @_ssdm_op_SpecFifo(i1* %input_V_last_V, [8 x i8]* @str113, i32 0, i32 0, i32 0, [8 x i8]* @str113)
  %empty_33 = call i32 (...)* @_ssdm_op_SpecFifo(i1* %input_V_user_V, [8 x i8]* @str112, i32 0, i32 0, i32 0, [8 x i8]* @str112)
  %empty_34 = call i32 (...)* @_ssdm_op_SpecFifo(i4* %input_V_strb_V, [8 x i8]* @str111, i32 0, i32 0, i32 0, [8 x i8]* @str111)
  %empty_35 = call i32 (...)* @_ssdm_op_SpecFifo(i4* %input_V_keep_V, [8 x i8]* @str110, i32 0, i32 0, i32 0, [8 x i8]* @str110)
  %empty_36 = call i32 (...)* @_ssdm_op_SpecFifo(i32* %input_V_data_V, [8 x i8]* @str109, i32 0, i32 0, i32 0, [8 x i8]* @str109)
  ...
  %empty_37 = call i32 (...)* @_ssdm_op_SpecChannel([23 x i8]* @str130, i32 1, [1 x i8]* @str131, [1 x i8]* @str131, i32 1, i32 1, i8* %img_0_data_stream_0_V, i8* %img_0_data_stream_0_V)
  %empty_38 = call i32 (...)* @_ssdm_op_SpecFifo(i8* %img_0_data_stream_0_V, [8 x i8]* @str132, i32 0, i32 0, i32 0, [8 x i8]* @str132)
  %img_0_data_stream_1_V = alloca i8, align 1
  %empty_39 = call i32 (...)* @_ssdm_op_SpecChannel([23 x i8]* @str133, i32 1, [1 x i8]* @str134, [1 x i8]* @str134, i32 1, i32 1, i8* %img_0_data_stream_1_V, i8* %img_0_data_stream_1_V)
  %empty_40 = call i32 (...)* @_ssdm_op_SpecFifo(i8* %img_0_data_stream_1_V, [8 x i8]* @str135, i32 0, i32 0, i32 0, [8 x i8]* @str135)
  %img_0_data_stream_2_V = alloca i8, align 1
  %empty_41 = call i32 (...)* @_ssdm_op_SpecChannel([23 x i8]* @str136, i32 1, [1 x i8]* @str137, [1 x i8]* @str137, i32 1, i32 1, i8* %img_0_data_stream_2_V, i8* %img_0_data_stream_2_V)
  %empty_42 = call i32 (...)* @_ssdm_op_SpecFifo(i8* %img_0_data_stream_2_V, [8 x i8]* @str138, i32 0, i32 0, i32 0, [8 x i8]* @str138)
  %img_1_data_stream_0_V = alloca i8, align 1
  %empty_43 = call i32 (...)* @_ssdm_op_SpecChannel([23 x i8]* @str139, i32 1, [1 x i8]* @str140, [1 x i8]* @str140, i32 1, i32 1, i8* %img_1_data_stream_0_V, i8* %img_1_data_stream_0_V)
  %empty_44 = call i32 (...)* @_ssdm_op_SpecFifo(i8* %img_1_data_stream_0_V, [8 x i8]* @str141, i32 0, i32 0, i32 0, [8 x i8]* @str141)
  %img_1_data_stream_1_V = alloca i8, align 1
  %empty_45 = call i32 (...)* @_ssdm_op_SpecChannel([23 x i8]* @str142, i32 1, [1 x i8]* @str143, [1 x i8]* @str143, i32 1, i32 1, i8* %img_1_data_stream_1_V, i8* %img_1_data_stream_1_V)
  %empty_46 = call i32 (...)* @_ssdm_op_SpecFifo(i8* %img_1_data_stream_1_V, [8 x i8]* @str144, i32 0, i32 0, i32 0, [8 x i8]* @str144)
  %img_1_data_stream_2_V = alloca i8, align 1
  %empty_47 = call i32 (...)* @_ssdm_op_SpecChannel([23 x i8]* @str145, i32 1, [1 x i8]* @str146, [1 x i8]* @str146, i32 1, i32 1, i8* %img_1_data_stream_2_V, i8* %img_1_data_stream_2_V)
  %empty_48 = call i32 (...)* @_ssdm_op_SpecFifo(i8* %img_1_data_stream_2_V, [8 x i8]* @str147, i32 0, i32 0, i32 0, [8 x i8]* @str147)
...
define internal fastcc void @"AXIvideo2Mat<32,1080,1920,32>"(i32* %AXI_video_strm_V_data_V, i4* %AXI_video_strm_V_keep_V, i4* %AXI_video_strm_V_strb_V, i1* %AXI_video_strm_V_user_V, i1* %AXI_video_strm_V_last_V, i1* %AXI_video_strm_V_id_V, i1* %AXI_video_strm_V_dest_V, i12 %img_rows_V_read, i12 %img_cols_V_read, i8* %img_data_stream_0_V, i8* %img_data_stream_1_V, i8* %img_data_stream_2_V) {
  %empty = call i32 (...)* @_ssdm_op_SpecFifo(i8* %img_data_stream_2_V, [8 x i8]* @str138, i32 0, i32 0, i32 0, [8 x i8]* @str138)
  %empty_67 = call i32 (...)* @_ssdm_op_SpecFifo(i8* %img_data_stream_1_V, [8 x i8]* @str135, i32 0, i32 0, i32 0, [8 x i8]* @str135)
  %empty_68 = call i32 (...)* @_ssdm_op_SpecFifo(i8* %img_data_stream_0_V, [8 x i8]* @str132, i32 0, i32 0, i32 0, [8 x i8]* @str132)
  %empty_69 = call i32 (...)* @_ssdm_op_SpecFifo(i1* %AXI_video_strm_V_dest_V, [8 x i8]* @str115, i32 0, i32 0, i32 0, [8 x i8]* @str115)
  %empty_70 = call i32 (...)* @_ssdm_op_SpecFifo(i1* %AXI_video_strm_V_id_V, [8 x i8]* @str114, i32 0, i32 0, i32 0, [8 x i8]* @str114)
  %empty_71 = call i32 (...)* @_ssdm_op_SpecFifo(i1* %AXI_video_strm_V_last_V, [8 x i8]* @str113, i32 0, i32 0, i32 0, [8 x i8]* @str113)
  %empty_72 = call i32 (...)* @_ssdm_op_SpecFifo(i1* %AXI_video_strm_V_user_V, [8 x i8]* @str112, i32 0, i32 0, i32 0, [8 x i8]* @str112)
  %empty_73 = call i32 (...)* @_ssdm_op_SpecFifo(i4* %AXI_video_strm_V_strb_V, [8 x i8]* @str111, i32 0, i32 0, i32 0, [8 x i8]* @str111)
  %empty_74 = call i32 (...)* @_ssdm_op_SpecFifo(i4* %AXI_video_strm_V_keep_V, [8 x i8]* @str110, i32 0, i32 0, i32 0, [8 x i8]* @str110)
  %empty_75 = call i32 (...)* @_ssdm_op_SpecFifo(i32* %AXI_video_strm_V_data_V, [8 x i8]* @str109, i32 0, i32 0, i32 0, [8 x i8]* @str109)
...
; <label>:2                                       ; preds = %1
  ...
  %empty_77 = call i32 (...)* @_ssdm_op_SpecRegionEnd([20 x i8]* @p_str1827, i32 %tmp)
  br label %1
...
._crit_edge:                                      ; preds = %6, %5
  ...
  %empty_79 = call i32 (...)* @_ssdm_op_SpecRegionEnd([11 x i8]* @p_str1820, i32 %tmp_2)
...
; <label>:7                                       ; preds = %.preheader
  ...
  %tmp_3 = call i32 (...)* @_ssdm_op_SpecRegionBegin([18 x i8]* @p_str1828)
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, [1 x i8]* @p_str1808) nounwind
  call void (...)* @_ssdm_op_SpecLoopTripCount(i32 0, i32 1, i32 1, [1 x i8]* @p_str1808) nounwind
  ...
  %empty_81 = call i32 (...)* @_ssdm_op_SpecRegionEnd([18 x i8]* @p_str1828, i32 %tmp_3)
  br label %.preheader

; <label>:8                                       ; preds = %.preheader
  %empty_82 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @p_str1819, i32 %tmp_1)
  br label %.preheader148
...
._crit_edge.i46:
  %empty = call i32 (...)* @_ssdm_op_SpecFifo(i8* %p_dst_data_stream_2_V, [8 x i8]* @str147, i32 0, i32 0, i32 0, [8 x i8]* @str147)
  %empty_83 = call i32 (...)* @_ssdm_op_SpecFifo(i8* %p_dst_data_stream_1_V, [8 x i8]* @str144, i32 0, i32 0, i32 0, [8 x i8]* @str144)
  %empty_84 = call i32 (...)* @_ssdm_op_SpecFifo(i8* %p_dst_data_stream_0_V, [8 x i8]* @str141, i32 0, i32 0, i32 0, [8 x i8]* @str141)
  %empty_85 = call i32 (...)* @_ssdm_op_SpecFifo(i8* %p_src_data_stream_2_V, [8 x i8]* @str138, i32 0, i32 0, i32 0, [8 x i8]* @str138)
  %empty_86 = call i32 (...)* @_ssdm_op_SpecFifo(i8* %p_src_data_stream_1_V, [8 x i8]* @str135, i32 0, i32 0, i32 0, [8 x i8]* @str135)
  %empty_87 = call i32 (...)* @_ssdm_op_SpecFifo(i8* %p_src_data_stream_0_V, [8 x i8]* @str132, i32 0, i32 0, i32 0, [8 x i8]* @str132)
...
"operator>>.exit":                                ; preds = %2
  ...
  %empty_88 = call i32 (...)* @_ssdm_op_SpecRegionEnd([11 x i8]* @p_str1820, i32 %tmp_s)
  br label %2

; <label>:3                                       ; preds = %2
  %empty_89 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @p_str1819, i32 %tmp)
  br label %0
...
define internal fastcc void @"Mat2AXIvideo<32,1080,1920,32>"(i12 %img_rows_V_read, i12 %img_cols_V_read, i8* %img_data_stream_0_V, i8* %img_data_stream_1_V, i8* %img_data_stream_2_V, i32* %AXI_video_strm_V_data_V, i4* %AXI_video_strm_V_keep_V, i4* %AXI_video_strm_V_strb_V, i1* %AXI_video_strm_V_user_V, i1* %AXI_video_strm_V_last_V, i1* %AXI_video_strm_V_id_V, i1* %AXI_video_strm_V_dest_V) {
  ...
  %empty = call i32 (...)* @_ssdm_op_SpecFifo(i8* %img_data_stream_2_V, [8 x i8]* @str147, i32 0, i32 0, i32 0, [8 x i8]* @str147)
  %empty_90 = call i32 (...)* @_ssdm_op_SpecFifo(i8* %img_data_stream_1_V, [8 x i8]* @str144, i32 0, i32 0, i32 0, [8 x i8]* @str144)
  %empty_91 = call i32 (...)* @_ssdm_op_SpecFifo(i8* %img_data_stream_0_V, [8 x i8]* @str141, i32 0, i32 0, i32 0, [8 x i8]* @str141)
  %empty_92 = call i32 (...)* @_ssdm_op_SpecFifo(i1* %AXI_video_strm_V_dest_V, [8 x i8]* @str122, i32 0, i32 0, i32 0, [8 x i8]* @str122)
  %empty_93 = call i32 (...)* @_ssdm_op_SpecFifo(i1* %AXI_video_strm_V_id_V, [8 x i8]* @str121, i32 0, i32 0, i32 0, [8 x i8]* @str121)
  %empty_94 = call i32 (...)* @_ssdm_op_SpecFifo(i1* %AXI_video_strm_V_last_V, [8 x i8]* @str120, i32 0, i32 0, i32 0, [8 x i8]* @str120)
  %empty_95 = call i32 (...)* @_ssdm_op_SpecFifo(i1* %AXI_video_strm_V_user_V, [8 x i8]* @str119, i32 0, i32 0, i32 0, [8 x i8]* @str119)
  %empty_96 = call i32 (...)* @_ssdm_op_SpecFifo(i4* %AXI_video_strm_V_strb_V, [8 x i8]* @str118, i32 0, i32 0, i32 0, [8 x i8]* @str118)
  %empty_97 = call i32 (...)* @_ssdm_op_SpecFifo(i4* %AXI_video_strm_V_keep_V, [8 x i8]* @str117, i32 0, i32 0, i32 0, [8 x i8]* @str117)
  %empty_98 = call i32 (...)* @_ssdm_op_SpecFifo(i32* %AXI_video_strm_V_data_V, [8 x i8]* @str116, i32 0, i32 0, i32 0, [8 x i8]* @str116)
...
"operator>>.exit":                                ; preds = %3
  ...
  call void (...)* @_ssdm_op_SpecLoopName([11 x i8]* @p_str1820) nounwind
  %tmp_1 = call i32 (...)* @_ssdm_op_SpecRegionBegin([11 x i8]* @p_str1820)
  call void (...)* @_ssdm_op_SpecLoopTripCount(i32 0, i32 1920, i32 0, [1 x i8]* @p_str1808) nounwind
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, [1 x i8]* @p_str1808) nounwind
  ...
  %empty_100 = call i32 (...)* @_ssdm_op_SpecRegionEnd([11 x i8]* @p_str1820, i32 %tmp_1)
