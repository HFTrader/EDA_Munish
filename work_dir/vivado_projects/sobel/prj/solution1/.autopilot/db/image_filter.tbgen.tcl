...
set C_modelArgList { 
	{ input_V_data_V int 64 {fifo 0 volatile}  }
	{ input_V_keep_V int 8 {fifo 0 volatile}  }
	{ input_V_strb_V int 8 {fifo 0 volatile}  }
	{ input_V_user_V int 1 {fifo 0 volatile}  }
	{ input_V_last_V int 1 {fifo 0 volatile}  }
	{ input_V_id_V int 1 {fifo 0 volatile}  }
	{ input_V_dest_V int 1 {fifo 0 volatile}  }
	{ output_V_data_V int 64 {fifo 1 volatile}  }
	{ output_V_keep_V int 8 {fifo 1 volatile}  }
	{ output_V_strb_V int 8 {fifo 1 volatile}  }
	{ output_V_user_V int 1 {fifo 1 volatile}  }
	{ output_V_last_V int 1 {fifo 1 volatile}  }
	{ output_V_id_V int 1 {fifo 1 volatile}  }
	{ output_V_dest_V int 1 {fifo 1 volatile}  }
	{ rows int 32  }
	{ cols int 32  }
}
...
set Spec2ImplPortList { 
	input_V_data_V { ap_fifo {  { input_V_data_V_dout fifo_data 0 64 }  { input_V_data_V_empty_n fifo_status 0 1 }  { input_V_data_V_read fifo_update 1 1 } } }
	input_V_keep_V { ap_fifo {  { input_V_keep_V_dout fifo_data 0 8 }  { input_V_keep_V_empty_n fifo_status 0 1 }  { input_V_keep_V_read fifo_update 1 1 } } }
	input_V_strb_V { ap_fifo {  { input_V_strb_V_dout fifo_data 0 8 }  { input_V_strb_V_empty_n fifo_status 0 1 }  { input_V_strb_V_read fifo_update 1 1 } } }
	...
	output_V_data_V { ap_fifo {  { output_V_data_V_din fifo_data 1 64 }  { output_V_data_V_full_n fifo_status 0 1 }  { output_V_data_V_write fifo_update 1 1 } } }
	output_V_keep_V { ap_fifo {  { output_V_keep_V_din fifo_data 1 8 }  { output_V_keep_V_full_n fifo_status 0 1 }  { output_V_keep_V_write fifo_update 1 1 } } }
	output_V_strb_V { ap_fifo {  { output_V_strb_V_din fifo_data 1 8 }  { output_V_strb_V_full_n fifo_status 0 1 }  { output_V_strb_V_write fifo_update 1 1 } } }
