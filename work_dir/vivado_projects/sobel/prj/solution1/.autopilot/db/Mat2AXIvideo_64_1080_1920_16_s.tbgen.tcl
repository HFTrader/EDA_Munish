set moduleName Mat2AXIvideo_64_1080_1920_16_s
set isCombinational 0
set isDatapathOnly 0
set isPipelined 0
set isOneStateSeq 0
set C_modelName Mat2AXIvideo<64,1080,1920,16>
set C_modelType { void 0 }
set C_modelArgList { 
	{ img_rows_V_read int 12  }
	{ img_cols_V_read int 12  }
	{ img_data_stream_0_V int 8 {fifo 0 volatile}  }
	{ img_data_stream_1_V int 8 {fifo 0 volatile}  }
	{ img_data_stream_2_V int 8 {fifo 0 volatile}  }
	{ AXI_video_strm_V_data_V int 64 {fifo 1 volatile}  }
	{ AXI_video_strm_V_keep_V int 8 {fifo 1 volatile}  }
	{ AXI_video_strm_V_strb_V int 8 {fifo 1 volatile}  }
	{ AXI_video_strm_V_user_V int 1 {fifo 1 volatile}  }
	{ AXI_video_strm_V_last_V int 1 {fifo 1 volatile}  }
	{ AXI_video_strm_V_id_V int 1 {fifo 1 volatile}  }
	{ AXI_video_strm_V_dest_V int 1 {fifo 1 volatile}  }
}
...
set Spec2ImplPortList { 
	...
	AXI_video_strm_V_data_V { ap_fifo {  { AXI_video_strm_V_data_V_din fifo_data 1 64 }  { AXI_video_strm_V_data_V_full_n fifo_status 0 1 }  { AXI_video_strm_V_data_V_write fifo_update 1 1 } } }
	AXI_video_strm_V_keep_V { ap_fifo {  { AXI_video_strm_V_keep_V_din fifo_data 1 8 }  { AXI_video_strm_V_keep_V_full_n fifo_status 0 1 }  { AXI_video_strm_V_keep_V_write fifo_update 1 1 } } }
	AXI_video_strm_V_strb_V { ap_fifo {  { AXI_video_strm_V_strb_V_din fifo_data 1 8 }  { AXI_video_strm_V_strb_V_full_n fifo_status 0 1 }  { AXI_video_strm_V_strb_V_write fifo_update 1 1 } } }
