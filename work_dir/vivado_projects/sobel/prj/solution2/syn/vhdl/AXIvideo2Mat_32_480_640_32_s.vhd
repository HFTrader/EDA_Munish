...
entity AXIvideo2Mat_32_480_640_32_s is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of AXIvideo2Mat_32_480_640_32_s is 
    ...
    signal i_V_reg_468 : STD_LOGIC_VECTOR (11 downto 0);
    signal exitcond2_fu_373_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal exitcond2_reg_473 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal eol_1_mux_fu_399_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal not_sof_2_fu_393_p2 : STD_LOGIC_VECTOR (0 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_ST_pp1_stg0_fsm_4 = ap_CS_fsm) and (ap_const_lv1_0 = exitcond2_reg_473) and (ap_const_logic_1 = ap_reg_ppiten_pp1_it1) and not((ap_sig_bdd_139 and (ap_const_logic_1 = ap_reg_ppiten_pp1_it1))))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_ST_pp1_stg0_fsm_4 = ap_CS_fsm) and (ap_const_logic_1 = ap_reg_ppiten_pp1_it1) and not((ap_sig_bdd_139 and (ap_const_logic_1 = ap_reg_ppiten_pp1_it1))) and not((ap_const_lv1_0 = exitcond2_reg_473)))) then 
    ...
    AXI_video_strm_V_0_update_assign_proc : process(ap_CS_fsm, ap_sig_bdd_89, ap_sig_bdd_97, exitcond2_reg_473, brmerge_fu_387_p2, ap_sig_bdd_139, ap_reg_ppiten_pp1_it1, sof_reg_189, eol_3_reg_326)
    begin
        if ((((ap_ST_st2_fsm_1 = ap_CS_fsm) and (sof_reg_189 = ap_const_lv1_0) and not(ap_sig_bdd_89)) or ((ap_ST_st7_fsm_5 = ap_CS_fsm) and (ap_const_lv1_0 = eol_3_reg_326) and not(ap_sig_bdd_97)) or ((ap_ST_pp1_stg0_fsm_4 = ap_CS_fsm) and (ap_const_lv1_0 = exitcond2_reg_473) and (ap_const_lv1_0 = brmerge_fu_387_p2) and (ap_const_logic_1 = ap_reg_ppiten_pp1_it1) and not((ap_sig_bdd_139 and (ap_const_logic_1 = ap_reg_ppiten_pp1_it1)))))) then 
    ...
    ap_sig_bdd_139_assign_proc : process(img_data_stream_0_V_full_n, img_data_stream_1_V_full_n, img_data_stream_2_V_full_n, AXI_video_strm_V_0_status, exitcond2_reg_473, brmerge_fu_387_p2)
    begin
                ap_sig_bdd_139 <= (((AXI_video_strm_V_0_status = ap_const_logic_0) and (ap_const_lv1_0 = exitcond2_reg_473) and (ap_const_lv1_0 = brmerge_fu_387_p2)) or ((ap_const_lv1_0 = exitcond2_reg_473) and (img_data_stream_0_V_full_n = ap_const_logic_0)) or ((ap_const_lv1_0 = exitcond2_reg_473) and (img_data_stream_1_V_full_n = ap_const_logic_0)) or ((ap_const_lv1_0 = exitcond2_reg_473) and (img_data_stream_2_V_full_n = ap_const_logic_0)));
    end process;


    -- ap_sig_bdd_218 assign process. --
    ap_sig_bdd_218_assign_proc : process(ap_CS_fsm, exitcond2_reg_473, ap_reg_ppiten_pp1_it1)
    begin
                ap_sig_bdd_218 <= ((ap_ST_pp1_stg0_fsm_4 = ap_CS_fsm) and (ap_const_lv1_0 = exitcond2_reg_473) and (ap_const_logic_1 = ap_reg_ppiten_pp1_it1));
    end process;
    ...
    brmerge_fu_387_p2 <= (sof_1_fu_110 or eol_reg_266);
    eol_1_mux_fu_399_p2 <= (eol_1_reg_244 or not_sof_2_fu_393_p2);

    -- eol_2_phi_fu_295_p4 assign process. --
    eol_2_phi_fu_295_p4_assign_proc : process(AXI_video_strm_V_last_V_dout, brmerge_fu_387_p2, eol_1_mux_fu_399_p2, ap_sig_bdd_218)
    begin
        if (ap_sig_bdd_218) then
            if (not((ap_const_lv1_0 = brmerge_fu_387_p2))) then 
                eol_2_phi_fu_295_p4 <= eol_1_mux_fu_399_p2;
            elsif ((ap_const_lv1_0 = brmerge_fu_387_p2)) then 
    ...
    img_data_stream_0_V_write_assign_proc : process(ap_CS_fsm, exitcond2_reg_473, ap_sig_bdd_139, ap_reg_ppiten_pp1_it1)
    begin
        if (((ap_ST_pp1_stg0_fsm_4 = ap_CS_fsm) and (ap_const_lv1_0 = exitcond2_reg_473) and (ap_const_logic_1 = ap_reg_ppiten_pp1_it1) and not((ap_sig_bdd_139 and (ap_const_logic_1 = ap_reg_ppiten_pp1_it1))))) then 
    ...
    img_data_stream_1_V_write_assign_proc : process(ap_CS_fsm, exitcond2_reg_473, ap_sig_bdd_139, ap_reg_ppiten_pp1_it1)
    begin
        if (((ap_ST_pp1_stg0_fsm_4 = ap_CS_fsm) and (ap_const_lv1_0 = exitcond2_reg_473) and (ap_const_logic_1 = ap_reg_ppiten_pp1_it1) and not((ap_sig_bdd_139 and (ap_const_logic_1 = ap_reg_ppiten_pp1_it1))))) then 
    ...
    img_data_stream_2_V_write_assign_proc : process(ap_CS_fsm, exitcond2_reg_473, ap_sig_bdd_139, ap_reg_ppiten_pp1_it1)
    begin
        if (((ap_ST_pp1_stg0_fsm_4 = ap_CS_fsm) and (ap_const_lv1_0 = exitcond2_reg_473) and (ap_const_logic_1 = ap_reg_ppiten_pp1_it1) and not((ap_sig_bdd_139 and (ap_const_logic_1 = ap_reg_ppiten_pp1_it1))))) then 
    ...
    not_sof_2_fu_393_p2 <= (sof_1_fu_110 xor ap_const_lv1_1);

    -- p_Val2_s_phi_fu_282_p4 assign process. --
    p_Val2_s_phi_fu_282_p4_assign_proc : process(AXI_video_strm_V_data_V_dout, axi_0_2_reg_255, brmerge_fu_387_p2, ap_sig_bdd_218)
    begin
        if (ap_sig_bdd_218) then
            if (not((ap_const_lv1_0 = brmerge_fu_387_p2))) then 
