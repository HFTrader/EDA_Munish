...
void Filter2D_32_32_int_int_480_640_3_3_s_k_buf_0_val_0::proc_mem_q()
{
...
void Filter2D_32_32_int_int_480_640_3_3_s_k_buf_0_val_0::proc_mem_ra()
{
...
void Filter2D_32_32_int_int_480_640_3_3_s_k_buf_0_val_0::proc_mem_ce()
{
    sc_lv<1> tmp;
    tmp[0] = ce0.read();
    mem_ce.write(tmp);
...
void Filter2D_32_32_int_int_480_640_3_3_s_k_buf_0_val_0::proc_mem_wa()
{
    sc_lv<1 * AddressWidth> tmp;
    tmp = (address1.read());
    mem_wa.write(tmp);
...
void Filter2D_32_32_int_int_480_640_3_3_s_k_buf_0_val_0::proc_mem_we()
{
    sc_lv<1> tmp;
    tmp[0] = we1.read();
    mem_we.write(tmp);
...
void Filter2D_32_32_int_int_480_640_3_3_s_k_buf_0_val_0::proc_mem_d()
{
...
void Filter2D_32_32_int_int_480_640_3_3_s_k_buf_0_val_0::proc_op()
{
...
void Filter2D_32_32_int_int_480_640_3_3_s_k_buf_0_val_0::proc_addr()
{
...
// check collision
void Filter2D_32_32_int_int_480_640_3_3_s_k_buf_0_val_0::proc_check()
{
    int f = 0;
    for (int i = 0; i < 1; i++) {
        for (int j = i + 1; j < 2; j++) {
