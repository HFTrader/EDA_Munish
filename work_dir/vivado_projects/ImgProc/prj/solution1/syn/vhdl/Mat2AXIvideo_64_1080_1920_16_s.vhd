...
entity Mat2AXIvideo_64_1080_1920_16_s is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of Mat2AXIvideo_64_1080_1920_16_s is 
    ...
    signal t_V_2_reg_174 : STD_LOGIC_VECTOR (11 downto 0);
...
begin
    ...
    AXI_video_strm_V_data_V_din <= (((ap_const_lv40_FFFFFFFFFF & img_data_stream_2_V_dout) & img_data_stream_1_V_dout) & img_data_stream_0_V_dout);
    ...
    exitcond2_fu_212_p2 <= "1" when (t_V_2_reg_174 = img_cols_V_read) else "0";
    ...
    j_V_fu_217_p2 <= std_logic_vector(unsigned(t_V_2_reg_174) + unsigned(ap_const_lv12_1));
    ...
    tmp_cast_fu_223_p1 <= std_logic_vector(resize(unsigned(t_V_2_reg_174),13));
end behav;
