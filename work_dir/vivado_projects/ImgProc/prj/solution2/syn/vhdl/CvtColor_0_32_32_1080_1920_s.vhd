...
architecture behav of CvtColor_0_32_32_1080_1920_s is 
    ...
    signal tmp_56_reg_307 : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal p_Val2_4_reg_332 : STD_LOGIC_VECTOR (27 downto 0);
    signal grp_fu_205_p2 : STD_LOGIC_VECTOR (28 downto 0);
    signal p_Val2_3_reg_337 : STD_LOGIC_VECTOR (28 downto 0);
    signal p_Val2_5_fu_214_p2 : STD_LOGIC_VECTOR (27 downto 0);
    signal p_Val2_5_reg_342 : STD_LOGIC_VECTOR (27 downto 0);
    signal tmp_s_reg_347 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_52_reg_352 : STD_LOGIC_VECTOR (0 downto 0);
    signal exitcond8_fu_160_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal i_reg_137 : STD_LOGIC_VECTOR (11 downto 0);
    signal tmp_22_fu_269_p3 : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal tmp_23_cast_fu_211_p1 : STD_LOGIC_VECTOR (27 downto 0);
    signal tmp_25_cast_fu_219_p1 : STD_LOGIC_VECTOR (28 downto 0);
    signal p_Val2_6_fu_222_p2 : STD_LOGIC_VECTOR (28 downto 0);
    signal p_Val2_7_cast_fu_245_p1 : STD_LOGIC_VECTOR (8 downto 0);
    signal tmp_28_cast_fu_248_p1 : STD_LOGIC_VECTOR (8 downto 0);
    signal p_Val2_13_fu_251_p2 : STD_LOGIC_VECTOR (8 downto 0);
    signal tmp_53_fu_257_p3 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_54_fu_265_p1 : STD_LOGIC_VECTOR (7 downto 0);
    ...
    component image_processor_mul_8ns_18ns_27_3 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
...
begin
    image_processor_mul_8ns_18ns_27_3_U21 : component image_processor_mul_8ns_18ns_27_3
    generic map (
        ID => 21,
        NUM_STAGE => 3,
        din0_WIDTH => 8,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_ST_pp0_stg0_fsm_2 = ap_CS_fsm) and (ap_const_logic_1 = ap_reg_ppiten_pp0_it5) and not(((ap_sig_bdd_80 and (ap_const_logic_1 = ap_reg_ppiten_pp0_it1)) or (ap_sig_bdd_102 and (ap_const_logic_1 = ap_reg_ppiten_pp0_it6)))) and (ap_const_lv1_0 = ap_reg_ppstg_exitcond_reg_298_pp0_it4))) then
                tmp_52_reg_352 <= p_Val2_6_fu_222_p2(20 downto 20);
                tmp_s_reg_347 <= p_Val2_6_fu_222_p2(28 downto 21);
            end if;
        end if;
    end process;
    ...
    grp_fu_205_p00 <= std_logic_vector(resize(unsigned(tmp_56_reg_307),29));
    ...
    p_Val2_13_fu_251_p2 <= std_logic_vector(unsigned(p_Val2_7_cast_fu_245_p1) + unsigned(tmp_28_cast_fu_248_p1));
    p_Val2_5_fu_214_p2 <= std_logic_vector(unsigned(p_Val2_4_reg_332) + unsigned(tmp_23_cast_fu_211_p1));
    p_Val2_6_fu_222_p2 <= std_logic_vector(unsigned(p_Val2_3_reg_337) + unsigned(tmp_25_cast_fu_219_p1));
    p_Val2_7_cast_fu_245_p1 <= std_logic_vector(resize(unsigned(tmp_s_reg_347),9));
    p_dst_data_stream_0_V_din <= tmp_22_fu_269_p3;
    ...
    p_dst_data_stream_1_V_din <= tmp_22_fu_269_p3;
    ...
    p_dst_data_stream_2_V_din <= tmp_22_fu_269_p3;
    ...
    tmp_22_fu_269_p3 <= 
        ap_const_lv8_FF when (tmp_53_fu_257_p3(0) = '1') else 
        tmp_54_fu_265_p1;
    tmp_23_cast_fu_211_p1 <= std_logic_vector(resize(unsigned(p_Val2_s_reg_327),28));
    tmp_25_cast_fu_219_p1 <= std_logic_vector(resize(unsigned(p_Val2_5_reg_342),29));
    tmp_28_cast_fu_248_p1 <= std_logic_vector(resize(unsigned(tmp_52_reg_352),9));
    tmp_53_fu_257_p3 <= p_Val2_13_fu_251_p2(8 downto 8);
    tmp_54_fu_265_p1 <= p_Val2_13_fu_251_p2(8 - 1 downto 0);
end behav;
