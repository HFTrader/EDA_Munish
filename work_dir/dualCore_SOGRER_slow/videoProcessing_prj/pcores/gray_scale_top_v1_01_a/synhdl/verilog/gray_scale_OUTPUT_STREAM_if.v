...
module gray_scale_OUTPUT_STREAM_if (
    // AXI4-Stream singals
    input  wire        ACLK,
    input  wire        ARESETN,
    output wire        TVALID,
...
//------------------------Instantiation------------------
// rs
gray_scale_OUTPUT_STREAM_reg_slice #(
    .N       ( 44 )
) rs (
    .clk     ( ACLK ),
    .reset   ( ARESETN ),
...
module gray_scale_OUTPUT_STREAM_fifo
#(parameter
    DATA_BITS  = 8,
    DEPTH_BITS = 4
)(
...
module gray_scale_OUTPUT_STREAM_reg_slice
#(parameter
    N = 8   // data width
) (
    // system signals
