...
C_SRCS += \
../src/IP_SW/SobelIP/SW/ErodeIP_func.c 

OBJS += \
./src/IP_SW/SobelIP/SW/ErodeIP_func.o 

C_DEPS += \
./src/IP_SW/SobelIP/SW/ErodeIP_func.d 


# Each subdirectory must supply rules for building sources it contributes
src/IP_SW/SobelIP/SW/%.o: ../src/IP_SW/SobelIP/SW/%.c
	@echo 'Building file: $<'
