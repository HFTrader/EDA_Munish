...
Mat2AXIvideo_32_1080_1920_32_s::Mat2AXIvideo_32_1080_1920_32_s(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    sensitive << ( ap_sig_bdd_102 );
    sensitive << ( ap_reg_ppiten_pp0_it1 );
    sensitive << ( tmp_cast_99_fu_227_p1 );
    ...
    SC_METHOD(thread_tmp_cast_99_fu_227_p1);
    sensitive << ( p_3_reg_178 );
    ...
    sc_trace(mVcdFile, tmp_cast_99_fu_227_p1, "tmp_cast_99_fu_227_p1");
...
void Mat2AXIvideo_32_1080_1920_32_s::thread_axi_last_V_fu_231_p2() {
    axi_last_V_fu_231_p2 = (!tmp_cast_99_fu_227_p1.read().is_01() || !op2_assign_reg_275.read().is_01())? sc_lv<1>(): sc_lv<1>(tmp_cast_99_fu_227_p1.read() == op2_assign_reg_275.read());
}
...
void Mat2AXIvideo_32_1080_1920_32_s::thread_tmp_cast_99_fu_227_p1() {
    tmp_cast_99_fu_227_p1 = esl_zext<13,12>(p_3_reg_178.read());
}
