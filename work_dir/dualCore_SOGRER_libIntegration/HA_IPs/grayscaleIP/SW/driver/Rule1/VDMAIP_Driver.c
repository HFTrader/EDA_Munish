...
void VDMAIP_Driver_initialize(VDMAIPDriverInstance *InstancePtr) {    
    InitMode.MM2S_START_ADDDRESS1 = {0x5c, 0xffffffff, InstancePtr->baseaddr};
    InitMode.MM2S_START_ADDDRESS2 = {0x60, 0xffffffff, InstancePtr->baseaddr};
    InitMode.MM2S_START_ADDDRESS3 = {0x64, 0xffffffff, InstancePtr->baseaddr};
    InitMode.MM2S_START_ADDDRESS1 = {0xac, 0xffffffff, InstancePtr->baseaddr};
    InitMode.MM2S_START_ADDDRESS1 = {0xb0, 0xffffffff, InstancePtr->baseaddr};
    InitMode.MM2S_START_ADDDRESS1 = {0xb4, 0xffffffff, InstancePtr->baseaddr};
...
void GrayscaleIP_Rule1Driver_start(VDMAIPDriverInstance *InstancePtr, unsigned long ImgIn_BaseAddr,unsigned long ImgOut_BaseAddr,unsigned short width, unsigned short height, unsigned short horizontalActiveTime, unsigned short verticalActiveTime) {
    StartMode.MM2S_VSIZE = {0x50, 0xffffffff, verticalActiveTime};
