...
#include "GrayscaleIP_VDMA_Driver_template.h"
...
GRAYSCALEIP_VDMARegMap GRAYSCALEIP_VDMAInitMode = {
...
GRAYSCALEIP_VDMARegMap GRAYSCALEIP_VDMAStartMode = {
								.MM2S_DMACR = {.offset = 0x00, .mask = 0x00000000, .value = 0xffffffff},
								//      ...     //  NOTE: not shown here for simplicity
								.S2MM_DMACR = {.offset = 0x30, .mask = 0x00000000, .value = 0xffffffff},
								.S2MM_DMASR = {.offset = 0x34, .mask = 0x00000000, .value = 0xffffffff},
...
GRAYSCALEIP_VDMARegMap GRAYSCALEIP_VDMAStopMode = {
								.MM2S_DMACR = {.offset = 0x00, .mask = 0x00000000, .value = 0xffffffff},
								//      ...     //  NOTE: not shown here for simplicity
								.S2MM_DMACR = {.offset = 0x30, .mask = 0x00000000, .value = 0xffffffff},
								.S2MM_DMASR = {.offset = 0x34, .mask = 0x00000000, .value = 0xffffffff},
...
static void SetHAMode(GRAYSCALEIP_VDMARegMap mode, unsigned int baseaddr) {
...
void GRAYSCALEIP_VDMA_Driver_start(GRAYSCALEIP_VDMADriverInstance *InstancePtr) {
    SetHAMode(GRAYSCALEIP_VDMAStartMode, InstancePtr->baseaddr);
...
void GRAYSCALEIP_VDMA_Driver_stop(GRAYSCALEIP_VDMADriverInstance *InstancePtr) {
    SetHAMode(GRAYSCALEIP_VDMAStopMode, InstancePtr->baseaddr);
}
