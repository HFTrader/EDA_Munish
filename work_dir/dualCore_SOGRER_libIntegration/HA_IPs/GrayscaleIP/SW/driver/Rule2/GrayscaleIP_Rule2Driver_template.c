...
#include "GrayscaleIP_Rule2Driver_template.h"



GrayscaleIPRule2RegMap GrayscaleIPRule1InitMode = {
...
GrayscaleIPRule2RegMap GrayscaleIPRule1StartMode = {
													.AP_CTRL = {.offset = 0x00, .mask = 0x00000000, .value = 0xffffffff},
													.GIE = {.offset = 0x04, .mask = 0x00000000, .value = 0xffffffff},
													.IER = {.offset = 0x08, .mask = 0x00000000, .value = 0xffffffff},
													.ISR = {.offset = 0x0c, .mask = 0x00000000, .value = 0xffffffff},
...
GrayscaleIPRule2RegMap GrayscaleIPRule1StopMode = {
													.AP_CTRL = {.offset = 0x00, .mask = 0x00000000, .value = 0xffffffff},
													.GIE = {.offset = 0x04, .mask = 0x00000000, .value = 0xffffffff},
													.IER = {.offset = 0x08, .mask = 0x00000000, .value = 0xffffffff},
													.ISR = {.offset = 0x0c, .mask = 0x00000000, .value = 0xffffffff},
...
void GrayscaleIP_Rule2Driver_initialize(GrayscaleIPDriverInstance *InstancePtr) {
