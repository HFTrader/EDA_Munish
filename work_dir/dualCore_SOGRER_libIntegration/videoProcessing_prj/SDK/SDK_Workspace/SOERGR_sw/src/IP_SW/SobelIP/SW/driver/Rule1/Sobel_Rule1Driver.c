// this driver corresponds to Sobel IP configuration corresponding to GRIP Rule 1 i.e Sobel IP integrated with AXI-VDMA 
// it is generated by modifying the auto-generated template

#include "Sobel_Rule1Driver.h"
...
Sobel_Rule1_RegMap Sobel_Rule1_InitMode = {
                ._SobelIP_RegMap = {
...
Sobel_Rule1_RegMap Sobel_Rule1_StartMode = {
                ._SobelIP_RegMap = {
										.AP_CTRL = {.offset = 0x00, .mask = 0x00000000, .value = 0xffffffff},
...
Sobel_Rule1_RegMap Sobel_Rule1_StopMode = {
                ._SobelIP_RegMap = {
...
void Sobel_Rule1Driver_initialize(Sobel_Rule1_DriverInstance *InstancePtr, XScuGic *InterruptController, unsigned long ImgIn_BaseAddr,unsigned long ImgOut_BaseAddr,unsigned short width, unsigned short height, unsigned short horizontalActiveTime, unsigned short verticalActiveTime) {
    // initializing the SobelIP
    Sobel_Rule1_InitMode._SobelIP_RegMap.ROWS_DATA.mask = 0xffffffff;
    Sobel_Rule1_InitMode._SobelIP_RegMap.ROWS_DATA.value = verticalActiveTime;
...
void Sobel_Rule1Driver_start(Sobel_Rule1_DriverInstance *InstancePtr, unsigned long ImgIn_BaseAddr,unsigned long ImgOut_BaseAddr,unsigned short width, unsigned short height, unsigned short horizontalActiveTime, unsigned short verticalActiveTime) {
	// starting the SobelIP
	SobelIP_Driver_start(&InstancePtr->_SobelIP_DriverInstance, Sobel_Rule1_StartMode._SobelIP_RegMap, ImgIn_BaseAddr, ImgOut_BaseAddr, width, height, horizontalActiveTime, verticalActiveTime);

	// starting the VDMAIP
	VDMAIP_Driver_start(&InstancePtr->_VDMAIP_DriverInstance, Sobel_Rule1_StartMode._VDMAIP_RegMap);
	// MEM2DEV
...
void Sobel_Rule1Driver_stop(Sobel_Rule1_DriverInstance *InstancePtr) {
	// stopping SobelIP
	SobelIP_Driver_stop(&InstancePtr->_SobelIP_DriverInstance, Sobel_Rule1_StopMode._SobelIP_RegMap);

	// stopping VDMAIP
	VDMAIP_Driver_stop(&InstancePtr->_VDMAIP_DriverInstance, Sobel_Rule1_StopMode._VDMAIP_RegMap);
}
