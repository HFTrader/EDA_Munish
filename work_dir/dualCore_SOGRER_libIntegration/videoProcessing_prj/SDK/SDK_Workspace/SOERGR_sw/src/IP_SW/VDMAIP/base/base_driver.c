...
static void VDMAIP_Driver_ISR(void *baseaddr_p) {
	...
	// resetting VDMA
	RegWrite(InstancePtr->baseaddr + 0x30, 0x00000004, 0x00000004);
...
void VDMAIP_Driver_initialize(VDMAIP_DriverInstance *InstancePtr, IntCntrl_t *InterruptController, VDMAIP_RegMap InitMode) {
