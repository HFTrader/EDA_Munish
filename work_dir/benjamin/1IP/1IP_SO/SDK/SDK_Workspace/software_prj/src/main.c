...
//	Status = XScuGic_Connect(&InterruptController,XPAR_FABRIC_SOBEL_FILTER_TOP_0_INTERRUPT_INTR,
//			(Xil_ExceptionHandler)AXI_INTERRUPT_SobelIntr_Handler,
//			(void *) &InterruptController);
//	XScuGic_Enable(&InterruptController, XPAR_FABRIC_SOBEL_FILTER_TOP_0_INTERRUPT_INTR);
//
//
//	Status = XScuGic_Connect(&InterruptController,XPAR_FABRIC_AXI_VDMA_4_MM2S_INTROUT_INTR,
//			(Xil_ExceptionHandler)AXI_INTERRUPT_VDMA4_MM2SIntr_Handler,
//			(void *) &InterruptController);
//	XScuGic_Enable(&InterruptController, XPAR_FABRIC_AXI_VDMA_4_MM2S_INTROUT_INTR);


	Status = XScuGic_Connect(&InterruptController,XPAR_FABRIC_AXI_VDMA_4_S2MM_INTROUT_INTR,
			(Xil_ExceptionHandler)AXI_INTERRUPT__VDMA4_S2MMIntr_Handler,
			(void *) &InterruptController);
	XScuGic_Enable(&InterruptController, XPAR_FABRIC_AXI_VDMA_4_S2MM_INTROUT_INTR);
...
//###########################################################################################################################
	//Init ErodeFilter
		...
		config_filterVDMA(XPAR_AXI_VDMA_2_BASEADDR, DMA_DEV_TO_MEM, ERODE_VIDEO_BASEADDR); */
//###########################################################################################################################
	//Init SobelFilter // Edge Detection
...
//		AXI_monitor_reset(XPAR_AXI_PERF_MON_0_BASEADDR);
		...
		AXI_monitor_reset(XPAR_AXI_PERF_MON_0_BASEADDR);
		SOBEL_INTR=0; 			//Ben
		while(SOBEL_INTR==0); //";" Ben
		SOBEL_INTR=0;
		printf("Sobel: %d CPU clk\n\r", get_cyclecount());
