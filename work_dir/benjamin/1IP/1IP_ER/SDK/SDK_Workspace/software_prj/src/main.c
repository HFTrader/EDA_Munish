...
//	Status = XScuGic_Connect(&InterruptController,XPAR_FABRIC_AXI_VDMA_2_MM2S_INTROUT_INTR,
//			(Xil_ExceptionHandler)AXI_INTERRUPT_VDMA2_MM2SIntr_Handler,
//			(void *) &InterruptController);
//	XScuGic_Enable(&InterruptController, XPAR_FABRIC_AXI_VDMA_2_MM2S_INTROUT_INTR);
...
//------------ SOBEL Software ------------------//
			...
			//printf("SO SW Frame Proc: %d CPU clk\n\r", get_cyclecount());
			printf("Edge Proc: %d CPU clk\n\r", get_cyclecount());
