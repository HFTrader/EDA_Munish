...
void AXI_INTERRUPT_VDMA3_MM2SIntr_Handler(void * baseaddr_p)
{
	printf("VDMA3_MM2S: %d clk\n\r", get_cyclecount());
...
//	config_filterVDMA(XPAR_AXI_VDMA_3_BASEADDR, DMA_MEM_TO_DEV, VIDEO_BASEADDR);
//	config_filterVDMA(XPAR_AXI_VDMA_3_BASEADDR, DMA_DEV_TO_MEM, SOBEL_VIDEO_BASEADDR);
//	printf("VDMA3_S2MM: %d clk\n\r", get_cyclecount());
//	PerfResult(XPAR_AXI_PERF_MON_0_BASEADDR);
	GRAY_INTR = 1;
