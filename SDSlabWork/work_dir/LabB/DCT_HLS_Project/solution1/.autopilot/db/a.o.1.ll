; ModuleID = '/home/ga38qoh/EDA_Munish/SDSlabWork/work_dir/LabB/DCT_HLS_Project/solution1/.autopilot/db/a.g.1.bc'
...
; <label>:4                                       ; preds = %3
  ...
  call void @llvm.dbg.value(metadata !{i32 %coeff}, i64 0, metadata !939), !dbg !933 ; [debug line = 21:48] [debug variable = coeff]
  %src.addr = getelementptr inbounds i16* %src, i64 %tmp.6, !dbg !940 ; [#uses=1 type=i16*] [debug line = 22:10]
  %src.load = load i16* %src.addr, align 2, !dbg !940 ; [#uses=2 type=i16] [debug line = 22:10]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i16 %src.load) nounwind
  %tmp.7 = sext i16 %src.load to i32, !dbg !940   ; [#uses=1 type=i32] [debug line = 22:10]
  %tmp.8 = mul nsw i32 %tmp.7, %coeff, !dbg !940  ; [#uses=1 type=i32] [debug line = 22:10]
  %tmp.9 = add nsw i32 %tmp.8, %tmp1, !dbg !940   ; [#uses=1 type=i32] [debug line = 22:10]
  call void @llvm.dbg.value(metadata !{i32 %tmp.9}, i64 0, metadata !941), !dbg !940 ; [debug line = 22:10] [debug variable = tmp]
  %rend = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([15 x i8]* @.str1, i64 0, i64 0), i32 %rbegin) nounwind, !dbg !942 ; [#uses=0 type=i32] [debug line = 23:7]
  %n.1 = add i32 %n, 1, !dbg !943                 ; [#uses=1 type=i32] [debug line = 20:72]
  call void @llvm.dbg.value(metadata !{i32 %n.1}, i64 0, metadata !944), !dbg !943 ; [debug line = 20:72] [debug variable = n]
  br label %3, !dbg !943                          ; [debug line = 20:72]

; <label>:5                                       ; preds = %3
  %tmp.0.lcssa = phi i32 [ %tmp1, %3 ]            ; [#uses=1 type=i32]
  %tmp.2 = add nsw i32 %tmp.0.lcssa, 4096, !dbg !946 ; [#uses=1 type=i32] [debug line = 24:7]
  %tmp.3 = lshr i32 %tmp.2, 13, !dbg !946         ; [#uses=1 type=i32] [debug line = 24:7]
  %tmp.4 = trunc i32 %tmp.3 to i16, !dbg !946     ; [#uses=1 type=i16] [debug line = 24:7]
  %dst.addr = getelementptr inbounds i16* %dst, i64 %tmp, !dbg !946 ; [#uses=1 type=i16*] [debug line = 24:7]
  store i16 %tmp.4, i16* %dst.addr, align 2, !dbg !946 ; [debug line = 24:7]
  %rend3 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([15 x i8]* @.str, i64 0, i64 0), i32 %rbegin2) nounwind, !dbg !947 ; [#uses=0 type=i32] [debug line = 25:4]
  %k.1 = add i32 %k, 1, !dbg !948                 ; [#uses=1 type=i32] [debug line = 18:61]
  call void @llvm.dbg.value(metadata !{i32 %k.1}, i64 0, metadata !949), !dbg !948 ; [debug line = 18:61] [debug variable = k]
  br label %1, !dbg !948                          ; [debug line = 18:61]

; <label>:6                                       ; preds = %1
  ret void, !dbg !950                             ; [debug line = 26:1]
}
...
define internal fastcc void @dct_2d([8 x i16]* %in_block, [8 x i16]* %out_block) nounwind uwtable {
  ...
  call void @llvm.dbg.value(metadata !{[8 x i16]* %in_block}, i64 0, metadata !951), !dbg !952 ; [debug line = 28:24] [debug variable = in_block]
  call void @llvm.dbg.value(metadata !{[8 x i16]* %out_block}, i64 0, metadata !953), !dbg !954 ; [debug line = 29:18] [debug variable = out_block]
  call void (...)* @_ssdm_SpecArrayDimSize([8 x i16]* %out_block, i32 8) nounwind, !dbg !955 ; [debug line = 30:2]
  call void (...)* @_ssdm_SpecArrayDimSize([8 x i16]* %in_block, i32 8) nounwind, !dbg !957 ; [debug line = 30:38]
  call void @llvm.dbg.declare(metadata !{[8 x [8 x i16]]* %row_outbuf}, metadata !958), !dbg !960 ; [debug line = 31:15] [debug variable = row_outbuf]
  call void @llvm.dbg.declare(metadata !{[8 x [8 x i16]]* %col_outbuf}, metadata !961), !dbg !962 ; [debug line = 32:15] [debug variable = col_outbuf]
  call void @llvm.dbg.declare(metadata !{[8 x [8 x i16]]* %col_inbuf}, metadata !963), !dbg !964 ; [debug line = 32:109] [debug variable = col_inbuf]
  br label %1, !dbg !965                          ; [debug line = 37:8]

; <label>:1                                       ; preds = %2, %0
  %i = phi i32 [ 0, %0 ], [ %i.4, %2 ]            ; [#uses=3 type=i32]
  %exitcond7 = icmp eq i32 %i, 8, !dbg !965       ; [#uses=1 type=i1] [debug line = 37:8]
  br i1 %exitcond7, label %.preheader2.preheader, label %2, !dbg !965 ; [debug line = 37:8]

.preheader2.preheader:                            ; preds = %1
  br label %.preheader2, !dbg !967                ; [debug line = 42:9]

; <label>:2                                       ; preds = %1
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([13 x i8]* @.str2, i64 0, i64 0)) nounwind, !dbg !969 ; [debug line = 37:66]
  %rbegin8 = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([13 x i8]* @.str2, i64 0, i64 0)) nounwind, !dbg !971 ; [#uses=1 type=i32] [debug line = 37:104]
  %tmp = zext i32 %i to i64, !dbg !972            ; [#uses=2 type=i64] [debug line = 38:7]
  %in_block.addr = getelementptr inbounds [8 x i16]* %in_block, i64 %tmp, i64 0, !dbg !972 ; [#uses=1 type=i16*] [debug line = 38:7]
  %row_outbuf.addr = getelementptr inbounds [8 x [8 x i16]]* %row_outbuf, i64 0, i64 %tmp, i64 0, !dbg !972 ; [#uses=1 type=i16*] [debug line = 38:7]
  call fastcc void @dct_1d(i16* %in_block.addr, i16* %row_outbuf.addr), !dbg !972 ; [debug line = 38:7]
  %rend9 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([13 x i8]* @.str2, i64 0, i64 0), i32 %rbegin8) nounwind, !dbg !973 ; [#uses=0 type=i32] [debug line = 39:4]
  %i.4 = add i32 %i, 1, !dbg !974                 ; [#uses=1 type=i32] [debug line = 37:60]
  call void @llvm.dbg.value(metadata !{i32 %i.4}, i64 0, metadata !975), !dbg !974 ; [debug line = 37:60] [debug variable = i]
  br label %1, !dbg !974                          ; [debug line = 37:60]

.preheader2:                                      ; preds = %6, %.preheader2.preheader
  %j = phi i32 [ %j.2, %6 ], [ 0, %.preheader2.preheader ] ; [#uses=3 type=i32]
  %exitcond6 = icmp eq i32 %j, 8, !dbg !967       ; [#uses=1 type=i1] [debug line = 42:9]
  br i1 %exitcond6, label %.preheader1.preheader, label %3, !dbg !967 ; [debug line = 42:9]

.preheader1.preheader:                            ; preds = %.preheader2
  br label %.preheader1, !dbg !976                ; [debug line = 48:9]

; <label>:3                                       ; preds = %.preheader2
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([21 x i8]* @.str3, i64 0, i64 0)) nounwind, !dbg !978 ; [debug line = 43:2]
  %rbegin1 = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([21 x i8]* @.str3, i64 0, i64 0)) nounwind, !dbg !980 ; [#uses=1 type=i32] [debug line = 43:48]
  %tmp.12 = zext i32 %j to i64, !dbg !981         ; [#uses=2 type=i64] [debug line = 45:1]
  br label %4, !dbg !984                          ; [debug line = 44:11]

; <label>:4                                       ; preds = %5, %3
  %i.1 = phi i32 [ 0, %3 ], [ %i.6, %5 ]          ; [#uses=3 type=i32]
  %exitcond5 = icmp eq i32 %i.1, 8, !dbg !984     ; [#uses=1 type=i1] [debug line = 44:11]
  br i1 %exitcond5, label %6, label %5, !dbg !984 ; [debug line = 44:11]

; <label>:5                                       ; preds = %4
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([21 x i8]* @.str4, i64 0, i64 0)) nounwind, !dbg !985 ; [debug line = 45:11]
  %rbegin2 = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([21 x i8]* @.str4, i64 0, i64 0)) nounwind, !dbg !986 ; [#uses=1 type=i32] [debug line = 45:57]
  %tmp.16 = zext i32 %i.1 to i64, !dbg !981       ; [#uses=2 type=i64] [debug line = 45:1]
  %row_outbuf.addr.1 = getelementptr inbounds [8 x [8 x i16]]* %row_outbuf, i64 0, i64 %tmp.16, i64 %tmp.12, !dbg !981 ; [#uses=1 type=i16*] [debug line = 45:1]
  %row_outbuf.load = load i16* %row_outbuf.addr.1, align 2, !dbg !981 ; [#uses=2 type=i16] [debug line = 45:1]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i16 %row_outbuf.load) nounwind
  %col_inbuf.addr.1 = getelementptr inbounds [8 x [8 x i16]]* %col_inbuf, i64 0, i64 %tmp.12, i64 %tmp.16, !dbg !981 ; [#uses=1 type=i16*] [debug line = 45:1]
  store i16 %row_outbuf.load, i16* %col_inbuf.addr.1, align 2, !dbg !981 ; [debug line = 45:1]
  %rend15 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([21 x i8]* @.str4, i64 0, i64 0), i32 %rbegin2) nounwind, !dbg !987 ; [#uses=0 type=i32] [debug line = 45:36]
  %i.6 = add i32 %i.1, 1, !dbg !988               ; [#uses=1 type=i32] [debug line = 44:63]
  call void @llvm.dbg.value(metadata !{i32 %i.6}, i64 0, metadata !975), !dbg !988 ; [debug line = 44:63] [debug variable = i]
  br label %4, !dbg !988                          ; [debug line = 44:63]

; <label>:6                                       ; preds = %4
  %rend17 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([21 x i8]* @.str3, i64 0, i64 0), i32 %rbegin1) nounwind, !dbg !989 ; [#uses=0 type=i32] [debug line = 45:77]
  %j.2 = add i32 %j, 1, !dbg !990                 ; [#uses=1 type=i32] [debug line = 42:61]
  call void @llvm.dbg.value(metadata !{i32 %j.2}, i64 0, metadata !991), !dbg !990 ; [debug line = 42:61] [debug variable = j]
  br label %.preheader2, !dbg !990                ; [debug line = 42:61]

.preheader1:                                      ; preds = %7, %.preheader1.preheader
  %i.2 = phi i32 [ %i.5, %7 ], [ 0, %.preheader1.preheader ] ; [#uses=3 type=i32]
  %exitcond4 = icmp eq i32 %i.2, 8, !dbg !976     ; [#uses=1 type=i1] [debug line = 48:9]
  br i1 %exitcond4, label %.preheader.preheader, label %7, !dbg !976 ; [debug line = 48:9]

.preheader.preheader:                             ; preds = %.preheader1
  br label %.preheader, !dbg !992                 ; [debug line = 53:9]

; <label>:7                                       ; preds = %.preheader1
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([13 x i8]* @.str5, i64 0, i64 0)) nounwind, !dbg !994 ; [debug line = 48:67]
  %rbegin = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([13 x i8]* @.str5, i64 0, i64 0)) nounwind, !dbg !996 ; [#uses=1 type=i32] [debug line = 48:105]
  %tmp.13 = zext i32 %i.2 to i64, !dbg !997       ; [#uses=2 type=i64] [debug line = 49:7]
  %col_inbuf.addr = getelementptr inbounds [8 x [8 x i16]]* %col_inbuf, i64 0, i64 %tmp.13, i64 0, !dbg !997 ; [#uses=1 type=i16*] [debug line = 49:7]
  %col_outbuf.addr = getelementptr inbounds [8 x [8 x i16]]* %col_outbuf, i64 0, i64 %tmp.13, i64 0, !dbg !997 ; [#uses=1 type=i16*] [debug line = 49:7]
  call fastcc void @dct_1d(i16* %col_inbuf.addr, i16* %col_outbuf.addr), !dbg !997 ; [debug line = 49:7]
  %rend = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([13 x i8]* @.str5, i64 0, i64 0), i32 %rbegin) nounwind, !dbg !998 ; [#uses=0 type=i32] [debug line = 50:4]
  %i.5 = add i32 %i.2, 1, !dbg !999               ; [#uses=1 type=i32] [debug line = 48:61]
  call void @llvm.dbg.value(metadata !{i32 %i.5}, i64 0, metadata !975), !dbg !999 ; [debug line = 48:61] [debug variable = i]
  br label %.preheader1, !dbg !999                ; [debug line = 48:61]

.preheader:                                       ; preds = %11, %.preheader.preheader
  %j.1 = phi i32 [ %j.3, %11 ], [ 0, %.preheader.preheader ] ; [#uses=3 type=i32]
  %exitcond3 = icmp eq i32 %j.1, 8, !dbg !992     ; [#uses=1 type=i1] [debug line = 53:9]
  br i1 %exitcond3, label %12, label %8, !dbg !992 ; [debug line = 53:9]

; <label>:8                                       ; preds = %.preheader
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([21 x i8]* @.str6, i64 0, i64 0)) nounwind, !dbg !1000 ; [debug line = 54:2]
  %rbegin3 = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([21 x i8]* @.str6, i64 0, i64 0)) nounwind, !dbg !1002 ; [#uses=1 type=i32] [debug line = 54:48]
  %tmp.18 = zext i32 %j.1 to i64, !dbg !1003      ; [#uses=2 type=i64] [debug line = 56:1]
  br label %9, !dbg !1006                         ; [debug line = 55:11]

; <label>:9                                       ; preds = %10, %8
  %i.3 = phi i32 [ 0, %8 ], [ %i.7, %10 ]         ; [#uses=3 type=i32]
  %exitcond = icmp eq i32 %i.3, 8, !dbg !1006     ; [#uses=1 type=i1] [debug line = 55:11]
  br i1 %exitcond, label %11, label %10, !dbg !1006 ; [debug line = 55:11]

; <label>:10                                      ; preds = %9
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([21 x i8]* @.str7, i64 0, i64 0)) nounwind, !dbg !1007 ; [debug line = 56:11]
  %rbegin4 = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([21 x i8]* @.str7, i64 0, i64 0)) nounwind, !dbg !1008 ; [#uses=1 type=i32] [debug line = 56:57]
  %tmp.20 = zext i32 %i.3 to i64, !dbg !1003      ; [#uses=2 type=i64] [debug line = 56:1]
  %col_outbuf.addr.1 = getelementptr inbounds [8 x [8 x i16]]* %col_outbuf, i64 0, i64 %tmp.20, i64 %tmp.18, !dbg !1003 ; [#uses=1 type=i16*] [debug line = 56:1]
  %col_outbuf.load = load i16* %col_outbuf.addr.1, align 2, !dbg !1003 ; [#uses=2 type=i16] [debug line = 56:1]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i16 %col_outbuf.load) nounwind
  %out_block.addr = getelementptr inbounds [8 x i16]* %out_block, i64 %tmp.18, i64 %tmp.20, !dbg !1003 ; [#uses=1 type=i16*] [debug line = 56:1]
  store i16 %col_outbuf.load, i16* %out_block.addr, align 2, !dbg !1003 ; [debug line = 56:1]
  %rend11 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([21 x i8]* @.str7, i64 0, i64 0), i32 %rbegin4) nounwind, !dbg !1009 ; [#uses=0 type=i32] [debug line = 56:36]
  %i.7 = add i32 %i.3, 1, !dbg !1010              ; [#uses=1 type=i32] [debug line = 55:63]
  call void @llvm.dbg.value(metadata !{i32 %i.7}, i64 0, metadata !975), !dbg !1010 ; [debug line = 55:63] [debug variable = i]
  br label %9, !dbg !1010                         ; [debug line = 55:63]

; <label>:11                                      ; preds = %9
  %rend13 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([21 x i8]* @.str6, i64 0, i64 0), i32 %rbegin3) nounwind, !dbg !1011 ; [#uses=0 type=i32] [debug line = 56:77]
  %j.3 = add i32 %j.1, 1, !dbg !1012              ; [#uses=1 type=i32] [debug line = 53:61]
  call void @llvm.dbg.value(metadata !{i32 %j.3}, i64 0, metadata !991), !dbg !1012 ; [debug line = 53:61] [debug variable = j]
  br label %.preheader, !dbg !1012                ; [debug line = 53:61]

; <label>:12                                      ; preds = %.preheader
  ret void, !dbg !1013                            ; [debug line = 57:1]
}

; [#uses=1]
define internal fastcc void @read_data(i16* %input, [8 x i16]* %buf) nounwind uwtable {
  call void @llvm.dbg.value(metadata !{i16* %input}, i64 0, metadata !1014), !dbg !1015 ; [debug line = 59:22] [debug variable = input]
  call void @llvm.dbg.value(metadata !{[8 x i16]* %buf}, i64 0, metadata !1016), !dbg !1017 ; [debug line = 59:44] [debug variable = buf]
  call void (...)* @_ssdm_SpecArrayDimSize(i16* %input, i32 64) nounwind, !dbg !1018 ; [debug line = 60:2]
  call void (...)* @_ssdm_SpecArrayDimSize([8 x i16]* %buf, i32 8) nounwind, !dbg !1020 ; [debug line = 60:40]
  br label %1, !dbg !1021                         ; [debug line = 64:9]

; <label>:1                                       ; preds = %5, %0
  %r = phi i32 [ 0, %0 ], [ %r.1, %5 ]            ; [#uses=4 type=i32]
  %exitcond1 = icmp eq i32 %r, 8, !dbg !1021      ; [#uses=1 type=i1] [debug line = 64:9]
  br i1 %exitcond1, label %6, label %2, !dbg !1021 ; [debug line = 64:9]

; <label>:2                                       ; preds = %1
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([12 x i8]* @.str8, i64 0, i64 0)) nounwind, !dbg !1023 ; [debug line = 64:67]
  %rbegin2 = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([12 x i8]* @.str8, i64 0, i64 0)) nounwind, !dbg !1025 ; [#uses=1 type=i32] [debug line = 64:104]
  %tmp = shl i32 %r, 3, !dbg !1026                ; [#uses=1 type=i32] [debug line = 67:1]
  %tmp.22 = sext i32 %r to i64, !dbg !1026        ; [#uses=1 type=i64] [debug line = 67:1]
  br label %3, !dbg !1029                         ; [debug line = 66:12]

; <label>:3                                       ; preds = %4, %2
  %c = phi i32 [ 0, %2 ], [ %c.1, %4 ]            ; [#uses=4 type=i32]
  %exitcond = icmp eq i32 %c, 8, !dbg !1029       ; [#uses=1 type=i1] [debug line = 66:12]
  br i1 %exitcond, label %5, label %4, !dbg !1029 ; [debug line = 66:12]

; <label>:4                                       ; preds = %3
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([12 x i8]* @.str9, i64 0, i64 0)) nounwind, !dbg !1030 ; [debug line = 67:11]
  %rbegin = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([12 x i8]* @.str9, i64 0, i64 0)) nounwind, !dbg !1031 ; [#uses=1 type=i32] [debug line = 67:48]
  %tmp.24 = add nsw i32 %c, %tmp, !dbg !1026      ; [#uses=1 type=i32] [debug line = 67:1]
  %tmp.25 = sext i32 %tmp.24 to i64, !dbg !1026   ; [#uses=1 type=i64] [debug line = 67:1]
  %input.addr = getelementptr inbounds i16* %input, i64 %tmp.25, !dbg !1026 ; [#uses=1 type=i16*] [debug line = 67:1]
  %input.load = load i16* %input.addr, align 2, !dbg !1026 ; [#uses=2 type=i16] [debug line = 67:1]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i16 %input.load) nounwind
  %tmp.26 = sext i32 %c to i64, !dbg !1026        ; [#uses=1 type=i64] [debug line = 67:1]
  %buf.addr = getelementptr inbounds [8 x i16]* %buf, i64 %tmp.22, i64 %tmp.26, !dbg !1026 ; [#uses=1 type=i16*] [debug line = 67:1]
  store i16 %input.load, i16* %buf.addr, align 2, !dbg !1026 ; [debug line = 67:1]
  %rend = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([12 x i8]* @.str9, i64 0, i64 0), i32 %rbegin) nounwind, !dbg !1032 ; [#uses=0 type=i32] [debug line = 67:68]
  %c.1 = add nsw i32 %c, 1, !dbg !1033            ; [#uses=1 type=i32] [debug line = 66:64]
  call void @llvm.dbg.value(metadata !{i32 %c.1}, i64 0, metadata !1034), !dbg !1033 ; [debug line = 66:64] [debug variable = c]
  br label %3, !dbg !1033                         ; [debug line = 66:64]

; <label>:5                                       ; preds = %3
  %rend3 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([12 x i8]* @.str8, i64 0, i64 0), i32 %rbegin2) nounwind, !dbg !1035 ; [#uses=0 type=i32] [debug line = 68:4]
  %r.1 = add nsw i32 %r, 1, !dbg !1036            ; [#uses=1 type=i32] [debug line = 64:61]
  call void @llvm.dbg.value(metadata !{i32 %r.1}, i64 0, metadata !1037), !dbg !1036 ; [debug line = 64:61] [debug variable = r]
  br label %1, !dbg !1036                         ; [debug line = 64:61]

; <label>:6                                       ; preds = %1
  ret void, !dbg !1038                            ; [debug line = 69:1]
}

; [#uses=1]
define internal fastcc void @write_data([8 x i16]* %buf, i16* %output) nounwind uwtable {
  call void @llvm.dbg.value(metadata !{[8 x i16]* %buf}, i64 0, metadata !1039), !dbg !1040 ; [debug line = 71:23] [debug variable = buf]
  call void @llvm.dbg.value(metadata !{i16* %output}, i64 0, metadata !1041), !dbg !1042 ; [debug line = 71:116] [debug variable = output]
  call void (...)* @_ssdm_SpecArrayDimSize(i16* %output, i32 64) nounwind, !dbg !1043 ; [debug line = 72:2]
  call void (...)* @_ssdm_SpecArrayDimSize([8 x i16]* %buf, i32 8) nounwind, !dbg !1045 ; [debug line = 72:41]
  br label %1, !dbg !1046                         ; [debug line = 76:9]

; <label>:1                                       ; preds = %5, %0
  %r = phi i32 [ 0, %0 ], [ %r.2, %5 ]            ; [#uses=4 type=i32]
  %exitcond1 = icmp eq i32 %r, 8, !dbg !1046      ; [#uses=1 type=i1] [debug line = 76:9]
  br i1 %exitcond1, label %6, label %2, !dbg !1046 ; [debug line = 76:9]

; <label>:2                                       ; preds = %1
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([12 x i8]* @.str10, i64 0, i64 0)) nounwind, !dbg !1048 ; [debug line = 76:67]
  %rbegin2 = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([12 x i8]* @.str10, i64 0, i64 0)) nounwind, !dbg !1050 ; [#uses=1 type=i32] [debug line = 76:104]
  %tmp = sext i32 %r to i64, !dbg !1051           ; [#uses=1 type=i64] [debug line = 79:1]
  %tmp.28 = shl i32 %r, 3, !dbg !1051             ; [#uses=1 type=i32] [debug line = 79:1]
  br label %3, !dbg !1054                         ; [debug line = 78:12]

; <label>:3                                       ; preds = %4, %2
  %c = phi i32 [ 0, %2 ], [ %c.2, %4 ]            ; [#uses=4 type=i32]
  %exitcond = icmp eq i32 %c, 8, !dbg !1054       ; [#uses=1 type=i1] [debug line = 78:12]
  br i1 %exitcond, label %5, label %4, !dbg !1054 ; [debug line = 78:12]

; <label>:4                                       ; preds = %3
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([12 x i8]* @.str11, i64 0, i64 0)) nounwind, !dbg !1055 ; [debug line = 79:11]
  %rbegin = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([12 x i8]* @.str11, i64 0, i64 0)) nounwind, !dbg !1056 ; [#uses=1 type=i32] [debug line = 79:48]
  %tmp.30 = sext i32 %c to i64, !dbg !1051        ; [#uses=1 type=i64] [debug line = 79:1]
  %buf.addr = getelementptr inbounds [8 x i16]* %buf, i64 %tmp, i64 %tmp.30, !dbg !1051 ; [#uses=1 type=i16*] [debug line = 79:1]
  %buf.load = load i16* %buf.addr, align 2, !dbg !1051 ; [#uses=2 type=i16] [debug line = 79:1]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i16 %buf.load) nounwind
  %tmp.31 = add nsw i32 %c, %tmp.28, !dbg !1051   ; [#uses=1 type=i32] [debug line = 79:1]
  %tmp.32 = sext i32 %tmp.31 to i64, !dbg !1051   ; [#uses=1 type=i64] [debug line = 79:1]
  %output.addr = getelementptr inbounds i16* %output, i64 %tmp.32, !dbg !1051 ; [#uses=1 type=i16*] [debug line = 79:1]
  store i16 %buf.load, i16* %output.addr, align 2, !dbg !1051 ; [debug line = 79:1]
  %rend = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([12 x i8]* @.str11, i64 0, i64 0), i32 %rbegin) nounwind, !dbg !1057 ; [#uses=0 type=i32] [debug line = 79:69]
  %c.2 = add nsw i32 %c, 1, !dbg !1058            ; [#uses=1 type=i32] [debug line = 78:64]
  call void @llvm.dbg.value(metadata !{i32 %c.2}, i64 0, metadata !1059), !dbg !1058 ; [debug line = 78:64] [debug variable = c]
  br label %3, !dbg !1058                         ; [debug line = 78:64]

; <label>:5                                       ; preds = %3
  %rend3 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([12 x i8]* @.str10, i64 0, i64 0), i32 %rbegin2) nounwind, !dbg !1060 ; [#uses=0 type=i32] [debug line = 80:4]
  %r.2 = add nsw i32 %r, 1, !dbg !1061            ; [#uses=1 type=i32] [debug line = 76:61]
  call void @llvm.dbg.value(metadata !{i32 %r.2}, i64 0, metadata !1062), !dbg !1061 ; [debug line = 76:61] [debug variable = r]
  br label %1, !dbg !1061                         ; [debug line = 76:61]

; <label>:6                                       ; preds = %1
  ret void, !dbg !1063                            ; [debug line = 81:1]
}
...
define void @dct(i16* %input, i16* %output) nounwind uwtable {
  ...
  call void @llvm.dbg.value(metadata !{i16* %input}, i64 0, metadata !1064), !dbg !1065 ; [debug line = 83:16] [debug variable = input]
  call void @llvm.dbg.value(metadata !{i16* %output}, i64 0, metadata !1066), !dbg !1067 ; [debug line = 83:38] [debug variable = output]
  call void (...)* @_ssdm_SpecArrayDimSize(i16* %input, i32 64) nounwind, !dbg !1068 ; [debug line = 84:2]
  call void (...)* @_ssdm_SpecArrayDimSize(i16* %output, i32 64) nounwind, !dbg !1070 ; [debug line = 84:40]
  call void @llvm.dbg.declare(metadata !{[8 x [8 x i16]]* %buf_2d_in}, metadata !1071), !dbg !1073 ; [debug line = 85:10] [debug variable = buf_2d_in]
  call void @llvm.dbg.declare(metadata !{[8 x [8 x i16]]* %buf_2d_out}, metadata !1074), !dbg !1075 ; [debug line = 86:10] [debug variable = buf_2d_out]
  %buf_2d_in.addr = getelementptr inbounds [8 x [8 x i16]]* %buf_2d_in, i64 0, i64 0, !dbg !1076 ; [#uses=2 type=[8 x i16]*] [debug line = 89:4]
  call fastcc void @read_data(i16* %input, [8 x i16]* %buf_2d_in.addr), !dbg !1076 ; [debug line = 89:4]
  %buf_2d_out.addr = getelementptr inbounds [8 x [8 x i16]]* %buf_2d_out, i64 0, i64 0, !dbg !1077 ; [#uses=2 type=[8 x i16]*] [debug line = 91:4]
  call fastcc void @dct_2d([8 x i16]* %buf_2d_in.addr, [8 x i16]* %buf_2d_out.addr), !dbg !1077 ; [debug line = 91:4]
  call fastcc void @write_data([8 x i16]* %buf_2d_out.addr, i16* %output), !dbg !1078 ; [debug line = 94:4]
  ret void, !dbg !1079                            ; [debug line = 95:1]
}
...
!939 = metadata !{i32 786688, metadata !934, metadata !"coeff", metadata !833, i32 21, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!940 = metadata !{i32 22, i32 10, metadata !934, null}
!941 = metadata !{i32 786688, metadata !926, metadata !"tmp", metadata !833, i32 12, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!942 = metadata !{i32 23, i32 7, metadata !934, null}
!943 = metadata !{i32 20, i32 72, metadata !935, null}
!944 = metadata !{i32 786688, metadata !926, metadata !"n", metadata !833, i32 11, metadata !945, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!945 = metadata !{i32 786468, null, metadata !"unsigned int", null, i32 0, i64 32, i64 32, i64 0, i32 0, i32 7} ; [ DW_TAG_base_type ]
!946 = metadata !{i32 24, i32 7, metadata !931, null}
!947 = metadata !{i32 25, i32 4, metadata !931, null}
!948 = metadata !{i32 18, i32 61, metadata !929, null}
!949 = metadata !{i32 786688, metadata !926, metadata !"k", metadata !833, i32 11, metadata !945, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!950 = metadata !{i32 26, i32 1, metadata !926, null}
!951 = metadata !{i32 786689, metadata !839, metadata !"in_block", metadata !833, i32 16777244, metadata !842, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!952 = metadata !{i32 28, i32 24, metadata !839, null}
!953 = metadata !{i32 786689, metadata !839, metadata !"out_block", metadata !833, i32 33554461, metadata !842, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!954 = metadata !{i32 29, i32 18, metadata !839, null}
!955 = metadata !{i32 30, i32 2, metadata !956, null}
!956 = metadata !{i32 786443, metadata !839, i32 30, i32 1, metadata !833, i32 5} ; [ DW_TAG_lexical_block ]
!957 = metadata !{i32 30, i32 38, metadata !956, null}
!958 = metadata !{i32 786688, metadata !956, metadata !"row_outbuf", metadata !833, i32 31, metadata !959, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!959 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 1024, i64 16, i32 0, i32 0, metadata !837, metadata !920, i32 0, i32 0} ; [ DW_TAG_array_type ]
!960 = metadata !{i32 31, i32 15, metadata !956, null}
!961 = metadata !{i32 786688, metadata !956, metadata !"col_outbuf", metadata !833, i32 32, metadata !959, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!962 = metadata !{i32 32, i32 15, metadata !956, null}
!963 = metadata !{i32 786688, metadata !956, metadata !"col_inbuf", metadata !833, i32 32, metadata !959, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!964 = metadata !{i32 32, i32 109, metadata !956, null}
!965 = metadata !{i32 37, i32 8, metadata !966, null}
!966 = metadata !{i32 786443, metadata !956, i32 37, i32 4, metadata !833, i32 6} ; [ DW_TAG_lexical_block ]
!967 = metadata !{i32 42, i32 9, metadata !968, null}
!968 = metadata !{i32 786443, metadata !956, i32 42, i32 4, metadata !833, i32 8} ; [ DW_TAG_lexical_block ]
!969 = metadata !{i32 37, i32 66, metadata !970, null}
!970 = metadata !{i32 786443, metadata !966, i32 37, i32 65, metadata !833, i32 7} ; [ DW_TAG_lexical_block ]
!971 = metadata !{i32 37, i32 104, metadata !970, null}
!972 = metadata !{i32 38, i32 7, metadata !970, null}
!973 = metadata !{i32 39, i32 4, metadata !970, null}
!974 = metadata !{i32 37, i32 60, metadata !966, null}
!975 = metadata !{i32 786688, metadata !956, metadata !"i", metadata !833, i32 33, metadata !945, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!976 = metadata !{i32 48, i32 9, metadata !977, null}
!977 = metadata !{i32 786443, metadata !956, i32 48, i32 4, metadata !833, i32 12} ; [ DW_TAG_lexical_block ]
!978 = metadata !{i32 43, i32 2, metadata !979, null}
!979 = metadata !{i32 786443, metadata !968, i32 43, i32 1, metadata !833, i32 9} ; [ DW_TAG_lexical_block ]
!980 = metadata !{i32 43, i32 48, metadata !979, null}
!981 = metadata !{i32 45, i32 1, metadata !982, null}
!982 = metadata !{i32 786443, metadata !983, i32 45, i32 10, metadata !833, i32 11} ; [ DW_TAG_lexical_block ]
!983 = metadata !{i32 786443, metadata !979, i32 44, i32 7, metadata !833, i32 10} ; [ DW_TAG_lexical_block ]
!984 = metadata !{i32 44, i32 11, metadata !983, null}
!985 = metadata !{i32 45, i32 11, metadata !982, null}
!986 = metadata !{i32 45, i32 57, metadata !982, null}
!987 = metadata !{i32 45, i32 36, metadata !982, null}
!988 = metadata !{i32 44, i32 63, metadata !983, null}
!989 = metadata !{i32 45, i32 77, metadata !979, null}
!990 = metadata !{i32 42, i32 61, metadata !968, null}
!991 = metadata !{i32 786688, metadata !956, metadata !"j", metadata !833, i32 33, metadata !945, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!992 = metadata !{i32 53, i32 9, metadata !993, null}
!993 = metadata !{i32 786443, metadata !956, i32 53, i32 4, metadata !833, i32 14} ; [ DW_TAG_lexical_block ]
!994 = metadata !{i32 48, i32 67, metadata !995, null}
!995 = metadata !{i32 786443, metadata !977, i32 48, i32 66, metadata !833, i32 13} ; [ DW_TAG_lexical_block ]
!996 = metadata !{i32 48, i32 105, metadata !995, null}
!997 = metadata !{i32 49, i32 7, metadata !995, null}
!998 = metadata !{i32 50, i32 4, metadata !995, null}
!999 = metadata !{i32 48, i32 61, metadata !977, null}
!1000 = metadata !{i32 54, i32 2, metadata !1001, null}
!1001 = metadata !{i32 786443, metadata !993, i32 54, i32 1, metadata !833, i32 15} ; [ DW_TAG_lexical_block ]
!1002 = metadata !{i32 54, i32 48, metadata !1001, null}
!1003 = metadata !{i32 56, i32 1, metadata !1004, null}
!1004 = metadata !{i32 786443, metadata !1005, i32 56, i32 10, metadata !833, i32 17} ; [ DW_TAG_lexical_block ]
!1005 = metadata !{i32 786443, metadata !1001, i32 55, i32 7, metadata !833, i32 16} ; [ DW_TAG_lexical_block ]
!1006 = metadata !{i32 55, i32 11, metadata !1005, null}
!1007 = metadata !{i32 56, i32 11, metadata !1004, null}
!1008 = metadata !{i32 56, i32 57, metadata !1004, null}
!1009 = metadata !{i32 56, i32 36, metadata !1004, null}
!1010 = metadata !{i32 55, i32 63, metadata !1005, null}
!1011 = metadata !{i32 56, i32 77, metadata !1001, null}
!1012 = metadata !{i32 53, i32 61, metadata !993, null}
!1013 = metadata !{i32 57, i32 1, metadata !956, null}
!1014 = metadata !{i32 786689, metadata !844, metadata !"input", metadata !833, i32 16777275, metadata !847, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!1015 = metadata !{i32 59, i32 22, metadata !844, null}
!1016 = metadata !{i32 786689, metadata !844, metadata !"buf", metadata !833, i32 33554491, metadata !848, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!1017 = metadata !{i32 59, i32 44, metadata !844, null}
!1018 = metadata !{i32 60, i32 2, metadata !1019, null}
!1019 = metadata !{i32 786443, metadata !844, i32 60, i32 1, metadata !833, i32 18} ; [ DW_TAG_lexical_block ]
!1020 = metadata !{i32 60, i32 40, metadata !1019, null}
!1021 = metadata !{i32 64, i32 9, metadata !1022, null}
!1022 = metadata !{i32 786443, metadata !1019, i32 64, i32 4, metadata !833, i32 19} ; [ DW_TAG_lexical_block ]
!1023 = metadata !{i32 64, i32 67, metadata !1024, null}
!1024 = metadata !{i32 786443, metadata !1022, i32 64, i32 66, metadata !833, i32 20} ; [ DW_TAG_lexical_block ]
!1025 = metadata !{i32 64, i32 104, metadata !1024, null}
!1026 = metadata !{i32 67, i32 1, metadata !1027, null}
!1027 = metadata !{i32 786443, metadata !1028, i32 67, i32 10, metadata !833, i32 22} ; [ DW_TAG_lexical_block ]
!1028 = metadata !{i32 786443, metadata !1024, i32 66, i32 7, metadata !833, i32 21} ; [ DW_TAG_lexical_block ]
!1029 = metadata !{i32 66, i32 12, metadata !1028, null}
!1030 = metadata !{i32 67, i32 11, metadata !1027, null}
!1031 = metadata !{i32 67, i32 48, metadata !1027, null}
!1032 = metadata !{i32 67, i32 68, metadata !1027, null}
!1033 = metadata !{i32 66, i32 64, metadata !1028, null}
!1034 = metadata !{i32 786688, metadata !1019, metadata !"c", metadata !833, i32 61, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!1035 = metadata !{i32 68, i32 4, metadata !1024, null}
!1036 = metadata !{i32 64, i32 61, metadata !1022, null}
!1037 = metadata !{i32 786688, metadata !1019, metadata !"r", metadata !833, i32 61, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!1038 = metadata !{i32 69, i32 1, metadata !1019, null}
!1039 = metadata !{i32 786689, metadata !850, metadata !"buf", metadata !833, i32 16777287, metadata !848, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!1040 = metadata !{i32 71, i32 23, metadata !850, null}
!1041 = metadata !{i32 786689, metadata !850, metadata !"output", metadata !833, i32 33554503, metadata !847, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!1042 = metadata !{i32 71, i32 116, metadata !850, null}
!1043 = metadata !{i32 72, i32 2, metadata !1044, null}
!1044 = metadata !{i32 786443, metadata !850, i32 72, i32 1, metadata !833, i32 23} ; [ DW_TAG_lexical_block ]
!1045 = metadata !{i32 72, i32 41, metadata !1044, null}
!1046 = metadata !{i32 76, i32 9, metadata !1047, null}
!1047 = metadata !{i32 786443, metadata !1044, i32 76, i32 4, metadata !833, i32 24} ; [ DW_TAG_lexical_block ]
!1048 = metadata !{i32 76, i32 67, metadata !1049, null}
!1049 = metadata !{i32 786443, metadata !1047, i32 76, i32 66, metadata !833, i32 25} ; [ DW_TAG_lexical_block ]
!1050 = metadata !{i32 76, i32 104, metadata !1049, null}
!1051 = metadata !{i32 79, i32 1, metadata !1052, null}
!1052 = metadata !{i32 786443, metadata !1053, i32 79, i32 10, metadata !833, i32 27} ; [ DW_TAG_lexical_block ]
!1053 = metadata !{i32 786443, metadata !1049, i32 78, i32 7, metadata !833, i32 26} ; [ DW_TAG_lexical_block ]
!1054 = metadata !{i32 78, i32 12, metadata !1053, null}
!1055 = metadata !{i32 79, i32 11, metadata !1052, null}
!1056 = metadata !{i32 79, i32 48, metadata !1052, null}
!1057 = metadata !{i32 79, i32 69, metadata !1052, null}
!1058 = metadata !{i32 78, i32 64, metadata !1053, null}
!1059 = metadata !{i32 786688, metadata !1044, metadata !"c", metadata !833, i32 73, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!1060 = metadata !{i32 80, i32 4, metadata !1049, null}
!1061 = metadata !{i32 76, i32 61, metadata !1047, null}
!1062 = metadata !{i32 786688, metadata !1044, metadata !"r", metadata !833, i32 73, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!1063 = metadata !{i32 81, i32 1, metadata !1044, null}
!1064 = metadata !{i32 786689, metadata !853, metadata !"input", metadata !833, i32 16777299, metadata !847, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!1065 = metadata !{i32 83, i32 16, metadata !853, null}
!1066 = metadata !{i32 786689, metadata !853, metadata !"output", metadata !833, i32 33554515, metadata !847, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!1067 = metadata !{i32 83, i32 38, metadata !853, null}
!1068 = metadata !{i32 84, i32 2, metadata !1069, null}
!1069 = metadata !{i32 786443, metadata !853, i32 84, i32 1, metadata !833, i32 28} ; [ DW_TAG_lexical_block ]
!1070 = metadata !{i32 84, i32 40, metadata !1069, null}
!1071 = metadata !{i32 786688, metadata !1069, metadata !"buf_2d_in", metadata !833, i32 85, metadata !1072, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!1072 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 1024, i64 16, i32 0, i32 0, metadata !838, metadata !920, i32 0, i32 0} ; [ DW_TAG_array_type ]
!1073 = metadata !{i32 85, i32 10, metadata !1069, null}
!1074 = metadata !{i32 786688, metadata !1069, metadata !"buf_2d_out", metadata !833, i32 86, metadata !1072, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!1075 = metadata !{i32 86, i32 10, metadata !1069, null}
!1076 = metadata !{i32 89, i32 4, metadata !1069, null}
!1077 = metadata !{i32 91, i32 4, metadata !1069, null}
!1078 = metadata !{i32 94, i32 4, metadata !1069, null}
!1079 = metadata !{i32 95, i32 1, metadata !1069, null}
