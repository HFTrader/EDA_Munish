...
; <label>:3                                       ; preds = %4, %2
  ...
  %empty_15 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 8, i64 8, i64 8) nounwind
  %c = add i4 %c_i, 1
...
; <label>:4                                       ; preds = %3
  ...
  %tmp_2 = call i7 @_ssdm_op_BitConcatenate.i7.i4.i3(i4 %r_i, i3 0)
  %p_addr_cast = zext i7 %tmp_2 to i8
  %p_addr1 = add i8 %p_addr_cast, %tmp_7_i_trn_cast
  %tmp_3 = zext i8 %p_addr1 to i64
  %buf_2d_in_addr = getelementptr [64 x i16]* %buf_2d_in, i64 0, i64 %tmp_3
  store i16 %input_load, i16* %buf_2d_in_addr, align 2
  br label %3

; <label>:5                                       ; preds = %3
  %empty_16 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @p_str8, i32 %tmp_11_i) nounwind
  br label %1
...
; <label>:7                                       ; preds = %6
  ...
  %tmp_1 = trunc i4 %r_i2 to i3
  %tmp_i5 = call i6 @_ssdm_op_BitConcatenate.i6.i3.i3(i3 %tmp_1, i3 0)
  br label %8
...
; <label>:9                                       ; preds = %8
  ...
  %tmp_4 = call i7 @_ssdm_op_BitConcatenate.i7.i4.i3(i4 %r_i2, i3 0)
...
; <label>:10                                      ; preds = %8
  %empty_19 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @p_str10, i32 %tmp_1_i) nounwind
  br label %6
...
; <label>:1                                       ; preds = %2, %0
  ...
  %i_4 = add i4 %i, 1
  br i1 %exitcond7, label %.preheader2, label %2
...
; <label>:5                                       ; preds = %4
  ...
  %tmp = call i7 @_ssdm_op_BitConcatenate.i7.i4.i3(i4 %i_1, i3 0)
  %p_addr_cast = zext i7 %tmp to i8
  %p_addr1 = add i8 %p_addr_cast, %tmp_trn_cast
  %tmp_7 = zext i8 %p_addr1 to i64
  %row_outbuf_addr = getelementptr [64 x i16]* %row_outbuf, i64 0, i64 %tmp_7
  %row_outbuf_load = load i16* %row_outbuf_addr, align 2
  %tmp_9 = call i7 @_ssdm_op_BitConcatenate.i7.i4.i3(i4 %j, i3 0)
  %p_addr6_cast = zext i7 %tmp_9 to i8
  %p_addr7 = add i8 %p_addr6_cast, %tmp_2_trn_cast
  %tmp_s = zext i8 %p_addr7 to i64
  %col_inbuf_addr = getelementptr [64 x i16]* %col_inbuf, i64 0, i64 %tmp_s
  store i16 %row_outbuf_load, i16* %col_inbuf_addr, align 2
  br label %4

; <label>:6                                       ; preds = %4
  %empty_22 = call i32 (...)* @_ssdm_op_SpecRegionEnd([21 x i8]* @p_str3, i32 %tmp_6)
  br label %.preheader2

.preheader1:                                      ; preds = %.preheader2, %7
  %i_2 = phi i4 [ %i_5, %7 ], [ 0, %.preheader2 ]
  %exitcond4 = icmp eq i4 %i_2, -8
  %empty_23 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 8, i64 8, i64 8)
  %i_5 = add i4 %i_2, 1
  br i1 %exitcond4, label %.preheader, label %7
...
.preheader:                                       ; preds = %.preheader1, %11
  %j_1 = phi i4 [ %j_3, %11 ], [ 0, %.preheader1 ]
  %exitcond3 = icmp eq i4 %j_1, -8
  %empty_24 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 8, i64 8, i64 8)
  %j_3 = add i4 %j_1, 1
  br i1 %exitcond3, label %12, label %8
...
; <label>:10                                      ; preds = %9
  ...
  %tmp_1 = call i7 @_ssdm_op_BitConcatenate.i7.i4.i3(i4 %i_3, i3 0)
  %p_addr2_cast = zext i7 %tmp_1 to i8
  %p_addr3 = add i8 %p_addr2_cast, %tmp_3_trn_cast
  %tmp_2 = zext i8 %p_addr3 to i64
  %col_outbuf_addr = getelementptr [64 x i16]* %col_outbuf, i64 0, i64 %tmp_2
  %col_outbuf_load = load i16* %col_outbuf_addr, align 2
  %tmp_3 = call i7 @_ssdm_op_BitConcatenate.i7.i4.i3(i4 %j_1, i3 0)
  %p_addr4_cast = zext i7 %tmp_3 to i8
...
; <label>:11                                      ; preds = %9
  %empty_26 = call i32 (...)* @_ssdm_op_SpecRegionEnd([21 x i8]* @p_str6, i32 %tmp_8)
  br label %.preheader
...
; <label>:4                                       ; preds = %3
  ...
  %tmp_9 = zext i8 %dct_coeff_table_addr7 to i64
  %dct_coeff_table_addr = getelementptr [64 x i15]* @dct_coeff_table, i64 0, i64 %tmp_9
  %dct_coeff_table_load = load i15* %dct_coeff_table_addr, align 2
  %coeff_cast = sext i15 %dct_coeff_table_load to i31
  %tmp_10 = call i7 @_ssdm_op_BitConcatenate.i7.i4.i3(i4 %tmp_1_read, i3 0)
  %p_addr_cast = zext i7 %tmp_10 to i8
...
; <label>:5                                       ; preds = %3
  ...
  %tmp_6 = zext i8 %p_addr3 to i64
  %dst_addr = getelementptr [64 x i16]* %dst, i64 0, i64 %tmp_6
  store i16 %tmp_4, i16* %dst_addr, align 2
  %empty_28 = call i32 (...)* @_ssdm_op_SpecRegionEnd([15 x i8]* @p_str, i32 %tmp_s) nounwind
  br label %1
...
entry:
  ...
  %empty_29 = zext i3 %1 to i6
  %empty_30 = trunc i6 %empty to i3
  %empty_31 = call i3 @_ssdm_op_PartSelect.i3.i6.i32.i32(i6 %empty_29, i32 3, i32 5)
  %empty_32 = or i3 %empty_30, %empty_31
  %empty_33 = call i6 @_ssdm_op_PartSet.i6.i6.i3.i32.i32(i6 %empty_29, i3 %empty_32, i32 3, i32 5)
  ret i6 %empty_33
}
...
entry:
  ...
  %empty_36 = call i4 @_ssdm_op_PartSelect.i4.i7.i32.i32(i7 %empty_34, i32 3, i32 6)
  %empty_37 = or i4 %empty_35, %empty_36
  %empty_38 = call i7 @_ssdm_op_PartSet.i7.i7.i4.i32.i32(i7 %empty_34, i4 %empty_37, i32 3, i32 6)
  ret i7 %empty_38
}
...
entry:
  ...
  %empty_39 = trunc i29 %empty to i16
  ret i16 %empty_39
}
