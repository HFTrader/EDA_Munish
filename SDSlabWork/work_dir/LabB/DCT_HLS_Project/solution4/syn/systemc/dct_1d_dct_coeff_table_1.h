...
#ifndef _dct_1d_dct_coeff_table_1_H_
#define _dct_1d_dct_coeff_table_1_H_
...
struct dct_1d_dct_coeff_table_1_core : public sc_core::sc_module
{
public:
    ...
    SC_HAS_PROCESS(dct_1d_dct_coeff_table_1_core);
    dct_1d_dct_coeff_table_1_core(sc_core::sc_module_name) {
...
SC_MODULE( dct_1d_dct_coeff_table_1 )
{
    ...
    SC_CTOR( dct_1d_dct_coeff_table_1 ) {
        meminst = new dct_1d_dct_coeff_table_1_core <1, 1, DataWidth, AddressWidth, AddressRange>("core_inst");
...
public:
    ...
    dct_1d_dct_coeff_table_1_core <1, 1, DataWidth, AddressWidth, AddressRange>* meminst;
};

#endif //_dct_1d_dct_coeff_table_1_H_
