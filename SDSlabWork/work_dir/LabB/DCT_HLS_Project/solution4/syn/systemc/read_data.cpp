...
read_data::read_data(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    sensitive << ( tmp_7_trn_cast_fu_175_p1 );
    ...
    SC_METHOD(thread_tmp_5_fu_164_p2);
    sensitive << ( tmp_fu_153_p3 );
    sensitive << ( c_cast6_fu_161_p1 );

    SC_METHOD(thread_tmp_6_fu_170_p1);
    sensitive << ( tmp_5_fu_164_p2 );

    SC_METHOD(thread_tmp_7_trn_cast_fu_175_p1);
    ...
    sc_trace(mVcdFile, tmp_7_trn_cast_fu_175_p1, "tmp_7_trn_cast_fu_175_p1");
...
void read_data::thread_buf_r_address0() {
    buf_r_address0 =  (sc_lv<6>) (tmp_4_fu_195_p1.read());
}
...
void read_data::thread_input_r_address0() {
    input_r_address0 =  (sc_lv<6>) (tmp_6_fu_170_p1.read());
}
...
void read_data::thread_p_addr1_fu_189_p2() {
    p_addr1_fu_189_p2 = (!p_addr_cast_fu_185_p1.read().is_01() || !tmp_7_trn_cast_fu_175_p1.read().is_01())? sc_lv<8>(): (sc_bigint<8>(p_addr_cast_fu_185_p1.read()) + sc_biguint<8>(tmp_7_trn_cast_fu_175_p1.read()));
}

void read_data::thread_p_addr_cast_fu_185_p1() {
    p_addr_cast_fu_185_p1 = esl_zext<8,7>(tmp_s_fu_178_p3.read());
}
...
void read_data::thread_tmp_1_fu_149_p1() {
    tmp_1_fu_149_p1 = r_mid2_fu_142_p3.read().range(3-1, 0);
}

void read_data::thread_tmp_4_fu_195_p1() {
    tmp_4_fu_195_p1 = esl_zext<64,8>(p_addr1_fu_189_p2.read());
}

void read_data::thread_tmp_5_fu_164_p2() {
    tmp_5_fu_164_p2 = (!tmp_fu_153_p3.read().is_01() || !c_cast6_fu_161_p1.read().is_01())? sc_lv<6>(): (sc_bigint<6>(tmp_fu_153_p3.read()) + sc_biguint<6>(c_cast6_fu_161_p1.read()));
}

void read_data::thread_tmp_6_fu_170_p1() {
    tmp_6_fu_170_p1 = esl_zext<64,6>(tmp_5_fu_164_p2.read());
}

void read_data::thread_tmp_7_trn_cast_fu_175_p1() {
    tmp_7_trn_cast_fu_175_p1 = esl_zext<8,4>(ap_reg_ppstg_c_mid2_reg_214_pp0_it1.read());
}

void read_data::thread_tmp_fu_153_p3() {
    tmp_fu_153_p3 = esl_concat<3,3>(tmp_1_fu_149_p1.read(), ap_const_lv3_0);
}

void read_data::thread_tmp_s_fu_178_p3() {
    tmp_s_fu_178_p3 = esl_concat<4,3>(r_mid2_reg_225.read(), ap_const_lv3_0);
}
