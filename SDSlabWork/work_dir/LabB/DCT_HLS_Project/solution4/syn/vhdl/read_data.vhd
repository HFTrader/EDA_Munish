...
begin
    ...
    buf_r_address0 <= tmp_4_fu_195_p1(6 - 1 downto 0);
    ...
    input_r_address0 <= tmp_6_fu_170_p1(6 - 1 downto 0);
    ...
    p_addr1_fu_189_p2 <= std_logic_vector(unsigned(p_addr_cast_fu_185_p1) + unsigned(tmp_7_trn_cast_fu_175_p1));
    p_addr_cast_fu_185_p1 <= std_logic_vector(resize(unsigned(tmp_s_fu_178_p3),8));
    r_mid2_fu_142_p3 <= 
    ...
    tmp_1_fu_149_p1 <= r_mid2_fu_142_p3(3 - 1 downto 0);
    tmp_4_fu_195_p1 <= std_logic_vector(resize(unsigned(p_addr1_fu_189_p2),64));
    tmp_5_fu_164_p2 <= std_logic_vector(unsigned(tmp_fu_153_p3) + unsigned(c_cast6_fu_161_p1));
    tmp_6_fu_170_p1 <= std_logic_vector(resize(unsigned(tmp_5_fu_164_p2),64));
    tmp_7_trn_cast_fu_175_p1 <= std_logic_vector(resize(unsigned(ap_reg_ppstg_c_mid2_reg_214_pp0_it1),8));
    tmp_fu_153_p3 <= (tmp_1_fu_149_p1 & ap_const_lv3_0);
    tmp_s_fu_178_p3 <= (r_mid2_reg_225 & ap_const_lv3_0);
end behav;
