...
architecture behav of dct is 
    ...
    "dct,hls_ip_2013_3,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg484-1,HLS_INPUT_CLOCK=8.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=6.380000,HLS_SYN_LAT=895,HLS_SYN_TPT=760,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=0,HLS_SYN_LUT=0}";
    ...
    signal dct_2d_U0_in_block_address0 : STD_LOGIC_VECTOR (5 downto 0);
    signal dct_2d_U0_in_block_ce0 : STD_LOGIC;
    signal dct_2d_U0_in_block_q0 : STD_LOGIC_VECTOR (15 downto 0);
    signal dct_2d_U0_in_block_address1 : STD_LOGIC_VECTOR (5 downto 0);
    signal dct_2d_U0_in_block_ce1 : STD_LOGIC;
    signal dct_2d_U0_in_block_q1 : STD_LOGIC_VECTOR (15 downto 0);
    ...
    signal ap_chn_write_dct_2d_U0_buf_2d_out : STD_LOGIC;
    signal dct_2d_U0_out_block_pipo_status : STD_LOGIC;
    ...
    signal ap_reg_procdone_dct_2d_U0 : STD_LOGIC := '0';
...
begin
    ...
    ap_reg_procdone_dct_2d_U0_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((ap_const_logic_1 = ap_sig_hs_done)) then 
                    ap_reg_procdone_dct_2d_U0 <= ap_const_logic_0;
                elsif ((ap_const_logic_1 = dct_2d_U0_ap_done)) then 
    ...
    ap_chn_write_dct_2d_U0_buf_2d_out <= dct_2d_U0_ap_done;
    ap_chn_write_read_data_U0_buf_2d_in <= read_data_U0_ap_done;
    ap_done <= ap_sig_hs_done;

    -- ap_idle assign process. --
    ap_idle_assign_proc : process(read_data_U0_ap_idle, dct_2d_U0_ap_idle, write_data_U0_ap_idle, buf_2d_in_t_empty_n, buf_2d_out_t_empty_n)
    begin
        if (((read_data_U0_ap_idle = ap_const_logic_1) and (ap_const_logic_1 = dct_2d_U0_ap_idle) and (ap_const_logic_1 = write_data_U0_ap_idle) and (ap_const_logic_0 = buf_2d_in_t_empty_n) and (ap_const_logic_0 = buf_2d_out_t_empty_n))) then 
    ...
    buf_2d_in_t_address0 <= dct_2d_U0_in_block_address0;
    buf_2d_in_t_address1 <= dct_2d_U0_in_block_address1;
    buf_2d_in_t_ce0 <= dct_2d_U0_in_block_ce0;
    buf_2d_in_t_ce1 <= dct_2d_U0_in_block_ce1;
    buf_2d_in_t_read <= dct_2d_U0_ap_ready;
    buf_2d_out_U_ap_dummy_ce <= ap_const_logic_1;
    buf_2d_out_i_address0 <= dct_2d_U0_out_block_address0;
    buf_2d_out_i_ce0 <= dct_2d_U0_out_block_ce0;
    buf_2d_out_i_d0 <= dct_2d_U0_out_block_d0;
    buf_2d_out_i_we0 <= dct_2d_U0_out_block_we0;
    buf_2d_out_i_write <= dct_2d_U0_ap_done;
    ...
    dct_2d_U0_ap_continue <= dct_2d_U0_out_block_pipo_status;
    dct_2d_U0_ap_start <= buf_2d_in_t_empty_n;
    dct_2d_U0_in_block_q0 <= buf_2d_in_t_q0;
    dct_2d_U0_in_block_q1 <= buf_2d_in_t_q1;
    dct_2d_U0_out_block_pipo_status <= buf_2d_out_i_full_n;
    input_r_address0 <= read_data_U0_input_r_address0;
