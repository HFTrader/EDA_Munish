...
define void @dct([64 x i16]* %input, [64 x i16]* %output) nounwind uwtable {
  ...
  call fastcc void @read_data([64 x i16]* %input, [8 x [8 x i16]]* %buf_2d_in) nounwind, !dbg !933 ; [debug line = 89:4]
  call fastcc void @dct_2d([8 x [8 x i16]]* %buf_2d_in, [8 x [8 x i16]]* %buf_2d_out) nounwind, !dbg !934 ; [debug line = 91:4]
  call fastcc void @write_data([8 x [8 x i16]]* %buf_2d_out, [64 x i16]* %output) nounwind, !dbg !935 ; [debug line = 94:4]
  ret void, !dbg !936                             ; [debug line = 95:1]
}

; [#uses=1]
define internal fastcc void @write_data([8 x [8 x i16]]* nocapture %buf, [64 x i16]* nocapture %output) {
  call void @llvm.dbg.value(metadata !{[8 x [8 x i16]]* %buf}, i64 0, metadata !937), !dbg !943 ; [debug line = 71:23] [debug variable = buf]
  call void @llvm.dbg.value(metadata !{[64 x i16]* %output}, i64 0, metadata !944), !dbg !945 ; [debug line = 71:116] [debug variable = output]
  br label %1, !dbg !946                          ; [debug line = 76:9]

; <label>:1                                       ; preds = %8, %0
  %r = phi i4 [ 0, %0 ], [ %r.1, %8 ]             ; [#uses=4 type=i4]
  %r.cast7 = zext i4 %r to i6, !dbg !946          ; [#uses=1 type=i6] [debug line = 76:9]
  %exitcond1 = icmp eq i4 %r, -8, !dbg !946       ; [#uses=1 type=i1] [debug line = 76:9]
  %2 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 8, i64 8, i64 8) ; [#uses=0 type=i32]
  br i1 %exitcond1, label %10, label %3, !dbg !946 ; [debug line = 76:9]

; <label>:3                                       ; preds = %1
  call void (...)* @_ssdm_op_SpecLoopName([12 x i8]* @.str11) nounwind, !dbg !949 ; [debug line = 76:67]
  %tmp.1 = call i32 (...)* @_ssdm_op_SpecRegionBegin([12 x i8]* @.str11), !dbg !951 ; [#uses=1 type=i32] [debug line = 76:104]
  %tmp = zext i4 %r to i64, !dbg !952             ; [#uses=1 type=i64] [debug line = 79:1]
  %tmp. = shl i6 %r.cast7, 3, !dbg !952           ; [#uses=1 type=i6] [debug line = 79:1]
  br label %4, !dbg !955                          ; [debug line = 78:12]

; <label>:4                                       ; preds = %6, %3
  %c = phi i4 [ 0, %3 ], [ %c.1, %6 ]             ; [#uses=4 type=i4]
  %c.cast6 = zext i4 %c to i6, !dbg !955          ; [#uses=1 type=i6] [debug line = 78:12]
  %exitcond = icmp eq i4 %c, -8, !dbg !955        ; [#uses=1 type=i1] [debug line = 78:12]
  %5 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 8, i64 8, i64 8) ; [#uses=0 type=i32]
  br i1 %exitcond, label %8, label %6, !dbg !955  ; [debug line = 78:12]

; <label>:6                                       ; preds = %4
  call void (...)* @_ssdm_op_SpecLoopName([12 x i8]* @.str12) nounwind, !dbg !956 ; [debug line = 79:11]
  %tmp.2 = call i32 (...)* @_ssdm_op_SpecRegionBegin([12 x i8]* @.str12), !dbg !957 ; [#uses=1 type=i32] [debug line = 79:48]
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, [1 x i8]* @.str1) nounwind, !dbg !958 ; [debug line = 80:1]
  %tmp.8 = zext i4 %c to i64, !dbg !952           ; [#uses=1 type=i64] [debug line = 79:1]
  %buf.addr = getelementptr [8 x [8 x i16]]* %buf, i64 0, i64 %tmp, i64 %tmp.8, !dbg !952 ; [#uses=1 type=i16*] [debug line = 79:1]
  %buf.load = load i16* %buf.addr, align 2, !dbg !952 ; [#uses=1 type=i16] [debug line = 79:1]
  %tmp.9 = add i6 %tmp., %c.cast6, !dbg !952      ; [#uses=1 type=i6] [debug line = 79:1]
  %tmp.3 = zext i6 %tmp.9 to i64, !dbg !952       ; [#uses=1 type=i64] [debug line = 79:1]
  %output.addr = getelementptr [64 x i16]* %output, i64 0, i64 %tmp.3, !dbg !952 ; [#uses=1 type=i16*] [debug line = 79:1]
  store i16 %buf.load, i16* %output.addr, align 2, !dbg !952 ; [debug line = 79:1]
  %7 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @.str12, i32 %tmp.2), !dbg !959 ; [#uses=0 type=i32] [debug line = 79:69]
  %c.1 = add i4 %c, 1, !dbg !960                  ; [#uses=1 type=i4] [debug line = 78:64]
  call void @llvm.dbg.value(metadata !{i4 %c.1}, i64 0, metadata !961), !dbg !960 ; [debug line = 78:64] [debug variable = c]
  br label %4, !dbg !960                          ; [debug line = 78:64]

; <label>:8                                       ; preds = %4
  %9 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @.str11, i32 %tmp.1), !dbg !962 ; [#uses=0 type=i32] [debug line = 80:4]
  %r.1 = add i4 %r, 1, !dbg !963                  ; [#uses=1 type=i4] [debug line = 76:61]
  call void @llvm.dbg.value(metadata !{i4 %r.1}, i64 0, metadata !964), !dbg !963 ; [debug line = 76:61] [debug variable = r]
  br label %1, !dbg !963                          ; [debug line = 76:61]

; <label>:10                                      ; preds = %1
  ret void, !dbg !965                             ; [debug line = 81:1]
}
...
define internal fastcc void @dct_2d([8 x [8 x i16]]* nocapture %in_block, [8 x [8 x i16]]* nocapture %out_block) {
  ...
  call void @llvm.dbg.value(metadata !{[8 x [8 x i16]]* %in_block}, i64 0, metadata !966), !dbg !973 ; [debug line = 28:24] [debug variable = in_block]
  call void @llvm.dbg.value(metadata !{[8 x [8 x i16]]* %out_block}, i64 0, metadata !974), !dbg !975 ; [debug line = 29:18] [debug variable = out_block]
  call void @llvm.dbg.declare(metadata !{[8 x [8 x i16]]* %row_outbuf}, metadata !976), !dbg !978 ; [debug line = 31:15] [debug variable = row_outbuf]
  call void @llvm.dbg.declare(metadata !{[8 x [8 x i16]]* %col_outbuf}, metadata !979), !dbg !980 ; [debug line = 32:15] [debug variable = col_outbuf]
  call void @llvm.dbg.declare(metadata !{[8 x [8 x i16]]* %col_inbuf}, metadata !981), !dbg !982 ; [debug line = 32:109] [debug variable = col_inbuf]
  br label %1, !dbg !983                          ; [debug line = 37:8]

; <label>:1                                       ; preds = %3, %0
  %i = phi i4 [ 0, %0 ], [ %i.4, %3 ]             ; [#uses=4 type=i4]
  %exitcond7 = icmp eq i4 %i, -8, !dbg !983       ; [#uses=1 type=i1] [debug line = 37:8]
  %2 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 8, i64 8, i64 8) ; [#uses=0 type=i32]
  br i1 %exitcond7, label %.preheader2, label %3, !dbg !983 ; [debug line = 37:8]

; <label>:3                                       ; preds = %1
  call void (...)* @_ssdm_op_SpecLoopName([13 x i8]* @.str3) nounwind, !dbg !985 ; [debug line = 37:66]
  call fastcc void @dct_1d([8 x [8 x i16]]* %in_block, i4 %i, [8 x [8 x i16]]* %row_outbuf, i4 %i), !dbg !987 ; [debug line = 38:7]
  %i.4 = add i4 %i, 1, !dbg !988                  ; [#uses=1 type=i4] [debug line = 37:60]
  call void @llvm.dbg.value(metadata !{i4 %i.4}, i64 0, metadata !989), !dbg !988 ; [debug line = 37:60] [debug variable = i]
  br label %1, !dbg !988                          ; [debug line = 37:60]

.preheader2:                                      ; preds = %10, %1
  %j = phi i4 [ %j.2, %10 ], [ 0, %1 ]            ; [#uses=3 type=i4]
  %exitcond6 = icmp eq i4 %j, -8, !dbg !991       ; [#uses=1 type=i1] [debug line = 42:9]
  %4 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 8, i64 8, i64 8) ; [#uses=0 type=i32]
  br i1 %exitcond6, label %.preheader1, label %5, !dbg !991 ; [debug line = 42:9]

; <label>:5                                       ; preds = %.preheader2
  call void (...)* @_ssdm_op_SpecLoopName([21 x i8]* @.str4) nounwind, !dbg !993 ; [debug line = 43:2]
  %tmp.6 = call i32 (...)* @_ssdm_op_SpecRegionBegin([21 x i8]* @.str4), !dbg !995 ; [#uses=1 type=i32] [debug line = 43:48]
  %tmp. = zext i4 %j to i64, !dbg !996            ; [#uses=2 type=i64] [debug line = 45:1]
  br label %6, !dbg !999                          ; [debug line = 44:11]

; <label>:6                                       ; preds = %8, %5
  %i.1 = phi i4 [ 0, %5 ], [ %i.6, %8 ]           ; [#uses=3 type=i4]
  %exitcond5 = icmp eq i4 %i.1, -8, !dbg !999     ; [#uses=1 type=i1] [debug line = 44:11]
  %7 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 8, i64 8, i64 8) ; [#uses=0 type=i32]
  br i1 %exitcond5, label %10, label %8, !dbg !999 ; [debug line = 44:11]

; <label>:8                                       ; preds = %6
  call void (...)* @_ssdm_op_SpecLoopName([21 x i8]* @.str5) nounwind, !dbg !1000 ; [debug line = 45:11]
  %tmp.9 = call i32 (...)* @_ssdm_op_SpecRegionBegin([21 x i8]* @.str5), !dbg !1001 ; [#uses=1 type=i32] [debug line = 45:57]
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, [1 x i8]* @.str1) nounwind, !dbg !1002 ; [debug line = 46:1]
  %tmp.2 = zext i4 %i.1 to i64, !dbg !996         ; [#uses=2 type=i64] [debug line = 45:1]
  %row_outbuf.addr = getelementptr inbounds [8 x [8 x i16]]* %row_outbuf, i64 0, i64 %tmp.2, i64 %tmp., !dbg !996 ; [#uses=1 type=i16*] [debug line = 45:1]
  %row_outbuf.load = load i16* %row_outbuf.addr, align 2, !dbg !996 ; [#uses=1 type=i16] [debug line = 45:1]
  %col_inbuf.addr = getelementptr inbounds [8 x [8 x i16]]* %col_inbuf, i64 0, i64 %tmp., i64 %tmp.2, !dbg !996 ; [#uses=1 type=i16*] [debug line = 45:1]
  store i16 %row_outbuf.load, i16* %col_inbuf.addr, align 2, !dbg !996 ; [debug line = 45:1]
  %9 = call i32 (...)* @_ssdm_op_SpecRegionEnd([21 x i8]* @.str5, i32 %tmp.9), !dbg !1003 ; [#uses=0 type=i32] [debug line = 45:36]
  %i.6 = add i4 %i.1, 1, !dbg !1004               ; [#uses=1 type=i4] [debug line = 44:63]
  call void @llvm.dbg.value(metadata !{i4 %i.6}, i64 0, metadata !989), !dbg !1004 ; [debug line = 44:63] [debug variable = i]
  br label %6, !dbg !1004                         ; [debug line = 44:63]

; <label>:10                                      ; preds = %6
  %11 = call i32 (...)* @_ssdm_op_SpecRegionEnd([21 x i8]* @.str4, i32 %tmp.6), !dbg !1005 ; [#uses=0 type=i32] [debug line = 45:77]
  %j.2 = add i4 %j, 1, !dbg !1006                 ; [#uses=1 type=i4] [debug line = 42:61]
  call void @llvm.dbg.value(metadata !{i4 %j.2}, i64 0, metadata !1007), !dbg !1006 ; [debug line = 42:61] [debug variable = j]
  br label %.preheader2, !dbg !1006               ; [debug line = 42:61]

.preheader1:                                      ; preds = %13, %.preheader2
  %i.2 = phi i4 [ %i.5, %13 ], [ 0, %.preheader2 ] ; [#uses=4 type=i4]
  %exitcond4 = icmp eq i4 %i.2, -8, !dbg !1008    ; [#uses=1 type=i1] [debug line = 48:9]
  %12 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 8, i64 8, i64 8) ; [#uses=0 type=i32]
  br i1 %exitcond4, label %.preheader, label %13, !dbg !1008 ; [debug line = 48:9]

; <label>:13                                      ; preds = %.preheader1
  call void (...)* @_ssdm_op_SpecLoopName([13 x i8]* @.str6) nounwind, !dbg !1010 ; [debug line = 48:67]
  call fastcc void @dct_1d([8 x [8 x i16]]* %col_inbuf, i4 %i.2, [8 x [8 x i16]]* %col_outbuf, i4 %i.2), !dbg !1012 ; [debug line = 49:7]
  %i.5 = add i4 %i.2, 1, !dbg !1013               ; [#uses=1 type=i4] [debug line = 48:61]
  call void @llvm.dbg.value(metadata !{i4 %i.5}, i64 0, metadata !989), !dbg !1013 ; [debug line = 48:61] [debug variable = i]
  br label %.preheader1, !dbg !1013               ; [debug line = 48:61]

.preheader:                                       ; preds = %20, %.preheader1
  %j.1 = phi i4 [ %j.3, %20 ], [ 0, %.preheader1 ] ; [#uses=3 type=i4]
  %exitcond3 = icmp eq i4 %j.1, -8, !dbg !1014    ; [#uses=1 type=i1] [debug line = 53:9]
  %14 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 8, i64 8, i64 8) ; [#uses=0 type=i32]
  br i1 %exitcond3, label %22, label %15, !dbg !1014 ; [debug line = 53:9]

; <label>:15                                      ; preds = %.preheader
  call void (...)* @_ssdm_op_SpecLoopName([21 x i8]* @.str7) nounwind, !dbg !1016 ; [debug line = 54:2]
  %tmp.8 = call i32 (...)* @_ssdm_op_SpecRegionBegin([21 x i8]* @.str7), !dbg !1018 ; [#uses=1 type=i32] [debug line = 54:48]
  %tmp.3 = zext i4 %j.1 to i64, !dbg !1019        ; [#uses=2 type=i64] [debug line = 56:1]
  br label %16, !dbg !1022                        ; [debug line = 55:11]

; <label>:16                                      ; preds = %18, %15
  %i.3 = phi i4 [ 0, %15 ], [ %i.7, %18 ]         ; [#uses=3 type=i4]
  %exitcond = icmp eq i4 %i.3, -8, !dbg !1022     ; [#uses=1 type=i1] [debug line = 55:11]
  %17 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 8, i64 8, i64 8) ; [#uses=0 type=i32]
  br i1 %exitcond, label %20, label %18, !dbg !1022 ; [debug line = 55:11]

; <label>:18                                      ; preds = %16
  call void (...)* @_ssdm_op_SpecLoopName([21 x i8]* @.str8) nounwind, !dbg !1023 ; [debug line = 56:11]
  %tmp.1 = call i32 (...)* @_ssdm_op_SpecRegionBegin([21 x i8]* @.str8), !dbg !1024 ; [#uses=1 type=i32] [debug line = 56:57]
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, [1 x i8]* @.str1) nounwind, !dbg !1025 ; [debug line = 57:1]
  %tmp.4 = zext i4 %i.3 to i64, !dbg !1019        ; [#uses=2 type=i64] [debug line = 56:1]
  %col_outbuf.addr = getelementptr inbounds [8 x [8 x i16]]* %col_outbuf, i64 0, i64 %tmp.4, i64 %tmp.3, !dbg !1019 ; [#uses=1 type=i16*] [debug line = 56:1]
  %col_outbuf.load = load i16* %col_outbuf.addr, align 2, !dbg !1019 ; [#uses=1 type=i16] [debug line = 56:1]
  %out_block.addr = getelementptr [8 x [8 x i16]]* %out_block, i64 0, i64 %tmp.3, i64 %tmp.4, !dbg !1019 ; [#uses=1 type=i16*] [debug line = 56:1]
  store i16 %col_outbuf.load, i16* %out_block.addr, align 2, !dbg !1019 ; [debug line = 56:1]
  %19 = call i32 (...)* @_ssdm_op_SpecRegionEnd([21 x i8]* @.str8, i32 %tmp.1), !dbg !1026 ; [#uses=0 type=i32] [debug line = 56:36]
  %i.7 = add i4 %i.3, 1, !dbg !1027               ; [#uses=1 type=i4] [debug line = 55:63]
  call void @llvm.dbg.value(metadata !{i4 %i.7}, i64 0, metadata !989), !dbg !1027 ; [debug line = 55:63] [debug variable = i]
  br label %16, !dbg !1027                        ; [debug line = 55:63]

; <label>:20                                      ; preds = %16
  %21 = call i32 (...)* @_ssdm_op_SpecRegionEnd([21 x i8]* @.str7, i32 %tmp.8), !dbg !1028 ; [#uses=0 type=i32] [debug line = 56:77]
  %j.3 = add i4 %j.1, 1, !dbg !1029               ; [#uses=1 type=i4] [debug line = 53:61]
  call void @llvm.dbg.value(metadata !{i4 %j.3}, i64 0, metadata !1007), !dbg !1029 ; [debug line = 53:61] [debug variable = j]
  br label %.preheader, !dbg !1029                ; [debug line = 53:61]

; <label>:22                                      ; preds = %.preheader
  ret void, !dbg !1030                            ; [debug line = 57:1]
}

; [#uses=1]
define internal fastcc void @read_data([64 x i16]* nocapture %input, [8 x [8 x i16]]* nocapture %buf) {
  call void @llvm.dbg.value(metadata !{[64 x i16]* %input}, i64 0, metadata !1031), !dbg !1035 ; [debug line = 59:22] [debug variable = input]
  call void @llvm.dbg.value(metadata !{[8 x [8 x i16]]* %buf}, i64 0, metadata !1036), !dbg !1037 ; [debug line = 59:44] [debug variable = buf]
  br label %1, !dbg !1038                         ; [debug line = 64:9]

; <label>:1                                       ; preds = %8, %0
  %r = phi i4 [ 0, %0 ], [ %r.1, %8 ]             ; [#uses=4 type=i4]
  %r.cast7 = zext i4 %r to i6, !dbg !1038         ; [#uses=1 type=i6] [debug line = 64:9]
  %exitcond1 = icmp eq i4 %r, -8, !dbg !1038      ; [#uses=1 type=i1] [debug line = 64:9]
  %2 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 8, i64 8, i64 8) ; [#uses=0 type=i32]
  br i1 %exitcond1, label %10, label %3, !dbg !1038 ; [debug line = 64:9]

; <label>:3                                       ; preds = %1
  call void (...)* @_ssdm_op_SpecLoopName([12 x i8]* @.str9) nounwind, !dbg !1041 ; [debug line = 64:67]
  %tmp.2 = call i32 (...)* @_ssdm_op_SpecRegionBegin([12 x i8]* @.str9), !dbg !1043 ; [#uses=1 type=i32] [debug line = 64:104]
  %tmp = shl i6 %r.cast7, 3, !dbg !1044           ; [#uses=1 type=i6] [debug line = 67:1]
  %tmp. = zext i4 %r to i64, !dbg !1044           ; [#uses=1 type=i64] [debug line = 67:1]
  br label %4, !dbg !1047                         ; [debug line = 66:12]

; <label>:4                                       ; preds = %6, %3
  %c = phi i4 [ 0, %3 ], [ %c.1, %6 ]             ; [#uses=4 type=i4]
  %c.cast6 = zext i4 %c to i6, !dbg !1047         ; [#uses=1 type=i6] [debug line = 66:12]
  %exitcond = icmp eq i4 %c, -8, !dbg !1047       ; [#uses=1 type=i1] [debug line = 66:12]
  %5 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 8, i64 8, i64 8) ; [#uses=0 type=i32]
  br i1 %exitcond, label %8, label %6, !dbg !1047 ; [debug line = 66:12]

; <label>:6                                       ; preds = %4
  call void (...)* @_ssdm_op_SpecLoopName([12 x i8]* @.str10) nounwind, !dbg !1048 ; [debug line = 67:11]
  %tmp.3 = call i32 (...)* @_ssdm_op_SpecRegionBegin([12 x i8]* @.str10), !dbg !1049 ; [#uses=1 type=i32] [debug line = 67:48]
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, [1 x i8]* @.str1) nounwind, !dbg !1050 ; [debug line = 68:1]
  %tmp.5 = add i6 %tmp, %c.cast6, !dbg !1044      ; [#uses=1 type=i6] [debug line = 67:1]
  %tmp.6 = zext i6 %tmp.5 to i64, !dbg !1044      ; [#uses=1 type=i64] [debug line = 67:1]
  %input.addr = getelementptr [64 x i16]* %input, i64 0, i64 %tmp.6, !dbg !1044 ; [#uses=1 type=i16*] [debug line = 67:1]
  %input.load = load i16* %input.addr, align 2, !dbg !1044 ; [#uses=1 type=i16] [debug line = 67:1]
  %tmp.7 = zext i4 %c to i64, !dbg !1044          ; [#uses=1 type=i64] [debug line = 67:1]
  %buf.addr = getelementptr [8 x [8 x i16]]* %buf, i64 0, i64 %tmp., i64 %tmp.7, !dbg !1044 ; [#uses=1 type=i16*] [debug line = 67:1]
  store i16 %input.load, i16* %buf.addr, align 2, !dbg !1044 ; [debug line = 67:1]
  %7 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @.str10, i32 %tmp.3), !dbg !1051 ; [#uses=0 type=i32] [debug line = 67:68]
  %c.1 = add i4 %c, 1, !dbg !1052                 ; [#uses=1 type=i4] [debug line = 66:64]
  call void @llvm.dbg.value(metadata !{i4 %c.1}, i64 0, metadata !1053), !dbg !1052 ; [debug line = 66:64] [debug variable = c]
  br label %4, !dbg !1052                         ; [debug line = 66:64]

; <label>:8                                       ; preds = %4
  %9 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @.str9, i32 %tmp.2), !dbg !1054 ; [#uses=0 type=i32] [debug line = 68:4]
  %r.1 = add i4 %r, 1, !dbg !1055                 ; [#uses=1 type=i4] [debug line = 64:61]
  call void @llvm.dbg.value(metadata !{i4 %r.1}, i64 0, metadata !1056), !dbg !1055 ; [debug line = 64:61] [debug variable = r]
  br label %1, !dbg !1055                         ; [debug line = 64:61]

; <label>:10                                      ; preds = %1
  ret void, !dbg !1057                            ; [debug line = 69:1]
}
...
define internal fastcc void @dct_1d([8 x [8 x i16]]* nocapture %src, i4 %tmp.1, [8 x [8 x i16]]* nocapture %dst, i4 %tmp.11) {
  ...
  %tmp.1.cast = zext i4 %tmp.1 to i64             ; [#uses=8 type=i64]
  call void @llvm.dbg.value(metadata !{[8 x [8 x i16]]* %src}, i64 0, metadata !1058), !dbg !1060 ; [debug line = 9:24] [debug variable = src]
  call void @llvm.dbg.value(metadata !{[8 x [8 x i16]]* %dst}, i64 0, metadata !1061), !dbg !1062 ; [debug line = 9:81] [debug variable = dst]
  br label %1, !dbg !1063                         ; [debug line = 18:9]

; <label>:1                                       ; preds = %3, %0
  %k = phi i4 [ 0, %0 ], [ %k.1, %3 ]             ; [#uses=3 type=i4]
  %exitcond1 = icmp eq i4 %k, -8, !dbg !1063      ; [#uses=1 type=i1] [debug line = 18:9]
  %2 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 8, i64 8, i64 8) ; [#uses=0 type=i32]
  br i1 %exitcond1, label %5, label %3, !dbg !1063 ; [debug line = 18:9]

; <label>:3                                       ; preds = %1
  call void (...)* @_ssdm_op_SpecLoopName([15 x i8]* @.str) nounwind, !dbg !1066 ; [debug line = 18:67]
  %tmp. = call i32 (...)* @_ssdm_op_SpecRegionBegin([15 x i8]* @.str) nounwind, !dbg !1068 ; [#uses=1 type=i32] [debug line = 18:107]
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, [1 x i8]* @.str1) nounwind, !dbg !1069 ; [debug line = 19:1]
  %tmp = zext i4 %k to i64, !dbg !1070            ; [#uses=9 type=i64] [debug line = 21:48]
  %dct_coeff_table.0.addr = getelementptr [8 x i14]* @dct_coeff_table.0, i64 0, i64 %tmp, !dbg !1070 ; [#uses=1 type=i14*] [debug line = 21:48]
  %dct_coeff_table.0.load = load i14* %dct_coeff_table.0.addr, align 2, !dbg !1070 ; [#uses=1 type=i14] [debug line = 21:48]
  %coeff.cast = zext i14 %dct_coeff_table.0.load to i29, !dbg !1073 ; [#uses=1 type=i29] [debug line = 22:10]
  %src.addr = getelementptr [8 x [8 x i16]]* %src, i64 0, i64 %tmp.1.cast, i64 0, !dbg !1073 ; [#uses=1 type=i16*] [debug line = 22:10]
  %src.load = load i16* %src.addr, align 2, !dbg !1073 ; [#uses=1 type=i16] [debug line = 22:10]
  %tmp.7.cast = sext i16 %src.load to i29, !dbg !1073 ; [#uses=1 type=i29] [debug line = 22:10]
  %tmp.8 = mul i29 %tmp.7.cast, %coeff.cast, !dbg !1073 ; [#uses=1 type=i29] [debug line = 22:10]
  %dct_coeff_table.1.addr = getelementptr [8 x i15]* @dct_coeff_table.1, i64 0, i64 %tmp, !dbg !1070 ; [#uses=1 type=i15*] [debug line = 21:48]
  %dct_coeff_table.1.load = load i15* %dct_coeff_table.1.addr, align 2, !dbg !1070 ; [#uses=1 type=i15] [debug line = 21:48]
  %coeff.1.cast = sext i15 %dct_coeff_table.1.load to i29, !dbg !1073 ; [#uses=1 type=i29] [debug line = 22:10]
  %src.addr.1 = getelementptr [8 x [8 x i16]]* %src, i64 0, i64 %tmp.1.cast, i64 1, !dbg !1073 ; [#uses=1 type=i16*] [debug line = 22:10]
  %src.load.1 = load i16* %src.addr.1, align 2, !dbg !1073 ; [#uses=1 type=i16] [debug line = 22:10]
  %tmp.7.1.cast = sext i16 %src.load.1 to i29, !dbg !1073 ; [#uses=1 type=i29] [debug line = 22:10]
  %tmp.8.1 = mul i29 %tmp.7.1.cast, %coeff.1.cast, !dbg !1073 ; [#uses=1 type=i29] [debug line = 22:10]
  %dct_coeff_table.2.addr = getelementptr [8 x i15]* @dct_coeff_table.2, i64 0, i64 %tmp, !dbg !1070 ; [#uses=1 type=i15*] [debug line = 21:48]
  %dct_coeff_table.2.load = load i15* %dct_coeff_table.2.addr, align 2, !dbg !1070 ; [#uses=1 type=i15] [debug line = 21:48]
  %coeff.2.cast = sext i15 %dct_coeff_table.2.load to i29, !dbg !1073 ; [#uses=1 type=i29] [debug line = 22:10]
  %src.addr.2 = getelementptr [8 x [8 x i16]]* %src, i64 0, i64 %tmp.1.cast, i64 2, !dbg !1073 ; [#uses=1 type=i16*] [debug line = 22:10]
  %src.load.2 = load i16* %src.addr.2, align 2, !dbg !1073 ; [#uses=1 type=i16] [debug line = 22:10]
  %tmp.7.2.cast = sext i16 %src.load.2 to i29, !dbg !1073 ; [#uses=1 type=i29] [debug line = 22:10]
  %tmp.8.2 = mul i29 %tmp.7.2.cast, %coeff.2.cast, !dbg !1073 ; [#uses=1 type=i29] [debug line = 22:10]
  %dct_coeff_table.3.addr = getelementptr [8 x i15]* @dct_coeff_table.3, i64 0, i64 %tmp, !dbg !1070 ; [#uses=1 type=i15*] [debug line = 21:48]
  %dct_coeff_table.3.load = load i15* %dct_coeff_table.3.addr, align 2, !dbg !1070 ; [#uses=1 type=i15] [debug line = 21:48]
  %coeff.3.cast = sext i15 %dct_coeff_table.3.load to i29, !dbg !1073 ; [#uses=1 type=i29] [debug line = 22:10]
  %src.addr.3 = getelementptr [8 x [8 x i16]]* %src, i64 0, i64 %tmp.1.cast, i64 3, !dbg !1073 ; [#uses=1 type=i16*] [debug line = 22:10]
  %src.load.3 = load i16* %src.addr.3, align 2, !dbg !1073 ; [#uses=1 type=i16] [debug line = 22:10]
  %tmp.7.3.cast = sext i16 %src.load.3 to i29, !dbg !1073 ; [#uses=1 type=i29] [debug line = 22:10]
  %tmp.8.3 = mul i29 %tmp.7.3.cast, %coeff.3.cast, !dbg !1073 ; [#uses=1 type=i29] [debug line = 22:10]
  %dct_coeff_table.4.addr = getelementptr [8 x i15]* @dct_coeff_table.4, i64 0, i64 %tmp, !dbg !1070 ; [#uses=1 type=i15*] [debug line = 21:48]
  %dct_coeff_table.4.load = load i15* %dct_coeff_table.4.addr, align 2, !dbg !1070 ; [#uses=1 type=i15] [debug line = 21:48]
  %coeff.4.cast = sext i15 %dct_coeff_table.4.load to i29, !dbg !1073 ; [#uses=1 type=i29] [debug line = 22:10]
  %src.addr.4 = getelementptr [8 x [8 x i16]]* %src, i64 0, i64 %tmp.1.cast, i64 4, !dbg !1073 ; [#uses=1 type=i16*] [debug line = 22:10]
  %src.load.4 = load i16* %src.addr.4, align 2, !dbg !1073 ; [#uses=1 type=i16] [debug line = 22:10]
  %tmp.7.4.cast = sext i16 %src.load.4 to i29, !dbg !1073 ; [#uses=1 type=i29] [debug line = 22:10]
  %tmp.8.4 = mul i29 %tmp.7.4.cast, %coeff.4.cast, !dbg !1073 ; [#uses=1 type=i29] [debug line = 22:10]
  %dct_coeff_table.5.addr = getelementptr [8 x i15]* @dct_coeff_table.5, i64 0, i64 %tmp, !dbg !1070 ; [#uses=1 type=i15*] [debug line = 21:48]
  %dct_coeff_table.5.load = load i15* %dct_coeff_table.5.addr, align 2, !dbg !1070 ; [#uses=1 type=i15] [debug line = 21:48]
  %coeff.5.cast = sext i15 %dct_coeff_table.5.load to i29, !dbg !1073 ; [#uses=1 type=i29] [debug line = 22:10]
  %src.addr.5 = getelementptr [8 x [8 x i16]]* %src, i64 0, i64 %tmp.1.cast, i64 5, !dbg !1073 ; [#uses=1 type=i16*] [debug line = 22:10]
  %src.load.5 = load i16* %src.addr.5, align 2, !dbg !1073 ; [#uses=1 type=i16] [debug line = 22:10]
  %tmp.7.5.cast = sext i16 %src.load.5 to i29, !dbg !1073 ; [#uses=1 type=i29] [debug line = 22:10]
  %tmp.8.5 = mul i29 %tmp.7.5.cast, %coeff.5.cast, !dbg !1073 ; [#uses=1 type=i29] [debug line = 22:10]
  %dct_coeff_table.6.addr = getelementptr [8 x i15]* @dct_coeff_table.6, i64 0, i64 %tmp, !dbg !1070 ; [#uses=1 type=i15*] [debug line = 21:48]
  %dct_coeff_table.6.load = load i15* %dct_coeff_table.6.addr, align 2, !dbg !1070 ; [#uses=1 type=i15] [debug line = 21:48]
  %coeff.6.cast = sext i15 %dct_coeff_table.6.load to i29, !dbg !1073 ; [#uses=1 type=i29] [debug line = 22:10]
  %src.addr.6 = getelementptr [8 x [8 x i16]]* %src, i64 0, i64 %tmp.1.cast, i64 6, !dbg !1073 ; [#uses=1 type=i16*] [debug line = 22:10]
  %src.load.6 = load i16* %src.addr.6, align 2, !dbg !1073 ; [#uses=1 type=i16] [debug line = 22:10]
  %tmp.7.6.cast = sext i16 %src.load.6 to i29, !dbg !1073 ; [#uses=1 type=i29] [debug line = 22:10]
  %tmp.8.6 = mul i29 %tmp.7.6.cast, %coeff.6.cast, !dbg !1073 ; [#uses=1 type=i29] [debug line = 22:10]
  %dct_coeff_table.7.addr = getelementptr [8 x i15]* @dct_coeff_table.7, i64 0, i64 %tmp, !dbg !1070 ; [#uses=1 type=i15*] [debug line = 21:48]
  %dct_coeff_table.7.load = load i15* %dct_coeff_table.7.addr, align 2, !dbg !1070 ; [#uses=1 type=i15] [debug line = 21:48]
  %coeff.7.cast = sext i15 %dct_coeff_table.7.load to i29, !dbg !1073 ; [#uses=1 type=i29] [debug line = 22:10]
  %src.addr.7 = getelementptr [8 x [8 x i16]]* %src, i64 0, i64 %tmp.1.cast, i64 7, !dbg !1073 ; [#uses=1 type=i16*] [debug line = 22:10]
  %src.load.7 = load i16* %src.addr.7, align 2, !dbg !1073 ; [#uses=1 type=i16] [debug line = 22:10]
  %tmp.7.7.cast = sext i16 %src.load.7 to i29, !dbg !1073 ; [#uses=1 type=i29] [debug line = 22:10]
  %tmp.8.7 = mul i29 %tmp.7.7.cast, %coeff.7.cast, !dbg !1073 ; [#uses=1 type=i29] [debug line = 22:10]
  %tmp2 = add i29 %tmp.8.1, %tmp.8, !dbg !1074    ; [#uses=1 type=i29] [debug line = 24:7]
  %tmp3 = add i29 %tmp.8.2, %tmp.8.3, !dbg !1074  ; [#uses=1 type=i29] [debug line = 24:7]
  %tmp1 = add i29 %tmp3, %tmp2, !dbg !1074        ; [#uses=1 type=i29] [debug line = 24:7]
  %tmp5 = add i29 %tmp.8.4, %tmp.8.5, !dbg !1074  ; [#uses=1 type=i29] [debug line = 24:7]
  %tmp7 = add i29 %tmp.8.7, 4096, !dbg !1074      ; [#uses=1 type=i29] [debug line = 24:7]
  %tmp6 = add i29 %tmp7, %tmp.8.6, !dbg !1074     ; [#uses=1 type=i29] [debug line = 24:7]
  %tmp4 = add i29 %tmp6, %tmp5, !dbg !1074        ; [#uses=1 type=i29] [debug line = 24:7]
  %tmp.2 = add i29 %tmp4, %tmp1, !dbg !1074       ; [#uses=1 type=i29] [debug line = 24:7]
  %tmp.3 = lshr i29 %tmp.2, 13, !dbg !1074        ; [#uses=1 type=i29] [debug line = 24:7]
  %tmp.4 = trunc i29 %tmp.3 to i16, !dbg !1074    ; [#uses=1 type=i16] [debug line = 24:7]
  %dst.addr = getelementptr [8 x [8 x i16]]* %dst, i64 0, i64 %tmp.11.cast, i64 %tmp, !dbg !1074 ; [#uses=1 type=i16*] [debug line = 24:7]
  store i16 %tmp.4, i16* %dst.addr, align 2, !dbg !1074 ; [debug line = 24:7]
  %4 = call i32 (...)* @_ssdm_op_SpecRegionEnd([15 x i8]* @.str, i32 %tmp.) nounwind, !dbg !1075 ; [#uses=0 type=i32] [debug line = 25:4]
  %k.1 = add i4 %k, 1, !dbg !1076                 ; [#uses=1 type=i4] [debug line = 18:61]
  call void @llvm.dbg.value(metadata !{i4 %k.1}, i64 0, metadata !1077), !dbg !1076 ; [debug line = 18:61] [debug variable = k]
  br label %1, !dbg !1076                         ; [debug line = 18:61]

; <label>:5                                       ; preds = %1
  ret void, !dbg !1078                            ; [debug line = 26:1]
}
...
!933 = metadata !{i32 89, i32 4, metadata !906, null}
!934 = metadata !{i32 91, i32 4, metadata !906, null}
!935 = metadata !{i32 94, i32 4, metadata !906, null}
!936 = metadata !{i32 95, i32 1, metadata !906, null}
!937 = metadata !{i32 786689, metadata !938, metadata !"buf", null, i32 71, metadata !929, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!938 = metadata !{i32 786478, i32 0, metadata !32, metadata !"write_data", metadata !"write_data", metadata !"_Z10write_dataPA8_sPs", metadata !32, i32 71, metadata !939, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, null, metadata !38, i32 72} ; [ DW_TAG_subprogram ]
!939 = metadata !{i32 786453, i32 0, metadata !"", i32 0, i32 0, i64 0, i64 0, i64 0, i32 0, null, metadata !940, i32 0, i32 0} ; [ DW_TAG_subroutine_type ]
!940 = metadata !{null, metadata !941, metadata !910}
!941 = metadata !{i32 786447, null, metadata !"", null, i32 0, i64 64, i64 64, i64 0, i32 0, metadata !942} ; [ DW_TAG_pointer_type ]
!942 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 128, i64 16, i32 0, i32 0, metadata !37, metadata !92, i32 0, i32 0} ; [ DW_TAG_array_type ]
!943 = metadata !{i32 71, i32 23, metadata !938, null}
!944 = metadata !{i32 786689, metadata !938, metadata !"output", null, i32 71, metadata !922, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!945 = metadata !{i32 71, i32 116, metadata !938, null}
!946 = metadata !{i32 76, i32 9, metadata !947, null}
!947 = metadata !{i32 786443, metadata !948, i32 76, i32 4, metadata !32, i32 24} ; [ DW_TAG_lexical_block ]
!948 = metadata !{i32 786443, metadata !938, i32 72, i32 1, metadata !32, i32 23} ; [ DW_TAG_lexical_block ]
!949 = metadata !{i32 76, i32 67, metadata !950, null}
!950 = metadata !{i32 786443, metadata !947, i32 76, i32 66, metadata !32, i32 25} ; [ DW_TAG_lexical_block ]
!951 = metadata !{i32 76, i32 104, metadata !950, null}
!952 = metadata !{i32 79, i32 1, metadata !953, null}
!953 = metadata !{i32 786443, metadata !954, i32 79, i32 10, metadata !32, i32 27} ; [ DW_TAG_lexical_block ]
!954 = metadata !{i32 786443, metadata !950, i32 78, i32 7, metadata !32, i32 26} ; [ DW_TAG_lexical_block ]
!955 = metadata !{i32 78, i32 12, metadata !954, null}
!956 = metadata !{i32 79, i32 11, metadata !953, null}
!957 = metadata !{i32 79, i32 48, metadata !953, null}
!958 = metadata !{i32 80, i32 1, metadata !953, null}
!959 = metadata !{i32 79, i32 69, metadata !953, null}
!960 = metadata !{i32 78, i32 64, metadata !954, null}
!961 = metadata !{i32 786688, metadata !948, metadata !"c", metadata !32, i32 73, metadata !55, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!962 = metadata !{i32 80, i32 4, metadata !950, null}
!963 = metadata !{i32 76, i32 61, metadata !947, null}
!964 = metadata !{i32 786688, metadata !948, metadata !"r", metadata !32, i32 73, metadata !55, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!965 = metadata !{i32 81, i32 1, metadata !948, null}
!966 = metadata !{i32 786689, metadata !967, metadata !"in_block", null, i32 28, metadata !972, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!967 = metadata !{i32 786478, i32 0, metadata !32, metadata !"dct_2d", metadata !"dct_2d", metadata !"_Z6dct_2dPA8_sS0_", metadata !32, i32 28, metadata !968, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, null, metadata !38, i32 30} ; [ DW_TAG_subprogram ]
!968 = metadata !{i32 786453, i32 0, metadata !"", i32 0, i32 0, i64 0, i64 0, i64 0, i32 0, null, metadata !969, i32 0, i32 0} ; [ DW_TAG_subroutine_type ]
!969 = metadata !{null, metadata !970, metadata !970}
!970 = metadata !{i32 786447, null, metadata !"", null, i32 0, i64 64, i64 64, i64 0, i32 0, metadata !971} ; [ DW_TAG_pointer_type ]
!971 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 128, i64 16, i32 0, i32 0, metadata !36, metadata !92, i32 0, i32 0} ; [ DW_TAG_array_type ]
!972 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 1024, i64 16, i32 0, i32 0, metadata !36, metadata !45, i32 0, i32 0} ; [ DW_TAG_array_type ]
!973 = metadata !{i32 28, i32 24, metadata !967, null}
!974 = metadata !{i32 786689, metadata !967, metadata !"out_block", null, i32 29, metadata !972, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!975 = metadata !{i32 29, i32 18, metadata !967, null}
!976 = metadata !{i32 786688, metadata !977, metadata !"row_outbuf", metadata !32, i32 31, metadata !972, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!977 = metadata !{i32 786443, metadata !967, i32 30, i32 1, metadata !32, i32 5} ; [ DW_TAG_lexical_block ]
!978 = metadata !{i32 31, i32 15, metadata !977, null}
!979 = metadata !{i32 786688, metadata !977, metadata !"col_outbuf", metadata !32, i32 32, metadata !972, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!980 = metadata !{i32 32, i32 15, metadata !977, null}
!981 = metadata !{i32 786688, metadata !977, metadata !"col_inbuf", metadata !32, i32 32, metadata !972, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!982 = metadata !{i32 32, i32 109, metadata !977, null}
!983 = metadata !{i32 37, i32 8, metadata !984, null}
!984 = metadata !{i32 786443, metadata !977, i32 37, i32 4, metadata !32, i32 6} ; [ DW_TAG_lexical_block ]
!985 = metadata !{i32 37, i32 66, metadata !986, null}
!986 = metadata !{i32 786443, metadata !984, i32 37, i32 65, metadata !32, i32 7} ; [ DW_TAG_lexical_block ]
!987 = metadata !{i32 38, i32 7, metadata !986, null}
!988 = metadata !{i32 37, i32 60, metadata !984, null}
!989 = metadata !{i32 786688, metadata !977, metadata !"i", metadata !32, i32 33, metadata !990, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!990 = metadata !{i32 786468, null, metadata !"unsigned int", null, i32 0, i64 32, i64 32, i64 0, i32 0, i32 7} ; [ DW_TAG_base_type ]
!991 = metadata !{i32 42, i32 9, metadata !992, null}
!992 = metadata !{i32 786443, metadata !977, i32 42, i32 4, metadata !32, i32 8} ; [ DW_TAG_lexical_block ]
!993 = metadata !{i32 43, i32 2, metadata !994, null}
!994 = metadata !{i32 786443, metadata !992, i32 43, i32 1, metadata !32, i32 9} ; [ DW_TAG_lexical_block ]
!995 = metadata !{i32 43, i32 48, metadata !994, null}
!996 = metadata !{i32 45, i32 1, metadata !997, null}
!997 = metadata !{i32 786443, metadata !998, i32 45, i32 10, metadata !32, i32 11} ; [ DW_TAG_lexical_block ]
!998 = metadata !{i32 786443, metadata !994, i32 44, i32 7, metadata !32, i32 10} ; [ DW_TAG_lexical_block ]
!999 = metadata !{i32 44, i32 11, metadata !998, null}
!1000 = metadata !{i32 45, i32 11, metadata !997, null}
!1001 = metadata !{i32 45, i32 57, metadata !997, null}
!1002 = metadata !{i32 46, i32 1, metadata !997, null}
!1003 = metadata !{i32 45, i32 36, metadata !997, null}
!1004 = metadata !{i32 44, i32 63, metadata !998, null}
!1005 = metadata !{i32 45, i32 77, metadata !994, null}
!1006 = metadata !{i32 42, i32 61, metadata !992, null}
!1007 = metadata !{i32 786688, metadata !977, metadata !"j", metadata !32, i32 33, metadata !990, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!1008 = metadata !{i32 48, i32 9, metadata !1009, null}
!1009 = metadata !{i32 786443, metadata !977, i32 48, i32 4, metadata !32, i32 12} ; [ DW_TAG_lexical_block ]
!1010 = metadata !{i32 48, i32 67, metadata !1011, null}
!1011 = metadata !{i32 786443, metadata !1009, i32 48, i32 66, metadata !32, i32 13} ; [ DW_TAG_lexical_block ]
!1012 = metadata !{i32 49, i32 7, metadata !1011, null}
!1013 = metadata !{i32 48, i32 61, metadata !1009, null}
!1014 = metadata !{i32 53, i32 9, metadata !1015, null}
!1015 = metadata !{i32 786443, metadata !977, i32 53, i32 4, metadata !32, i32 14} ; [ DW_TAG_lexical_block ]
!1016 = metadata !{i32 54, i32 2, metadata !1017, null}
!1017 = metadata !{i32 786443, metadata !1015, i32 54, i32 1, metadata !32, i32 15} ; [ DW_TAG_lexical_block ]
!1018 = metadata !{i32 54, i32 48, metadata !1017, null}
!1019 = metadata !{i32 56, i32 1, metadata !1020, null}
!1020 = metadata !{i32 786443, metadata !1021, i32 56, i32 10, metadata !32, i32 17} ; [ DW_TAG_lexical_block ]
!1021 = metadata !{i32 786443, metadata !1017, i32 55, i32 7, metadata !32, i32 16} ; [ DW_TAG_lexical_block ]
!1022 = metadata !{i32 55, i32 11, metadata !1021, null}
!1023 = metadata !{i32 56, i32 11, metadata !1020, null}
!1024 = metadata !{i32 56, i32 57, metadata !1020, null}
!1025 = metadata !{i32 57, i32 1, metadata !1020, null}
!1026 = metadata !{i32 56, i32 36, metadata !1020, null}
!1027 = metadata !{i32 55, i32 63, metadata !1021, null}
!1028 = metadata !{i32 56, i32 77, metadata !1017, null}
!1029 = metadata !{i32 53, i32 61, metadata !1015, null}
!1030 = metadata !{i32 57, i32 1, metadata !977, null}
!1031 = metadata !{i32 786689, metadata !1032, metadata !"input", null, i32 59, metadata !922, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!1032 = metadata !{i32 786478, i32 0, metadata !32, metadata !"read_data", metadata !"read_data", metadata !"_Z9read_dataPsPA8_s", metadata !32, i32 59, metadata !1033, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, null, metadata !38, i32 60} ; [ DW_TAG_subprogram ]
!1033 = metadata !{i32 786453, i32 0, metadata !"", i32 0, i32 0, i64 0, i64 0, i64 0, i32 0, null, metadata !1034, i32 0, i32 0} ; [ DW_TAG_subroutine_type ]
!1034 = metadata !{null, metadata !910, metadata !941}
!1035 = metadata !{i32 59, i32 22, metadata !1032, null}
!1036 = metadata !{i32 786689, metadata !1032, metadata !"buf", null, i32 59, metadata !929, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!1037 = metadata !{i32 59, i32 44, metadata !1032, null}
!1038 = metadata !{i32 64, i32 9, metadata !1039, null}
!1039 = metadata !{i32 786443, metadata !1040, i32 64, i32 4, metadata !32, i32 19} ; [ DW_TAG_lexical_block ]
!1040 = metadata !{i32 786443, metadata !1032, i32 60, i32 1, metadata !32, i32 18} ; [ DW_TAG_lexical_block ]
!1041 = metadata !{i32 64, i32 67, metadata !1042, null}
!1042 = metadata !{i32 786443, metadata !1039, i32 64, i32 66, metadata !32, i32 20} ; [ DW_TAG_lexical_block ]
!1043 = metadata !{i32 64, i32 104, metadata !1042, null}
!1044 = metadata !{i32 67, i32 1, metadata !1045, null}
!1045 = metadata !{i32 786443, metadata !1046, i32 67, i32 10, metadata !32, i32 22} ; [ DW_TAG_lexical_block ]
!1046 = metadata !{i32 786443, metadata !1042, i32 66, i32 7, metadata !32, i32 21} ; [ DW_TAG_lexical_block ]
!1047 = metadata !{i32 66, i32 12, metadata !1046, null}
!1048 = metadata !{i32 67, i32 11, metadata !1045, null}
!1049 = metadata !{i32 67, i32 48, metadata !1045, null}
!1050 = metadata !{i32 68, i32 1, metadata !1045, null}
!1051 = metadata !{i32 67, i32 68, metadata !1045, null}
!1052 = metadata !{i32 66, i32 64, metadata !1046, null}
!1053 = metadata !{i32 786688, metadata !1040, metadata !"c", metadata !32, i32 61, metadata !55, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!1054 = metadata !{i32 68, i32 4, metadata !1042, null}
!1055 = metadata !{i32 64, i32 61, metadata !1039, null}
!1056 = metadata !{i32 786688, metadata !1040, metadata !"r", metadata !32, i32 61, metadata !55, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!1057 = metadata !{i32 69, i32 1, metadata !1040, null}
!1058 = metadata !{i32 786689, metadata !31, metadata !"src", null, i32 9, metadata !1059, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!1059 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 0, i64 0, i32 0, i32 0, metadata !36, metadata !92, i32 0, i32 0} ; [ DW_TAG_array_type ]
!1060 = metadata !{i32 9, i32 24, metadata !31, null}
!1061 = metadata !{i32 786689, metadata !31, metadata !"dst", null, i32 9, metadata !1059, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!1062 = metadata !{i32 9, i32 81, metadata !31, null}
!1063 = metadata !{i32 18, i32 9, metadata !1064, null}
!1064 = metadata !{i32 786443, metadata !1065, i32 18, i32 4, metadata !32, i32 1} ; [ DW_TAG_lexical_block ]
!1065 = metadata !{i32 786443, metadata !31, i32 10, i32 1, metadata !32, i32 0} ; [ DW_TAG_lexical_block ]
!1066 = metadata !{i32 18, i32 67, metadata !1067, null}
!1067 = metadata !{i32 786443, metadata !1064, i32 18, i32 66, metadata !32, i32 2} ; [ DW_TAG_lexical_block ]
!1068 = metadata !{i32 18, i32 107, metadata !1067, null}
!1069 = metadata !{i32 19, i32 1, metadata !1067, null}
!1070 = metadata !{i32 21, i32 48, metadata !1071, null}
!1071 = metadata !{i32 786443, metadata !1072, i32 20, i32 77, metadata !32, i32 4} ; [ DW_TAG_lexical_block ]
!1072 = metadata !{i32 786443, metadata !1067, i32 20, i32 7, metadata !32, i32 3} ; [ DW_TAG_lexical_block ]
!1073 = metadata !{i32 22, i32 10, metadata !1071, null}
!1074 = metadata !{i32 24, i32 7, metadata !1067, null}
!1075 = metadata !{i32 25, i32 4, metadata !1067, null}
!1076 = metadata !{i32 18, i32 61, metadata !1064, null}
!1077 = metadata !{i32 786688, metadata !1065, metadata !"k", metadata !32, i32 11, metadata !990, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!1078 = metadata !{i32 26, i32 1, metadata !1065, null}
