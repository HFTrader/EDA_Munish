...
architecture behav of dct_1d is 
    ...
    signal p_addr_fu_415_p2 : STD_LOGIC_VECTOR (7 downto 0);
    signal p_addr_reg_655 : STD_LOGIC_VECTOR (7 downto 0);
    signal ap_reg_ppstg_p_addr_reg_655_pp0_it1 : STD_LOGIC_VECTOR (7 downto 0);
...
begin
    ...
    dct_mul_16s_14ns_29_3_U1 : component dct_mul_16s_14ns_29_3
    generic map (
        ID => 1,
        NUM_STAGE => 3,
        din0_WIDTH => 16,
    ...
    dct_mul_16s_15s_29_3_U2 : component dct_mul_16s_15s_29_3
    generic map (
        ID => 2,
        NUM_STAGE => 3,
        din0_WIDTH => 16,
    ...
    dct_mul_16s_15s_29_3_U3 : component dct_mul_16s_15s_29_3
    generic map (
        ID => 3,
        NUM_STAGE => 3,
        din0_WIDTH => 16,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_ST_pp0_stg0_fsm_1 = ap_CS_fsm)) then
                ...
                ap_reg_ppstg_p_addr_reg_655_pp0_it1 <= p_addr_reg_655;
            end if;
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_reg_ppiten_pp0_it0) and (ap_ST_pp0_stg0_fsm_1 = ap_CS_fsm) and (ap_const_lv1_0 = exitcond1_fu_382_p2))) then
                p_addr_reg_655 <= p_addr_fu_415_p2;
    ...
    p_addr_fu_415_p2 <= std_logic_vector(unsigned(p_addr_cast_fu_411_p1) + unsigned(tmp_trn_cast_fu_400_p1));
    ...
    tmp_24_fu_577_p1 <= std_logic_vector(resize(unsigned(ap_reg_ppstg_p_addr_reg_655_pp0_it1),64));
