...
#ifndef _dct_2d_col_inbuf_H_
#define _dct_2d_col_inbuf_H_
...
struct dct_2d_col_inbuf_core : public sc_core::sc_module
{
public:
    ...
    SC_HAS_PROCESS(dct_2d_col_inbuf_core);
    dct_2d_col_inbuf_core(sc_core::sc_module_name) {
...
SC_MODULE( dct_2d_col_inbuf )
{
    ...
    SC_CTOR( dct_2d_col_inbuf ) {
        meminst = new dct_2d_col_inbuf_core <2, 1, DataWidth, AddressWidth, AddressRange>("core_inst");
...
public:
    ...
    dct_2d_col_inbuf_core <2, 1, DataWidth, AddressWidth, AddressRange>* meminst;
