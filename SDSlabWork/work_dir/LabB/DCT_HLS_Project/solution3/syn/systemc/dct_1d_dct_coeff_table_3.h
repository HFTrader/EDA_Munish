...
#ifndef _dct_1d_dct_coeff_table_3_H_
#define _dct_1d_dct_coeff_table_3_H_
...
struct dct_1d_dct_coeff_table_3_core : public sc_core::sc_module
{
public:
    ...
    SC_HAS_PROCESS(dct_1d_dct_coeff_table_3_core);
    dct_1d_dct_coeff_table_3_core(sc_core::sc_module_name) {
...
SC_MODULE( dct_1d_dct_coeff_table_3 )
{
    ...
    SC_CTOR( dct_1d_dct_coeff_table_3 ) {
        meminst = new dct_1d_dct_coeff_table_3_core <1, 1, DataWidth, AddressWidth, AddressRange>("core_inst");
...
public:
    ...
    dct_1d_dct_coeff_table_3_core <1, 1, DataWidth, AddressWidth, AddressRange>* meminst;
};

#endif //_dct_1d_dct_coeff_table_3_H_
