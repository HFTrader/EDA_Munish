...
set ::env(LD_LIBRARY_PATH) /nfs/tools/xilinx/Vivado_HLS/2013.3/lnx64/tools/fpo_v7_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /nfs/tools/xilinx/Vivado_HLS/2013.3/lnx64/tools/opencv:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /nfs/tools/xilinx/Vivado_HLS/2013.3/lnx64/tools/fft_v9_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /nfs/tools/xilinx/Vivado_HLS/2013.3/lnx64/tools/fir_v7_0:$::env(LD_LIBRARY_PATH)
...
file delete -force [file join "../tv" dct.hdltvin.dat]
file delete -force [file join "../tv" dct.hdltvout.dat]
file delete -force  "err.log"
