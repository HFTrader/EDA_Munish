...
void dct_row_outbuf::proc_count() {
    if (reset.read() == SC_LOGIC_1) {
        count.write(0);
...
void dct_row_outbuf::proc_full_n() {
    if (reset.read() == SC_LOGIC_1) {
...
void dct_row_outbuf::proc_empty_n() {
    if (reset.read() == SC_LOGIC_1) {
