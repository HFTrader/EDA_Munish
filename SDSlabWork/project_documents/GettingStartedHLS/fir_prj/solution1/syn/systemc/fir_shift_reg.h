...
#ifndef _fir_shift_reg_H_
#define _fir_shift_reg_H_
...
struct fir_shift_reg_core : public sc_core::sc_module
{
public:
    ...
    SC_HAS_PROCESS(fir_shift_reg_core);
    fir_shift_reg_core(sc_core::sc_module_name) {
...
SC_MODULE( fir_shift_reg )
{
    ...
    SC_CTOR( fir_shift_reg ) {
        meminst = new fir_shift_reg_core <1, 1, DataWidth, AddressWidth, AddressRange>("core_inst");
...
public:
    ...
    fir_shift_reg_core <1, 1, DataWidth, AddressWidth, AddressRange>* meminst;
};

#endif //_fir_shift_reg_H_
