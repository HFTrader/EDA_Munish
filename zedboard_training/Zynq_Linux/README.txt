...
This archive contains files pertaining to "Linux on Zynq" SpeedWay training.

For best results, extract the contents of this archive to the following 
folder: 

C:\Speedway\Fall_12\

Thank you for your interest in Avnet SpeedWay trainings!