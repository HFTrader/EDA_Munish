...
#ifndef __gray_scale_mul_8ns_20ns_28_3__HH__
#define __gray_scale_mul_8ns_20ns_28_3__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(gray_scale_mul_8ns_20ns_28_3) {
    ...
    SC_CTOR(gray_scale_mul_8ns_20ns_28_3):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
