...
#ifndef _dct_buf_2d_out_memcore_H_
#define _dct_buf_2d_out_memcore_H_
...
struct dct_buf_2d_out_memcore_core : public sc_core::sc_module
{
public:
    ...
    SC_HAS_PROCESS(dct_buf_2d_out_memcore_core);
    dct_buf_2d_out_memcore_core(sc_core::sc_module_name) {
...
SC_MODULE( dct_buf_2d_out_memcore )
{
    ...
    SC_CTOR( dct_buf_2d_out_memcore ) {
        meminst = new dct_buf_2d_out_memcore_core <2, 2, DataWidth, AddressWidth, AddressRange>("core_inst");
...
public:
    ...
    dct_buf_2d_out_memcore_core <2, 2, DataWidth, AddressWidth, AddressRange>* meminst;
...
#endif //_dct_buf_2d_out_memcore_H_
