...
#ifndef _AESL_automem_output_r_H_
#define _AESL_automem_output_r_H_
...
struct AESL_automem_output_r_core : public sc_core::sc_module
{
public:
    ...
    SC_HAS_PROCESS(AESL_automem_output_r_core);
    AESL_automem_output_r_core(sc_core::sc_module_name) {
...
SC_MODULE( AESL_automem_output_r )
{
    ...
    SC_CTOR( AESL_automem_output_r ) {
        meminst = new AESL_automem_output_r_core <1, 1, DataWidth, AddressWidth, AddressRange>("core_inst");
...
public:
    ...
    AESL_automem_output_r_core <1, 1, DataWidth, AddressWidth, AddressRange>* meminst;
};

#endif //_AESL_automem_output_r_H_
