...
architecture behav of dct_Loop_Xpose_Col_Outer_Loop_proc is 
    ...
    signal j_1_i_reg_78 : STD_LOGIC_VECTOR (3 downto 0);
    signal i_3_i_reg_89 : STD_LOGIC_VECTOR (3 downto 0);
    ...
    signal i_3_i_mid2_fu_119_p3 : STD_LOGIC_VECTOR (3 downto 0);
    signal i_3_i_mid2_reg_206 : STD_LOGIC_VECTOR (3 downto 0);
    signal ap_reg_ppstg_i_3_i_mid2_reg_206_pp0_it1 : STD_LOGIC_VECTOR (3 downto 0);
    signal j_1_i_mid2_fu_133_p3 : STD_LOGIC_VECTOR (3 downto 0);
    signal j_1_i_mid2_reg_212 : STD_LOGIC_VECTOR (3 downto 0);
    signal ap_reg_ppstg_j_1_i_mid2_reg_212_pp0_it1 : STD_LOGIC_VECTOR (3 downto 0);
    signal i_fu_141_p2 : STD_LOGIC_VECTOR (3 downto 0);
    signal ap_sig_bdd_76 : BOOLEAN;
    signal j_1_i_phi_fu_82_p4 : STD_LOGIC_VECTOR (3 downto 0);
    signal tmp_s_fu_167_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_36_fu_192_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal exitcond_i8_fu_113_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal tmp_9_trn_cast_fu_147_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal p_addr1_fu_161_p2 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_35_fu_175_p3 : STD_LOGIC_VECTOR (6 downto 0);
...
begin
    ...
    -- i_3_i_reg_89 assign process. --
    i_3_i_reg_89_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
    ...
    -- j_1_i_reg_78 assign process. --
    j_1_i_reg_78_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
    ...
    buf_2d_out_address0 <= tmp_36_fu_192_p1(6 - 1 downto 0);

    -- buf_2d_out_ce0 assign process. --
    buf_2d_out_ce0_assign_proc : process(ap_CS_fsm, ap_reg_ppiten_pp0_it2, ap_reg_ppstg_exitcond_flatten_reg_197_pp0_it1)
    begin
    ...
    buf_2d_out_we0_assign_proc : process(ap_CS_fsm, ap_reg_ppiten_pp0_it2, ap_reg_ppstg_exitcond_flatten_reg_197_pp0_it1)
    begin
        if ((((ap_ST_pp0_stg0_fsm_1 = ap_CS_fsm) and (ap_const_logic_1 = ap_reg_ppiten_pp0_it2) and (ap_reg_ppstg_exitcond_flatten_reg_197_pp0_it1 = ap_const_lv1_0)))) then 
    ...
    col_outbuf_address0 <= tmp_s_fu_167_p1(6 - 1 downto 0);

    -- col_outbuf_ce0 assign process. --
    col_outbuf_ce0_assign_proc : process(ap_CS_fsm, exitcond_flatten_reg_197, ap_reg_ppiten_pp0_it1)
    begin
        if (((ap_ST_pp0_stg0_fsm_1 = ap_CS_fsm) and (ap_const_logic_1 = ap_reg_ppiten_pp0_it1) and (exitcond_flatten_reg_197 = ap_const_lv1_0))) then 
    ...
    exitcond_i8_fu_113_p2 <= "1" when (i_3_i_reg_89 = ap_const_lv4_8) else "0";
    i_3_i_mid2_fu_119_p3 <= 
        ap_const_lv4_0 when (exitcond_i8_fu_113_p2(0) = '1') else 
        i_3_i_reg_89;
    i_fu_141_p2 <= std_logic_vector(unsigned(i_3_i_mid2_fu_119_p3) + unsigned(ap_const_lv4_1));
    indvar_flatten_next_fu_107_p2 <= std_logic_vector(unsigned(indvar_flatten_reg_67) + unsigned(ap_const_lv7_1));
    j6_fu_127_p2 <= std_logic_vector(unsigned(j_1_i_phi_fu_82_p4) + unsigned(ap_const_lv4_1));
    j_1_i_mid2_fu_133_p3 <= 
        j6_fu_127_p2 when (exitcond_i8_fu_113_p2(0) = '1') else 
        j_1_i_phi_fu_82_p4;

    -- j_1_i_phi_fu_82_p4 assign process. --
    j_1_i_phi_fu_82_p4_assign_proc : process(ap_CS_fsm, j_1_i_reg_78, exitcond_flatten_reg_197, ap_reg_ppiten_pp0_it1, j_1_i_mid2_reg_212)
    begin
        if (((ap_ST_pp0_stg0_fsm_1 = ap_CS_fsm) and (ap_const_logic_1 = ap_reg_ppiten_pp0_it1) and (exitcond_flatten_reg_197 = ap_const_lv1_0))) then 
    ...
    p_addr1_fu_161_p2 <= std_logic_vector(unsigned(p_addr_cast_fu_157_p1) + unsigned(tmp_9_trn_cast_fu_147_p1));
    p_addr4_cast_fu_182_p1 <= std_logic_vector(resize(unsigned(tmp_35_fu_175_p3),8));
    p_addr5_fu_186_p2 <= std_logic_vector(unsigned(p_addr4_cast_fu_182_p1) + unsigned(tmp_trn_cast_fu_172_p1));
    p_addr_cast_fu_157_p1 <= std_logic_vector(resize(unsigned(tmp_fu_150_p3),8));
    tmp_35_fu_175_p3 <= (ap_reg_ppstg_j_1_i_mid2_reg_212_pp0_it1 & ap_const_lv3_0);
    tmp_36_fu_192_p1 <= std_logic_vector(resize(unsigned(p_addr5_fu_186_p2),64));
    tmp_9_trn_cast_fu_147_p1 <= std_logic_vector(resize(unsigned(j_1_i_mid2_reg_212),8));
    tmp_fu_150_p3 <= (i_3_i_mid2_reg_206 & ap_const_lv3_0);
    tmp_s_fu_167_p1 <= std_logic_vector(resize(unsigned(p_addr1_fu_161_p2),64));
    tmp_trn_cast_fu_172_p1 <= std_logic_vector(resize(unsigned(ap_reg_ppstg_i_3_i_mid2_reg_206_pp0_it1),8));
end behav;
