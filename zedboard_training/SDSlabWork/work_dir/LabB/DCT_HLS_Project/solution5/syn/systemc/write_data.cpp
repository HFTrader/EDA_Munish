...
write_data::write_data(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    sensitive << ( tmp_4_trn_cast_fu_164_p1 );
    ...
    SC_METHOD(thread_tmp_4_trn_cast_fu_164_p1);
    sensitive << ( c_mid2_reg_214 );
    ...
    sc_trace(mVcdFile, tmp_5_reg_235, "tmp_5_reg_235");
    ...
    sc_trace(mVcdFile, tmp_4_trn_cast_fu_164_p1, "tmp_4_trn_cast_fu_164_p1");
...
void write_data::thread_ap_clk_no_reset_() {
    ...
    if ((esl_seteq<1,2,2>(ap_ST_pp0_stg0_fsm_1, ap_CS_fsm.read()) && esl_seteq<1,1,1>(ap_const_logic_1, ap_reg_ppiten_pp0_it1.read()) && esl_seteq<1,1,1>(exitcond_flatten_reg_200.read(), ap_const_lv1_0))) {
        ...
        tmp_5_reg_235 = tmp_5_fu_190_p2.read();
    }
}
...
void write_data::thread_buf_r_address0() {
    buf_r_address0 =  (sc_lv<6>) (tmp_2_fu_185_p1.read());
}
...
void write_data::thread_output_r_address0() {
    output_r_address0 =  (sc_lv<6>) (tmp_6_fu_196_p1.read());
}
...
void write_data::thread_p_addr1_fu_179_p2() {
    p_addr1_fu_179_p2 = (!p_addr_cast_fu_175_p1.read().is_01() || !tmp_4_trn_cast_fu_164_p1.read().is_01())? sc_lv<8>(): (sc_bigint<8>(p_addr_cast_fu_175_p1.read()) + sc_biguint<8>(tmp_4_trn_cast_fu_164_p1.read()));
}
...
void write_data::thread_tmp_2_fu_185_p1() {
    tmp_2_fu_185_p1 = esl_zext<64,8>(p_addr1_fu_179_p2.read());
}

void write_data::thread_tmp_4_trn_cast_fu_164_p1() {
    tmp_4_trn_cast_fu_164_p1 = esl_zext<8,4>(c_mid2_reg_214.read());
}

void write_data::thread_tmp_5_fu_190_p2() {
    tmp_5_fu_190_p2 = (!tmp_s_fu_153_p3.read().is_01() || !c_cast6_fu_161_p1.read().is_01())? sc_lv<6>(): (sc_bigint<6>(tmp_s_fu_153_p3.read()) + sc_biguint<6>(c_cast6_fu_161_p1.read()));
}

void write_data::thread_tmp_6_fu_196_p1() {
    tmp_6_fu_196_p1 = esl_zext<64,6>(tmp_5_reg_235.read());
}
