...
#ifndef _dct_row_outbuf_memcore_H_
#define _dct_row_outbuf_memcore_H_
...
struct dct_row_outbuf_memcore_core : public sc_core::sc_module
{
public:
    ...
    SC_HAS_PROCESS(dct_row_outbuf_memcore_core);
    dct_row_outbuf_memcore_core(sc_core::sc_module_name) {
...
SC_MODULE( dct_row_outbuf_memcore )
{
    ...
    SC_CTOR( dct_row_outbuf_memcore ) {
        meminst = new dct_row_outbuf_memcore_core <2, 2, DataWidth, AddressWidth, AddressRange>("core_inst");
...
public:
    ...
    dct_row_outbuf_memcore_core <2, 2, DataWidth, AddressWidth, AddressRange>* meminst;
...
#endif //_dct_row_outbuf_memcore_H_
