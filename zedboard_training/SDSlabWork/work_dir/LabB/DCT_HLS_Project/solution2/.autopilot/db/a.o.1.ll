; ModuleID = '/home/ga38qoh/EDA_Munish/SDSlabWork/work_dir/LabB/DCT_HLS_Project/solution2/.autopilot/db/a.g.1.bc'
...
; <label>:2                                       ; preds = %1
  ...
  %tmp = zext i32 %k to i64, !dbg !933            ; [#uses=2 type=i64] [debug line = 21:48]
  br label %3, !dbg !936                          ; [debug line = 20:11]

; <label>:3                                       ; preds = %4, %2
  %n = phi i32 [ 0, %2 ], [ %n.1, %4 ]            ; [#uses=3 type=i32]
  %tmp1 = phi i32 [ 0, %2 ], [ %tmp.9, %4 ]       ; [#uses=2 type=i32]
  %exitcond = icmp eq i32 %n, 8, !dbg !936        ; [#uses=1 type=i1] [debug line = 20:11]
  br i1 %exitcond, label %5, label %4, !dbg !936  ; [debug line = 20:11]

; <label>:4                                       ; preds = %3
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([15 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !937 ; [debug line = 20:78]
  %rbegin = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([15 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !938 ; [#uses=1 type=i32] [debug line = 20:118]
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0)) nounwind, !dbg !939 ; [debug line = 21:1]
  %tmp.6 = zext i32 %n to i64, !dbg !933          ; [#uses=2 type=i64] [debug line = 21:48]
  %dct_coeff_table.addr = getelementptr inbounds [8 x [8 x i16]]* @dct_coeff_table, i64 0, i64 %tmp, i64 %tmp.6, !dbg !933 ; [#uses=1 type=i16*] [debug line = 21:48]
  %dct_coeff_table.load = load i16* %dct_coeff_table.addr, align 2, !dbg !933 ; [#uses=2 type=i16] [debug line = 21:48]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i16 %dct_coeff_table.load) nounwind
  %coeff = sext i16 %dct_coeff_table.load to i32, !dbg !933 ; [#uses=1 type=i32] [debug line = 21:48]
  call void @llvm.dbg.value(metadata !{i32 %coeff}, i64 0, metadata !940), !dbg !933 ; [debug line = 21:48] [debug variable = coeff]
  ...
  %rend = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([15 x i8]* @.str1, i64 0, i64 0), i32 %rbegin) nounwind, !dbg !943 ; [#uses=0 type=i32] [debug line = 23:7]
...
; <label>:5                                       ; preds = %4
  ...
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0)) nounwind, !dbg !988 ; [debug line = 46:1]
...
; <label>:10                                      ; preds = %9
  ...
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0)) nounwind, !dbg !1011 ; [debug line = 57:1]
...
; <label>:4                                       ; preds = %3
  ...
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0)) nounwind, !dbg !1035 ; [debug line = 68:1]
...
; <label>:4                                       ; preds = %3
  ...
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, i8* getelementptr inbounds ([1 x i8]* @.str2, i64 0, i64 0)) nounwind, !dbg !1061 ; [debug line = 80:1]
...
!933 = metadata !{i32 21, i32 48, metadata !934, null}
!934 = metadata !{i32 786443, metadata !935, i32 20, i32 77, metadata !833, i32 4} ; [ DW_TAG_lexical_block ]
!935 = metadata !{i32 786443, metadata !931, i32 20, i32 7, metadata !833, i32 3} ; [ DW_TAG_lexical_block ]
!936 = metadata !{i32 20, i32 11, metadata !935, null}
!937 = metadata !{i32 20, i32 78, metadata !934, null}
!938 = metadata !{i32 20, i32 118, metadata !934, null}
!939 = metadata !{i32 21, i32 1, metadata !934, null}
!940 = metadata !{i32 786688, metadata !934, metadata !"coeff", metadata !833, i32 21, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!941 = metadata !{i32 22, i32 10, metadata !934, null}
!942 = metadata !{i32 786688, metadata !926, metadata !"tmp", metadata !833, i32 12, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!943 = metadata !{i32 23, i32 7, metadata !934, null}
!944 = metadata !{i32 20, i32 72, metadata !935, null}
