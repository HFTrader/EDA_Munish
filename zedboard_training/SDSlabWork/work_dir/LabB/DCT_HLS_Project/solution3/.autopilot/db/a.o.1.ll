; ModuleID = '/home/ga38qoh/EDA_Munish/SDSlabWork/work_dir/LabB/DCT_HLS_Project/solution3/.autopilot/db/a.g.1.bc'
...
define void @dct(i16* %input, i16* %output) nounwind uwtable {
  ...
  call void @llvm.dbg.declare(metadata !{[8 x [8 x i16]]* %buf_2d_in}, metadata !1076), !dbg !1078 ; [debug line = 85:10] [debug variable = buf_2d_in]
  call void @llvm.dbg.declare(metadata !{[8 x [8 x i16]]* %buf_2d_out}, metadata !1079), !dbg !1080 ; [debug line = 86:10] [debug variable = buf_2d_out]
  %buf_2d_in.addr = getelementptr inbounds [8 x [8 x i16]]* %buf_2d_in, i64 0, i64 0, !dbg !1081 ; [#uses=2 type=[8 x i16]*] [debug line = 89:4]
  call fastcc void @read_data(i16* %input, [8 x i16]* %buf_2d_in.addr), !dbg !1081 ; [debug line = 89:4]
  %buf_2d_out.addr = getelementptr inbounds [8 x [8 x i16]]* %buf_2d_out, i64 0, i64 0, !dbg !1082 ; [#uses=2 type=[8 x i16]*] [debug line = 91:4]
  call fastcc void @dct_2d([8 x i16]* %buf_2d_in.addr, [8 x i16]* %buf_2d_out.addr), !dbg !1082 ; [debug line = 91:4]
  call fastcc void @write_data([8 x i16]* %buf_2d_out.addr, i16* %output), !dbg !1083 ; [debug line = 94:4]
  ret void, !dbg !1084                            ; [debug line = 95:1]
}
...
!1076 = metadata !{i32 786688, metadata !1074, metadata !"buf_2d_in", metadata !833, i32 85, metadata !1077, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!1077 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 1024, i64 16, i32 0, i32 0, metadata !838, metadata !920, i32 0, i32 0} ; [ DW_TAG_array_type ]
!1078 = metadata !{i32 85, i32 10, metadata !1074, null}
!1079 = metadata !{i32 786688, metadata !1074, metadata !"buf_2d_out", metadata !833, i32 86, metadata !1077, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!1080 = metadata !{i32 86, i32 10, metadata !1074, null}
!1081 = metadata !{i32 89, i32 4, metadata !1074, null}
!1082 = metadata !{i32 91, i32 4, metadata !1074, null}
!1083 = metadata !{i32 94, i32 4, metadata !1074, null}
!1084 = metadata !{i32 95, i32 1, metadata !1074, null}
