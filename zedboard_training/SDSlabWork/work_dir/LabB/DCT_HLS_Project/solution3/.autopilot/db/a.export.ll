...
; <label>:2                                       ; preds = %1
  ...
  %p_addr = add i8 %p_addr_cast, %tmp_trn_cast
  %tmp_24 = zext i8 %p_addr to i64
  %dst_addr = getelementptr [64 x i16]* %dst, i64 0, i64 %tmp_24
  store i16 %tmp_4, i16* %dst_addr, align 2
  %empty_23 = call i32 (...)* @_ssdm_op_SpecRegionEnd([15 x i8]* @p_str, i32 %tmp_s) nounwind
  br label %1
...
entry:
  ...
  %empty_25 = trunc i6 %empty to i3
  %empty_26 = call i3 @_ssdm_op_PartSelect.i3.i6.i32.i32(i6 %empty_24, i32 3, i32 5)
  %empty_27 = or i3 %empty_25, %empty_26
  %empty_28 = call i6 @_ssdm_op_PartSet.i6.i6.i3.i32.i32(i6 %empty_24, i3 %empty_27, i32 3, i32 5)
  ret i6 %empty_28
}
...
entry:
  ...
  %empty_30 = trunc i7 %empty to i4
  %empty_31 = call i4 @_ssdm_op_PartSelect.i4.i7.i32.i32(i7 %empty_29, i32 3, i32 6)
  %empty_32 = or i4 %empty_30, %empty_31
  %empty_33 = call i7 @_ssdm_op_PartSet.i7.i7.i4.i32.i32(i7 %empty_29, i4 %empty_32, i32 3, i32 6)
  ret i7 %empty_33
}
...
entry:
  ...
  %empty_34 = trunc i29 %empty to i16
  ret i16 %empty_34
}
