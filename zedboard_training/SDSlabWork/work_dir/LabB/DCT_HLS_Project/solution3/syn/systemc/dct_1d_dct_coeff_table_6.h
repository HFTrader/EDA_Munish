...
#ifndef _dct_1d_dct_coeff_table_6_H_
#define _dct_1d_dct_coeff_table_6_H_
...
struct dct_1d_dct_coeff_table_6_core : public sc_core::sc_module
{
public:
    ...
    SC_HAS_PROCESS(dct_1d_dct_coeff_table_6_core);
    dct_1d_dct_coeff_table_6_core(sc_core::sc_module_name) {
...
SC_MODULE( dct_1d_dct_coeff_table_6 )
{
    ...
    SC_CTOR( dct_1d_dct_coeff_table_6 ) {
        meminst = new dct_1d_dct_coeff_table_6_core <1, 1, DataWidth, AddressWidth, AddressRange>("core_inst");
...
public:
    ...
    dct_1d_dct_coeff_table_6_core <1, 1, DataWidth, AddressWidth, AddressRange>* meminst;
};

#endif //_dct_1d_dct_coeff_table_6_H_
