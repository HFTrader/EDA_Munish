; ModuleID = '/home/ga38qoh/EDA_Munish/SDSlabWork/work_dir/LabB/DCT_HLS_Project/solution1/.autopilot/db/a.o.2.bc'
...
; <label>:3                                       ; preds = %1
  call void (...)* @_ssdm_op_SpecLoopName([12 x i8]* @.str8) nounwind, !dbg !945 ; [debug line = 64:67@89:4]
  %tmp.11.i = call i32 (...)* @_ssdm_op_SpecRegionBegin([12 x i8]* @.str8) nounwind, !dbg !947 ; [#uses=1 type=i32] [debug line = 64:104@89:4]
...
; <label>:4                                       ; preds = %6, %3
  ...
  br i1 %exitcond.i, label %7, label %6, !dbg !951 ; [debug line = 66:12@89:4]

; <label>:6                                       ; preds = %4
  call void (...)* @_ssdm_op_SpecLoopName([12 x i8]* @.str9) nounwind, !dbg !952 ; [debug line = 67:11@89:4]
  ...
  %c = add i4 %c.i, 1, !dbg !953                  ; [#uses=1 type=i4] [debug line = 66:64@89:4]
  call void @llvm.dbg.value(metadata !{i4 %c}, i64 0, metadata !954) nounwind, !dbg !953 ; [debug line = 66:64@89:4] [debug variable = c]
  br label %4, !dbg !953                          ; [debug line = 66:64@89:4]

; <label>:7                                       ; preds = %4
  %8 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @.str8, i32 %tmp.11.i) nounwind, !dbg !955 ; [#uses=0 type=i32] [debug line = 68:4@89:4]
  %r = add i4 %r.i, 1, !dbg !956                  ; [#uses=1 type=i4] [debug line = 64:61@89:4]
  call void @llvm.dbg.value(metadata !{i4 %r}, i64 0, metadata !957) nounwind, !dbg !956 ; [debug line = 64:61@89:4] [debug variable = r]
  br label %1, !dbg !956                          ; [debug line = 64:61@89:4]

read_data.exit:                                   ; preds = %1
  call fastcc void @dct_2d([8 x [8 x i16]]* %buf_2d_in, [8 x [8 x i16]]* %buf_2d_out) nounwind, !dbg !958 ; [debug line = 91:4]
  call void @llvm.dbg.value(metadata !{[8 x [8 x i16]]* %buf_2d_out}, i64 0, metadata !959) nounwind, !dbg !964 ; [debug line = 71:23@94:4] [debug variable = buf]
  call void @llvm.dbg.value(metadata !{[64 x i16]* %output}, i64 0, metadata !965) nounwind, !dbg !966 ; [debug line = 71:116@94:4] [debug variable = output]
  br label %9, !dbg !967                          ; [debug line = 76:9@94:4]

; <label>:9                                       ; preds = %15, %read_data.exit
  %r.i2 = phi i4 [ 0, %read_data.exit ], [ %r.1, %15 ] ; [#uses=4 type=i4]
  %r.i2.cast4 = zext i4 %r.i2 to i6, !dbg !967    ; [#uses=1 type=i6] [debug line = 76:9@94:4]
  %exitcond1.i3 = icmp eq i4 %r.i2, -8, !dbg !967 ; [#uses=1 type=i1] [debug line = 76:9@94:4]
  %10 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 8, i64 8, i64 8) nounwind ; [#uses=0 type=i32]
  br i1 %exitcond1.i3, label %write_data.exit, label %11, !dbg !967 ; [debug line = 76:9@94:4]

; <label>:11                                      ; preds = %9
  call void (...)* @_ssdm_op_SpecLoopName([12 x i8]* @.str10) nounwind, !dbg !970 ; [debug line = 76:67@94:4]
  %tmp.1.i = call i32 (...)* @_ssdm_op_SpecRegionBegin([12 x i8]* @.str10) nounwind, !dbg !972 ; [#uses=1 type=i32] [debug line = 76:104@94:4]
  %tmp.i4 = zext i4 %r.i2 to i64, !dbg !973       ; [#uses=1 type=i64] [debug line = 79:1@94:4]
  %tmp..i5 = shl i6 %r.i2.cast4, 3, !dbg !973     ; [#uses=1 type=i6] [debug line = 79:1@94:4]
  br label %12, !dbg !976                         ; [debug line = 78:12@94:4]

; <label>:12                                      ; preds = %14, %11
  %c.i6 = phi i4 [ 0, %11 ], [ %c.1, %14 ]        ; [#uses=4 type=i4]
  %c.i6.cast2 = zext i4 %c.i6 to i6, !dbg !976    ; [#uses=1 type=i6] [debug line = 78:12@94:4]
  %exitcond.i7 = icmp eq i4 %c.i6, -8, !dbg !976  ; [#uses=1 type=i1] [debug line = 78:12@94:4]
  %13 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 8, i64 8, i64 8) nounwind ; [#uses=0 type=i32]
  br i1 %exitcond.i7, label %15, label %14, !dbg !976 ; [debug line = 78:12@94:4]

; <label>:14                                      ; preds = %12
  call void (...)* @_ssdm_op_SpecLoopName([12 x i8]* @.str11) nounwind, !dbg !977 ; [debug line = 79:11@94:4]
  %tmp.8.i = zext i4 %c.i6 to i64, !dbg !973      ; [#uses=1 type=i64] [debug line = 79:1@94:4]
  %buf.assign.1.addr = getelementptr [8 x [8 x i16]]* %buf_2d_out, i64 0, i64 %tmp.i4, i64 %tmp.8.i, !dbg !973 ; [#uses=1 type=i16*] [debug line = 79:1@94:4]
  %buf.assign.1.load = load i16* %buf.assign.1.addr, align 2, !dbg !973 ; [#uses=1 type=i16] [debug line = 79:1@94:4]
  %tmp.9.i = add i6 %c.i6.cast2, %tmp..i5, !dbg !973 ; [#uses=1 type=i6] [debug line = 79:1@94:4]
  %tmp.3.i = zext i6 %tmp.9.i to i64, !dbg !973   ; [#uses=1 type=i64] [debug line = 79:1@94:4]
  %output.addr = getelementptr [64 x i16]* %output, i64 0, i64 %tmp.3.i, !dbg !973 ; [#uses=1 type=i16*] [debug line = 79:1@94:4]
  store i16 %buf.assign.1.load, i16* %output.addr, align 2, !dbg !973 ; [debug line = 79:1@94:4]
  %c.1 = add i4 %c.i6, 1, !dbg !978               ; [#uses=1 type=i4] [debug line = 78:64@94:4]
  call void @llvm.dbg.value(metadata !{i4 %c.1}, i64 0, metadata !979) nounwind, !dbg !978 ; [debug line = 78:64@94:4] [debug variable = c]
  br label %12, !dbg !978                         ; [debug line = 78:64@94:4]

; <label>:15                                      ; preds = %12
  %16 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @.str10, i32 %tmp.1.i) nounwind, !dbg !980 ; [#uses=0 type=i32] [debug line = 80:4@94:4]
  %r.1 = add i4 %r.i2, 1, !dbg !981               ; [#uses=1 type=i4] [debug line = 76:61@94:4]
  call void @llvm.dbg.value(metadata !{i4 %r.1}, i64 0, metadata !982) nounwind, !dbg !981 ; [debug line = 76:61@94:4] [debug variable = r]
  br label %9, !dbg !981                          ; [debug line = 76:61@94:4]

write_data.exit:                                  ; preds = %9
  ret void, !dbg !983                             ; [debug line = 95:1]
}
...
define internal fastcc void @dct_2d([8 x [8 x i16]]* nocapture %in_block, [8 x [8 x i16]]* nocapture %out_block) {
  ...
  call void @llvm.dbg.value(metadata !{[8 x [8 x i16]]* %in_block}, i64 0, metadata !984), !dbg !991 ; [debug line = 28:24] [debug variable = in_block]
  call void @llvm.dbg.value(metadata !{[8 x [8 x i16]]* %out_block}, i64 0, metadata !992), !dbg !993 ; [debug line = 29:18] [debug variable = out_block]
  call void @llvm.dbg.declare(metadata !{[8 x [8 x i16]]* %row_outbuf}, metadata !994), !dbg !996 ; [debug line = 31:15] [debug variable = row_outbuf]
  call void @llvm.dbg.declare(metadata !{[8 x [8 x i16]]* %col_outbuf}, metadata !997), !dbg !998 ; [debug line = 32:15] [debug variable = col_outbuf]
  call void @llvm.dbg.declare(metadata !{[8 x [8 x i16]]* %col_inbuf}, metadata !999), !dbg !1000 ; [debug line = 32:109] [debug variable = col_inbuf]
  br label %1, !dbg !1001                         ; [debug line = 37:8]

; <label>:1                                       ; preds = %3, %0
  %i = phi i4 [ 0, %0 ], [ %i.4, %3 ]             ; [#uses=4 type=i4]
  %exitcond7 = icmp eq i4 %i, -8, !dbg !1001      ; [#uses=1 type=i1] [debug line = 37:8]
  %2 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 8, i64 8, i64 8) ; [#uses=0 type=i32]
  br i1 %exitcond7, label %.preheader2, label %3, !dbg !1001 ; [debug line = 37:8]

; <label>:3                                       ; preds = %1
  call void (...)* @_ssdm_op_SpecLoopName([13 x i8]* @.str2) nounwind, !dbg !1003 ; [debug line = 37:66]
  call fastcc void @dct_1d([8 x [8 x i16]]* %in_block, i4 %i, [8 x [8 x i16]]* %row_outbuf, i4 %i), !dbg !1005 ; [debug line = 38:7]
  %i.4 = add i4 %i, 1, !dbg !1006                 ; [#uses=1 type=i4] [debug line = 37:60]
  call void @llvm.dbg.value(metadata !{i4 %i.4}, i64 0, metadata !1007), !dbg !1006 ; [debug line = 37:60] [debug variable = i]
  br label %1, !dbg !1006                         ; [debug line = 37:60]

.preheader2:                                      ; preds = %9, %1
  %j = phi i4 [ %j.2, %9 ], [ 0, %1 ]             ; [#uses=3 type=i4]
  %exitcond6 = icmp eq i4 %j, -8, !dbg !1009      ; [#uses=1 type=i1] [debug line = 42:9]
  %4 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 8, i64 8, i64 8) ; [#uses=0 type=i32]
  br i1 %exitcond6, label %.preheader1, label %5, !dbg !1009 ; [debug line = 42:9]

; <label>:5                                       ; preds = %.preheader2
  call void (...)* @_ssdm_op_SpecLoopName([21 x i8]* @.str3) nounwind, !dbg !1011 ; [debug line = 43:2]
  %tmp.6 = call i32 (...)* @_ssdm_op_SpecRegionBegin([21 x i8]* @.str3), !dbg !1013 ; [#uses=1 type=i32] [debug line = 43:48]
  %tmp. = zext i4 %j to i64, !dbg !1014           ; [#uses=2 type=i64] [debug line = 45:1]
  br label %6, !dbg !1017                         ; [debug line = 44:11]

; <label>:6                                       ; preds = %8, %5
  %i.1 = phi i4 [ 0, %5 ], [ %i.6, %8 ]           ; [#uses=3 type=i4]
  %exitcond5 = icmp eq i4 %i.1, -8, !dbg !1017    ; [#uses=1 type=i1] [debug line = 44:11]
  %7 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 8, i64 8, i64 8) ; [#uses=0 type=i32]
  br i1 %exitcond5, label %9, label %8, !dbg !1017 ; [debug line = 44:11]

; <label>:8                                       ; preds = %6
  call void (...)* @_ssdm_op_SpecLoopName([21 x i8]* @.str4) nounwind, !dbg !1018 ; [debug line = 45:11]
  %tmp.2 = zext i4 %i.1 to i64, !dbg !1014        ; [#uses=2 type=i64] [debug line = 45:1]
  %row_outbuf.addr = getelementptr inbounds [8 x [8 x i16]]* %row_outbuf, i64 0, i64 %tmp.2, i64 %tmp., !dbg !1014 ; [#uses=1 type=i16*] [debug line = 45:1]
  %row_outbuf.load = load i16* %row_outbuf.addr, align 2, !dbg !1014 ; [#uses=1 type=i16] [debug line = 45:1]
  %col_inbuf.addr = getelementptr inbounds [8 x [8 x i16]]* %col_inbuf, i64 0, i64 %tmp., i64 %tmp.2, !dbg !1014 ; [#uses=1 type=i16*] [debug line = 45:1]
  store i16 %row_outbuf.load, i16* %col_inbuf.addr, align 2, !dbg !1014 ; [debug line = 45:1]
  %i.6 = add i4 %i.1, 1, !dbg !1019               ; [#uses=1 type=i4] [debug line = 44:63]
  call void @llvm.dbg.value(metadata !{i4 %i.6}, i64 0, metadata !1007), !dbg !1019 ; [debug line = 44:63] [debug variable = i]
  br label %6, !dbg !1019                         ; [debug line = 44:63]

; <label>:9                                       ; preds = %6
  %10 = call i32 (...)* @_ssdm_op_SpecRegionEnd([21 x i8]* @.str3, i32 %tmp.6), !dbg !1020 ; [#uses=0 type=i32] [debug line = 45:77]
  %j.2 = add i4 %j, 1, !dbg !1021                 ; [#uses=1 type=i4] [debug line = 42:61]
  call void @llvm.dbg.value(metadata !{i4 %j.2}, i64 0, metadata !1022), !dbg !1021 ; [debug line = 42:61] [debug variable = j]
  br label %.preheader2, !dbg !1021               ; [debug line = 42:61]

.preheader1:                                      ; preds = %12, %.preheader2
  %i.2 = phi i4 [ %i.5, %12 ], [ 0, %.preheader2 ] ; [#uses=4 type=i4]
  %exitcond4 = icmp eq i4 %i.2, -8, !dbg !1023    ; [#uses=1 type=i1] [debug line = 48:9]
  %11 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 8, i64 8, i64 8) ; [#uses=0 type=i32]
  br i1 %exitcond4, label %.preheader, label %12, !dbg !1023 ; [debug line = 48:9]

; <label>:12                                      ; preds = %.preheader1
  call void (...)* @_ssdm_op_SpecLoopName([13 x i8]* @.str5) nounwind, !dbg !1025 ; [debug line = 48:67]
  call fastcc void @dct_1d([8 x [8 x i16]]* %col_inbuf, i4 %i.2, [8 x [8 x i16]]* %col_outbuf, i4 %i.2), !dbg !1027 ; [debug line = 49:7]
  %i.5 = add i4 %i.2, 1, !dbg !1028               ; [#uses=1 type=i4] [debug line = 48:61]
  call void @llvm.dbg.value(metadata !{i4 %i.5}, i64 0, metadata !1007), !dbg !1028 ; [debug line = 48:61] [debug variable = i]
  br label %.preheader1, !dbg !1028               ; [debug line = 48:61]

.preheader:                                       ; preds = %18, %.preheader1
  %j.1 = phi i4 [ %j.3, %18 ], [ 0, %.preheader1 ] ; [#uses=3 type=i4]
  %exitcond3 = icmp eq i4 %j.1, -8, !dbg !1029    ; [#uses=1 type=i1] [debug line = 53:9]
  %13 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 8, i64 8, i64 8) ; [#uses=0 type=i32]
  br i1 %exitcond3, label %20, label %14, !dbg !1029 ; [debug line = 53:9]

; <label>:14                                      ; preds = %.preheader
  call void (...)* @_ssdm_op_SpecLoopName([21 x i8]* @.str6) nounwind, !dbg !1031 ; [debug line = 54:2]
  %tmp.8 = call i32 (...)* @_ssdm_op_SpecRegionBegin([21 x i8]* @.str6), !dbg !1033 ; [#uses=1 type=i32] [debug line = 54:48]
  %tmp.3 = zext i4 %j.1 to i64, !dbg !1034        ; [#uses=2 type=i64] [debug line = 56:1]
  br label %15, !dbg !1037                        ; [debug line = 55:11]

; <label>:15                                      ; preds = %17, %14
  %i.3 = phi i4 [ 0, %14 ], [ %i.7, %17 ]         ; [#uses=3 type=i4]
  %exitcond = icmp eq i4 %i.3, -8, !dbg !1037     ; [#uses=1 type=i1] [debug line = 55:11]
  %16 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 8, i64 8, i64 8) ; [#uses=0 type=i32]
  br i1 %exitcond, label %18, label %17, !dbg !1037 ; [debug line = 55:11]

; <label>:17                                      ; preds = %15
  call void (...)* @_ssdm_op_SpecLoopName([21 x i8]* @.str7) nounwind, !dbg !1038 ; [debug line = 56:11]
  %tmp.4 = zext i4 %i.3 to i64, !dbg !1034        ; [#uses=2 type=i64] [debug line = 56:1]
  %col_outbuf.addr = getelementptr inbounds [8 x [8 x i16]]* %col_outbuf, i64 0, i64 %tmp.4, i64 %tmp.3, !dbg !1034 ; [#uses=1 type=i16*] [debug line = 56:1]
  %col_outbuf.load = load i16* %col_outbuf.addr, align 2, !dbg !1034 ; [#uses=1 type=i16] [debug line = 56:1]
  %out_block.addr = getelementptr [8 x [8 x i16]]* %out_block, i64 0, i64 %tmp.3, i64 %tmp.4, !dbg !1034 ; [#uses=1 type=i16*] [debug line = 56:1]
  store i16 %col_outbuf.load, i16* %out_block.addr, align 2, !dbg !1034 ; [debug line = 56:1]
  %i.7 = add i4 %i.3, 1, !dbg !1039               ; [#uses=1 type=i4] [debug line = 55:63]
  call void @llvm.dbg.value(metadata !{i4 %i.7}, i64 0, metadata !1007), !dbg !1039 ; [debug line = 55:63] [debug variable = i]
  br label %15, !dbg !1039                        ; [debug line = 55:63]

; <label>:18                                      ; preds = %15
  %19 = call i32 (...)* @_ssdm_op_SpecRegionEnd([21 x i8]* @.str6, i32 %tmp.8), !dbg !1040 ; [#uses=0 type=i32] [debug line = 56:77]
  %j.3 = add i4 %j.1, 1, !dbg !1041               ; [#uses=1 type=i4] [debug line = 53:61]
  call void @llvm.dbg.value(metadata !{i4 %j.3}, i64 0, metadata !1022), !dbg !1041 ; [debug line = 53:61] [debug variable = j]
  br label %.preheader, !dbg !1041                ; [debug line = 53:61]

; <label>:20                                      ; preds = %.preheader
  ret void, !dbg !1042                            ; [debug line = 57:1]
}
...
define internal fastcc void @dct_1d([8 x [8 x i16]]* nocapture %src, i4 %tmp.1, [8 x [8 x i16]]* nocapture %dst, i4 %tmp.11) {
  ...
  call void @llvm.dbg.value(metadata !{[8 x [8 x i16]]* %src}, i64 0, metadata !1043), !dbg !1045 ; [debug line = 9:24] [debug variable = src]
  call void @llvm.dbg.value(metadata !{[8 x [8 x i16]]* %dst}, i64 0, metadata !1046), !dbg !1047 ; [debug line = 9:81] [debug variable = dst]
  br label %1, !dbg !1048                         ; [debug line = 18:9]

; <label>:1                                       ; preds = %7, %0
  %k = phi i4 [ 0, %0 ], [ %k.1, %7 ]             ; [#uses=3 type=i4]
  %exitcond1 = icmp eq i4 %k, -8, !dbg !1048      ; [#uses=1 type=i1] [debug line = 18:9]
  %2 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 8, i64 8, i64 8) ; [#uses=0 type=i32]
  br i1 %exitcond1, label %9, label %3, !dbg !1048 ; [debug line = 18:9]

; <label>:3                                       ; preds = %1
  call void (...)* @_ssdm_op_SpecLoopName([15 x i8]* @.str) nounwind, !dbg !1051 ; [debug line = 18:67]
  %tmp. = call i32 (...)* @_ssdm_op_SpecRegionBegin([15 x i8]* @.str) nounwind, !dbg !1053 ; [#uses=1 type=i32] [debug line = 18:107]
  %tmp = zext i4 %k to i64, !dbg !1054            ; [#uses=2 type=i64] [debug line = 21:48]
  br label %4, !dbg !1057                         ; [debug line = 20:11]

; <label>:4                                       ; preds = %6, %3
  %n = phi i4 [ 0, %3 ], [ %n.1, %6 ]             ; [#uses=3 type=i4]
  %tmp1 = phi i32 [ 0, %3 ], [ %tmp.5, %6 ]       ; [#uses=2 type=i32]
  %tmp1.cast = trunc i32 %tmp1 to i29, !dbg !1057 ; [#uses=1 type=i29] [debug line = 20:11]
  %exitcond = icmp eq i4 %n, -8, !dbg !1057       ; [#uses=1 type=i1] [debug line = 20:11]
  %5 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 8, i64 8, i64 8) ; [#uses=0 type=i32]
  br i1 %exitcond, label %7, label %6, !dbg !1057 ; [debug line = 20:11]

; <label>:6                                       ; preds = %4
  call void (...)* @_ssdm_op_SpecLoopName([15 x i8]* @.str1) nounwind, !dbg !1058 ; [debug line = 20:78]
  %tmp.6 = zext i4 %n to i64, !dbg !1054          ; [#uses=2 type=i64] [debug line = 21:48]
  %dct_coeff_table.addr = getelementptr inbounds [8 x [8 x i16]]* @dct_coeff_table, i64 0, i64 %tmp, i64 %tmp.6, !dbg !1054 ; [#uses=1 type=i16*] [debug line = 21:48]
  %dct_coeff_table.load = load i16* %dct_coeff_table.addr, align 2, !dbg !1054 ; [#uses=1 type=i16] [debug line = 21:48]
  %coeff = sext i16 %dct_coeff_table.load to i32, !dbg !1054 ; [#uses=1 type=i32] [debug line = 21:48]
  call void @llvm.dbg.value(metadata !{i32 %coeff}, i64 0, metadata !1059), !dbg !1054 ; [debug line = 21:48] [debug variable = coeff]
  %src.addr = getelementptr [8 x [8 x i16]]* %src, i64 0, i64 %tmp.1.cast, i64 %tmp.6, !dbg !1060 ; [#uses=1 type=i16*] [debug line = 22:10]
  %src.load = load i16* %src.addr, align 2, !dbg !1060 ; [#uses=1 type=i16] [debug line = 22:10]
  %tmp.7 = sext i16 %src.load to i32, !dbg !1060  ; [#uses=1 type=i32] [debug line = 22:10]
  %tmp.8 = mul nsw i32 %tmp.7, %coeff, !dbg !1060 ; [#uses=1 type=i32] [debug line = 22:10]
  %tmp.5 = add nsw i32 %tmp.8, %tmp1, !dbg !1060  ; [#uses=1 type=i32] [debug line = 22:10]
  call void @llvm.dbg.value(metadata !{i32 %tmp.5}, i64 0, metadata !1061), !dbg !1060 ; [debug line = 22:10] [debug variable = tmp]
  %n.1 = add i4 %n, 1, !dbg !1062                 ; [#uses=1 type=i4] [debug line = 20:72]
  call void @llvm.dbg.value(metadata !{i4 %n.1}, i64 0, metadata !1063), !dbg !1062 ; [debug line = 20:72] [debug variable = n]
  br label %4, !dbg !1062                         ; [debug line = 20:72]

; <label>:7                                       ; preds = %4
  %tmp1.cast.lcssa = phi i29 [ %tmp1.cast, %4 ]   ; [#uses=1 type=i29]
  %tmp.2 = add i29 %tmp1.cast.lcssa, 4096, !dbg !1064 ; [#uses=1 type=i29] [debug line = 24:7]
  %tmp.3 = lshr i29 %tmp.2, 13, !dbg !1064        ; [#uses=1 type=i29] [debug line = 24:7]
  %tmp.4 = trunc i29 %tmp.3 to i16, !dbg !1064    ; [#uses=1 type=i16] [debug line = 24:7]
  %dst.addr = getelementptr [8 x [8 x i16]]* %dst, i64 0, i64 %tmp.11.cast, i64 %tmp, !dbg !1064 ; [#uses=1 type=i16*] [debug line = 24:7]
  store i16 %tmp.4, i16* %dst.addr, align 2, !dbg !1064 ; [debug line = 24:7]
  %8 = call i32 (...)* @_ssdm_op_SpecRegionEnd([15 x i8]* @.str, i32 %tmp.) nounwind, !dbg !1065 ; [#uses=0 type=i32] [debug line = 25:4]
  %k.1 = add i4 %k, 1, !dbg !1066                 ; [#uses=1 type=i4] [debug line = 18:61]
  call void @llvm.dbg.value(metadata !{i4 %k.1}, i64 0, metadata !1067), !dbg !1066 ; [debug line = 18:61] [debug variable = k]
  br label %1, !dbg !1066                         ; [debug line = 18:61]

; <label>:9                                       ; preds = %1
  ret void, !dbg !1068                            ; [debug line = 26:1]
}
...
!953 = metadata !{i32 66, i32 64, metadata !950, metadata !938}
!954 = metadata !{i32 786688, metadata !944, metadata !"c", metadata !12, i32 61, metadata !34, i32 0, metadata !938} ; [ DW_TAG_auto_variable ]
!955 = metadata !{i32 68, i32 4, metadata !946, metadata !938}
!956 = metadata !{i32 64, i32 61, metadata !943, metadata !938}
!957 = metadata !{i32 786688, metadata !944, metadata !"r", metadata !12, i32 61, metadata !34, i32 0, metadata !938} ; [ DW_TAG_auto_variable ]
!958 = metadata !{i32 91, i32 4, metadata !927, null}
!959 = metadata !{i32 786689, metadata !960, metadata !"buf", null, i32 71, metadata !928, i32 0, metadata !963} ; [ DW_TAG_arg_variable ]
!960 = metadata !{i32 786478, i32 0, metadata !12, metadata !"write_data", metadata !"write_data", metadata !"_Z10write_dataPA8_sPs", metadata !12, i32 71, metadata !961, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, null, metadata !18, i32 72} ; [ DW_TAG_subprogram ]
!961 = metadata !{i32 786453, i32 0, metadata !"", i32 0, i32 0, i64 0, i64 0, i64 0, i32 0, null, metadata !962, i32 0, i32 0} ; [ DW_TAG_subroutine_type ]
!962 = metadata !{null, metadata !936, metadata !919}
!963 = metadata !{i32 94, i32 4, metadata !927, null}
!964 = metadata !{i32 71, i32 23, metadata !960, metadata !963}
!965 = metadata !{i32 786689, metadata !960, metadata !"output", null, i32 71, metadata !920, i32 0, metadata !963} ; [ DW_TAG_arg_variable ]
!966 = metadata !{i32 71, i32 116, metadata !960, metadata !963}
!967 = metadata !{i32 76, i32 9, metadata !968, metadata !963}
!968 = metadata !{i32 786443, metadata !969, i32 76, i32 4, metadata !12, i32 24} ; [ DW_TAG_lexical_block ]
!969 = metadata !{i32 786443, metadata !960, i32 72, i32 1, metadata !12, i32 23} ; [ DW_TAG_lexical_block ]
!970 = metadata !{i32 76, i32 67, metadata !971, metadata !963}
!971 = metadata !{i32 786443, metadata !968, i32 76, i32 66, metadata !12, i32 25} ; [ DW_TAG_lexical_block ]
!972 = metadata !{i32 76, i32 104, metadata !971, metadata !963}
!973 = metadata !{i32 79, i32 1, metadata !974, metadata !963}
!974 = metadata !{i32 786443, metadata !975, i32 79, i32 10, metadata !12, i32 27} ; [ DW_TAG_lexical_block ]
!975 = metadata !{i32 786443, metadata !971, i32 78, i32 7, metadata !12, i32 26} ; [ DW_TAG_lexical_block ]
!976 = metadata !{i32 78, i32 12, metadata !975, metadata !963}
!977 = metadata !{i32 79, i32 11, metadata !974, metadata !963}
!978 = metadata !{i32 78, i32 64, metadata !975, metadata !963}
!979 = metadata !{i32 786688, metadata !969, metadata !"c", metadata !12, i32 73, metadata !34, i32 0, metadata !963} ; [ DW_TAG_auto_variable ]
!980 = metadata !{i32 80, i32 4, metadata !971, metadata !963}
!981 = metadata !{i32 76, i32 61, metadata !968, metadata !963}
!982 = metadata !{i32 786688, metadata !969, metadata !"r", metadata !12, i32 73, metadata !34, i32 0, metadata !963} ; [ DW_TAG_auto_variable ]
!983 = metadata !{i32 95, i32 1, metadata !927, null}
!984 = metadata !{i32 786689, metadata !985, metadata !"in_block", null, i32 28, metadata !990, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!985 = metadata !{i32 786478, i32 0, metadata !12, metadata !"dct_2d", metadata !"dct_2d", metadata !"_Z6dct_2dPA8_sS0_", metadata !12, i32 28, metadata !986, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, null, metadata !18, i32 30} ; [ DW_TAG_subprogram ]
!986 = metadata !{i32 786453, i32 0, metadata !"", i32 0, i32 0, i64 0, i64 0, i64 0, i32 0, null, metadata !987, i32 0, i32 0} ; [ DW_TAG_subroutine_type ]
!987 = metadata !{null, metadata !988, metadata !988}
!988 = metadata !{i32 786447, null, metadata !"", null, i32 0, i64 64, i64 64, i64 0, i32 0, metadata !989} ; [ DW_TAG_pointer_type ]
!989 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 128, i64 16, i32 0, i32 0, metadata !16, metadata !92, i32 0, i32 0} ; [ DW_TAG_array_type ]
!990 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 1024, i64 16, i32 0, i32 0, metadata !16, metadata !22, i32 0, i32 0} ; [ DW_TAG_array_type ]
!991 = metadata !{i32 28, i32 24, metadata !985, null}
!992 = metadata !{i32 786689, metadata !985, metadata !"out_block", null, i32 29, metadata !990, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!993 = metadata !{i32 29, i32 18, metadata !985, null}
!994 = metadata !{i32 786688, metadata !995, metadata !"row_outbuf", metadata !12, i32 31, metadata !990, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!995 = metadata !{i32 786443, metadata !985, i32 30, i32 1, metadata !12, i32 5} ; [ DW_TAG_lexical_block ]
!996 = metadata !{i32 31, i32 15, metadata !995, null}
!997 = metadata !{i32 786688, metadata !995, metadata !"col_outbuf", metadata !12, i32 32, metadata !990, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!998 = metadata !{i32 32, i32 15, metadata !995, null}
!999 = metadata !{i32 786688, metadata !995, metadata !"col_inbuf", metadata !12, i32 32, metadata !990, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!1000 = metadata !{i32 32, i32 109, metadata !995, null}
!1001 = metadata !{i32 37, i32 8, metadata !1002, null}
!1002 = metadata !{i32 786443, metadata !995, i32 37, i32 4, metadata !12, i32 6} ; [ DW_TAG_lexical_block ]
!1003 = metadata !{i32 37, i32 66, metadata !1004, null}
!1004 = metadata !{i32 786443, metadata !1002, i32 37, i32 65, metadata !12, i32 7} ; [ DW_TAG_lexical_block ]
!1005 = metadata !{i32 38, i32 7, metadata !1004, null}
!1006 = metadata !{i32 37, i32 60, metadata !1002, null}
!1007 = metadata !{i32 786688, metadata !995, metadata !"i", metadata !12, i32 33, metadata !1008, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!1008 = metadata !{i32 786468, null, metadata !"unsigned int", null, i32 0, i64 32, i64 32, i64 0, i32 0, i32 7} ; [ DW_TAG_base_type ]
!1009 = metadata !{i32 42, i32 9, metadata !1010, null}
!1010 = metadata !{i32 786443, metadata !995, i32 42, i32 4, metadata !12, i32 8} ; [ DW_TAG_lexical_block ]
!1011 = metadata !{i32 43, i32 2, metadata !1012, null}
!1012 = metadata !{i32 786443, metadata !1010, i32 43, i32 1, metadata !12, i32 9} ; [ DW_TAG_lexical_block ]
!1013 = metadata !{i32 43, i32 48, metadata !1012, null}
!1014 = metadata !{i32 45, i32 1, metadata !1015, null}
!1015 = metadata !{i32 786443, metadata !1016, i32 45, i32 10, metadata !12, i32 11} ; [ DW_TAG_lexical_block ]
!1016 = metadata !{i32 786443, metadata !1012, i32 44, i32 7, metadata !12, i32 10} ; [ DW_TAG_lexical_block ]
!1017 = metadata !{i32 44, i32 11, metadata !1016, null}
!1018 = metadata !{i32 45, i32 11, metadata !1015, null}
!1019 = metadata !{i32 44, i32 63, metadata !1016, null}
!1020 = metadata !{i32 45, i32 77, metadata !1012, null}
!1021 = metadata !{i32 42, i32 61, metadata !1010, null}
!1022 = metadata !{i32 786688, metadata !995, metadata !"j", metadata !12, i32 33, metadata !1008, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!1023 = metadata !{i32 48, i32 9, metadata !1024, null}
!1024 = metadata !{i32 786443, metadata !995, i32 48, i32 4, metadata !12, i32 12} ; [ DW_TAG_lexical_block ]
!1025 = metadata !{i32 48, i32 67, metadata !1026, null}
!1026 = metadata !{i32 786443, metadata !1024, i32 48, i32 66, metadata !12, i32 13} ; [ DW_TAG_lexical_block ]
!1027 = metadata !{i32 49, i32 7, metadata !1026, null}
!1028 = metadata !{i32 48, i32 61, metadata !1024, null}
!1029 = metadata !{i32 53, i32 9, metadata !1030, null}
!1030 = metadata !{i32 786443, metadata !995, i32 53, i32 4, metadata !12, i32 14} ; [ DW_TAG_lexical_block ]
!1031 = metadata !{i32 54, i32 2, metadata !1032, null}
!1032 = metadata !{i32 786443, metadata !1030, i32 54, i32 1, metadata !12, i32 15} ; [ DW_TAG_lexical_block ]
!1033 = metadata !{i32 54, i32 48, metadata !1032, null}
!1034 = metadata !{i32 56, i32 1, metadata !1035, null}
!1035 = metadata !{i32 786443, metadata !1036, i32 56, i32 10, metadata !12, i32 17} ; [ DW_TAG_lexical_block ]
!1036 = metadata !{i32 786443, metadata !1032, i32 55, i32 7, metadata !12, i32 16} ; [ DW_TAG_lexical_block ]
!1037 = metadata !{i32 55, i32 11, metadata !1036, null}
!1038 = metadata !{i32 56, i32 11, metadata !1035, null}
!1039 = metadata !{i32 55, i32 63, metadata !1036, null}
!1040 = metadata !{i32 56, i32 77, metadata !1032, null}
!1041 = metadata !{i32 53, i32 61, metadata !1030, null}
!1042 = metadata !{i32 57, i32 1, metadata !995, null}
!1043 = metadata !{i32 786689, metadata !11, metadata !"src", null, i32 9, metadata !1044, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!1044 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 0, i64 0, i32 0, i32 0, metadata !16, metadata !92, i32 0, i32 0} ; [ DW_TAG_array_type ]
!1045 = metadata !{i32 9, i32 24, metadata !11, null}
!1046 = metadata !{i32 786689, metadata !11, metadata !"dst", null, i32 9, metadata !1044, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!1047 = metadata !{i32 9, i32 81, metadata !11, null}
!1048 = metadata !{i32 18, i32 9, metadata !1049, null}
!1049 = metadata !{i32 786443, metadata !1050, i32 18, i32 4, metadata !12, i32 1} ; [ DW_TAG_lexical_block ]
!1050 = metadata !{i32 786443, metadata !11, i32 10, i32 1, metadata !12, i32 0} ; [ DW_TAG_lexical_block ]
!1051 = metadata !{i32 18, i32 67, metadata !1052, null}
!1052 = metadata !{i32 786443, metadata !1049, i32 18, i32 66, metadata !12, i32 2} ; [ DW_TAG_lexical_block ]
!1053 = metadata !{i32 18, i32 107, metadata !1052, null}
!1054 = metadata !{i32 21, i32 48, metadata !1055, null}
!1055 = metadata !{i32 786443, metadata !1056, i32 20, i32 77, metadata !12, i32 4} ; [ DW_TAG_lexical_block ]
!1056 = metadata !{i32 786443, metadata !1052, i32 20, i32 7, metadata !12, i32 3} ; [ DW_TAG_lexical_block ]
!1057 = metadata !{i32 20, i32 11, metadata !1056, null}
!1058 = metadata !{i32 20, i32 78, metadata !1055, null}
!1059 = metadata !{i32 786688, metadata !1055, metadata !"coeff", metadata !12, i32 21, metadata !34, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!1060 = metadata !{i32 22, i32 10, metadata !1055, null}
!1061 = metadata !{i32 786688, metadata !1050, metadata !"tmp", metadata !12, i32 12, metadata !34, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!1062 = metadata !{i32 20, i32 72, metadata !1056, null}
!1063 = metadata !{i32 786688, metadata !1050, metadata !"n", metadata !12, i32 11, metadata !1008, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!1064 = metadata !{i32 24, i32 7, metadata !1052, null}
!1065 = metadata !{i32 25, i32 4, metadata !1052, null}
!1066 = metadata !{i32 18, i32 61, metadata !1049, null}
!1067 = metadata !{i32 786688, metadata !1050, metadata !"k", metadata !12, i32 11, metadata !1008, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!1068 = metadata !{i32 26, i32 1, metadata !1050, null}
