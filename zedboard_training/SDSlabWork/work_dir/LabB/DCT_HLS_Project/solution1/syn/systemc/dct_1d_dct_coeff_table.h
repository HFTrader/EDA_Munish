...
#ifndef _dct_1d_dct_coeff_table_H_
#define _dct_1d_dct_coeff_table_H_
...
struct dct_1d_dct_coeff_table_core : public sc_core::sc_module
{
public:
    ...
    SC_HAS_PROCESS(dct_1d_dct_coeff_table_core);
    dct_1d_dct_coeff_table_core(sc_core::sc_module_name) {
        ...
        for (unsigned i = 0; i < 8 ; i = i + 1) {
            mem[i] = "010000000000000";
        }
        mem[8] = "010110001100011";
        mem[9] = "010010110100001";
        mem[10] = "001100100100100";
        mem[11] = "000100011010100";
        mem[12] = "111011100101100";
        mem[13] = "110011011011100";
        mem[14] = "101101001100000";
        mem[15] = "101001110011110";
        mem[16] = "010100111001111";
        mem[17] = "001000101010001";
        mem[18] = "110111010101111";
        mem[19] = "101011000110001";
        mem[20] = "101011000110001";
        mem[21] = "110111010101111";
        mem[22] = "001000101010001";
        mem[23] = "010100111001111";
        mem[24] = "010010110100001";
        mem[25] = "111011100101100";
        mem[26] = "101001110011110";
        mem[27] = "110011011011100";
        mem[28] = "001100100100100";
        mem[29] = "010110001100011";
        mem[30] = "000100011010100";
        mem[31] = "101101001100000";
        mem[32] = "010000000000000";
        mem[33] = "110000000000000";
        mem[34] = "110000000000000";
        mem[35] = "010000000000000";
        mem[36] = "010000000000000";
        mem[37] = "110000000000001";
        mem[38] = "110000000000001";
        mem[39] = "010000000000000";
        mem[40] = "001100100100100";
        mem[41] = "101001110011110";
        mem[42] = "000100011010100";
        mem[43] = "010010110100001";
        mem[44] = "101101001100000";
        mem[45] = "111011100101100";
        mem[46] = "010110001100011";
        mem[47] = "110011011011100";
        mem[48] = "001000101010001";
        mem[49] = "101011000110001";
        mem[50] = "010100111001111";
        mem[51] = "110111010101111";
        mem[52] = "110111010101111";
        mem[53] = "010100111001111";
        mem[54] = "101011000110001";
        mem[55] = "001000101010001";
        mem[56] = "000100011010100";
        mem[57] = "110011011011100";
        mem[58] = "010010110100001";
        mem[59] = "101001110011110";
        mem[60] = "010110001100011";
        mem[61] = "101101001100000";
        mem[62] = "001100100100100";
        mem[63] = "111011100101100";
    }
...
SC_MODULE( dct_1d_dct_coeff_table )
{
    ...
    SC_CTOR( dct_1d_dct_coeff_table ) {
        meminst = new dct_1d_dct_coeff_table_core <1, 1, DataWidth, AddressWidth, AddressRange>("core_inst");
...
public:
    ...
    dct_1d_dct_coeff_table_core <1, 1, DataWidth, AddressWidth, AddressRange>* meminst;
};

#endif //_dct_1d_dct_coeff_table_H_
