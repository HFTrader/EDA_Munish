...
#ifndef _dct_2d_row_outbuf_H_
#define _dct_2d_row_outbuf_H_
...
struct dct_2d_row_outbuf_core : public sc_core::sc_module
{
public:
    ...
    SC_HAS_PROCESS(dct_2d_row_outbuf_core);
    dct_2d_row_outbuf_core(sc_core::sc_module_name) {
...
SC_MODULE( dct_2d_row_outbuf )
{
    ...
    SC_CTOR( dct_2d_row_outbuf ) {
        meminst = new dct_2d_row_outbuf_core <1, 1, DataWidth, AddressWidth, AddressRange>("core_inst");
...
public:
    ...
    dct_2d_row_outbuf_core <1, 1, DataWidth, AddressWidth, AddressRange>* meminst;
};

#endif //_dct_2d_row_outbuf_H_
