...
define void @fir(i32* %y, [11 x i32]* %c, i32 %x) nounwind uwtable {
  ...
  %c_addr = getelementptr [11 x i32]* %c, i64 0, i64 0
...
; <label>:3                                       ; preds = %2
  ...
  %tmp_2 = mul nsw i32 %c_load, %x_read
  store i32 %x_read, i32* getelementptr inbounds ([11 x i32]* @shift_reg, i64 0, i64 0), align 16
  br label %5

; <label>:4                                       ; preds = %2
  %tmp_7 = trunc i5 %i to i4
  %tmp_3 = add i4 %tmp_7, -1
  %tmp_4 = zext i4 %tmp_3 to i64
  %shift_reg_addr = getelementptr inbounds [11 x i32]* @shift_reg, i64 0, i64 %tmp_4
  %shift_reg_load = load i32* %shift_reg_addr, align 4
  %tmp_5 = zext i32 %i_cast to i64
  %shift_reg_addr_1 = getelementptr inbounds [11 x i32]* @shift_reg, i64 0, i64 %tmp_5
  store i32 %shift_reg_load, i32* %shift_reg_addr_1, align 4
  %c_addr_1 = getelementptr [11 x i32]* %c, i64 0, i64 %tmp_5
  %c_load_1 = load i32* %c_addr_1, align 4
  %tmp_6 = mul nsw i32 %c_load_1, %shift_reg_load
  br label %5

; <label>:5                                       ; preds = %4, %3
  %p_pn = phi i32 [ %tmp_2, %3 ], [ %tmp_6, %4 ]
